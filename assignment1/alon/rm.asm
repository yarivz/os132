...
main(int argc, char *argv[])
{
  ...
  47:	e8 ac 04 00 00       	call   4f8 <unlink>
  ...
  66:	c7 44 24 04 09 0a 00 	movl   $0xa09,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5b6:	0f b6 80 e8 0c 00 00 	movzbl 0xce8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 71b:	75 27                	jne    744 <printf+0x11f>
          s = "(null)";
 71d:	c7 45 f4 22 0a 00 00 	movl   $0xa22,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7eb:	a1 04 0d 00 00       	mov    0xd04,%eax
...
free(void *ap)
{
 ...
 8b6:	a3 04 0d 00 00       	mov    %eax,0xd04
}
 8bb:	c9                   	leave  
 8bc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 909:	e8 ce fe ff ff       	call   7dc <free>
  return freep;
 90e:	a1 04 0d 00 00       	mov    0xd04,%eax
}
 913:	c9                   	leave  
 914:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 927:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 92a:	a1 04 0d 00 00       	mov    0xd04,%eax
 92f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 932:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 936:	75 23                	jne    95b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 938:	c7 45 f0 fc 0c 00 00 	movl   $0xcfc,-0x10(%ebp)
 93f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 942:	a3 04 0d 00 00       	mov    %eax,0xd04
 947:	a1 04 0d 00 00       	mov    0xd04,%eax
 94c:	a3 fc 0c 00 00       	mov    %eax,0xcfc
    base.s.size = 0;
 951:	c7 05 00 0d 00 00 00 	movl   $0x0,0xd00
 958:	00 00 00 
  }
 ...
 9ae:	a3 04 0d 00 00       	mov    %eax,0xd04
      return (void*)(p + 1);
 ...
 9b9:	eb 38                	jmp    9f3 <malloc+0xde>
    ...
    if(p == freep)
 9bb:	a1 04 0d 00 00       	mov    0xd04,%eax
