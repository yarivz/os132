...
main(int argc, char *argv[])
{
  ...
  41:	e8 92 04 00 00       	call   4d8 <unlink>
  ...
  5a:	c7 44 24 04 d7 09 00 	movl   $0x9d7,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 596:	0f b6 90 b4 0c 00 00 	movzbl 0xcb4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6f5:	75 27                	jne    71e <printf+0x11f>
          s = "(null)";
 6f7:	c7 45 f4 f0 09 00 00 	movl   $0x9f0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c3:	a1 d0 0c 00 00       	mov    0xcd0,%eax
...
morecore(uint nu)
{
 ...
 8d7:	e8 d8 fe ff ff       	call   7b4 <free>
  return freep;
 8dc:	a1 d0 0c 00 00       	mov    0xcd0,%eax
}
 8e1:	c9                   	leave  
 8e2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8f5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8f8:	a1 d0 0c 00 00       	mov    0xcd0,%eax
 8fd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 900:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 904:	75 23                	jne    929 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 906:	c7 45 f0 c8 0c 00 00 	movl   $0xcc8,-0x10(%ebp)
 90d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 910:	a3 d0 0c 00 00       	mov    %eax,0xcd0
 915:	a1 d0 0c 00 00       	mov    0xcd0,%eax
 91a:	a3 c8 0c 00 00       	mov    %eax,0xcc8
    base.s.size = 0;
 91f:	c7 05 cc 0c 00 00 00 	movl   $0x0,0xccc
 926:	00 00 00 
  }
 ...
 97c:	a3 d0 0c 00 00       	mov    %eax,0xcd0
      return (void*)(p + 1);
 ...
 987:	eb 38                	jmp    9c1 <malloc+0xde>
    ...
    if(p == freep)
 989:	a1 d0 0c 00 00       	mov    0xcd0,%eax
