...
main(int argc, char *argv[])
{
  ...
  41:	e8 b2 04 00 00       	call   4f8 <mkdir>
  ...
  5a:	c7 44 24 04 e2 09 00 	movl   $0x9e2,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 59e:	0f b6 90 c4 0c 00 00 	movzbl 0xcc4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6fd:	75 27                	jne    726 <printf+0x11f>
          s = "(null)";
 6ff:	c7 45 f4 fe 09 00 00 	movl   $0x9fe,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7cb:	a1 e0 0c 00 00       	mov    0xce0,%eax
...
free(void *ap)
{
 ...
 88c:	a3 e0 0c 00 00       	mov    %eax,0xce0
}
 891:	c9                   	leave  
 892:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8df:	e8 d8 fe ff ff       	call   7bc <free>
  return freep;
 8e4:	a1 e0 0c 00 00       	mov    0xce0,%eax
}
 8e9:	c9                   	leave  
 8ea:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 900:	a1 e0 0c 00 00       	mov    0xce0,%eax
 905:	89 45 f0             	mov    %eax,-0x10(%ebp)
 908:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 90c:	75 23                	jne    931 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 90e:	c7 45 f0 d8 0c 00 00 	movl   $0xcd8,-0x10(%ebp)
 915:	8b 45 f0             	mov    -0x10(%ebp),%eax
 918:	a3 e0 0c 00 00       	mov    %eax,0xce0
 91d:	a1 e0 0c 00 00       	mov    0xce0,%eax
 922:	a3 d8 0c 00 00       	mov    %eax,0xcd8
    base.s.size = 0;
 927:	c7 05 dc 0c 00 00 00 	movl   $0x0,0xcdc
 92e:	00 00 00 
  }
 ...
 984:	a3 e0 0c 00 00       	mov    %eax,0xce0
      return (void*)(p + 1);
 ...
 98f:	eb 38                	jmp    9c9 <malloc+0xde>
    ...
    if(p == freep)
 991:	a1 e0 0c 00 00       	mov    0xce0,%eax
