...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 dc 60 00 00       	mov    0x60dc,%eax
       b:	c7 44 24 04 1a 43 00 	movl   $0x431a,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 24 3f 00 00       	call   3f3f <printf>
  fd = open("echo", 0);
      1b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      22:	00 
      23:	c7 04 24 04 43 00 00 	movl   $0x4304,(%esp)
      2a:	e8 d9 3d 00 00       	call   3e08 <open>
      2f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
      32:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
      36:	79 1a                	jns    52 <opentest+0x52>
    printf(stdout, "open echo failed!\n");
      38:	a1 dc 60 00 00       	mov    0x60dc,%eax
      3d:	c7 44 24 04 25 43 00 	movl   $0x4325,0x4(%esp)
      44:	00 
      45:	89 04 24             	mov    %eax,(%esp)
      48:	e8 f2 3e 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
      ...
      58:	e8 93 3d 00 00       	call   3df0 <close>
  fd = open("doesnotexist", 0);
      5d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
      64:	00 
      65:	c7 04 24 38 43 00 00 	movl   $0x4338,(%esp)
      6c:	e8 97 3d 00 00       	call   3e08 <open>
      71:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
      74:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
      78:	78 1a                	js     94 <opentest+0x94>
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 dc 60 00 00       	mov    0x60dc,%eax
      7f:	c7 44 24 04 45 43 00 	movl   $0x4345,0x4(%esp)
      86:	00 
      87:	89 04 24             	mov    %eax,(%esp)
      8a:	e8 b0 3e 00 00       	call   3f3f <printf>
    exit();
      8f:	e8 2c 3d 00 00       	call   3dc0 <exit>
  }
  printf(stdout, "open test ok\n");
      94:	a1 dc 60 00 00       	mov    0x60dc,%eax
      99:	c7 44 24 04 63 43 00 	movl   $0x4363,0x4(%esp)
      a0:	00 
      a1:	89 04 24             	mov    %eax,(%esp)
      a4:	e8 96 3e 00 00       	call   3f3f <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 dc 60 00 00       	mov    0x60dc,%eax
      b6:	c7 44 24 04 71 43 00 	movl   $0x4371,0x4(%esp)
      bd:	00 
      be:	89 04 24             	mov    %eax,(%esp)
      c1:	e8 79 3e 00 00       	call   3f3f <printf>
  fd = open("small", O_CREATE|O_RDWR);
      c6:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
      cd:	00 
      ce:	c7 04 24 82 43 00 00 	movl   $0x4382,(%esp)
      d5:	e8 2e 3d 00 00       	call   3e08 <open>
      da:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd >= 0){
      dd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
      e1:	78 21                	js     104 <writetest+0x59>
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 dc 60 00 00       	mov    0x60dc,%eax
      e8:	c7 44 24 04 88 43 00 	movl   $0x4388,0x4(%esp)
      ef:	00 
      f0:	89 04 24             	mov    %eax,(%esp)
      f3:	e8 47 3e 00 00       	call   3f3f <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 dc 60 00 00       	mov    0x60dc,%eax
     109:	c7 44 24 04 a3 43 00 	movl   $0x43a3,0x4(%esp)
     110:	00 
     111:	89 04 24             	mov    %eax,(%esp)
     114:	e8 26 3e 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 bf 43 00 	movl   $0x43bf,0x4(%esp)
     12d:	00 
     12e:	8b 45 f0             	mov    -0x10(%ebp),%eax
     131:	89 04 24             	mov    %eax,(%esp)
     134:	e8 af 3c 00 00       	call   3de8 <write>
     139:	83 f8 0a             	cmp    $0xa,%eax
     13c:	74 21                	je     15f <writetest+0xb4>
      printf(stdout, "error: write aa %d new file failed\n", i);
     13e:	a1 dc 60 00 00       	mov    0x60dc,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 cc 43 00 	movl   $0x43cc,0x4(%esp)
     151:	00 
     152:	89 04 24             	mov    %eax,(%esp)
     155:	e8 e5 3d 00 00       	call   3f3f <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 f0 43 00 	movl   $0x43f0,0x4(%esp)
     16e:	00 
     16f:	8b 45 f0             	mov    -0x10(%ebp),%eax
     172:	89 04 24             	mov    %eax,(%esp)
     175:	e8 6e 3c 00 00       	call   3de8 <write>
     17a:	83 f8 0a             	cmp    $0xa,%eax
     17d:	74 21                	je     1a0 <writetest+0xf5>
      printf(stdout, "error: write bb %d new file failed\n", i);
     17f:	a1 dc 60 00 00       	mov    0x60dc,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 fc 43 00 	movl   $0x43fc,0x4(%esp)
     192:	00 
     193:	89 04 24             	mov    %eax,(%esp)
     196:	e8 a4 3d 00 00       	call   3f3f <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 dc 60 00 00       	mov    0x60dc,%eax
     1b3:	c7 44 24 04 20 44 00 	movl   $0x4420,0x4(%esp)
     1ba:	00 
     1bb:	89 04 24             	mov    %eax,(%esp)
     1be:	e8 7c 3d 00 00       	call   3f3f <printf>
  close(fd);
     1c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
     1c6:	89 04 24             	mov    %eax,(%esp)
     1c9:	e8 22 3c 00 00       	call   3df0 <close>
  fd = open("small", O_RDONLY);
     1ce:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     1d5:	00 
     1d6:	c7 04 24 82 43 00 00 	movl   $0x4382,(%esp)
     1dd:	e8 26 3c 00 00       	call   3e08 <open>
     1e2:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd >= 0){
     1e5:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
     1e9:	78 3e                	js     229 <writetest+0x17e>
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 dc 60 00 00       	mov    0x60dc,%eax
     1f0:	c7 44 24 04 2b 44 00 	movl   $0x442b,0x4(%esp)
     1f7:	00 
     1f8:	89 04 24             	mov    %eax,(%esp)
     1fb:	e8 3f 3d 00 00       	call   3f3f <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     216:	e8 c5 3b 00 00       	call   3de0 <read>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 dc 60 00 00       	mov    0x60dc,%eax
     22e:	c7 44 24 04 44 44 00 	movl   $0x4444,0x4(%esp)
     235:	00 
     236:	89 04 24             	mov    %eax,(%esp)
     239:	e8 01 3d 00 00       	call   3f3f <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 dc 60 00 00       	mov    0x60dc,%eax
     248:	c7 44 24 04 5f 44 00 	movl   $0x445f,0x4(%esp)
     24f:	00 
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 e7 3c 00 00       	call   3f3f <printf>
  } else {
  ...
  close(fd);
     ...
     25e:	e8 8d 3b 00 00       	call   3df0 <close>

  if(unlink("small") < 0){
     263:	c7 04 24 82 43 00 00 	movl   $0x4382,(%esp)
     26a:	e8 a9 3b 00 00       	call   3e18 <unlink>
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 dc 60 00 00       	mov    0x60dc,%eax
     27a:	c7 44 24 04 72 44 00 	movl   $0x4472,0x4(%esp)
     281:	00 
     282:	89 04 24             	mov    %eax,(%esp)
     285:	e8 b5 3c 00 00       	call   3f3f <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 dc 60 00 00       	mov    0x60dc,%eax
     294:	c7 44 24 04 7f 44 00 	movl   $0x447f,0x4(%esp)
     29b:	00 
     29c:	89 04 24             	mov    %eax,(%esp)
     29f:	e8 9b 3c 00 00       	call   3f3f <printf>
    exit();
     2a4:	e8 17 3b 00 00       	call   3dc0 <exit>
  }
  printf(stdout, "small file test ok\n");
     2a9:	a1 dc 60 00 00       	mov    0x60dc,%eax
     2ae:	c7 44 24 04 94 44 00 	movl   $0x4494,0x4(%esp)
     2b5:	00 
     2b6:	89 04 24             	mov    %eax,(%esp)
     2b9:	e8 81 3c 00 00       	call   3f3f <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 dc 60 00 00       	mov    0x60dc,%eax
     2cb:	c7 44 24 04 a8 44 00 	movl   $0x44a8,0x4(%esp)
     2d2:	00 
     2d3:	89 04 24             	mov    %eax,(%esp)
     2d6:	e8 64 3c 00 00       	call   3f3f <printf>

  fd = open("big", O_CREATE|O_RDWR);
     2db:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     2e2:	00 
     2e3:	c7 04 24 b8 44 00 00 	movl   $0x44b8,(%esp)
     2ea:	e8 19 3b 00 00       	call   3e08 <open>
     2ef:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
     2f2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     2f6:	79 1a                	jns    312 <writetest1+0x52>
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 dc 60 00 00       	mov    0x60dc,%eax
     2fd:	c7 44 24 04 bc 44 00 	movl   $0x44bc,0x4(%esp)
     304:	00 
     305:	89 04 24             	mov    %eax,(%esp)
     308:	e8 32 3c 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
     ...
     37c:	e8 6f 3a 00 00       	call   3df0 <close>

  fd = open("big", O_RDONLY);
     381:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     388:	00 
     389:	c7 04 24 b8 44 00 00 	movl   $0x44b8,(%esp)
     390:	e8 73 3a 00 00       	call   3e08 <open>
     395:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
     398:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
     39c:	79 1a                	jns    3b8 <writetest1+0xf8>
    printf(stdout, "error: open big failed!\n");
     39e:	a1 dc 60 00 00       	mov    0x60dc,%eax
     3a3:	c7 44 24 04 f4 44 00 	movl   $0x44f4,0x4(%esp)
     3aa:	00 
     3ab:	89 04 24             	mov    %eax,(%esp)
     3ae:	e8 8c 3b 00 00       	call   3f3f <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3d5:	e8 06 3a 00 00       	call   3de0 <read>
    ...
    if(i == 0){
     ...
     3f0:	a1 dc 60 00 00       	mov    0x60dc,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 0d 45 00 	movl   $0x450d,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 33 3b 00 00       	call   3f3f <printf>
        exit();
     ...
     41a:	a1 dc 60 00 00       	mov    0x60dc,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 2a 45 00 	movl   $0x452a,0x4(%esp)
     42d:	00 
     42e:	89 04 24             	mov    %eax,(%esp)
     431:	e8 09 3b 00 00       	call   3f3f <printf>
      exit();
  ...
  close(fd);
     ...
     483:	e8 68 39 00 00       	call   3df0 <close>
  if(unlink("big") < 0){
     488:	c7 04 24 b8 44 00 00 	movl   $0x44b8,(%esp)
     48f:	e8 84 39 00 00       	call   3e18 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 dc 60 00 00       	mov    0x60dc,%eax
     49d:	c7 44 24 04 5c 45 00 	movl   $0x455c,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 92 3a 00 00       	call   3f3f <printf>
    exit();
     4ad:	e8 0e 39 00 00       	call   3dc0 <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 dc 60 00 00       	mov    0x60dc,%eax
     4b7:	c7 44 24 04 6f 45 00 	movl   $0x456f,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 78 3a 00 00       	call   3f3f <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 dc 60 00 00       	mov    0x60dc,%eax
     4d4:	c7 44 24 04 80 45 00 	movl   $0x4580,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 5b 3a 00 00       	call   3f3f <printf>
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     55b:	e8 b8 38 00 00       	call   3e18 <unlink>
    fd = open(name, O_CREATE|O_RDWR);
    close(fd);
  }
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 dc 60 00 00       	mov    0x60dc,%eax
     56f:	c7 44 24 04 a8 45 00 	movl   $0x45a8,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 c0 39 00 00       	call   3f3f <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 dc 60 00 00       	mov    0x60dc,%eax
     58c:	c7 44 24 04 ce 45 00 	movl   $0x45ce,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 a3 39 00 00       	call   3f3f <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 da 45 00 00 	movl   $0x45da,(%esp)
     5a3:	e8 88 38 00 00       	call   3e30 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 dc 60 00 00       	mov    0x60dc,%eax
     5b1:	c7 44 24 04 df 45 00 	movl   $0x45df,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 7e 39 00 00       	call   3f3f <printf>
    exit();
     5c1:	e8 fa 37 00 00       	call   3dc0 <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 da 45 00 00 	movl   $0x45da,(%esp)
     5cd:	e8 66 38 00 00       	call   3e38 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 dc 60 00 00       	mov    0x60dc,%eax
     5db:	c7 44 24 04 ed 45 00 	movl   $0x45ed,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 54 39 00 00       	call   3f3f <printf>
    exit();
     5eb:	e8 d0 37 00 00       	call   3dc0 <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 00 46 00 00 	movl   $0x4600,(%esp)
     5f7:	e8 3c 38 00 00       	call   3e38 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 dc 60 00 00       	mov    0x60dc,%eax
     605:	c7 44 24 04 03 46 00 	movl   $0x4603,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 2a 39 00 00       	call   3f3f <printf>
    exit();
     615:	e8 a6 37 00 00       	call   3dc0 <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 da 45 00 00 	movl   $0x45da,(%esp)
     621:	e8 f2 37 00 00       	call   3e18 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 dc 60 00 00       	mov    0x60dc,%eax
     62f:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 00 39 00 00       	call   3f3f <printf>
    exit();
     63f:	e8 7c 37 00 00       	call   3dc0 <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 dc 60 00 00       	mov    0x60dc,%eax
     649:	c7 44 24 04 ce 45 00 	movl   $0x45ce,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 e6 38 00 00       	call   3f3f <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 dc 60 00 00       	mov    0x60dc,%eax
     666:	c7 44 24 04 28 46 00 	movl   $0x4628,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 c9 38 00 00       	call   3f3f <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 c8 60 00 	movl   $0x60c8,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 04 43 00 00 	movl   $0x4304,(%esp)
     685:	e8 76 37 00 00       	call   3e00 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 dc 60 00 00       	mov    0x60dc,%eax
     693:	c7 44 24 04 33 46 00 	movl   $0x4633,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 9c 38 00 00       	call   3f3f <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     6b6:	e8 1d 37 00 00       	call   3dd8 <pipe>
     6bb:	85 c0                	test   %eax,%eax
     6bd:	74 19                	je     6d8 <pipe1+0x2e>
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 45 46 00 	movl   $0x4645,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 6c 38 00 00       	call   3f3f <printf>
    exit();
  ...
  if(pid == 0){
    ...
    close(fds[0]);
     ...
     6f7:	e8 f4 36 00 00       	call   3df0 <close>
    for(n = 0; n < 5; n++){
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     743:	e8 a0 36 00 00       	call   3de8 <write>
     748:	3d 09 04 00 00       	cmp    $0x409,%eax
     74d:	74 19                	je     768 <pipe1+0xbe>
        printf(1, "pipe1 oops 1\n");
     74f:	c7 44 24 04 54 46 00 	movl   $0x4654,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 dc 37 00 00       	call   3f3f <printf>
        exit();
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     787:	e8 64 36 00 00       	call   3df0 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c8:	c7 44 24 04 62 46 00 	movl   $0x4662,0x4(%esp)
     7cf:	00 
     7d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d7:	e8 63 37 00 00       	call   3f3f <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     81c:	e8 bf 35 00 00       	call   3de0 <read>
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 70 46 00 	movl   $0x4670,0x4(%esp)
     845:	00 
     846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84d:	e8 ed 36 00 00       	call   3f3f <printf>
      exit();
    ...
    close(fds[0]);
     ...
     85d:	e8 8e 35 00 00       	call   3df0 <close>
    wait();
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 87 46 00 	movl   $0x4687,0x4(%esp)
     86e:	00 
     86f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     876:	e8 c4 36 00 00       	call   3f3f <printf>
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 91 46 00 	movl   $0x4691,0x4(%esp)
     884:	00 
     885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88c:	e8 ae 36 00 00       	call   3f3f <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 a0 46 00 	movl   $0x46a0,0x4(%esp)
     8a5:	00 
     8a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ad:	e8 8d 36 00 00       	call   3f3f <printf>
  pid1 = fork();
  ...
  pipe(pfds);
     ...
     8d8:	e8 fb 34 00 00       	call   3dd8 <pipe>
  pid3 = fork();
  ...
  close(pfds[1]);
     ...
     93d:	e8 ae 34 00 00       	call   3df0 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     958:	e8 83 34 00 00       	call   3de0 <read>
     95d:	83 f8 01             	cmp    $0x1,%eax
     960:	74 16                	je     978 <preempt+0xe0>
    printf(1, "preempt read error");
     962:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     969:	00 
     96a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     971:	e8 c9 35 00 00       	call   3f3f <printf>
    return;
  ...
  close(pfds[0]);
     ...
     97e:	e8 6d 34 00 00       	call   3df0 <close>
  printf(1, "kill... ");
     983:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 a8 35 00 00       	call   3f3f <printf>
  kill(pid1);
     997:	8b 45 f4             	mov    -0xc(%ebp),%eax
     99a:	89 04 24             	mov    %eax,(%esp)
     99d:	e8 56 34 00 00       	call   3df8 <kill>
  kill(pid2);
     9a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
     9a5:	89 04 24             	mov    %eax,(%esp)
     9a8:	e8 4b 34 00 00       	call   3df8 <kill>
  kill(pid3);
     9ad:	8b 45 ec             	mov    -0x14(%ebp),%eax
     9b0:	89 04 24             	mov    %eax,(%esp)
     9b3:	e8 40 34 00 00       	call   3df8 <kill>
  printf(1, "wait... ");
     9b8:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
     9bf:	00 
     9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c7:	e8 73 35 00 00       	call   3f3f <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 e5 46 00 	movl   $0x46e5,0x4(%esp)
     9e2:	00 
     9e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9ea:	e8 50 35 00 00       	call   3f3f <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 1d 35 00 00       	call   3f3f <printf>
      return;
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 fe 46 00 	movl   $0x46fe,0x4(%esp)
     a3b:	00 
     a3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a43:	e8 f7 34 00 00       	call   3f3f <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 0e 47 00 	movl   $0x470e,0x4(%esp)
     a60:	00 
     a61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a68:	e8 d2 34 00 00       	call   3f3f <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 1b 47 00 	movl   $0x471b,0x4(%esp)
     a7c:	00 
     a7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a84:	e8 b6 34 00 00       	call   3f3f <printf>
  ppid = getpid();
     a89:	e8 ba 33 00 00       	call   3e48 <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 5d 37 00 00       	call   4223 <malloc>
    ...
    while(m1){
     ...
     adf:	e8 10 36 00 00       	call   40f4 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2f:	e8 c0 35 00 00       	call   40f4 <free>
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 3f 47 00 	movl   $0x473f,0x4(%esp)
     b3b:	00 
     b3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b43:	e8 f7 33 00 00       	call   3f3f <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5a:	c7 44 24 04 47 47 00 	movl   $0x4747,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 d1 33 00 00       	call   3f3f <printf>

  unlink("sharedfd");
     b6e:	c7 04 24 56 47 00 00 	movl   $0x4756,(%esp)
     b75:	e8 9e 32 00 00       	call   3e18 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b81:	00 
     b82:	c7 04 24 56 47 00 00 	movl   $0x4756,(%esp)
     b89:	e8 7a 32 00 00       	call   3e08 <open>
     b8e:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     b91:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     b95:	79 19                	jns    bb0 <sharedfd+0x5c>
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 60 47 00 	movl   $0x4760,0x4(%esp)
     b9e:	00 
     b9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba6:	e8 94 33 00 00       	call   3f3f <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     bff:	e8 e4 31 00 00       	call   3de8 <write>
     c04:	83 f8 0a             	cmp    $0xa,%eax
     c07:	74 16                	je     c1f <sharedfd+0xcb>
      printf(1, "fstests: write sharedfd failed\n");
     c09:	c7 44 24 04 8c 47 00 	movl   $0x478c,0x4(%esp)
     c10:	00 
     c11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c18:	e8 22 33 00 00       	call   3f3f <printf>
      break;
  ...
  close(fd);
     ...
     c42:	e8 a9 31 00 00       	call   3df0 <close>
  fd = open("sharedfd", 0);
     c47:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     c4e:	00 
     c4f:	c7 04 24 56 47 00 00 	movl   $0x4756,(%esp)
     c56:	e8 ad 31 00 00       	call   3e08 <open>
     c5b:	89 45 e8             	mov    %eax,-0x18(%ebp)
  if(fd < 0){
     c5e:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
     c62:	79 19                	jns    c7d <sharedfd+0x129>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 ac 47 00 	movl   $0x47ac,0x4(%esp)
     c6b:	00 
     c6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c73:	e8 c7 32 00 00       	call   3f3f <printf>
    return;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     cd8:	e8 03 31 00 00       	call   3de0 <read>
  ...
  close(fd);
     ...
     cec:	e8 ff 30 00 00       	call   3df0 <close>
  unlink("sharedfd");
     cf1:	c7 04 24 56 47 00 00 	movl   $0x4756,(%esp)
     cf8:	e8 1b 31 00 00       	call   3e18 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 d7 47 00 	movl   $0x47d7,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 1c 32 00 00       	call   3f3f <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 e4 47 00 	movl   $0x47e4,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 f8 31 00 00       	call   3f3f <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 d7 31 00 00       	call   3f3f <printf>

  unlink("f1");
     d68:	c7 04 24 08 48 00 00 	movl   $0x4808,(%esp)
     d6f:	e8 a4 30 00 00       	call   3e18 <unlink>
  unlink("f2");
     d74:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
     d7b:	e8 98 30 00 00       	call   3e18 <unlink>
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 9d 31 00 00       	call   3f3f <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 08 48 00 00       	mov    $0x4808,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 0b 48 00 00       	mov    $0x480b,%eax
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e3a:	e8 a9 2f 00 00       	call   3de8 <write>
     ...
     e52:	c7 44 24 04 1d 48 00 	movl   $0x481d,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 d9 30 00 00       	call   3f3f <printf>
      exit();
  ...
  close(fd);
     ...
     e7b:	e8 70 2f 00 00       	call   3df0 <close>
  if(pid)
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 08 48 00 00       	mov    $0x4808,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 0b 48 00 00       	mov    $0x480b,%eax
     eae:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     eb5:	00 
     eb6:	89 04 24             	mov    %eax,(%esp)
     eb9:	e8 4a 2f 00 00       	call   3e08 <open>
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 2e 48 00 	movl   $0x482e,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 34 30 00 00       	call   3f3f <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f38:	e8 a3 2e 00 00       	call   3de0 <read>
    ...
    close(fd);
     ...
     f4c:	e8 9f 2e 00 00       	call   3df0 <close>
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 3a 48 00 	movl   $0x483a,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 ca 2f 00 00       	call   3f3f <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 08 48 00 00 	movl   $0x4808,(%esp)
     f8f:	e8 84 2e 00 00       	call   3e18 <unlink>
  unlink("f2");
     f94:	c7 04 24 0b 48 00 00 	movl   $0x480b,(%esp)
     f9b:	e8 78 2e 00 00       	call   3e18 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 4b 48 00 	movl   $0x484b,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 8b 2f 00 00       	call   3f3f <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 58 48 00 	movl   $0x4858,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 6f 2f 00 00       	call   3f3f <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 4d 2f 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1060:	e8 8b 2d 00 00       	call   3df0 <close>
    if(i > 0 && (i % 2 ) == 0){
    ...
    108d:	e8 86 2d 00 00       	call   3e18 <unlink>
    1092:	85 c0                	test   %eax,%eax
    1094:	79 19                	jns    10af <createdelete+0xf9>
        printf(1, "unlink failed\n");
    1096:	c7 44 24 04 6b 48 00 	movl   $0x486b,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 95 2e 00 00       	call   3f3f <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    10f4:	e8 0f 2d 00 00       	call   3e08 <open>
    ...
    1115:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 16 2e 00 00       	call   3f3f <printf>
      exit();
    ...
    1147:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 e4 2d 00 00       	call   3f3f <printf>
      exit();
    ...
    116c:	e8 7f 2c 00 00       	call   3df0 <close>
    ...
    118c:	e8 77 2c 00 00       	call   3e08 <open>
    ...
    11ad:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 7e 2d 00 00       	call   3f3f <printf>
      exit();
    ...
    11df:	c7 44 24 04 a0 48 00 	movl   $0x48a0,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 4c 2d 00 00       	call   3f3f <printf>
      exit();
    ...
    1204:	e8 e7 2b 00 00       	call   3df0 <close>
  if(pid==0)
    exit();
  else
    wait();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 c0 48 00 	movl   $0x48c0,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 da 2c 00 00       	call   3f3f <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 d1 48 00 	movl   $0x48d1,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 be 2c 00 00       	call   3f3f <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 e2 48 00 00 	movl   $0x48e2,(%esp)
    1290:	e8 73 2b 00 00       	call   3e08 <open>
    1295:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1298:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    129c:	79 19                	jns    12b7 <unlinkread+0x50>
    printf(1, "create unlinkread failed\n");
    129e:	c7 44 24 04 ed 48 00 	movl   $0x48ed,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 8d 2c 00 00       	call   3f3f <printf>
    exit();
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1343:	00 
    1344:	c7 04 24 e2 48 00 00 	movl   $0x48e2,(%esp)
    134b:	e8 b8 2a 00 00       	call   3e08 <open>
    1350:	89 45 f0             	mov    %eax,-0x10(%ebp)
  write(fd1, "yyy", 3);
    1353:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    135a:	00 
    135b:	c7 44 24 04 3f 49 00 	movl   $0x493f,0x4(%esp)
    1362:	00 
    1363:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1366:	89 04 24             	mov    %eax,(%esp)
    1369:	e8 7a 2a 00 00       	call   3de8 <write>
  close(fd1);
    136e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1371:	89 04 24             	mov    %eax,(%esp)
    1374:	e8 77 2a 00 00       	call   3df0 <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    138f:	e8 4c 2a 00 00       	call   3de0 <read>
    1394:	83 f8 05             	cmp    $0x5,%eax
    1397:	74 19                	je     13b2 <unlinkread+0x14b>
    printf(1, "unlinkread read failed");
    1399:	c7 44 24 04 43 49 00 	movl   $0x4943,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 92 2b 00 00       	call   3f3f <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 6e 2b 00 00       	call   3f3f <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13ec:	e8 f7 29 00 00       	call   3de8 <write>
    13f1:	83 f8 0a             	cmp    $0xa,%eax
    13f4:	74 19                	je     140f <unlinkread+0x1a8>
    printf(1, "unlinkread write failed\n");
    13f6:	c7 44 24 04 71 49 00 	movl   $0x4971,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 35 2b 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    1415:	e8 d6 29 00 00       	call   3df0 <close>
  unlink("unlinkread");
    141a:	c7 04 24 e2 48 00 00 	movl   $0x48e2,(%esp)
    1421:	e8 f2 29 00 00       	call   3e18 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 8a 49 00 	movl   $0x498a,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 05 2b 00 00       	call   3f3f <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 99 49 00 	movl   $0x4999,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 e9 2a 00 00       	call   3f3f <printf>

  unlink("lf1");
    1456:	c7 04 24 a3 49 00 00 	movl   $0x49a3,(%esp)
    145d:	e8 b6 29 00 00       	call   3e18 <unlink>
  unlink("lf2");
    1462:	c7 04 24 a7 49 00 00 	movl   $0x49a7,(%esp)
    1469:	e8 aa 29 00 00       	call   3e18 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 a3 49 00 00 	movl   $0x49a3,(%esp)
    147d:	e8 86 29 00 00       	call   3e08 <open>
    1482:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1485:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1489:	79 19                	jns    14a4 <linktest+0x68>
    printf(1, "create lf1 failed\n");
    148b:	c7 44 24 04 ab 49 00 	movl   $0x49ab,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 a0 2a 00 00       	call   3f3f <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 07 49 00 	movl   $0x4907,0x4(%esp)
    14b3:	00 
    14b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14b7:	89 04 24             	mov    %eax,(%esp)
    14ba:	e8 29 29 00 00       	call   3de8 <write>
    14bf:	83 f8 05             	cmp    $0x5,%eax
    14c2:	74 19                	je     14dd <linktest+0xa1>
    printf(1, "write lf1 failed\n");
    14c4:	c7 44 24 04 be 49 00 	movl   $0x49be,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 67 2a 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    14e3:	e8 08 29 00 00       	call   3df0 <close>

  if(link("lf1", "lf2") < 0){
    14e8:	c7 44 24 04 a7 49 00 	movl   $0x49a7,0x4(%esp)
    14ef:	00 
    14f0:	c7 04 24 a3 49 00 00 	movl   $0x49a3,(%esp)
    14f7:	e8 2c 29 00 00       	call   3e28 <link>
    14fc:	85 c0                	test   %eax,%eax
    14fe:	79 19                	jns    1519 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    1500:	c7 44 24 04 d0 49 00 	movl   $0x49d0,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 2b 2a 00 00       	call   3f3f <printf>
    exit();
    1514:	e8 a7 28 00 00       	call   3dc0 <exit>
  }
  unlink("lf1");
    1519:	c7 04 24 a3 49 00 00 	movl   $0x49a3,(%esp)
    1520:	e8 f3 28 00 00       	call   3e18 <unlink>

  if(open("lf1", 0) >= 0){
    1525:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    152c:	00 
    152d:	c7 04 24 a3 49 00 00 	movl   $0x49a3,(%esp)
    1534:	e8 cf 28 00 00       	call   3e08 <open>
    1539:	85 c0                	test   %eax,%eax
    153b:	78 19                	js     1556 <linktest+0x11a>
    printf(1, "unlinked lf1 but it is still there!\n");
    153d:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
    1544:	00 
    1545:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    154c:	e8 ee 29 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 a7 49 00 00 	movl   $0x49a7,(%esp)
    1565:	e8 9e 28 00 00       	call   3e08 <open>
    156a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    156d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1571:	79 19                	jns    158c <linktest+0x150>
    printf(1, "open lf2 failed\n");
    1573:	c7 44 24 04 0d 4a 00 	movl   $0x4a0d,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 b8 29 00 00       	call   3f3f <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15a2:	e8 39 28 00 00       	call   3de0 <read>
    15a7:	83 f8 05             	cmp    $0x5,%eax
    15aa:	74 19                	je     15c5 <linktest+0x189>
    printf(1, "read lf2 failed\n");
    15ac:	c7 44 24 04 1e 4a 00 	movl   $0x4a1e,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 7f 29 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    15cb:	e8 20 28 00 00       	call   3df0 <close>

  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 a7 49 00 	movl   $0x49a7,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 a7 49 00 00 	movl   $0x49a7,(%esp)
    15df:	e8 44 28 00 00       	call   3e28 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 2f 4a 00 	movl   $0x4a2f,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 43 29 00 00       	call   3f3f <printf>
    exit();
    15fc:	e8 bf 27 00 00       	call   3dc0 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 a7 49 00 00 	movl   $0x49a7,(%esp)
    1608:	e8 0b 28 00 00       	call   3e18 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 a3 49 00 	movl   $0x49a3,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 a7 49 00 00 	movl   $0x49a7,(%esp)
    161c:	e8 07 28 00 00       	call   3e28 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 50 4a 00 	movl   $0x4a50,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 06 29 00 00       	call   3f3f <printf>
    exit();
    1639:	e8 82 27 00 00       	call   3dc0 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 a3 49 00 	movl   $0x49a3,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    164d:	e8 d6 27 00 00       	call   3e28 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 75 4a 00 	movl   $0x4a75,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 d5 28 00 00       	call   3f3f <printf>
    exit();
    166a:	e8 51 27 00 00       	call   3dc0 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 91 4a 00 	movl   $0x4a91,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 bc 28 00 00       	call   3f3f <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 9e 4a 00 	movl   $0x4a9e,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 a0 28 00 00       	call   3f3f <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16c2:	e8 51 27 00 00       	call   3e18 <unlink>
    pid = fork();
    ...
    16fe:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
    1705:	e8 1e 27 00 00       	call   3e28 <link>
    ...
    1741:	c7 04 24 ae 4a 00 00 	movl   $0x4aae,(%esp)
    1748:	e8 db 26 00 00       	call   3e28 <link>
    ...
    175d:	e8 a6 26 00 00       	call   3e08 <open>
    ...
    1772:	c7 44 24 04 b1 4a 00 	movl   $0x4ab1,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 b9 27 00 00       	call   3f3f <printf>
        exit();
    ...
    1791:	e8 5a 26 00 00       	call   3df0 <close>
    }
    if(pid == 0)
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    17de:	e8 25 26 00 00       	call   3e08 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 cd 4a 00 	movl   $0x4acd,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 f3 26 00 00       	call   3f3f <printf>
        exit();
    ...
    1868:	c7 44 24 04 e6 4a 00 	movl   $0x4ae6,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 c3 26 00 00       	call   3f3f <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18a6:	e8 35 25 00 00       	call   3de0 <read>
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 2b 26 00 00       	call   3f3f <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 35 4b 00 	movl   $0x4b35,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 0b 25 00 00       	call   3f3f <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 43 4b 00 	movl   $0x4b43,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 ef 24 00 00       	call   3f3f <printf>

  unlink("x");
    1a50:	c7 04 24 aa 46 00 00 	movl   $0x46aa,(%esp)
    1a57:	e8 bc 23 00 00       	call   3e18 <unlink>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 c1 24 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 aa 46 00 00 	movl   $0x46aa,(%esp)
    1ae0:	e8 23 23 00 00       	call   3e08 <open>
    1ae5:	89 04 24             	mov    %eax,(%esp)
    1ae8:	e8 03 23 00 00       	call   3df0 <close>
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 aa 46 00 	movl   $0x46aa,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 54 4b 00 00 	movl   $0x4b54,(%esp)
    1b1b:	e8 08 23 00 00       	call   3e28 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 aa 46 00 00 	movl   $0x46aa,(%esp)
    1b29:	e8 ea 22 00 00       	call   3e18 <unlink>
    printf(1, "fork failed\n");
    exit();
  }
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 58 4b 00 	movl   $0x4b58,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 e4 23 00 00       	call   3f3f <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 67 4b 00 	movl   $0x4b67,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 c3 23 00 00       	call   3f3f <printf>
  unlink("bd");
    1b7c:	c7 04 24 74 4b 00 00 	movl   $0x4b74,(%esp)
    1b83:	e8 90 22 00 00       	call   3e18 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 74 4b 00 00 	movl   $0x4b74,(%esp)
    1b97:	e8 6c 22 00 00       	call   3e08 <open>
    1b9c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(fd < 0){
    1b9f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1ba3:	79 19                	jns    1bbe <bigdir+0x5c>
    printf(1, "bigdir create failed\n");
    1ba5:	c7 44 24 04 77 4b 00 	movl   $0x4b77,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 86 23 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    1bc4:	e8 27 22 00 00       	call   3df0 <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1c0d:	c7 04 24 74 4b 00 00 	movl   $0x4b74,(%esp)
    1c14:	e8 0f 22 00 00       	call   3e28 <link>
    1c19:	85 c0                	test   %eax,%eax
    1c1b:	74 19                	je     1c36 <bigdir+0xd4>
      printf(1, "bigdir link failed\n");
    1c1d:	c7 44 24 04 8d 4b 00 	movl   $0x4b8d,0x4(%esp)
    1c24:	00 
    1c25:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c2c:	e8 0e 23 00 00       	call   3f3f <printf>
      exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 74 4b 00 00 	movl   $0x4b74,(%esp)
    1c4a:	e8 c9 21 00 00       	call   3e18 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1c92:	e8 81 21 00 00       	call   3e18 <unlink>
    1c97:	85 c0                	test   %eax,%eax
    1c99:	74 19                	je     1cb4 <bigdir+0x152>
      printf(1, "bigdir unlink failed");
    1c9b:	c7 44 24 04 a1 4b 00 	movl   $0x4ba1,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 90 22 00 00       	call   3f3f <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 b6 4b 00 	movl   $0x4bb6,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 6a 22 00 00       	call   3f3f <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 c1 4b 00 	movl   $0x4bc1,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 4e 22 00 00       	call   3f3f <printf>

  unlink("ff");
    1cf1:	c7 04 24 ce 4b 00 00 	movl   $0x4bce,(%esp)
    1cf8:	e8 1b 21 00 00       	call   3e18 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    1d04:	e8 27 21 00 00       	call   3e30 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 d4 4b 00 	movl   $0x4bd4,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 1e 22 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 ec 4b 00 00 	movl   $0x4bec,(%esp)
    1d35:	e8 ce 20 00 00       	call   3e08 <open>
    1d3a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1d3d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1d41:	79 19                	jns    1d5c <subdir+0x85>
    printf(1, "create dd/ff failed\n");
    1d43:	c7 44 24 04 f2 4b 00 	movl   $0x4bf2,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 e8 21 00 00       	call   3f3f <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 ce 4b 00 	movl   $0x4bce,0x4(%esp)
    1d6b:	00 
    1d6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1d6f:	89 04 24             	mov    %eax,(%esp)
    1d72:	e8 71 20 00 00       	call   3de8 <write>
  close(fd);
    1d77:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1d7a:	89 04 24             	mov    %eax,(%esp)
    1d7d:	e8 6e 20 00 00       	call   3df0 <close>
  
  if(unlink("dd") >= 0){
    1d82:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    1d89:	e8 8a 20 00 00       	call   3e18 <unlink>
    1d8e:	85 c0                	test   %eax,%eax
    1d90:	78 19                	js     1dab <subdir+0xd4>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1d92:	c7 44 24 04 08 4c 00 	movl   $0x4c08,0x4(%esp)
    1d99:	00 
    1d9a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1da1:	e8 99 21 00 00       	call   3f3f <printf>
    exit();
    1da6:	e8 15 20 00 00       	call   3dc0 <exit>
  }

  if(mkdir("/dd/dd") != 0){
    1dab:	c7 04 24 2e 4c 00 00 	movl   $0x4c2e,(%esp)
    1db2:	e8 79 20 00 00       	call   3e30 <mkdir>
    1db7:	85 c0                	test   %eax,%eax
    1db9:	74 19                	je     1dd4 <subdir+0xfd>
    printf(1, "subdir mkdir dd/dd failed\n");
    1dbb:	c7 44 24 04 35 4c 00 	movl   $0x4c35,0x4(%esp)
    1dc2:	00 
    1dc3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dca:	e8 70 21 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    1de3:	e8 20 20 00 00       	call   3e08 <open>
    1de8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1deb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1def:	79 19                	jns    1e0a <subdir+0x133>
    printf(1, "create dd/dd/ff failed\n");
    1df1:	c7 44 24 04 59 4c 00 	movl   $0x4c59,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 3a 21 00 00       	call   3f3f <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e7c:	e8 5f 1f 00 00       	call   3de0 <read>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 99 4c 00 	movl   $0x4c99,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 96 20 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    1eb4:	e8 37 1f 00 00       	call   3df0 <close>

  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eb9:	c7 44 24 04 b4 4c 00 	movl   $0x4cb4,0x4(%esp)
    1ec0:	00 
    1ec1:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    1ec8:	e8 5b 1f 00 00       	call   3e28 <link>
    1ecd:	85 c0                	test   %eax,%eax
    1ecf:	74 19                	je     1eea <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ed1:	c7 44 24 04 c0 4c 00 	movl   $0x4cc0,0x4(%esp)
    1ed8:	00 
    1ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ee0:	e8 5a 20 00 00       	call   3f3f <printf>
    exit();
    1ee5:	e8 d6 1e 00 00       	call   3dc0 <exit>
  }

  if(unlink("dd/dd/ff") != 0){
    1eea:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    1ef1:	e8 22 1f 00 00       	call   3e18 <unlink>
    1ef6:	85 c0                	test   %eax,%eax
    1ef8:	74 19                	je     1f13 <subdir+0x23c>
    printf(1, "unlink dd/dd/ff failed\n");
    1efa:	c7 44 24 04 e1 4c 00 	movl   $0x4ce1,0x4(%esp)
    1f01:	00 
    1f02:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f09:	e8 31 20 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f1a:	00 
    1f1b:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    1f22:	e8 e1 1e 00 00       	call   3e08 <open>
    1f27:	85 c0                	test   %eax,%eax
    1f29:	78 19                	js     1f44 <subdir+0x26d>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1f2b:	c7 44 24 04 fc 4c 00 	movl   $0x4cfc,0x4(%esp)
    1f32:	00 
    1f33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f3a:	e8 00 20 00 00       	call   3f3f <printf>
    exit();
    1f3f:	e8 7c 1e 00 00       	call   3dc0 <exit>
  }

  if(chdir("dd") != 0){
    1f44:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    1f4b:	e8 e8 1e 00 00       	call   3e38 <chdir>
    1f50:	85 c0                	test   %eax,%eax
    1f52:	74 19                	je     1f6d <subdir+0x296>
    printf(1, "chdir dd failed\n");
    1f54:	c7 44 24 04 20 4d 00 	movl   $0x4d20,0x4(%esp)
    1f5b:	00 
    1f5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f63:	e8 d7 1f 00 00       	call   3f3f <printf>
    exit();
    1f68:	e8 53 1e 00 00       	call   3dc0 <exit>
  }
  if(chdir("dd/../../dd") != 0){
    1f6d:	c7 04 24 31 4d 00 00 	movl   $0x4d31,(%esp)
    1f74:	e8 bf 1e 00 00       	call   3e38 <chdir>
    1f79:	85 c0                	test   %eax,%eax
    1f7b:	74 19                	je     1f96 <subdir+0x2bf>
    printf(1, "chdir dd/../../dd failed\n");
    1f7d:	c7 44 24 04 3d 4d 00 	movl   $0x4d3d,0x4(%esp)
    1f84:	00 
    1f85:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f8c:	e8 ae 1f 00 00       	call   3f3f <printf>
    exit();
    1f91:	e8 2a 1e 00 00       	call   3dc0 <exit>
  }
  if(chdir("dd/../../../dd") != 0){
    1f96:	c7 04 24 57 4d 00 00 	movl   $0x4d57,(%esp)
    1f9d:	e8 96 1e 00 00       	call   3e38 <chdir>
    1fa2:	85 c0                	test   %eax,%eax
    1fa4:	74 19                	je     1fbf <subdir+0x2e8>
    printf(1, "chdir dd/../../dd failed\n");
    1fa6:	c7 44 24 04 3d 4d 00 	movl   $0x4d3d,0x4(%esp)
    1fad:	00 
    1fae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fb5:	e8 85 1f 00 00       	call   3f3f <printf>
    exit();
    1fba:	e8 01 1e 00 00       	call   3dc0 <exit>
  }
  if(chdir("./..") != 0){
    1fbf:	c7 04 24 66 4d 00 00 	movl   $0x4d66,(%esp)
    1fc6:	e8 6d 1e 00 00       	call   3e38 <chdir>
    1fcb:	85 c0                	test   %eax,%eax
    1fcd:	74 19                	je     1fe8 <subdir+0x311>
    printf(1, "chdir ./.. failed\n");
    1fcf:	c7 44 24 04 6b 4d 00 	movl   $0x4d6b,0x4(%esp)
    1fd6:	00 
    1fd7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fde:	e8 5c 1f 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 b4 4c 00 00 	movl   $0x4cb4,(%esp)
    1ff7:	e8 0c 1e 00 00       	call   3e08 <open>
    1ffc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    1fff:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2003:	79 19                	jns    201e <subdir+0x347>
    printf(1, "open dd/dd/ffff failed\n");
    2005:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 26 1f 00 00       	call   3f3f <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2034:	e8 a7 1d 00 00       	call   3de0 <read>
    2039:	83 f8 02             	cmp    $0x2,%eax
    203c:	74 19                	je     2057 <subdir+0x380>
    printf(1, "read dd/dd/ffff wrong len\n");
    203e:	c7 44 24 04 96 4d 00 	movl   $0x4d96,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 ed 1e 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    205d:	e8 8e 1d 00 00       	call   3df0 <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2062:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    2069:	00 
    206a:	c7 04 24 50 4c 00 00 	movl   $0x4c50,(%esp)
    2071:	e8 92 1d 00 00       	call   3e08 <open>
    2076:	85 c0                	test   %eax,%eax
    2078:	78 19                	js     2093 <subdir+0x3bc>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    207a:	c7 44 24 04 b4 4d 00 	movl   $0x4db4,0x4(%esp)
    2081:	00 
    2082:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2089:	e8 b1 1e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    209a:	00 
    209b:	c7 04 24 d9 4d 00 00 	movl   $0x4dd9,(%esp)
    20a2:	e8 61 1d 00 00       	call   3e08 <open>
    20a7:	85 c0                	test   %eax,%eax
    20a9:	78 19                	js     20c4 <subdir+0x3ed>
    printf(1, "create dd/ff/ff succeeded!\n");
    20ab:	c7 44 24 04 e2 4d 00 	movl   $0x4de2,0x4(%esp)
    20b2:	00 
    20b3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20ba:	e8 80 1e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    20cb:	00 
    20cc:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    20d3:	e8 30 1d 00 00       	call   3e08 <open>
    20d8:	85 c0                	test   %eax,%eax
    20da:	78 19                	js     20f5 <subdir+0x41e>
    printf(1, "create dd/xx/ff succeeded!\n");
    20dc:	c7 44 24 04 07 4e 00 	movl   $0x4e07,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 4f 1e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    20fc:	00 
    20fd:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    2104:	e8 ff 1c 00 00       	call   3e08 <open>
    2109:	85 c0                	test   %eax,%eax
    210b:	78 19                	js     2126 <subdir+0x44f>
    printf(1, "create dd succeeded!\n");
    210d:	c7 44 24 04 23 4e 00 	movl   $0x4e23,0x4(%esp)
    2114:	00 
    2115:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    211c:	e8 1e 1e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    212d:	00 
    212e:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    2135:	e8 ce 1c 00 00       	call   3e08 <open>
    213a:	85 c0                	test   %eax,%eax
    213c:	78 19                	js     2157 <subdir+0x480>
    printf(1, "open dd rdwr succeeded!\n");
    213e:	c7 44 24 04 39 4e 00 	movl   $0x4e39,0x4(%esp)
    2145:	00 
    2146:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    214d:	e8 ed 1d 00 00       	call   3f3f <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    215e:	00 
    215f:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    2166:	e8 9d 1c 00 00       	call   3e08 <open>
    216b:	85 c0                	test   %eax,%eax
    216d:	78 19                	js     2188 <subdir+0x4b1>
    printf(1, "open dd wronly succeeded!\n");
    216f:	c7 44 24 04 52 4e 00 	movl   $0x4e52,0x4(%esp)
    2176:	00 
    2177:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    217e:	e8 bc 1d 00 00       	call   3f3f <printf>
    exit();
    2183:	e8 38 1c 00 00       	call   3dc0 <exit>
  }
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2188:	c7 44 24 04 6d 4e 00 	movl   $0x4e6d,0x4(%esp)
    218f:	00 
    2190:	c7 04 24 d9 4d 00 00 	movl   $0x4dd9,(%esp)
    2197:	e8 8c 1c 00 00       	call   3e28 <link>
    219c:	85 c0                	test   %eax,%eax
    219e:	75 19                	jne    21b9 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    21a0:	c7 44 24 04 78 4e 00 	movl   $0x4e78,0x4(%esp)
    21a7:	00 
    21a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21af:	e8 8b 1d 00 00       	call   3f3f <printf>
    exit();
    21b4:	e8 07 1c 00 00       	call   3dc0 <exit>
  }
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21b9:	c7 44 24 04 6d 4e 00 	movl   $0x4e6d,0x4(%esp)
    21c0:	00 
    21c1:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    21c8:	e8 5b 1c 00 00       	call   3e28 <link>
    21cd:	85 c0                	test   %eax,%eax
    21cf:	75 19                	jne    21ea <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21d1:	c7 44 24 04 9c 4e 00 	movl   $0x4e9c,0x4(%esp)
    21d8:	00 
    21d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21e0:	e8 5a 1d 00 00       	call   3f3f <printf>
    exit();
    21e5:	e8 d6 1b 00 00       	call   3dc0 <exit>
  }
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21ea:	c7 44 24 04 b4 4c 00 	movl   $0x4cb4,0x4(%esp)
    21f1:	00 
    21f2:	c7 04 24 ec 4b 00 00 	movl   $0x4bec,(%esp)
    21f9:	e8 2a 1c 00 00       	call   3e28 <link>
    21fe:	85 c0                	test   %eax,%eax
    2200:	75 19                	jne    221b <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2202:	c7 44 24 04 c0 4e 00 	movl   $0x4ec0,0x4(%esp)
    2209:	00 
    220a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2211:	e8 29 1d 00 00       	call   3f3f <printf>
    exit();
    2216:	e8 a5 1b 00 00       	call   3dc0 <exit>
  }
  if(mkdir("dd/ff/ff") == 0){
    221b:	c7 04 24 d9 4d 00 00 	movl   $0x4dd9,(%esp)
    2222:	e8 09 1c 00 00       	call   3e30 <mkdir>
    2227:	85 c0                	test   %eax,%eax
    2229:	75 19                	jne    2244 <subdir+0x56d>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    222b:	c7 44 24 04 e2 4e 00 	movl   $0x4ee2,0x4(%esp)
    2232:	00 
    2233:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    223a:	e8 00 1d 00 00       	call   3f3f <printf>
    exit();
    223f:	e8 7c 1b 00 00       	call   3dc0 <exit>
  }
  if(mkdir("dd/xx/ff") == 0){
    2244:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    224b:	e8 e0 1b 00 00       	call   3e30 <mkdir>
    2250:	85 c0                	test   %eax,%eax
    2252:	75 19                	jne    226d <subdir+0x596>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    2254:	c7 44 24 04 fd 4e 00 	movl   $0x4efd,0x4(%esp)
    225b:	00 
    225c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2263:	e8 d7 1c 00 00       	call   3f3f <printf>
    exit();
    2268:	e8 53 1b 00 00       	call   3dc0 <exit>
  }
  if(mkdir("dd/dd/ffff") == 0){
    226d:	c7 04 24 b4 4c 00 00 	movl   $0x4cb4,(%esp)
    2274:	e8 b7 1b 00 00       	call   3e30 <mkdir>
    2279:	85 c0                	test   %eax,%eax
    227b:	75 19                	jne    2296 <subdir+0x5bf>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    227d:	c7 44 24 04 18 4f 00 	movl   $0x4f18,0x4(%esp)
    2284:	00 
    2285:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    228c:	e8 ae 1c 00 00       	call   3f3f <printf>
    exit();
    2291:	e8 2a 1b 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd/xx/ff") == 0){
    2296:	c7 04 24 fe 4d 00 00 	movl   $0x4dfe,(%esp)
    229d:	e8 76 1b 00 00       	call   3e18 <unlink>
    22a2:	85 c0                	test   %eax,%eax
    22a4:	75 19                	jne    22bf <subdir+0x5e8>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    22a6:	c7 44 24 04 35 4f 00 	movl   $0x4f35,0x4(%esp)
    22ad:	00 
    22ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22b5:	e8 85 1c 00 00       	call   3f3f <printf>
    exit();
    22ba:	e8 01 1b 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd/ff/ff") == 0){
    22bf:	c7 04 24 d9 4d 00 00 	movl   $0x4dd9,(%esp)
    22c6:	e8 4d 1b 00 00       	call   3e18 <unlink>
    22cb:	85 c0                	test   %eax,%eax
    22cd:	75 19                	jne    22e8 <subdir+0x611>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    22cf:	c7 44 24 04 51 4f 00 	movl   $0x4f51,0x4(%esp)
    22d6:	00 
    22d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22de:	e8 5c 1c 00 00       	call   3f3f <printf>
    exit();
    22e3:	e8 d8 1a 00 00       	call   3dc0 <exit>
  }
  if(chdir("dd/ff") == 0){
    22e8:	c7 04 24 ec 4b 00 00 	movl   $0x4bec,(%esp)
    22ef:	e8 44 1b 00 00       	call   3e38 <chdir>
    22f4:	85 c0                	test   %eax,%eax
    22f6:	75 19                	jne    2311 <subdir+0x63a>
    printf(1, "chdir dd/ff succeeded!\n");
    22f8:	c7 44 24 04 6d 4f 00 	movl   $0x4f6d,0x4(%esp)
    22ff:	00 
    2300:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2307:	e8 33 1c 00 00       	call   3f3f <printf>
    exit();
    230c:	e8 af 1a 00 00       	call   3dc0 <exit>
  }
  if(chdir("dd/xx") == 0){
    2311:	c7 04 24 85 4f 00 00 	movl   $0x4f85,(%esp)
    2318:	e8 1b 1b 00 00       	call   3e38 <chdir>
    231d:	85 c0                	test   %eax,%eax
    231f:	75 19                	jne    233a <subdir+0x663>
    printf(1, "chdir dd/xx succeeded!\n");
    2321:	c7 44 24 04 8b 4f 00 	movl   $0x4f8b,0x4(%esp)
    2328:	00 
    2329:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2330:	e8 0a 1c 00 00       	call   3f3f <printf>
    exit();
    2335:	e8 86 1a 00 00       	call   3dc0 <exit>
  }

  if(unlink("dd/dd/ffff") != 0){
    233a:	c7 04 24 b4 4c 00 00 	movl   $0x4cb4,(%esp)
    2341:	e8 d2 1a 00 00       	call   3e18 <unlink>
    2346:	85 c0                	test   %eax,%eax
    2348:	74 19                	je     2363 <subdir+0x68c>
    printf(1, "unlink dd/dd/ff failed\n");
    234a:	c7 44 24 04 e1 4c 00 	movl   $0x4ce1,0x4(%esp)
    2351:	00 
    2352:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2359:	e8 e1 1b 00 00       	call   3f3f <printf>
    exit();
    235e:	e8 5d 1a 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd/ff") != 0){
    2363:	c7 04 24 ec 4b 00 00 	movl   $0x4bec,(%esp)
    236a:	e8 a9 1a 00 00       	call   3e18 <unlink>
    236f:	85 c0                	test   %eax,%eax
    2371:	74 19                	je     238c <subdir+0x6b5>
    printf(1, "unlink dd/ff failed\n");
    2373:	c7 44 24 04 a3 4f 00 	movl   $0x4fa3,0x4(%esp)
    237a:	00 
    237b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2382:	e8 b8 1b 00 00       	call   3f3f <printf>
    exit();
    2387:	e8 34 1a 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd") == 0){
    238c:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    2393:	e8 80 1a 00 00       	call   3e18 <unlink>
    2398:	85 c0                	test   %eax,%eax
    239a:	75 19                	jne    23b5 <subdir+0x6de>
    printf(1, "unlink non-empty dd succeeded!\n");
    239c:	c7 44 24 04 b8 4f 00 	movl   $0x4fb8,0x4(%esp)
    23a3:	00 
    23a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23ab:	e8 8f 1b 00 00       	call   3f3f <printf>
    exit();
    23b0:	e8 0b 1a 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd/dd") < 0){
    23b5:	c7 04 24 d8 4f 00 00 	movl   $0x4fd8,(%esp)
    23bc:	e8 57 1a 00 00       	call   3e18 <unlink>
    23c1:	85 c0                	test   %eax,%eax
    23c3:	79 19                	jns    23de <subdir+0x707>
    printf(1, "unlink dd/dd failed\n");
    23c5:	c7 44 24 04 de 4f 00 	movl   $0x4fde,0x4(%esp)
    23cc:	00 
    23cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23d4:	e8 66 1b 00 00       	call   3f3f <printf>
    exit();
    23d9:	e8 e2 19 00 00       	call   3dc0 <exit>
  }
  if(unlink("dd") < 0){
    23de:	c7 04 24 d1 4b 00 00 	movl   $0x4bd1,(%esp)
    23e5:	e8 2e 1a 00 00       	call   3e18 <unlink>
    23ea:	85 c0                	test   %eax,%eax
    23ec:	79 19                	jns    2407 <subdir+0x730>
    printf(1, "unlink dd failed\n");
    23ee:	c7 44 24 04 f3 4f 00 	movl   $0x4ff3,0x4(%esp)
    23f5:	00 
    23f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23fd:	e8 3d 1b 00 00       	call   3f3f <printf>
    exit();
    2402:	e8 b9 19 00 00       	call   3dc0 <exit>
  }

  printf(1, "subdir ok\n");
    2407:	c7 44 24 04 05 50 00 	movl   $0x5005,0x4(%esp)
    240e:	00 
    240f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2416:	e8 24 1b 00 00       	call   3f3f <printf>
}
    241b:	c9                   	leave  
    241c:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 10 50 00 	movl   $0x5010,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 08 1b 00 00       	call   3f3f <printf>

  unlink("bigwrite");
    2437:	c7 04 24 1f 50 00 00 	movl   $0x501f,(%esp)
    243e:	e8 d5 19 00 00       	call   3e18 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 1f 50 00 00 	movl   $0x501f,(%esp)
    245e:	e8 a5 19 00 00       	call   3e08 <open>
    2463:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(fd < 0){
    2466:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    246a:	79 19                	jns    2485 <bigwrite+0x68>
      printf(1, "cannot create bigwrite\n");
    246c:	c7 44 24 04 28 50 00 	movl   $0x5028,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 bf 1a 00 00       	call   3f3f <printf>
      exit();
    ...
    24a3:	e8 40 19 00 00       	call   3de8 <write>
    ...
    24c1:	c7 44 24 04 40 50 00 	movl   $0x5040,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 6a 1a 00 00       	call   3f3f <printf>
        exit();
    ...
    24ea:	e8 01 19 00 00       	call   3df0 <close>
    unlink("bigwrite");
    24ef:	c7 04 24 1f 50 00 00 	movl   $0x501f,(%esp)
    24f6:	e8 1d 19 00 00       	call   3e18 <unlink>
  int fd, sz;
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 52 50 00 	movl   $0x5052,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 1c 1a 00 00       	call   3f3f <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 5f 50 00 	movl   $0x505f,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 00 1a 00 00       	call   3f3f <printf>

  unlink("bigfile");
    253f:	c7 04 24 6d 50 00 00 	movl   $0x506d,(%esp)
    2546:	e8 cd 18 00 00       	call   3e18 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 6d 50 00 00 	movl   $0x506d,(%esp)
    255a:	e8 a9 18 00 00       	call   3e08 <open>
    255f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    2562:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    2566:	79 19                	jns    2581 <bigfile+0x5c>
    printf(1, "cannot create bigfile");
    2568:	c7 44 24 04 75 50 00 	movl   $0x5075,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 c3 19 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25bb:	e8 28 18 00 00       	call   3de8 <write>
    25c0:	3d 58 02 00 00       	cmp    $0x258,%eax
    25c5:	74 19                	je     25e0 <bigfile+0xbb>
      printf(1, "write bigfile failed\n");
    25c7:	c7 44 24 04 8b 50 00 	movl   $0x508b,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 64 19 00 00       	call   3f3f <printf>
      exit();
  ...
  close(fd);
    ...
    25f0:	e8 fb 17 00 00       	call   3df0 <close>

  fd = open("bigfile", 0);
    25f5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    25fc:	00 
    25fd:	c7 04 24 6d 50 00 00 	movl   $0x506d,(%esp)
    2604:	e8 ff 17 00 00       	call   3e08 <open>
    2609:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    260c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    2610:	79 19                	jns    262b <bigfile+0x106>
    printf(1, "cannot open bigfile\n");
    2612:	c7 44 24 04 a1 50 00 	movl   $0x50a1,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 19 19 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2685:	c7 44 24 04 cb 50 00 	movl   $0x50cb,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 a6 18 00 00       	call   3f3f <printf>
      exit();
    ...
    26d2:	c7 44 24 04 df 50 00 	movl   $0x50df,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 59 18 00 00       	call   3f3f <printf>
      exit();
  ...
  close(fd);
    ...
    2701:	e8 ea 16 00 00       	call   3df0 <close>
  if(total != 20*600){
    2706:	81 7d f0 e0 2e 00 00 	cmpl   $0x2ee0,-0x10(%ebp)
    270d:	74 19                	je     2728 <bigfile+0x203>
    printf(1, "read bigfile wrong total\n");
    270f:	c7 44 24 04 f8 50 00 	movl   $0x50f8,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 1c 18 00 00       	call   3f3f <printf>
    exit();
    2723:	e8 98 16 00 00       	call   3dc0 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 6d 50 00 00 	movl   $0x506d,(%esp)
    272f:	e8 e4 16 00 00       	call   3e18 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 12 51 00 	movl   $0x5112,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 f7 17 00 00       	call   3f3f <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2750:	c7 44 24 04 23 51 00 	movl   $0x5123,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 db 17 00 00       	call   3f3f <printf>

  if(mkdir("12345678901234") != 0){
    2764:	c7 04 24 32 51 00 00 	movl   $0x5132,(%esp)
    276b:	e8 c0 16 00 00       	call   3e30 <mkdir>
    2770:	85 c0                	test   %eax,%eax
    2772:	74 19                	je     278d <fourteen+0x43>
    printf(1, "mkdir 12345678901234 failed\n");
    2774:	c7 44 24 04 41 51 00 	movl   $0x5141,0x4(%esp)
    277b:	00 
    277c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2783:	e8 b7 17 00 00       	call   3f3f <printf>
    exit();
    2788:	e8 33 16 00 00       	call   3dc0 <exit>
  }
  if(mkdir("12345678901234/123456789012345") != 0){
    278d:	c7 04 24 60 51 00 00 	movl   $0x5160,(%esp)
    2794:	e8 97 16 00 00       	call   3e30 <mkdir>
    2799:	85 c0                	test   %eax,%eax
    279b:	74 19                	je     27b6 <fourteen+0x6c>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    279d:	c7 44 24 04 80 51 00 	movl   $0x5180,0x4(%esp)
    27a4:	00 
    27a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ac:	e8 8e 17 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 b0 51 00 00 	movl   $0x51b0,(%esp)
    27c5:	e8 3e 16 00 00       	call   3e08 <open>
    27ca:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    27cd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    27d1:	79 19                	jns    27ec <fourteen+0xa2>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27d3:	c7 44 24 04 e0 51 00 	movl   $0x51e0,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 58 17 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    2833:	e8 b8 15 00 00       	call   3df0 <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    2838:	c7 04 24 8a 52 00 00 	movl   $0x528a,(%esp)
    283f:	e8 ec 15 00 00       	call   3e30 <mkdir>
    2844:	85 c0                	test   %eax,%eax
    2846:	75 19                	jne    2861 <fourteen+0x117>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2848:	c7 44 24 04 a8 52 00 	movl   $0x52a8,0x4(%esp)
    284f:	00 
    2850:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2857:	e8 e3 16 00 00       	call   3f3f <printf>
    exit();
    285c:	e8 5f 15 00 00       	call   3dc0 <exit>
  }
  if(mkdir("123456789012345/12345678901234") == 0){
    2861:	c7 04 24 d8 52 00 00 	movl   $0x52d8,(%esp)
    2868:	e8 c3 15 00 00       	call   3e30 <mkdir>
    286d:	85 c0                	test   %eax,%eax
    286f:	75 19                	jne    288a <fourteen+0x140>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2871:	c7 44 24 04 f8 52 00 	movl   $0x52f8,0x4(%esp)
    2878:	00 
    2879:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2880:	e8 ba 16 00 00       	call   3f3f <printf>
    exit();
    2885:	e8 36 15 00 00       	call   3dc0 <exit>
  }

  printf(1, "fourteen ok\n");
    288a:	c7 44 24 04 29 53 00 	movl   $0x5329,0x4(%esp)
    2891:	00 
    2892:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2899:	e8 a1 16 00 00       	call   3f3f <printf>
}
    289e:	c9                   	leave  
    289f:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    28a6:	c7 44 24 04 36 53 00 	movl   $0x5336,0x4(%esp)
    28ad:	00 
    28ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b5:	e8 85 16 00 00       	call   3f3f <printf>
  if(mkdir("dots") != 0){
    28ba:	c7 04 24 42 53 00 00 	movl   $0x5342,(%esp)
    28c1:	e8 6a 15 00 00       	call   3e30 <mkdir>
    28c6:	85 c0                	test   %eax,%eax
    28c8:	74 19                	je     28e3 <rmdot+0x43>
    printf(1, "mkdir dots failed\n");
    28ca:	c7 44 24 04 47 53 00 	movl   $0x5347,0x4(%esp)
    28d1:	00 
    28d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28d9:	e8 61 16 00 00       	call   3f3f <printf>
    exit();
    28de:	e8 dd 14 00 00       	call   3dc0 <exit>
  }
  if(chdir("dots") != 0){
    28e3:	c7 04 24 42 53 00 00 	movl   $0x5342,(%esp)
    28ea:	e8 49 15 00 00       	call   3e38 <chdir>
    28ef:	85 c0                	test   %eax,%eax
    28f1:	74 19                	je     290c <rmdot+0x6c>
    printf(1, "chdir dots failed\n");
    28f3:	c7 44 24 04 5a 53 00 	movl   $0x535a,0x4(%esp)
    28fa:	00 
    28fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2902:	e8 38 16 00 00       	call   3f3f <printf>
    exit();
    2907:	e8 b4 14 00 00       	call   3dc0 <exit>
  }
  if(unlink(".") == 0){
    290c:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    2913:	e8 00 15 00 00       	call   3e18 <unlink>
    2918:	85 c0                	test   %eax,%eax
    291a:	75 19                	jne    2935 <rmdot+0x95>
    printf(1, "rm . worked!\n");
    291c:	c7 44 24 04 6d 53 00 	movl   $0x536d,0x4(%esp)
    2923:	00 
    2924:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    292b:	e8 0f 16 00 00       	call   3f3f <printf>
    exit();
    2930:	e8 8b 14 00 00       	call   3dc0 <exit>
  }
  if(unlink("..") == 0){
    2935:	c7 04 24 00 46 00 00 	movl   $0x4600,(%esp)
    293c:	e8 d7 14 00 00       	call   3e18 <unlink>
    2941:	85 c0                	test   %eax,%eax
    2943:	75 19                	jne    295e <rmdot+0xbe>
    printf(1, "rm .. worked!\n");
    2945:	c7 44 24 04 7b 53 00 	movl   $0x537b,0x4(%esp)
    294c:	00 
    294d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2954:	e8 e6 15 00 00       	call   3f3f <printf>
    exit();
    2959:	e8 62 14 00 00       	call   3dc0 <exit>
  }
  if(chdir("/") != 0){
    295e:	c7 04 24 8a 53 00 00 	movl   $0x538a,(%esp)
    2965:	e8 ce 14 00 00       	call   3e38 <chdir>
    296a:	85 c0                	test   %eax,%eax
    296c:	74 19                	je     2987 <rmdot+0xe7>
    printf(1, "chdir / failed\n");
    296e:	c7 44 24 04 8c 53 00 	movl   $0x538c,0x4(%esp)
    2975:	00 
    2976:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    297d:	e8 bd 15 00 00       	call   3f3f <printf>
    exit();
    2982:	e8 39 14 00 00       	call   3dc0 <exit>
  }
  if(unlink("dots/.") == 0){
    2987:	c7 04 24 9c 53 00 00 	movl   $0x539c,(%esp)
    298e:	e8 85 14 00 00       	call   3e18 <unlink>
    2993:	85 c0                	test   %eax,%eax
    2995:	75 19                	jne    29b0 <rmdot+0x110>
    printf(1, "unlink dots/. worked!\n");
    2997:	c7 44 24 04 a3 53 00 	movl   $0x53a3,0x4(%esp)
    299e:	00 
    299f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29a6:	e8 94 15 00 00       	call   3f3f <printf>
    exit();
    29ab:	e8 10 14 00 00       	call   3dc0 <exit>
  }
  if(unlink("dots/..") == 0){
    29b0:	c7 04 24 ba 53 00 00 	movl   $0x53ba,(%esp)
    29b7:	e8 5c 14 00 00       	call   3e18 <unlink>
    29bc:	85 c0                	test   %eax,%eax
    29be:	75 19                	jne    29d9 <rmdot+0x139>
    printf(1, "unlink dots/.. worked!\n");
    29c0:	c7 44 24 04 c2 53 00 	movl   $0x53c2,0x4(%esp)
    29c7:	00 
    29c8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29cf:	e8 6b 15 00 00       	call   3f3f <printf>
    exit();
    29d4:	e8 e7 13 00 00       	call   3dc0 <exit>
  }
  if(unlink("dots") != 0){
    29d9:	c7 04 24 42 53 00 00 	movl   $0x5342,(%esp)
    29e0:	e8 33 14 00 00       	call   3e18 <unlink>
    29e5:	85 c0                	test   %eax,%eax
    29e7:	74 19                	je     2a02 <rmdot+0x162>
    printf(1, "unlink dots failed!\n");
    29e9:	c7 44 24 04 da 53 00 	movl   $0x53da,0x4(%esp)
    29f0:	00 
    29f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29f8:	e8 42 15 00 00       	call   3f3f <printf>
    exit();
    29fd:	e8 be 13 00 00       	call   3dc0 <exit>
  }
  printf(1, "rmdot ok\n");
    2a02:	c7 44 24 04 ef 53 00 	movl   $0x53ef,0x4(%esp)
    2a09:	00 
    2a0a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a11:	e8 29 15 00 00       	call   3f3f <printf>
}
    2a16:	c9                   	leave  
    2a17:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 f9 53 00 	movl   $0x53f9,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 0d 15 00 00       	call   3f3f <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 06 54 00 00 	movl   $0x5406,(%esp)
    2a41:	e8 c2 13 00 00       	call   3e08 <open>
    2a46:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd < 0){
    2a49:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2a4d:	79 19                	jns    2a68 <dirfile+0x50>
    printf(1, "create dirfile failed\n");
    2a4f:	c7 44 24 04 0e 54 00 	movl   $0x540e,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 dc 14 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    2a6e:	e8 7d 13 00 00       	call   3df0 <close>
  if(chdir("dirfile") == 0){
    2a73:	c7 04 24 06 54 00 00 	movl   $0x5406,(%esp)
    2a7a:	e8 b9 13 00 00       	call   3e38 <chdir>
    2a7f:	85 c0                	test   %eax,%eax
    2a81:	75 19                	jne    2a9c <dirfile+0x84>
    printf(1, "chdir dirfile succeeded!\n");
    2a83:	c7 44 24 04 25 54 00 	movl   $0x5425,0x4(%esp)
    2a8a:	00 
    2a8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a92:	e8 a8 14 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 3f 54 00 00 	movl   $0x543f,(%esp)
    2aab:	e8 58 13 00 00       	call   3e08 <open>
    2ab0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2ab3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2ab7:	78 19                	js     2ad2 <dirfile+0xba>
    printf(1, "create dirfile/xx succeeded!\n");
    2ab9:	c7 44 24 04 4a 54 00 	movl   $0x544a,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 72 14 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 3f 54 00 00 	movl   $0x543f,(%esp)
    2ae1:	e8 22 13 00 00       	call   3e08 <open>
    2ae6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2ae9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2aed:	78 19                	js     2b08 <dirfile+0xf0>
    printf(1, "create dirfile/xx succeeded!\n");
    2aef:	c7 44 24 04 4a 54 00 	movl   $0x544a,0x4(%esp)
    2af6:	00 
    2af7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2afe:	e8 3c 14 00 00       	call   3f3f <printf>
    exit();
    2b03:	e8 b8 12 00 00       	call   3dc0 <exit>
  }
  if(mkdir("dirfile/xx") == 0){
    2b08:	c7 04 24 3f 54 00 00 	movl   $0x543f,(%esp)
    2b0f:	e8 1c 13 00 00       	call   3e30 <mkdir>
    2b14:	85 c0                	test   %eax,%eax
    2b16:	75 19                	jne    2b31 <dirfile+0x119>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b18:	c7 44 24 04 68 54 00 	movl   $0x5468,0x4(%esp)
    2b1f:	00 
    2b20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b27:	e8 13 14 00 00       	call   3f3f <printf>
    exit();
    2b2c:	e8 8f 12 00 00       	call   3dc0 <exit>
  }
  if(unlink("dirfile/xx") == 0){
    2b31:	c7 04 24 3f 54 00 00 	movl   $0x543f,(%esp)
    2b38:	e8 db 12 00 00       	call   3e18 <unlink>
    2b3d:	85 c0                	test   %eax,%eax
    2b3f:	75 19                	jne    2b5a <dirfile+0x142>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b41:	c7 44 24 04 85 54 00 	movl   $0x5485,0x4(%esp)
    2b48:	00 
    2b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b50:	e8 ea 13 00 00       	call   3f3f <printf>
    exit();
    2b55:	e8 66 12 00 00       	call   3dc0 <exit>
  }
  if(link("README", "dirfile/xx") == 0){
    2b5a:	c7 44 24 04 3f 54 00 	movl   $0x543f,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 a3 54 00 00 	movl   $0x54a3,(%esp)
    2b69:	e8 ba 12 00 00       	call   3e28 <link>
    2b6e:	85 c0                	test   %eax,%eax
    2b70:	75 19                	jne    2b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b72:	c7 44 24 04 ac 54 00 	movl   $0x54ac,0x4(%esp)
    2b79:	00 
    2b7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b81:	e8 b9 13 00 00       	call   3f3f <printf>
    exit();
    2b86:	e8 35 12 00 00       	call   3dc0 <exit>
  }
  if(unlink("dirfile") != 0){
    2b8b:	c7 04 24 06 54 00 00 	movl   $0x5406,(%esp)
    2b92:	e8 81 12 00 00       	call   3e18 <unlink>
    2b97:	85 c0                	test   %eax,%eax
    2b99:	74 19                	je     2bb4 <dirfile+0x19c>
    printf(1, "unlink dirfile failed!\n");
    2b9b:	c7 44 24 04 cb 54 00 	movl   $0x54cb,0x4(%esp)
    2ba2:	00 
    2ba3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2baa:	e8 90 13 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    2bc3:	e8 40 12 00 00       	call   3e08 <open>
    2bc8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(fd >= 0){
    2bcb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    2bcf:	78 19                	js     2bea <dirfile+0x1d2>
    printf(1, "open . for writing succeeded!\n");
    2bd1:	c7 44 24 04 e4 54 00 	movl   $0x54e4,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 5a 13 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open(".", 0);
    ...
    2bf1:	00 
    2bf2:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    2bf9:	e8 0a 12 00 00       	call   3e08 <open>
    2bfe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(write(fd, "x", 1) > 0){
    2c01:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    2c08:	00 
    2c09:	c7 44 24 04 aa 46 00 	movl   $0x46aa,0x4(%esp)
    2c10:	00 
    2c11:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2c14:	89 04 24             	mov    %eax,(%esp)
    2c17:	e8 cc 11 00 00       	call   3de8 <write>
    2c1c:	85 c0                	test   %eax,%eax
    2c1e:	7e 19                	jle    2c39 <dirfile+0x221>
    printf(1, "write . succeeded!\n");
    2c20:	c7 44 24 04 03 55 00 	movl   $0x5503,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 0b 13 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    2c3f:	e8 ac 11 00 00       	call   3df0 <close>

  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 17 55 00 	movl   $0x5517,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 e7 12 00 00       	call   3f3f <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 27 55 00 	movl   $0x5527,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 cb 12 00 00       	call   3f3f <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(mkdir("irefd") != 0){
    2c80:	c7 04 24 38 55 00 00 	movl   $0x5538,(%esp)
    2c87:	e8 a4 11 00 00       	call   3e30 <mkdir>
    2c8c:	85 c0                	test   %eax,%eax
    2c8e:	74 19                	je     2ca9 <iref+0x4f>
      printf(1, "mkdir irefd failed\n");
    2c90:	c7 44 24 04 3e 55 00 	movl   $0x553e,0x4(%esp)
    2c97:	00 
    2c98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9f:	e8 9b 12 00 00       	call   3f3f <printf>
      exit();
    2ca4:	e8 17 11 00 00       	call   3dc0 <exit>
    }
    if(chdir("irefd") != 0){
    2ca9:	c7 04 24 38 55 00 00 	movl   $0x5538,(%esp)
    2cb0:	e8 83 11 00 00       	call   3e38 <chdir>
    2cb5:	85 c0                	test   %eax,%eax
    2cb7:	74 19                	je     2cd2 <iref+0x78>
      printf(1, "chdir irefd failed\n");
    2cb9:	c7 44 24 04 52 55 00 	movl   $0x5552,0x4(%esp)
    2cc0:	00 
    2cc1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc8:	e8 72 12 00 00       	call   3f3f <printf>
      exit();
    2ccd:	e8 ee 10 00 00       	call   3dc0 <exit>
    }

    mkdir("");
    2cd2:	c7 04 24 66 55 00 00 	movl   $0x5566,(%esp)
    2cd9:	e8 52 11 00 00       	call   3e30 <mkdir>
    link("README", "");
    2cde:	c7 44 24 04 66 55 00 	movl   $0x5566,0x4(%esp)
    2ce5:	00 
    2ce6:	c7 04 24 a3 54 00 00 	movl   $0x54a3,(%esp)
    2ced:	e8 36 11 00 00       	call   3e28 <link>
    fd = open("", O_CREATE);
    2cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 66 55 00 00 	movl   $0x5566,(%esp)
    2d01:	e8 02 11 00 00       	call   3e08 <open>
    ...
    2d15:	e8 d6 10 00 00       	call   3df0 <close>
    fd = open("xx", O_CREATE);
    2d1a:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2d21:	00 
    2d22:	c7 04 24 67 55 00 00 	movl   $0x5567,(%esp)
    2d29:	e8 da 10 00 00       	call   3e08 <open>
    ...
    2d3d:	e8 ae 10 00 00       	call   3df0 <close>
    unlink("xx");
    2d42:	c7 04 24 67 55 00 00 	movl   $0x5567,(%esp)
    2d49:	e8 ca 10 00 00       	call   3e18 <unlink>
  int i, fd;
  ...
  chdir("/");
    2d5c:	c7 04 24 8a 53 00 00 	movl   $0x538a,(%esp)
    2d63:	e8 d0 10 00 00       	call   3e38 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 6a 55 00 	movl   $0x556a,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 c3 11 00 00       	call   3f3f <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 7e 55 00 	movl   $0x557e,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 a7 11 00 00       	call   3f3f <printf>
    ...
    2db5:	e8 06 10 00 00       	call   3dc0 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 8c 55 00 	movl   $0x558c,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 58 11 00 00       	call   3f3f <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 ae 55 00 	movl   $0x55ae,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 36 11 00 00       	call   3f3f <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 c2 55 00 	movl   $0x55c2,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 09 11 00 00       	call   3f3f <printf>
    exit();
    2e36:	e8 85 0f 00 00       	call   3dc0 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 d5 55 00 	movl   $0x55d5,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 f0 10 00 00       	call   3f3f <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 dc 60 00 00       	mov    0x60dc,%eax
    2e60:	c7 44 24 04 e3 55 00 	movl   $0x55e3,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 cf 10 00 00       	call   3f3f <printf>
  oldbrk = sbrk(0);
    2e70:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2e77:	e8 d4 0f 00 00       	call   3e50 <sbrk>
    2e7c:	89 45 ec             	mov    %eax,-0x14(%ebp)

  // can one sbrk() less than a page?
  a = sbrk(0);
    2e7f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2e86:	e8 c5 0f 00 00       	call   3e50 <sbrk>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2e9e:	e8 ad 0f 00 00       	call   3e50 <sbrk>
    ...
    2eae:	a1 dc 60 00 00       	mov    0x60dc,%eax
    ...
    2ec8:	c7 44 24 04 ee 55 00 	movl   $0x55ee,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 67 10 00 00       	call   3f3f <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 dc 60 00 00       	mov    0x60dc,%eax
    2f0c:	c7 44 24 04 09 56 00 	movl   $0x5609,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 23 10 00 00       	call   3f3f <printf>
    exit();
    2f1c:	e8 9f 0e 00 00       	call   3dc0 <exit>
  }
  c = sbrk(1);
    2f21:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f28:	e8 23 0f 00 00       	call   3e50 <sbrk>
    2f2d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  c = sbrk(1);
    2f30:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f37:	e8 14 0f 00 00       	call   3e50 <sbrk>
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 dc 60 00 00       	mov    0x60dc,%eax
    2f4f:	c7 44 24 04 20 56 00 	movl   $0x5620,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 e0 0f 00 00       	call   3f3f <printf>
    exit();
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    2f7b:	e8 d0 0e 00 00       	call   3e50 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2f9a:	e8 b1 0e 00 00       	call   3e50 <sbrk>
  ...
  if (p != a) { 
    ...
    2faa:	a1 dc 60 00 00       	mov    0x60dc,%eax
    2faf:	c7 44 24 04 3c 56 00 	movl   $0x563c,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 80 0f 00 00       	call   3f3f <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c != a - 4096){
    ...
    302b:	a1 dc 60 00 00       	mov    0x60dc,%eax
    ...
    303e:	c7 44 24 04 98 56 00 	movl   $0x5698,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 f1 0e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3080:	e8 cb 0d 00 00       	call   3e50 <sbrk>
    ...
    3092:	a1 dc 60 00 00       	mov    0x60dc,%eax
    ...
    30a5:	c7 44 24 04 d0 56 00 	movl   $0x56d0,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 8a 0e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 dc 60 00 00       	mov    0x60dc,%eax
    30c9:	c7 44 24 04 f8 56 00 	movl   $0x56f8,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 66 0e 00 00       	call   3f3f <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 dc 60 00 00       	mov    0x60dc,%eax
    ...
    3128:	c7 44 24 04 28 57 00 	movl   $0x5728,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 07 0e 00 00       	call   3f3f <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    3146:	e8 fd 0c 00 00       	call   3e48 <getpid>
    ...
    315c:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3161:	c7 44 24 04 f1 46 00 	movl   $0x46f1,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 ce 0d 00 00       	call   3f3f <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    31d4:	e8 ff 0b 00 00       	call   3dd8 <pipe>
    31d9:	85 c0                	test   %eax,%eax
    31db:	74 19                	je     31f6 <sbrktest+0x3a5>
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 45 46 00 	movl   $0x4645,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 4e 0d 00 00       	call   3f3f <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3220:	e8 2b 0c 00 00       	call   3e50 <sbrk>
    ...
    3233:	e8 18 0c 00 00       	call   3e50 <sbrk>
      write(fds[1], "x", 1);
    3238:	8b 45 cc             	mov    -0x34(%ebp),%eax
    323b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3242:	00 
    3243:	c7 44 24 04 aa 46 00 	movl   $0x46aa,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 95 0b 00 00       	call   3de8 <write>
      // sit around until killed
      for(;;) sleep(1000);
    3253:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
    325a:	e8 f9 0b 00 00       	call   3e58 <sleep>
    ...
    3282:	e8 59 0b 00 00       	call   3de0 <read>
  // failed allocation?
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    exit();
  ...
  c = sbrk(4096);
    ...
    329e:	e8 ad 0b 00 00       	call   3e50 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    32c5:	e8 2e 0b 00 00       	call   3df8 <kill>
    wait();
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 dc 60 00 00       	mov    0x60dc,%eax
    32e9:	c7 44 24 04 62 57 00 	movl   $0x5762,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 46 0c 00 00       	call   3f3f <printf>
    exit();
  ...
  if(sbrk(0) > oldbrk)
    ...
    3305:	e8 46 0b 00 00       	call   3e50 <sbrk>
    ...
    3319:	e8 32 0b 00 00       	call   3e50 <sbrk>
    331e:	89 da                	mov    %ebx,%edx
    3320:	29 c2                	sub    %eax,%edx
    3322:	89 d0                	mov    %edx,%eax
    3324:	89 04 24             	mov    %eax,(%esp)
    3327:	e8 24 0b 00 00       	call   3e50 <sbrk>

  printf(stdout, "sbrk test OK\n");
    332c:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3331:	c7 44 24 04 7d 57 00 	movl   $0x577d,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 fe 0b 00 00       	call   3f3f <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3380:	c7 44 24 04 8b 57 00 	movl   $0x578b,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 af 0b 00 00       	call   3f3f <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33c5:	e8 8e 0a 00 00       	call   3e58 <sleep>
    sleep(0);
    33ca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    33d1:	e8 82 0a 00 00       	call   3e58 <sleep>
    kill(pid);
    33d6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    33d9:	89 04 24             	mov    %eax,(%esp)
    33dc:	e8 17 0a 00 00       	call   3df8 <kill>
    wait();
    ...
    33ed:	c7 04 24 9a 57 00 00 	movl   $0x579a,(%esp)
    33f4:	e8 2f 0a 00 00       	call   3e28 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3403:	c7 44 24 04 a5 57 00 	movl   $0x57a5,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 2c 0b 00 00       	call   3f3f <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3430:	c7 44 24 04 be 57 00 	movl   $0x57be,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 ff 0a 00 00       	call   3f3f <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 dc 60 00 00       	mov    0x60dc,%eax
    344d:	c7 44 24 04 cb 57 00 	movl   $0x57cb,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 e2 0a 00 00       	call   3f3f <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 dc 60 00 00       	mov    0x60dc,%eax
    347a:	c7 44 24 04 d5 57 00 	movl   $0x57d5,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 b5 0a 00 00       	call   3f3f <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 dc 60 00 00       	mov    0x60dc,%eax
    34a2:	c7 44 24 04 e6 57 00 	movl   $0x57e6,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 8d 0a 00 00       	call   3f3f <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
    34c1:	e8 52 09 00 00       	call   3e18 <unlink>
  pid = fork();
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 00 61 00 00 	movl   $0x5800,0x6100(,%eax,4)
    34eb:	00 58 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3508:	c7 44 24 04 dd 58 00 	movl   $0x58dd,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 27 0a 00 00       	call   3f3f <printf>
    exec("echo", args);
    3518:	c7 44 24 04 00 61 00 	movl   $0x6100,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 04 43 00 00 	movl   $0x4304,(%esp)
    3527:	e8 d4 08 00 00       	call   3e00 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3531:	c7 44 24 04 ea 58 00 	movl   $0x58ea,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 fe 09 00 00       	call   3f3f <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
    3550:	e8 b3 08 00 00       	call   3e08 <open>
    3555:	89 45 ec             	mov    %eax,-0x14(%ebp)
    close(fd);
    3558:	8b 45 ec             	mov    -0x14(%ebp),%eax
    355b:	89 04 24             	mov    %eax,(%esp)
    355e:	e8 8d 08 00 00       	call   3df0 <close>
    exit();
    ...
    356e:	a1 dc 60 00 00       	mov    0x60dc,%eax
    3573:	c7 44 24 04 fa 58 00 	movl   $0x58fa,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 bc 09 00 00       	call   3f3f <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
    359c:	e8 67 08 00 00       	call   3e08 <open>
    35a1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if(fd < 0){
    35a4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    35a8:	79 1a                	jns    35c4 <bigargtest+0x110>
    printf(stdout, "bigarg test failed!\n");
    35aa:	a1 dc 60 00 00       	mov    0x60dc,%eax
    35af:	c7 44 24 04 13 59 00 	movl   $0x5913,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 80 09 00 00       	call   3f3f <printf>
    exit();
  ...
  close(fd);
    ...
    35ca:	e8 21 08 00 00       	call   3df0 <close>
  unlink("bigarg-ok");
    35cf:	c7 04 24 f3 57 00 00 	movl   $0x57f3,(%esp)
    35d6:	e8 3d 08 00 00       	call   3e18 <unlink>
}
    35db:	c9                   	leave  
    35dc:	c3                   	ret    
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 28 59 00 	movl   $0x5928,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 40 09 00 00       	call   3f3f <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3712:	c7 44 24 04 41 59 00 	movl   $0x5941,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 19 08 00 00       	call   3f3f <printf>
      break;
    ...
    3745:	e8 9e 06 00 00       	call   3de8 <write>
    ...
    376a:	c7 44 24 04 51 59 00 	movl   $0x5951,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 c1 07 00 00       	call   3f3f <printf>
    close(fd);
    377e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3781:	89 04 24             	mov    %eax,(%esp)
    3784:	e8 67 06 00 00       	call   3df0 <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3872:	e8 a1 05 00 00       	call   3e18 <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 61 59 00 	movl   $0x5961,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 a6 06 00 00       	call   3f3f <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 e0 60 00 00       	mov    0x60e0,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 e0 60 00 00       	mov    %eax,0x60e0
  return randstate;
    38b7:	a1 e0 60 00 00       	mov    0x60e0,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38c7:	c7 44 24 04 77 59 00 	movl   $0x5977,0x4(%esp)
    38ce:	00 
    38cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    38d6:	e8 64 06 00 00       	call   3f3f <printf>

  if(open("usertests.ran", 0) >= 0){
    38db:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    38e2:	00 
    38e3:	c7 04 24 8b 59 00 00 	movl   $0x598b,(%esp)
    38ea:	e8 19 05 00 00       	call   3e08 <open>
    38ef:	85 c0                	test   %eax,%eax
    38f1:	78 19                	js     390c <main+0x4e>
    printf(1, "already ran user tests -- rebuild fs.img\n");
    38f3:	c7 44 24 04 9c 59 00 	movl   $0x599c,0x4(%esp)
    38fa:	00 
    38fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3902:	e8 38 06 00 00       	call   3f3f <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 8b 59 00 00 	movl   $0x598b,(%esp)
    391b:	e8 e8 04 00 00       	call   3e08 <open>
    3920:	89 04 24             	mov    %eax,(%esp)
    3923:	e8 c8 04 00 00       	call   3df0 <close>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3aff:	e8 dc 02 00 00       	call   3de0 <read>
...
stat(char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3b5d:	e8 a6 02 00 00       	call   3e08 <open>
...
00003dd8 <pipe>:
SYSCALL(pipe)
    3dd8:	b8 04 00 00 00       	mov    $0x4,%eax
    3ddd:	cd 40                	int    $0x40
    3ddf:	c3                   	ret    

00003de0 <read>:
SYSCALL(read)
    3de0:	b8 05 00 00 00       	mov    $0x5,%eax
    3de5:	cd 40                	int    $0x40
    3de7:	c3                   	ret    

00003de8 <write>:
SYSCALL(write)
    3de8:	b8 10 00 00 00       	mov    $0x10,%eax
    3ded:	cd 40                	int    $0x40
    3def:	c3                   	ret    

00003df0 <close>:
SYSCALL(close)
    3df0:	b8 15 00 00 00       	mov    $0x15,%eax
    3df5:	cd 40                	int    $0x40
    3df7:	c3                   	ret    

00003df8 <kill>:
SYSCALL(kill)
    3df8:	b8 06 00 00 00       	mov    $0x6,%eax
    3dfd:	cd 40                	int    $0x40
    3dff:	c3                   	ret    

00003e00 <exec>:
SYSCALL(exec)
    3e00:	b8 07 00 00 00       	mov    $0x7,%eax
    3e05:	cd 40                	int    $0x40
    3e07:	c3                   	ret    

00003e08 <open>:
SYSCALL(open)
    3e08:	b8 0f 00 00 00       	mov    $0xf,%eax
    3e0d:	cd 40                	int    $0x40
    3e0f:	c3                   	ret    

00003e10 <mknod>:
SYSCALL(mknod)
    3e10:	b8 11 00 00 00       	mov    $0x11,%eax
    3e15:	cd 40                	int    $0x40
    3e17:	c3                   	ret    

00003e18 <unlink>:
SYSCALL(unlink)
    3e18:	b8 12 00 00 00       	mov    $0x12,%eax
    3e1d:	cd 40                	int    $0x40
    3e1f:	c3                   	ret    

00003e20 <fstat>:
SYSCALL(fstat)
    3e20:	b8 08 00 00 00       	mov    $0x8,%eax
    3e25:	cd 40                	int    $0x40
    3e27:	c3                   	ret    

00003e28 <link>:
SYSCALL(link)
    3e28:	b8 13 00 00 00       	mov    $0x13,%eax
    3e2d:	cd 40                	int    $0x40
    3e2f:	c3                   	ret    

00003e30 <mkdir>:
SYSCALL(mkdir)
    3e30:	b8 14 00 00 00       	mov    $0x14,%eax
    3e35:	cd 40                	int    $0x40
    3e37:	c3                   	ret    

00003e38 <chdir>:
SYSCALL(chdir)
    3e38:	b8 09 00 00 00       	mov    $0x9,%eax
    3e3d:	cd 40                	int    $0x40
    3e3f:	c3                   	ret    

00003e40 <dup>:
SYSCALL(dup)
    3e40:	b8 0a 00 00 00       	mov    $0xa,%eax
    3e45:	cd 40                	int    $0x40
    3e47:	c3                   	ret    

00003e48 <getpid>:
SYSCALL(getpid)
    3e48:	b8 0b 00 00 00       	mov    $0xb,%eax
    3e4d:	cd 40                	int    $0x40
    3e4f:	c3                   	ret    

00003e50 <sbrk>:
SYSCALL(sbrk)
    3e50:	b8 0c 00 00 00       	mov    $0xc,%eax
    3e55:	cd 40                	int    $0x40
    3e57:	c3                   	ret    

00003e58 <sleep>:
SYSCALL(sleep)
    3e58:	b8 0d 00 00 00       	mov    $0xd,%eax
    3e5d:	cd 40                	int    $0x40
    3e5f:	c3                   	ret    

00003e60 <uptime>:
SYSCALL(uptime)
    3e60:	b8 0e 00 00 00       	mov    $0xe,%eax
    3e65:	cd 40                	int    $0x40
    3e67:	c3                   	ret    
...
{
    3e68:	55                   	push   %ebp
    3e69:	89 e5                	mov    %esp,%ebp
    3e6b:	83 ec 28             	sub    $0x28,%esp
    3e6e:	8b 45 0c             	mov    0xc(%ebp),%eax
    3e71:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3e74:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3e7b:	00 
    3e7c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3e7f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e83:	8b 45 08             	mov    0x8(%ebp),%eax
    3e86:	89 04 24             	mov    %eax,(%esp)
    3e89:	e8 5a ff ff ff       	call   3de8 <write>
}
    3e8e:	c9                   	leave  
    3e8f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    3e9d:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3ea1:	74 17                	je     3eba <printint+0x2a>
    3ea3:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3ea7:	79 11                	jns    3eba <printint+0x2a>
    neg = 1;
    3ea9:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3eb0:	8b 45 0c             	mov    0xc(%ebp),%eax
    3eb3:	f7 d8                	neg    %eax
    3eb5:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3eb8:	eb 06                	jmp    3ec0 <printint+0x30>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    3ec7:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3eca:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ecd:	ba 00 00 00 00       	mov    $0x0,%edx
    3ed2:	f7 f1                	div    %ecx
    3ed4:	89 d0                	mov    %edx,%eax
    3ed6:	0f b6 90 e4 60 00 00 	movzbl 0x60e4(%eax),%edx
    3edd:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3ee0:	03 45 f4             	add    -0xc(%ebp),%eax
    3ee3:	88 10                	mov    %dl,(%eax)
    3ee5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3ee9:	8b 55 10             	mov    0x10(%ebp),%edx
    3eec:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3eef:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ef2:	ba 00 00 00 00       	mov    $0x0,%edx
    3ef7:	f7 75 d4             	divl   -0x2c(%ebp)
    3efa:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3efd:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3f01:	75 c4                	jne    3ec7 <printint+0x37>
  if(neg)
    3f03:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3f07:	74 2a                	je     3f33 <printint+0xa3>
    buf[i++] = '-';
    3f09:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3f0c:	03 45 f4             	add    -0xc(%ebp),%eax
    3f0f:	c6 00 2d             	movb   $0x2d,(%eax)
    3f12:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3f16:	eb 1b                	jmp    3f33 <printint+0xa3>
    putc(fd, buf[i]);
    3f18:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3f1b:	03 45 f4             	add    -0xc(%ebp),%eax
    ...
    3f2e:	e8 35 ff ff ff       	call   3e68 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3f33:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3f37:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3f3b:	79 db                	jns    3f18 <printint+0x88>
    putc(fd, buf[i]);
}
    3f3d:	c9                   	leave  
    3f3e:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    3f42:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3f45:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3f4c:	8d 45 0c             	lea    0xc(%ebp),%eax
    3f4f:	83 c0 04             	add    $0x4,%eax
    3f52:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3f55:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3f5c:	e9 7d 01 00 00       	jmp    40de <printf+0x19f>
    c = fmt[i] & 0xff;
    3f61:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f64:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f67:	01 d0                	add    %edx,%eax
    3f69:	0f b6 00             	movzbl (%eax),%eax
    3f6c:	0f be c0             	movsbl %al,%eax
    3f6f:	25 ff 00 00 00       	and    $0xff,%eax
    3f74:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3f77:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3f7b:	75 2c                	jne    3fa9 <printf+0x6a>
      if(c == '%'){
    3f7d:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f81:	75 0c                	jne    3f8f <printf+0x50>
        state = '%';
    3f83:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3f8a:	e9 4b 01 00 00       	jmp    40da <printf+0x19b>
      } else {
        putc(fd, c);
    3f8f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f92:	0f be c0             	movsbl %al,%eax
    3f95:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f99:	8b 45 08             	mov    0x8(%ebp),%eax
    3f9c:	89 04 24             	mov    %eax,(%esp)
    3f9f:	e8 c4 fe ff ff       	call   3e68 <putc>
    3fa4:	e9 31 01 00 00       	jmp    40da <printf+0x19b>
      }
    } else if(state == '%'){
    3fa9:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3fad:	0f 85 27 01 00 00    	jne    40da <printf+0x19b>
      if(c == 'd'){
    3fb3:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3fb7:	75 2d                	jne    3fe6 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3fb9:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3fbc:	8b 00                	mov    (%eax),%eax
    3fbe:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3fc5:	00 
    3fc6:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3fcd:	00 
    3fce:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fd2:	8b 45 08             	mov    0x8(%ebp),%eax
    3fd5:	89 04 24             	mov    %eax,(%esp)
    3fd8:	e8 b3 fe ff ff       	call   3e90 <printint>
        ap++;
    3fdd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3fe1:	e9 ed 00 00 00       	jmp    40d3 <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3fe6:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3fea:	74 06                	je     3ff2 <printf+0xb3>
    3fec:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3ff0:	75 2d                	jne    401f <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3ff2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3ff5:	8b 00                	mov    (%eax),%eax
    3ff7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3ffe:	00 
    3fff:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4006:	00 
    4007:	89 44 24 04          	mov    %eax,0x4(%esp)
    400b:	8b 45 08             	mov    0x8(%ebp),%eax
    400e:	89 04 24             	mov    %eax,(%esp)
    4011:	e8 7a fe ff ff       	call   3e90 <printint>
        ap++;
    4016:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    401a:	e9 b4 00 00 00       	jmp    40d3 <printf+0x194>
      } else if(c == 's'){
    401f:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4023:	75 46                	jne    406b <printf+0x12c>
        s = (char*)*ap;
    4025:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4028:	8b 00                	mov    (%eax),%eax
    402a:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    402d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4031:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4035:	75 27                	jne    405e <printf+0x11f>
          s = "(null)";
    4037:	c7 45 f4 c6 59 00 00 	movl   $0x59c6,-0xc(%ebp)
        while(*s != 0){
    403e:	eb 1e                	jmp    405e <printf+0x11f>
          putc(fd, *s);
    4040:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4043:	0f b6 00             	movzbl (%eax),%eax
    4046:	0f be c0             	movsbl %al,%eax
    4049:	89 44 24 04          	mov    %eax,0x4(%esp)
    404d:	8b 45 08             	mov    0x8(%ebp),%eax
    4050:	89 04 24             	mov    %eax,(%esp)
    4053:	e8 10 fe ff ff       	call   3e68 <putc>
          s++;
    4058:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    405c:	eb 01                	jmp    405f <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    4065:	84 c0                	test   %al,%al
    4067:	75 d7                	jne    4040 <printf+0x101>
    4069:	eb 68                	jmp    40d3 <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    406b:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    406f:	75 1d                	jne    408e <printf+0x14f>
        putc(fd, *ap);
    4071:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4074:	8b 00                	mov    (%eax),%eax
    4076:	0f be c0             	movsbl %al,%eax
    4079:	89 44 24 04          	mov    %eax,0x4(%esp)
    407d:	8b 45 08             	mov    0x8(%ebp),%eax
    4080:	89 04 24             	mov    %eax,(%esp)
    4083:	e8 e0 fd ff ff       	call   3e68 <putc>
        ap++;
    4088:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    408c:	eb 45                	jmp    40d3 <printf+0x194>
      } else if(c == '%'){
    408e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4092:	75 17                	jne    40ab <printf+0x16c>
        putc(fd, c);
    4094:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4097:	0f be c0             	movsbl %al,%eax
    409a:	89 44 24 04          	mov    %eax,0x4(%esp)
    409e:	8b 45 08             	mov    0x8(%ebp),%eax
    40a1:	89 04 24             	mov    %eax,(%esp)
    40a4:	e8 bf fd ff ff       	call   3e68 <putc>
    40a9:	eb 28                	jmp    40d3 <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    40ab:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    40b2:	00 
    40b3:	8b 45 08             	mov    0x8(%ebp),%eax
    40b6:	89 04 24             	mov    %eax,(%esp)
    40b9:	e8 aa fd ff ff       	call   3e68 <putc>
        putc(fd, c);
    ...
    40ce:	e8 95 fd ff ff       	call   3e68 <putc>
      }
      state = 0;
    40d3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    40da:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    40de:	8b 55 0c             	mov    0xc(%ebp),%edx
    40e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40e4:	01 d0                	add    %edx,%eax
    40e6:	0f b6 00             	movzbl (%eax),%eax
    40e9:	84 c0                	test   %al,%al
    40eb:	0f 85 70 fe ff ff    	jne    3f61 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    40f7:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    40fa:	8b 45 08             	mov    0x8(%ebp),%eax
    40fd:	83 e8 08             	sub    $0x8,%eax
    4100:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4103:	a1 88 61 00 00       	mov    0x6188,%eax
    4108:	89 45 fc             	mov    %eax,-0x4(%ebp)
    410b:	eb 24                	jmp    4131 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    410d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4110:	8b 00                	mov    (%eax),%eax
    4112:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4115:	77 12                	ja     4129 <free+0x35>
    4117:	8b 45 f8             	mov    -0x8(%ebp),%eax
    411a:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    411d:	77 24                	ja     4143 <free+0x4f>
    411f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4122:	8b 00                	mov    (%eax),%eax
    4124:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4127:	77 1a                	ja     4143 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    412e:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4131:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4134:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4137:	76 d4                	jbe    410d <free+0x19>
    4139:	8b 45 fc             	mov    -0x4(%ebp),%eax
    413c:	8b 00                	mov    (%eax),%eax
    413e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4141:	76 ca                	jbe    410d <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    4143:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4146:	8b 40 04             	mov    0x4(%eax),%eax
    4149:	c1 e0 03             	shl    $0x3,%eax
    414c:	89 c2                	mov    %eax,%edx
    414e:	03 55 f8             	add    -0x8(%ebp),%edx
    4151:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4154:	8b 00                	mov    (%eax),%eax
    4156:	39 c2                	cmp    %eax,%edx
    4158:	75 24                	jne    417e <free+0x8a>
    bp->s.size += p->s.ptr->s.size;
    415a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    415d:	8b 50 04             	mov    0x4(%eax),%edx
    4160:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4163:	8b 00                	mov    (%eax),%eax
    4165:	8b 40 04             	mov    0x4(%eax),%eax
    4168:	01 c2                	add    %eax,%edx
    416a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    416d:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    4170:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4173:	8b 00                	mov    (%eax),%eax
    4175:	8b 10                	mov    (%eax),%edx
    4177:	8b 45 f8             	mov    -0x8(%ebp),%eax
    417a:	89 10                	mov    %edx,(%eax)
    417c:	eb 0a                	jmp    4188 <free+0x94>
  } else
    bp->s.ptr = p->s.ptr;
    417e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4181:	8b 10                	mov    (%eax),%edx
    4183:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4186:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    4188:	8b 45 fc             	mov    -0x4(%ebp),%eax
    418b:	8b 40 04             	mov    0x4(%eax),%eax
    418e:	c1 e0 03             	shl    $0x3,%eax
    4191:	03 45 fc             	add    -0x4(%ebp),%eax
    4194:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4197:	75 20                	jne    41b9 <free+0xc5>
    p->s.size += bp->s.size;
    4199:	8b 45 fc             	mov    -0x4(%ebp),%eax
    419c:	8b 50 04             	mov    0x4(%eax),%edx
    419f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    41a2:	8b 40 04             	mov    0x4(%eax),%eax
    41a5:	01 c2                	add    %eax,%edx
    41a7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    41aa:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    41ad:	8b 45 f8             	mov    -0x8(%ebp),%eax
    41b0:	8b 10                	mov    (%eax),%edx
    41b2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    41b5:	89 10                	mov    %edx,(%eax)
    41b7:	eb 08                	jmp    41c1 <free+0xcd>
  } else
    p->s.ptr = bp;
    41b9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    41bc:	8b 55 f8             	mov    -0x8(%ebp),%edx
    41bf:	89 10                	mov    %edx,(%eax)
  freep = p;
    41c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    41c4:	a3 88 61 00 00       	mov    %eax,0x6188
}
    41c9:	c9                   	leave  
    41ca:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    41ce:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    41d1:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    41d8:	77 07                	ja     41e1 <morecore+0x16>
    nu = 4096;
    41da:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    41e1:	8b 45 08             	mov    0x8(%ebp),%eax
    41e4:	c1 e0 03             	shl    $0x3,%eax
    41e7:	89 04 24             	mov    %eax,(%esp)
    41ea:	e8 61 fc ff ff       	call   3e50 <sbrk>
    41ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    41f2:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    41f6:	75 07                	jne    41ff <morecore+0x34>
    return 0;
    41f8:	b8 00 00 00 00       	mov    $0x0,%eax
    41fd:	eb 22                	jmp    4221 <morecore+0x56>
  hp = (Header*)p;
    41ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4202:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4205:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4208:	8b 55 08             	mov    0x8(%ebp),%edx
    420b:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    420e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4211:	83 c0 08             	add    $0x8,%eax
    4214:	89 04 24             	mov    %eax,(%esp)
    4217:	e8 d8 fe ff ff       	call   40f4 <free>
  return freep;
    421c:	a1 88 61 00 00       	mov    0x6188,%eax
}
    4221:	c9                   	leave  
    4222:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4226:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4229:	8b 45 08             	mov    0x8(%ebp),%eax
    422c:	83 c0 07             	add    $0x7,%eax
    422f:	c1 e8 03             	shr    $0x3,%eax
    4232:	83 c0 01             	add    $0x1,%eax
    4235:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    4238:	a1 88 61 00 00       	mov    0x6188,%eax
    423d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4240:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4244:	75 23                	jne    4269 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4246:	c7 45 f0 80 61 00 00 	movl   $0x6180,-0x10(%ebp)
    424d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4250:	a3 88 61 00 00       	mov    %eax,0x6188
    4255:	a1 88 61 00 00       	mov    0x6188,%eax
    425a:	a3 80 61 00 00       	mov    %eax,0x6180
    base.s.size = 0;
    425f:	c7 05 84 61 00 00 00 	movl   $0x0,0x6184
    4266:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    4271:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4274:	8b 40 04             	mov    0x4(%eax),%eax
    4277:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    427a:	72 4d                	jb     42c9 <malloc+0xa6>
      if(p->s.size == nunits)
    427c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    427f:	8b 40 04             	mov    0x4(%eax),%eax
    4282:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4285:	75 0c                	jne    4293 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4287:	8b 45 f4             	mov    -0xc(%ebp),%eax
    428a:	8b 10                	mov    (%eax),%edx
    428c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    428f:	89 10                	mov    %edx,(%eax)
    4291:	eb 26                	jmp    42b9 <malloc+0x96>
      else {
        p->s.size -= nunits;
    4293:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4296:	8b 40 04             	mov    0x4(%eax),%eax
    4299:	89 c2                	mov    %eax,%edx
    429b:	2b 55 ec             	sub    -0x14(%ebp),%edx
    429e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42a1:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    42a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42a7:	8b 40 04             	mov    0x4(%eax),%eax
    42aa:	c1 e0 03             	shl    $0x3,%eax
    42ad:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    42b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42b3:	8b 55 ec             	mov    -0x14(%ebp),%edx
    42b6:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    42b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    42bc:	a3 88 61 00 00       	mov    %eax,0x6188
      return (void*)(p + 1);
    42c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42c4:	83 c0 08             	add    $0x8,%eax
    42c7:	eb 38                	jmp    4301 <malloc+0xde>
    }
    if(p == freep)
    42c9:	a1 88 61 00 00       	mov    0x6188,%eax
    42ce:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    42d1:	75 1b                	jne    42ee <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    42d3:	8b 45 ec             	mov    -0x14(%ebp),%eax
    42d6:	89 04 24             	mov    %eax,(%esp)
    42d9:	e8 ed fe ff ff       	call   41cb <morecore>
    42de:	89 45 f4             	mov    %eax,-0xc(%ebp)
    42e1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    42e5:	75 07                	jne    42ee <malloc+0xcb>
        return 0;
    42e7:	b8 00 00 00 00       	mov    $0x0,%eax
    42ec:	eb 13                	jmp    4301 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    42f1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    42fc:	e9 70 ff ff ff       	jmp    4271 <malloc+0x4e>
}
    4301:	c9                   	leave  
    4302:	c3                   	ret    
