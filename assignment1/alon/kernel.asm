...
8010011f:	e8 20 4e 00 00       	call   80104f44 <sleep>
      goto loop;
...
8010029d:	e8 7e 4d 00 00       	call   80105020 <wakeup>
...
801003c5:	e8 ed 4e 00 00       	call   801052b7 <acquire>
...
801003cf:	75 0c                	jne    801003dd <cprintf+0x33>
    panic("null fmt");
801003d1:	c7 04 24 aa 89 10 80 	movl   $0x801089aa,(%esp)
...
801004b6:	74 20                	je     801004d8 <cprintf+0x12e>
        s = "(null)";
801004b8:	c7 45 ec b3 89 10 80 	movl   $0x801089b3,-0x14(%ebp)
      for(; *s; s++)
...
8010053f:	e8 d5 4d 00 00       	call   80105319 <release>
}
80100544:	c9                   	leave  
80100545:	c3                   	ret    
...
8010056b:	c7 04 24 ba 89 10 80 	movl   $0x801089ba,(%esp)
...
8010057d:	e8 28 fe ff ff       	call   801003aa <cprintf>
  cprintf("\n");
80100582:	c7 04 24 c9 89 10 80 	movl   $0x801089c9,(%esp)
...
8010059b:	e8 c8 4d 00 00       	call   80105368 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005b4:	c7 04 24 cb 89 10 80 	movl   $0x801089cb,(%esp)
...
8010069a:	a1 00 a0 10 80       	mov    0x8010a000,%eax
...
801006c0:	a1 00 a0 10 80       	mov    0x8010a000,%eax
...
801006df:	e8 01 4f 00 00       	call   801055e5 <memmove>
    pos -= 80;
...
801006f2:	8b 15 00 a0 10 80    	mov    0x8010a000,%edx
...
8010070e:	e8 ff 4d 00 00       	call   80105512 <memset>
  }
...
8010077a:	74 11                	je     8010078d <cgaputc+0x1b7>
    crt[pos] = ' ' | 0x0700;
8010077c:	a1 00 a0 10 80       	mov    0x8010a000,%eax
...
80100792:	83 ec 18             	sub    $0x18,%esp
  if(panicked){
80100795:	a1 a0 c5 10 80       	mov    0x8010c5a0,%eax
...
801007b5:	e8 17 68 00 00       	call   80106fd1 <uartputc>
801007ba:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801007c1:	e8 0b 68 00 00       	call   80106fd1 <uartputc>
801007c6:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801007cd:	e8 ff 67 00 00       	call   80106fd1 <uartputc>
...
801007da:	e8 f2 67 00 00       	call   80106fd1 <uartputc>
  cgaputc(c);
...
80100801:	0f b6 80 d4 ed 10 80 	movzbl -0x7fef122c(%eax),%eax
80100808:	8b 55 08             	mov    0x8(%ebp),%edx
8010080b:	81 c2 d0 ed 10 80    	add    $0x8010edd0,%edx
...
8010084a:	0f b6 80 d4 ed 10 80 	movzbl -0x7fef122c(%eax),%eax
80100851:	8b 55 fc             	mov    -0x4(%ebp),%edx
80100854:	81 c2 d0 ed 10 80    	add    $0x8010edd0,%edx
...
80100870:	05 d0 ed 10 80       	add    $0x8010edd0,%eax
...
8010087e:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&input.lock);
80100881:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100888:	e8 2a 4a 00 00       	call   801052b7 <acquire>
  while((c = getc()) >= 0){
...
801008c9:	e9 b7 01 00 00       	jmp    80100a85 <consoleintr+0x20a>
    case C('P'):  // Process listing.
      procdump();
801008ce:	e8 f3 47 00 00       	call   801050c6 <procdump>
      break;
801008d3:	e9 11 03 00 00       	jmp    80100be9 <consoleintr+0x36e>
    case C('U'):  // Kill line.
      while(input.e != input.w &&
        ...
        input.e--;
801008d8:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
801008dd:	83 e8 01             	sub    $0x1,%eax
801008e0:	a3 5c ee 10 80       	mov    %eax,0x8010ee5c
        consputc(BACKSPACE);
...
801008f1:	eb 01                	jmp    801008f4 <consoleintr+0x79>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
801008f3:	90                   	nop
801008f4:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
801008fa:	a1 58 ee 10 80       	mov    0x8010ee58,%eax
801008ff:	39 c2                	cmp    %eax,%edx
80100901:	0f 84 d5 02 00 00    	je     80100bdc <consoleintr+0x361>
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
80100907:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
8010090c:	83 e8 01             	sub    $0x1,%eax
8010090f:	83 e0 7f             	and    $0x7f,%eax
80100912:	0f b6 80 d4 ed 10 80 	movzbl -0x7fef122c(%eax),%eax
    switch(c){
    case C('P'):  // Process listing.
      procdump();
      break;
...
8010091d:	e9 ba 02 00 00       	jmp    80100bdc <consoleintr+0x361>
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
80100922:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
80100928:	a1 58 ee 10 80       	mov    0x8010ee58,%eax
8010092d:	39 c2                	cmp    %eax,%edx
8010092f:	0f 84 aa 02 00 00    	je     80100bdf <consoleintr+0x364>
	if(input.a > 0)
80100935:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
...
80100942:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
...
8010095f:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
80100965:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
...
8010098a:	0f b6 80 d4 ed 10 80 	movzbl -0x7fef122c(%eax),%eax
...
801009a0:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
801009a5:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801009a8:	77 da                	ja     80100984 <consoleintr+0x109>
	      consputc(input.buf[i%INPUT_BUF]);
	    }
	    i = input.e-input.a;
801009aa:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
801009b0:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
...
801009d0:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
801009e6:	e8 a4 fd ff ff       	call   8010078f <consputc>
	...
	input.e--;
801009eb:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
801009f0:	83 e8 01             	sub    $0x1,%eax
801009f3:	a3 5c ee 10 80       	mov    %eax,0x8010ee5c
      }
      break;
...
80100a07:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
80100a0d:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
80100a12:	29 c2                	sub    %eax,%edx
80100a14:	a1 58 ee 10 80       	mov    0x8010ee58,%eax
...
80100a28:	e8 62 fd ff ff       	call   8010078f <consputc>
	input.a++;
80100a2d:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
80100a32:	83 c0 01             	add    $0x1,%eax
80100a35:	a3 60 ee 10 80       	mov    %eax,0x8010ee60
      }
      break;
...
80100a49:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
80100a4e:	85 c0                	test   %eax,%eax
80100a50:	0f 84 8f 01 00 00    	je     80100be5 <consoleintr+0x36a>
80100a56:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
80100a6e:	e8 1c fd ff ff       	call   8010078f <consputc>
	input.a--;
80100a73:	a1 60 ee 10 80       	mov    0x8010ee60,%eax
80100a78:	83 e8 01             	sub    $0x1,%eax
80100a7b:	a3 60 ee 10 80       	mov    %eax,0x8010ee60
      }
      break;
...
80100a8f:	8b 15 5c ee 10 80    	mov    0x8010ee5c,%edx
80100a95:	a1 54 ee 10 80       	mov    0x8010ee54,%eax
...
80100af4:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
80100b04:	88 82 d4 ed 10 80    	mov    %al,-0x7fef122c(%edx)
	    
	    uint i = input.e-k;
80100b0a:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
80100b1d:	0f b6 80 d4 ed 10 80 	movzbl -0x7fef122c(%eax),%eax
...
80100b33:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
80100b3e:	77 d7                	ja     80100b17 <consoleintr+0x29c>
	    ...
	    i = input.e-k;
80100b40:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
...
80100b5d:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
80100b62:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80100b65:	77 e6                	ja     80100b4d <consoleintr+0x2d2>
	      consputc(KEY_LF);
	
	    input.e++;
80100b67:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
80100b6c:	83 c0 01             	add    $0x1,%eax
80100b6f:	a3 5c ee 10 80       	mov    %eax,0x8010ee5c
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF)
      {
	c = (c == '\r') ? '\n' : c;
...
80100b76:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
80100b7b:	89 c1                	mov    %eax,%ecx
80100b7d:	83 e1 7f             	and    $0x7f,%ecx
80100b80:	8b 55 ec             	mov    -0x14(%ebp),%edx
80100b83:	88 91 d4 ed 10 80    	mov    %dl,-0x7fef122c(%ecx)
80100b89:	83 c0 01             	add    $0x1,%eax
80100b8c:	a3 5c ee 10 80       	mov    %eax,0x8010ee5c
          consputc(c);
...
80100ba8:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
80100bad:	8b 15 54 ee 10 80    	mov    0x8010ee54,%edx
80100bb3:	83 ea 80             	sub    $0xffffff80,%edx
80100bb6:	39 d0                	cmp    %edx,%eax
80100bb8:	75 2e                	jne    80100be8 <consoleintr+0x36d>
	{
	  input.w = input.e;
80100bba:	a1 5c ee 10 80       	mov    0x8010ee5c,%eax
80100bbf:	a3 58 ee 10 80       	mov    %eax,0x8010ee58
          wakeup(&input.r);
80100bc4:	c7 04 24 54 ee 10 80 	movl   $0x8010ee54,(%esp)
80100bcb:	e8 50 44 00 00       	call   80105020 <wakeup>
	  input.a = 0;
80100bd0:	c7 05 60 ee 10 80 00 	movl   $0x0,0x8010ee60
80100bd7:	00 00 00 
        }
      }
      break;
...
80100bf5:	0f 89 97 fc ff ff    	jns    80100892 <consoleintr+0x17>
  ...
  release(&input.lock);
80100bfb:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100c02:	e8 12 47 00 00       	call   80105319 <release>
}
80100c07:	c9                   	leave  
80100c08:	c3                   	ret    
...
80100c1d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  acquire(&input.lock);
80100c20:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100c27:	e8 8b 46 00 00       	call   801052b7 <acquire>
  while(n > 0){
...
80100c3c:	74 21                	je     80100c5f <consoleread+0x56>
        release(&input.lock);
80100c3e:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100c45:	e8 cf 46 00 00       	call   80105319 <release>
        ilock(ip);
...
80100c5f:	c7 44 24 04 a0 ed 10 	movl   $0x8010eda0,0x4(%esp)
80100c66:	80 
80100c67:	c7 04 24 54 ee 10 80 	movl   $0x8010ee54,(%esp)
80100c6e:	e8 d1 42 00 00       	call   80104f44 <sleep>
80100c73:	eb 01                	jmp    80100c76 <consoleread+0x6d>
  ...
  while(n > 0){
    while(input.r == input.w){
80100c75:	90                   	nop
80100c76:	8b 15 54 ee 10 80    	mov    0x8010ee54,%edx
80100c7c:	a1 58 ee 10 80       	mov    0x8010ee58,%eax
...
80100cb0:	73 2f                	jae    80100ce1 <consoleread+0xd8>
        ...
        input.r--;
80100cb2:	a1 54 ee 10 80       	mov    0x8010ee54,%eax
80100cb7:	83 e8 01             	sub    $0x1,%eax
80100cba:	a3 54 ee 10 80       	mov    %eax,0x8010ee54
      }
      break;
...
80100ce4:	90                   	nop
  ...
  release(&input.lock);
80100ce5:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100cec:	e8 28 46 00 00       	call   80105319 <release>
  ilock(ip);
...
80100d16:	e8 a3 0f 00 00       	call   80101cbe <iunlock>
  acquire(&cons.lock);
80100d1b:	c7 04 24 c0 c5 10 80 	movl   $0x8010c5c0,(%esp)
80100d22:	e8 90 45 00 00       	call   801052b7 <acquire>
  for(i = 0; i < n; i++)
...
80100d55:	7c d9                	jl     80100d30 <consolewrite+0x26>
    consputc(buf[i] & 0xff);
  release(&cons.lock);
80100d57:	c7 04 24 c0 c5 10 80 	movl   $0x8010c5c0,(%esp)
80100d5e:	e8 b6 45 00 00       	call   80105319 <release>
  ilock(ip);
...
80100d79:	c7 44 24 04 cf 89 10 	movl   $0x801089cf,0x4(%esp)
80100d80:	80 
80100d81:	c7 04 24 c0 c5 10 80 	movl   $0x8010c5c0,(%esp)
80100d88:	e8 09 45 00 00       	call   80105296 <initlock>
  initlock(&input.lock, "input");
80100d8d:	c7 44 24 04 d7 89 10 	movl   $0x801089d7,0x4(%esp)
80100d94:	80 
80100d95:	c7 04 24 a0 ed 10 80 	movl   $0x8010eda0,(%esp)
80100d9c:	e8 f5 44 00 00       	call   80105296 <initlock>

  devsw[CONSOLE].write = consolewrite;
80100da1:	c7 05 2c f8 10 80 0a 	movl   $0x80100d0a,0x8010f82c
80100da8:	0d 10 80 
  devsw[CONSOLE].read = consoleread;
80100dab:	c7 05 28 f8 10 80 09 	movl   $0x80100c09,0x8010f828
80100db2:	0c 10 80 
  cons.locking = 1;
80100db5:	c7 05 f4 c5 10 80 01 	movl   $0x1,0x8010c5f4
80100dbc:	00 00 00 
...
80100e63:	e8 bb 72 00 00       	call   80108123 <setupkvm>
...
80100efc:	e8 f4 75 00 00       	call   801084f5 <allocuvm>
...
80100f39:	e8 c8 74 00 00       	call   80108406 <loaduvm>
...
80100fa4:	e8 4c 75 00 00       	call   801084f5 <allocuvm>
...
80100fc8:	e8 58 77 00 00       	call   80108725 <clearpteu>
  sp = sz;
...
80100ffd:	e8 8e 47 00 00       	call   80105790 <strlen>
...
80101025:	e8 66 47 00 00       	call   80105790 <strlen>
...
80101055:	e8 7f 78 00 00       	call   801088d9 <copyout>
...
801010fb:	e8 d9 77 00 00       	call   801088d9 <copyout>
...
80101152:	e8 eb 45 00 00       	call   80105742 <safestrcpy>
...
801011a4:	e8 6b 70 00 00       	call   80108214 <switchuvm>
  freevm(oldpgdir);
801011a9:	8b 45 d0             	mov    -0x30(%ebp),%eax
801011ac:	89 04 24             	mov    %eax,(%esp)
801011af:	e8 d7 74 00 00       	call   8010868b <freevm>
  return 0;
...
801011e6:	e8 a0 74 00 00       	call   8010868b <freevm>
  if(ip)
...
8010120a:	c7 44 24 04 dd 89 10 	movl   $0x801089dd,0x4(%esp)
80101211:	80 
80101212:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80101219:	e8 78 40 00 00       	call   80105296 <initlock>
}
8010121e:	c9                   	leave  
8010121f:	c3                   	ret    
...
80101223:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ftable.lock);
80101226:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
8010122d:	e8 85 40 00 00       	call   801052b7 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80101232:	c7 45 f4 b4 ee 10 80 	movl   $0x8010eeb4,-0xc(%ebp)
...
80101248:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
      release(&ftable.lock);
8010124f:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80101256:	e8 be 40 00 00       	call   80105319 <release>
      return f;
...
80101264:	81 7d f4 14 f8 10 80 	cmpl   $0x8010f814,-0xc(%ebp)
8010126b:	72 ce                	jb     8010123b <filealloc+0x1b>
  ...
  release(&ftable.lock);
8010126d:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80101274:	e8 a0 40 00 00       	call   80105319 <release>
  return 0;
...
80101283:	83 ec 18             	sub    $0x18,%esp
  acquire(&ftable.lock);
80101286:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
8010128d:	e8 25 40 00 00       	call   801052b7 <acquire>
  if(f->ref < 1)
...
8010129a:	7f 0c                	jg     801012a8 <filedup+0x28>
    panic("filedup");
8010129c:	c7 04 24 e4 89 10 80 	movl   $0x801089e4,(%esp)
...
801012b4:	89 50 04             	mov    %edx,0x4(%eax)
  release(&ftable.lock);
801012b7:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
801012be:	e8 56 40 00 00       	call   80105319 <release>
  return f;
...
801012cb:	83 ec 38             	sub    $0x38,%esp
  ...
  acquire(&ftable.lock);
801012ce:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
801012d5:	e8 dd 3f 00 00       	call   801052b7 <acquire>
  if(f->ref < 1)
...
801012e2:	7f 0c                	jg     801012f0 <fileclose+0x28>
    panic("fileclose");
801012e4:	c7 04 24 ec 89 10 80 	movl   $0x801089ec,(%esp)
...
80101307:	7e 11                	jle    8010131a <fileclose+0x52>
    release(&ftable.lock);
80101309:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80101310:	e8 04 40 00 00       	call   80105319 <release>
...
8010134d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  release(&ftable.lock);
80101353:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
8010135a:	e8 ba 3f 00 00       	call   80105319 <release>
...
80101499:	eb 0c                	jmp    801014a7 <fileread+0xba>
  ...
  panic("fileread");
8010149b:	c7 04 24 f6 89 10 80 	movl   $0x801089f6,(%esp)
...
801015a7:	c7 04 24 ff 89 10 80 	movl   $0x801089ff,(%esp)
...
801015da:	eb 0c                	jmp    801015e8 <filewrite+0x13f>
  ...
  panic("filewrite");
801015dc:	c7 04 24 0f 8a 10 80 	movl   $0x80108a0f,(%esp)
...
80101624:	e8 bc 3f 00 00       	call   801055e5 <memmove>
  brelse(bp);
...
8010166a:	e8 a3 3e 00 00       	call   80105512 <memset>
  log_write(bp);
...
801017ce:	c7 04 24 19 8a 10 80 	movl   $0x80108a19,(%esp)
...
8010186b:	c7 04 24 2f 8a 10 80 	movl   $0x80108a2f,(%esp)
...
801018bf:	c7 44 24 04 42 8a 10 	movl   $0x80108a42,0x4(%esp)
801018c6:	80 
801018c7:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801018ce:	e8 c3 39 00 00       	call   80105296 <initlock>
}
801018d3:	c9                   	leave  
801018d4:	c3                   	ret    
...
80101950:	e8 bd 3b 00 00       	call   80105512 <memset>
      dip->type = type;
...
801019a6:	c7 04 24 49 8a 10 80 	movl   $0x80108a49,(%esp)
...
80101a4f:	e8 91 3b 00 00       	call   801055e5 <memmove>
  log_write(bp);
...
80101a6f:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&icache.lock);
80101a72:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101a79:	e8 39 38 00 00       	call   801052b7 <acquire>

  // Is the inode already cached?
  empty = 0;
80101a7e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101a85:	c7 45 f4 b4 f8 10 80 	movl   $0x8010f8b4,-0xc(%ebp)
...
80101ab9:	89 50 08             	mov    %edx,0x8(%eax)
      release(&icache.lock);
80101abc:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101ac3:	e8 51 38 00 00       	call   80105319 <release>
      return ip;
...
80101ae7:	81 7d f4 54 08 11 80 	cmpl   $0x80110854,-0xc(%ebp)
...
80101af6:	c7 04 24 5b 8a 10 80 	movl   $0x80108a5b,(%esp)
...
80101b26:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  release(&icache.lock);
80101b2d:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101b34:	e8 e0 37 00 00       	call   80105319 <release>
...
80101b41:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
80101b44:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101b4b:	e8 67 37 00 00       	call   801052b7 <acquire>
  ip->ref++;
...
80101b5c:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101b5f:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101b66:	e8 ae 37 00 00       	call   80105319 <release>
  return ip;
...
80101b84:	7f 0c                	jg     80101b92 <ilock+0x22>
    panic("ilock");
80101b86:	c7 04 24 6b 8a 10 80 	movl   $0x80108a6b,(%esp)
80101b8d:	e8 b4 e9 ff ff       	call   80100546 <panic>

  acquire(&icache.lock);
80101b92:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101b99:	e8 19 37 00 00       	call   801052b7 <acquire>
  while(ip->flags & I_BUSY)
80101b9e:	eb 13                	jmp    80101bb3 <ilock+0x43>
    sleep(ip, &icache.lock);
80101ba0:	c7 44 24 04 80 f8 10 	movl   $0x8010f880,0x4(%esp)
80101ba7:	80 
80101ba8:	8b 45 08             	mov    0x8(%ebp),%eax
80101bab:	89 04 24             	mov    %eax,(%esp)
80101bae:	e8 91 33 00 00       	call   80104f44 <sleep>
...
80101bce:	89 50 0c             	mov    %edx,0xc(%eax)
  release(&icache.lock);
80101bd1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101bd8:	e8 3c 37 00 00       	call   80105319 <release>
...
80101c83:	e8 5d 39 00 00       	call   801055e5 <memmove>
    brelse(bp);
...
80101cae:	75 0c                	jne    80101cbc <ilock+0x14c>
      panic("ilock: no type");
80101cb0:	c7 04 24 71 8a 10 80 	movl   $0x80108a71,(%esp)
...
80101cdf:	7f 0c                	jg     80101ced <iunlock+0x2f>
    panic("iunlock");
80101ce1:	c7 04 24 80 8a 10 80 	movl   $0x80108a80,(%esp)
80101ce8:	e8 59 e8 ff ff       	call   80100546 <panic>

  acquire(&icache.lock);
80101ced:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101cf4:	e8 be 35 00 00       	call   801052b7 <acquire>
  ip->flags &= ~I_BUSY;
...
80101d10:	e8 0b 33 00 00       	call   80105020 <wakeup>
  release(&icache.lock);
80101d15:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101d1c:	e8 f8 35 00 00       	call   80105319 <release>
}
80101d21:	c9                   	leave  
80101d22:	c3                   	ret    
...
80101d26:	83 ec 18             	sub    $0x18,%esp
  acquire(&icache.lock);
80101d29:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101d30:	e8 82 35 00 00       	call   801052b7 <acquire>
...
80101d6c:	74 0c                	je     80101d7a <iput+0x57>
      panic("iput busy");
80101d6e:	c7 04 24 88 8a 10 80 	movl   $0x80108a88,(%esp)
...
80101d88:	89 50 0c             	mov    %edx,0xc(%eax)
    release(&icache.lock);
80101d8b:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101d92:	e8 82 35 00 00       	call   80105319 <release>
    itrunc(ip);
...
80101db1:	e8 fe fb ff ff       	call   801019b4 <iupdate>
    acquire(&icache.lock);
80101db6:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101dbd:	e8 f5 34 00 00       	call   801052b7 <acquire>
    ip->flags = 0;
...
80101dd2:	e8 49 32 00 00       	call   80105020 <wakeup>
  }
  ip->ref--;
...
80101de3:	89 50 08             	mov    %edx,0x8(%eax)
  release(&icache.lock);
80101de6:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101ded:	e8 27 35 00 00       	call   80105319 <release>
}
80101df2:	c9                   	leave  
80101df3:	c3                   	ret    
...
80101f0d:	c7 04 24 92 8a 10 80 	movl   $0x80108a92,(%esp)
...
801020b1:	98                   	cwtl   
801020b2:	8b 04 c5 20 f8 10 80 	mov    -0x7fef07e0(,%eax,8),%eax
...
801020ce:	98                   	cwtl   
801020cf:	8b 04 c5 20 f8 10 80 	mov    -0x7fef07e0(,%eax,8),%eax
...
801021b4:	e8 2c 34 00 00       	call   801055e5 <memmove>
    brelse(bp);
...
8010221f:	98                   	cwtl   
80102220:	8b 04 c5 24 f8 10 80 	mov    -0x7fef07dc(,%eax,8),%eax
...
8010223c:	98                   	cwtl   
8010223d:	8b 04 c5 24 f8 10 80 	mov    -0x7fef07dc(,%eax,8),%eax
...
8010231d:	e8 c3 32 00 00       	call   801055e5 <memmove>
    log_write(bp);
...
8010239f:	e8 e5 32 00 00       	call   80105689 <strncmp>
}
801023a4:	c9                   	leave  
801023a5:	c3                   	ret    
...
801023b9:	c7 04 24 a5 8a 10 80 	movl   $0x80108aa5,(%esp)
...
801023f5:	74 0c                	je     80102403 <dirlookup+0x5d>
      panic("dirlink read");
801023f7:	c7 04 24 b7 8a 10 80 	movl   $0x80108ab7,(%esp)
...
801024d9:	74 0c                	je     801024e7 <dirlink+0x79>
      panic("dirlink read");
801024db:	c7 04 24 b7 8a 10 80 	movl   $0x80108ab7,(%esp)
...
80102521:	e8 bb 31 00 00       	call   801056e1 <strncpy>
  de.inum = inum;
...
80102551:	74 0c                	je     8010255f <dirlink+0xf1>
    panic("dirlink");
80102553:	c7 04 24 c4 8a 10 80 	movl   $0x80108ac4,(%esp)
...
801025da:	e8 06 30 00 00       	call   801055e5 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801025f5:	e8 eb 2f 00 00       	call   801055e5 <memmove>
    name[len] = 0;
...
80102854:	c7 44 24 04 cc 8a 10 	movl   $0x80108acc,0x4(%esp)
8010285b:	80 
8010285c:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102863:	e8 2e 2a 00 00       	call   80105296 <initlock>
  picenable(IRQ_IDE);
80102868:	c7 04 24 0e 00 00 00 	movl   $0xe,(%esp)
8010286f:	e8 85 15 00 00       	call   80103df9 <picenable>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102874:	a1 20 0f 11 80       	mov    0x80110f20,%eax
...
801028c3:	74 0c                	je     801028d1 <ideinit+0x83>
      havedisk1 = 1;
801028c5:	c7 05 38 c6 10 80 01 	movl   $0x1,0x8010c638
801028cc:	00 00 00 
      break;
...
80102a1c:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&idelock);
80102a1f:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102a26:	e8 8c 28 00 00       	call   801052b7 <acquire>
  if((b = idequeue) == 0){
...
80102a37:	75 11                	jne    80102a4a <ideintr+0x31>
    release(&idelock);
80102a39:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102a40:	e8 d4 28 00 00       	call   80105319 <release>
...
80102a50:	a3 34 c6 10 80       	mov    %eax,0x8010c634
...
80102ab3:	e8 68 25 00 00       	call   80105020 <wakeup>
  
  // Start disk on next buf in queue.
  if(idequeue != 0)
80102ab8:	a1 34 c6 10 80       	mov    0x8010c634,%eax
80102abd:	85 c0                	test   %eax,%eax
80102abf:	74 0d                	je     80102ace <ideintr+0xb5>
    idestart(idequeue);
80102ac1:	a1 34 c6 10 80       	mov    0x8010c634,%eax
80102ac6:	89 04 24             	mov    %eax,(%esp)
80102ac9:	e8 26 fe ff ff       	call   801028f4 <idestart>

  release(&idelock);
80102ace:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102ad5:	e8 3f 28 00 00       	call   80105319 <release>
}
80102ada:	c9                   	leave  
80102adb:	c3                   	ret    
...
80102aee:	c7 04 24 d9 8a 10 80 	movl   $0x80108ad9,(%esp)
...
80102b07:	c7 04 24 ed 8a 10 80 	movl   $0x80108aed,(%esp)
...
80102b1d:	a1 38 c6 10 80       	mov    0x8010c638,%eax
80102b22:	85 c0                	test   %eax,%eax
80102b24:	75 0c                	jne    80102b32 <iderw+0x56>
    panic("iderw: ide disk 1 not present");
80102b26:	c7 04 24 02 8b 10 80 	movl   $0x80108b02,(%esp)
80102b2d:	e8 14 da ff ff       	call   80100546 <panic>

  acquire(&idelock);  //DOC: acquire-lock
80102b32:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102b39:	e8 79 27 00 00       	call   801052b7 <acquire>
...
80102b48:	c7 45 f4 34 c6 10 80 	movl   $0x8010c634,-0xc(%ebp)
...
80102b6b:	89 10                	mov    %edx,(%eax)
  ...
  if(idequeue == b)
80102b6d:	a1 34 c6 10 80       	mov    0x8010c634,%eax
...
80102b82:	eb 15                	jmp    80102b99 <iderw+0xbd>
    sleep(b, &idelock);
80102b84:	c7 44 24 04 00 c6 10 	movl   $0x8010c600,0x4(%esp)
80102b8b:	80 
80102b8c:	8b 45 08             	mov    0x8(%ebp),%eax
80102b8f:	89 04 24             	mov    %eax,(%esp)
80102b92:	e8 ad 23 00 00       	call   80104f44 <sleep>
...
80102ba5:	75 dd                	jne    80102b84 <iderw+0xa8>
  ...
  release(&idelock);
80102ba7:	c7 04 24 00 c6 10 80 	movl   $0x8010c600,(%esp)
80102bae:	e8 66 27 00 00       	call   80105319 <release>
}
80102bb3:	c9                   	leave  
80102bb4:	c3                   	ret    
...
80102bb9:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
80102bbb:	a1 54 08 11 80       	mov    0x80110854,%eax
80102bc0:	8b 55 08             	mov    0x8(%ebp),%edx
80102bc3:	89 10                	mov    %edx,(%eax)
  return ioapic->data;
80102bc5:	a1 54 08 11 80       	mov    0x80110854,%eax
...
80102bd0:	89 e5                	mov    %esp,%ebp
  ioapic->reg = reg;
80102bd2:	a1 54 08 11 80       	mov    0x80110854,%eax
80102bd7:	8b 55 08             	mov    0x8(%ebp),%edx
80102bda:	89 10                	mov    %edx,(%eax)
  ioapic->data = data;
80102bdc:	a1 54 08 11 80       	mov    0x80110854,%eax
...
80102bec:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!ismp)
80102bef:	a1 24 09 11 80       	mov    0x80110924,%eax
80102bf4:	85 c0                	test   %eax,%eax
80102bf6:	0f 84 9f 00 00 00    	je     80102c9b <ioapicinit+0xb2>
    return;

  ioapic = (volatile struct ioapic*)IOAPIC;
80102bfc:	c7 05 54 08 11 80 00 	movl   $0xfec00000,0x80110854
80102c03:	00 c0 fe 
...
80102ca1:	83 ec 08             	sub    $0x8,%esp
  if(!ismp)
80102ca4:	a1 24 09 11 80       	mov    0x80110924,%eax
...
80102cff:	c7 44 24 04 52 8b 10 	movl   $0x80108b52,0x4(%esp)
80102d06:	80 
80102d07:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80102d0e:	e8 83 25 00 00       	call   80105296 <initlock>
  kmem.use_lock = 0;
80102d13:	c7 05 94 08 11 80 00 	movl   $0x0,0x80110894
80102d1a:	00 00 00 
...
80102d44:	e8 0c 00 00 00       	call   80102d55 <freerange>
  kmem.use_lock = 1;
80102d49:	c7 05 94 08 11 80 01 	movl   $0x1,0x80110894
80102d50:	00 00 00 
}
80102d53:	c9                   	leave  
80102d54:	c3                   	ret    
...
80102da0:	81 7d 08 1c 3e 11 80 	cmpl   $0x80113e1c,0x8(%ebp)
...
80102db9:	76 0c                	jbe    80102dc7 <kfree+0x39>
    panic("kfree");
80102dbb:	c7 04 24 57 8b 10 80 	movl   $0x80108b57,(%esp)
...
80102ddd:	e8 30 27 00 00       	call   80105512 <memset>

  if(kmem.use_lock)
80102de2:	a1 94 08 11 80       	mov    0x80110894,%eax
80102de7:	85 c0                	test   %eax,%eax
80102de9:	74 0c                	je     80102df7 <kfree+0x69>
    acquire(&kmem.lock);
80102deb:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80102df2:	e8 c0 24 00 00       	call   801052b7 <acquire>
  r = (struct run*)v;
80102df7:	8b 45 08             	mov    0x8(%ebp),%eax
80102dfa:	89 45 f4             	mov    %eax,-0xc(%ebp)
  r->next = kmem.freelist;
80102dfd:	8b 15 98 08 11 80    	mov    0x80110898,%edx
80102e03:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102e06:	89 10                	mov    %edx,(%eax)
  kmem.freelist = r;
80102e08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80102e0b:	a3 98 08 11 80       	mov    %eax,0x80110898
  if(kmem.use_lock)
80102e10:	a1 94 08 11 80       	mov    0x80110894,%eax
80102e15:	85 c0                	test   %eax,%eax
80102e17:	74 0c                	je     80102e25 <kfree+0x97>
    release(&kmem.lock);
80102e19:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80102e20:	e8 f4 24 00 00       	call   80105319 <release>
}
80102e25:	c9                   	leave  
80102e26:	c3                   	ret    
...
80102e2a:	83 ec 28             	sub    $0x28,%esp
  ...
  if(kmem.use_lock)
80102e2d:	a1 94 08 11 80       	mov    0x80110894,%eax
80102e32:	85 c0                	test   %eax,%eax
80102e34:	74 0c                	je     80102e42 <kalloc+0x1b>
    acquire(&kmem.lock);
80102e36:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80102e3d:	e8 75 24 00 00       	call   801052b7 <acquire>
  r = kmem.freelist;
80102e42:	a1 98 08 11 80       	mov    0x80110898,%eax
...
80102e55:	a3 98 08 11 80       	mov    %eax,0x80110898
  if(kmem.use_lock)
80102e5a:	a1 94 08 11 80       	mov    0x80110894,%eax
80102e5f:	85 c0                	test   %eax,%eax
80102e61:	74 0c                	je     80102e6f <kalloc+0x48>
    release(&kmem.lock);
80102e63:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
80102e6a:	e8 aa 24 00 00       	call   80105319 <release>
  return (char*)r;
...
80102eed:	a3 3c c6 10 80       	mov    %eax,0x8010c63c
    return 0;
...
80102f25:	05 20 a0 10 80       	add    $0x8010a020,%eax
...
80102f59:	81 4d fc 80 00 00 00 	orl    $0x80,-0x4(%ebp)
    shift &= ~E0ESC;
80102f60:	a1 3c c6 10 80       	mov    0x8010c63c,%eax
80102f65:	83 e0 bf             	and    $0xffffffbf,%eax
80102f68:	a3 3c c6 10 80       	mov    %eax,0x8010c63c
  }

  shift |= shiftcode[data];
80102f6d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80102f70:	05 20 a0 10 80       	add    $0x8010a020,%eax
...
80102f82:	a3 3c c6 10 80       	mov    %eax,0x8010c63c
  shift ^= togglecode[data];
80102f87:	8b 45 fc             	mov    -0x4(%ebp),%eax
80102f8a:	05 20 a1 10 80       	add    $0x8010a120,%eax
...
80102f9c:	a3 3c c6 10 80       	mov    %eax,0x8010c63c
  c = charcode[shift & (CTL | SHIFT)][data];
80102fa1:	a1 3c c6 10 80       	mov    0x8010c63c,%eax
80102fa6:	83 e0 03             	and    $0x3,%eax
80102fa9:	8b 14 85 20 a5 10 80 	mov    -0x7fef5ae0(,%eax,4),%edx
...
80102fbb:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(shift & CAPSLOCK){
80102fbe:	a1 3c c6 10 80       	mov    0x8010c63c,%eax
...
8010303c:	89 e5                	mov    %esp,%ebp
  lapic[index] = value;
8010303e:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
80103050:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
8010305f:	83 ec 08             	sub    $0x8,%esp
  if(!lapic) 
80103062:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
801030e7:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
8010318a:	90                   	nop
8010318b:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
801031cb:	74 29                	je     801031f6 <cpunum+0x3d>
    static int n;
    if(n++ == 0)
801031cd:	a1 40 c6 10 80       	mov    0x8010c640,%eax
801031d2:	85 c0                	test   %eax,%eax
801031d4:	0f 94 c2             	sete   %dl
801031d7:	83 c0 01             	add    $0x1,%eax
801031da:	a3 40 c6 10 80       	mov    %eax,0x8010c640
...
801031ea:	c7 04 24 60 8b 10 80 	movl   $0x80108b60,(%esp)
801031f1:	e8 b4 d1 ff ff       	call   801003aa <cprintf>
        __builtin_return_address(0));
  }

  if(lapic)
801031f6:	a1 9c 08 11 80       	mov    0x8011089c,%eax
801031fb:	85 c0                	test   %eax,%eax
801031fd:	74 0f                	je     8010320e <cpunum+0x55>
    return lapic[ID]>>24;
801031ff:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
80103218:	83 ec 08             	sub    $0x8,%esp
  if(lapic)
8010321b:	a1 9c 08 11 80       	mov    0x8011089c,%eax
...
80103342:	c7 44 24 04 8c 8b 10 	movl   $0x80108b8c,0x4(%esp)
80103349:	80 
8010334a:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103351:	e8 40 1f 00 00       	call   80105296 <initlock>
  readsb(ROOTDEV, &sb);
...
80103375:	a3 d4 08 11 80       	mov    %eax,0x801108d4
  log.size = sb.nlog;
8010337a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010337d:	a3 d8 08 11 80       	mov    %eax,0x801108d8
  log.dev = ROOTDEV;
80103382:	c7 05 e0 08 11 80 01 	movl   $0x1,0x801108e0
80103389:	00 00 00 
  recover_from_log();
...
801033cf:	8b 04 85 a8 08 11 80 	mov    -0x7feef758(,%eax,4),%eax
801033d6:	89 c2                	mov    %eax,%edx
801033d8:	a1 e0 08 11 80       	mov    0x801108e0,%eax
...
80103407:	e8 d9 21 00 00       	call   801055e5 <memmove>
...
80103431:	a1 e4 08 11 80       	mov    0x801108e4,%eax
...
80103447:	a1 d4 08 11 80       	mov    0x801108d4,%eax
8010344c:	89 c2                	mov    %eax,%edx
8010344e:	a1 e0 08 11 80       	mov    0x801108e0,%eax
...
80103470:	a3 e4 08 11 80       	mov    %eax,0x801108e4
...
8010348e:	89 04 95 a8 08 11 80 	mov    %eax,-0x7feef758(,%edx,4)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80103499:	a1 e4 08 11 80       	mov    0x801108e4,%eax
...
801034b3:	83 ec 28             	sub    $0x28,%esp
  struct buf *buf = bread(log.dev, log.start);
801034b6:	a1 d4 08 11 80       	mov    0x801108d4,%eax
801034bb:	89 c2                	mov    %eax,%edx
801034bd:	a1 e0 08 11 80       	mov    0x801108e0,%eax
...
801034d7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  int i;
  hb->n = log.lh.n;
801034da:	8b 15 e4 08 11 80    	mov    0x801108e4,%edx
...
801034f4:	8b 0c 85 a8 08 11 80 	mov    -0x7feef758(,%eax,4),%ecx
...
80103509:	a1 e4 08 11 80       	mov    0x801108e4,%eax
...
80103536:	e8 58 fe ff ff       	call   80103393 <install_trans>
  log.lh.n = 0;
8010353b:	c7 05 e4 08 11 80 00 	movl   $0x0,0x801108e4
80103542:	00 00 00 
...
8010354f:	83 ec 18             	sub    $0x18,%esp
  acquire(&log.lock);
80103552:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103559:	e8 59 1d 00 00       	call   801052b7 <acquire>
  while (log.busy) {
8010355e:	eb 14                	jmp    80103574 <begin_trans+0x28>
    sleep(&log, &log.lock);
80103560:	c7 44 24 04 a0 08 11 	movl   $0x801108a0,0x4(%esp)
80103567:	80 
80103568:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
8010356f:	e8 d0 19 00 00       	call   80104f44 <sleep>
...
begin_trans(void)
{
  acquire(&log.lock);
  while (log.busy) {
80103574:	a1 dc 08 11 80       	mov    0x801108dc,%eax
80103579:	85 c0                	test   %eax,%eax
8010357b:	75 e3                	jne    80103560 <begin_trans+0x14>
    sleep(&log, &log.lock);
  }
  log.busy = 1;
8010357d:	c7 05 dc 08 11 80 01 	movl   $0x1,0x801108dc
80103584:	00 00 00 
  release(&log.lock);
80103587:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
8010358e:	e8 86 1d 00 00       	call   80105319 <release>
}
80103593:	c9                   	leave  
80103594:	c3                   	ret    
...
80103598:	83 ec 18             	sub    $0x18,%esp
  if (log.lh.n > 0) {
8010359b:	a1 e4 08 11 80       	mov    0x801108e4,%eax
...
801035a9:	e8 e5 fd ff ff       	call   80103393 <install_trans>
    log.lh.n = 0; 
801035ae:	c7 05 e4 08 11 80 00 	movl   $0x0,0x801108e4
801035b5:	00 00 00 
...
801035b8:	e8 f3 fe ff ff       	call   801034b0 <write_head>
  ...
  acquire(&log.lock);
801035bd:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
801035c4:	e8 ee 1c 00 00       	call   801052b7 <acquire>
  log.busy = 0;
801035c9:	c7 05 dc 08 11 80 00 	movl   $0x0,0x801108dc
801035d0:	00 00 00 
  wakeup(&log);
801035d3:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
801035da:	e8 41 1a 00 00       	call   80105020 <wakeup>
  release(&log.lock);
801035df:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
801035e6:	e8 2e 1d 00 00       	call   80105319 <release>
}
801035eb:	c9                   	leave  
801035ec:	c3                   	ret    
...
8010363f:	8b 04 85 a8 08 11 80 	mov    -0x7feef758(,%eax,4),%eax
...
80103656:	a1 e4 08 11 80       	mov    0x801108e4,%eax
...
8010366f:	89 04 95 a8 08 11 80 	mov    %eax,-0x7feef758(,%edx,4)
  struct buf *lbuf = bread(b->dev, log.start+i+1);
80103676:	8b 15 d4 08 11 80    	mov    0x801108d4,%edx
...
801036b6:	e8 2a 1f 00 00       	call   801055e5 <memmove>
  bwrite(lbuf);
...
801036cc:	e8 46 cb ff ff       	call   80100217 <brelse>
  if (i == log.lh.n)
801036d1:	a1 e4 08 11 80       	mov    0x801108e4,%eax
801036d6:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801036d9:	75 0d                	jne    801036e8 <log_write+0xfb>
    log.lh.n++;
801036db:	a1 e4 08 11 80       	mov    0x801108e4,%eax
801036e0:	83 c0 01             	add    $0x1,%eax
801036e3:	a3 e4 08 11 80       	mov    %eax,0x801108e4
...
8010374b:	80 
8010374c:	c7 04 24 1c 3e 11 80 	movl   $0x80113e1c,(%esp)
80103753:	e8 a1 f5 ff ff       	call   80102cf9 <kinit1>
  kvmalloc();      // kernel page table
80103758:	e8 83 4a 00 00       	call   801081e0 <kvmalloc>
...
8010376f:	e8 01 44 00 00       	call   80107b75 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103784:	c7 04 24 bd 8b 10 80 	movl   $0x80108bbd,(%esp)
...
8010379f:	e8 1c 37 00 00       	call   80106ec0 <uartinit>
  pinit();         // process table
801037a4:	e8 9e 0b 00 00       	call   80104347 <pinit>
  tvinit();        // trap vectors
801037a9:	e8 71 32 00 00       	call   80106a1f <tvinit>
  binit();         // buffer cache
...
801037bd:	e8 8c f0 ff ff       	call   8010284e <ideinit>
  if(!ismp)
801037c2:	a1 24 09 11 80       	mov    0x80110924,%eax
801037c7:	85 c0                	test   %eax,%eax
801037c9:	75 05                	jne    801037d0 <main+0x95>
    timerinit();   // uniprocessor timer
801037cb:	e8 92 31 00 00       	call   80106962 <timerinit>
...
801037f6:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801037f9:	e8 f9 49 00 00       	call   801081f7 <switchkvm>
  seginit();
801037fe:	e8 72 43 00 00       	call   80107b75 <seginit>
  lapicinit(cpunum());
...
8010382b:	c7 04 24 d4 8b 10 80 	movl   $0x80108bd4,(%esp)
80103832:	e8 73 cb ff ff       	call   801003aa <cprintf>
  idtinit();       // load idt register
80103837:	e8 57 33 00 00       	call   80106b93 <idtinit>
...
80103857:	e8 c6 13 00 00       	call   80104c22 <scheduler>
...
8010387b:	c7 44 24 04 0c c5 10 	movl   $0x8010c50c,0x4(%esp)
80103882:	80 
80103883:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103886:	89 04 24             	mov    %eax,(%esp)
80103889:	e8 57 1d 00 00       	call   801055e5 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
8010388e:	c7 45 f4 40 09 11 80 	movl   $0x80110940,-0xc(%ebp)
...
801038a5:	05 40 09 11 80       	add    $0x80110940,%eax
...
801038da:	c7 04 24 00 b0 10 80 	movl   $0x8010b000,(%esp)
...
80103996:	89 e5                	mov    %esp,%ebp
  return bcpu-cpus;
80103998:	a1 44 c6 10 80       	mov    0x8010c644,%eax
8010399d:	89 c2                	mov    %eax,%edx
8010399f:	b8 40 09 11 80       	mov    $0x80110940,%eax
...
80103a1b:	00 
80103a1c:	c7 44 24 04 e8 8b 10 	movl   $0x80108be8,0x4(%esp)
80103a23:	80 
80103a24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a27:	89 04 24             	mov    %eax,(%esp)
80103a2a:	e8 5a 1b 00 00       	call   80105589 <memcmp>
...
80103b5c:	00 
80103b5d:	c7 44 24 04 ed 8b 10 	movl   $0x80108bed,0x4(%esp)
80103b64:	80 
80103b65:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b68:	89 04 24             	mov    %eax,(%esp)
80103b6b:	e8 19 1a 00 00       	call   80105589 <memcmp>
...
80103bcc:	83 ec 38             	sub    $0x38,%esp
  ...
  bcpu = &cpus[0];
80103bcf:	c7 05 44 c6 10 80 40 	movl   $0x80110940,0x8010c644
80103bd6:	09 11 80 
...
80103beb:	0f 84 9c 01 00 00    	je     80103d8d <mpinit+0x1c4>
    return;
  ismp = 1;
80103bf1:	c7 05 24 09 11 80 01 	movl   $0x1,0x80110924
80103bf8:	00 00 00 
  lapic = (uint*)conf->lapicaddr;
80103bfb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103bfe:	8b 40 24             	mov    0x24(%eax),%eax
80103c01:	a3 9c 08 11 80       	mov    %eax,0x8011089c
...
80103c38:	8b 04 85 30 8c 10 80 	mov    -0x7fef73d0(,%eax,4),%eax
...
80103c51:	a1 20 0f 11 80       	mov    0x80110f20,%eax
...
80103c64:	a1 20 0f 11 80       	mov    0x80110f20,%eax
80103c69:	89 54 24 08          	mov    %edx,0x8(%esp)
80103c6d:	89 44 24 04          	mov    %eax,0x4(%esp)
80103c71:	c7 04 24 f2 8b 10 80 	movl   $0x80108bf2,(%esp)
80103c78:	e8 2d c7 ff ff       	call   801003aa <cprintf>
        ismp = 0;
80103c7d:	c7 05 24 09 11 80 00 	movl   $0x0,0x80110924
80103c84:	00 00 00 
      }
...
80103c96:	74 15                	je     80103cad <mpinit+0xe4>
        bcpu = &cpus[ncpu];
80103c98:	a1 20 0f 11 80       	mov    0x80110f20,%eax
80103c9d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80103ca3:	05 40 09 11 80       	add    $0x80110940,%eax
80103ca8:	a3 44 c6 10 80       	mov    %eax,0x8010c644
      cpus[ncpu].id = ncpu;
80103cad:	8b 15 20 0f 11 80    	mov    0x80110f20,%edx
80103cb3:	a1 20 0f 11 80       	mov    0x80110f20,%eax
80103cb8:	69 d2 bc 00 00 00    	imul   $0xbc,%edx,%edx
80103cbe:	81 c2 40 09 11 80    	add    $0x80110940,%edx
80103cc4:	88 02                	mov    %al,(%edx)
      ncpu++;
80103cc6:	a1 20 0f 11 80       	mov    0x80110f20,%eax
80103ccb:	83 c0 01             	add    $0x1,%eax
80103cce:	a3 20 0f 11 80       	mov    %eax,0x80110f20
...
80103ce6:	a2 20 09 11 80       	mov    %al,0x80110920
...
80103d04:	c7 04 24 10 8c 10 80 	movl   $0x80108c10,(%esp)
80103d0b:	e8 9a c6 ff ff       	call   801003aa <cprintf>
      ismp = 0;
80103d10:	c7 05 24 09 11 80 00 	movl   $0x0,0x80110924
80103d17:	00 00 00 
  bcpu = &cpus[0];
  if((conf = mpconfig(&mp)) == 0)
    return;
...
80103d20:	0f 82 00 ff ff ff    	jb     80103c26 <mpinit+0x5d>
  ...
  if(!ismp){
80103d26:	a1 24 09 11 80       	mov    0x80110924,%eax
80103d2b:	85 c0                	test   %eax,%eax
80103d2d:	75 1d                	jne    80103d4c <mpinit+0x183>
    // Didn't like what we found; fall back to no MP.
    ncpu = 1;
80103d2f:	c7 05 20 0f 11 80 01 	movl   $0x1,0x80110f20
80103d36:	00 00 00 
    lapic = 0;
80103d39:	c7 05 9c 08 11 80 00 	movl   $0x0,0x8011089c
80103d40:	00 00 00 
    ioapicid = 0;
80103d43:	c6 05 20 09 11 80 00 	movb   $0x0,0x80110920
...
80103dbf:	66 a3 00 c0 10 80    	mov    %ax,0x8010c000
  outb(IO_PIC1+1, mask);
...
80103e14:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
...
80103f47:	e8 44 fe ff ff       	call   80103d90 <outb>
  ...
  if(irqmask != 0xFFFF)
80103f4c:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
80103f53:	66 83 f8 ff          	cmp    $0xffff,%ax
80103f57:	74 12                	je     80103f6b <picinit+0x13d>
    picsetmask(irqmask);
80103f59:	0f b7 05 00 c0 10 80 	movzwl 0x8010c000,%eax
...
80104007:	c7 44 24 04 44 8c 10 	movl   $0x80108c44,0x4(%esp)
8010400e:	80 
8010400f:	89 04 24             	mov    %eax,(%esp)
80104012:	e8 7f 12 00 00       	call   80105296 <initlock>
  (*f0)->type = FD_PIPE;
...
801040bf:	e8 f3 11 00 00       	call   801052b7 <acquire>
  if(writable){
...
801040e2:	e8 39 0f 00 00       	call   80105020 <wakeup>
...
80104101:	e8 1a 0f 00 00       	call   80105020 <wakeup>
  }
...
80104126:	e8 ee 11 00 00       	call   80105319 <release>
    kfree((char*)p);
...
8010413e:	e8 d6 11 00 00       	call   80105319 <release>
}
80104143:	c9                   	leave  
80104144:	c3                   	ret    
...
80104152:	e8 60 11 00 00       	call   801052b7 <acquire>
  for(i = 0; i < n; i++){
...
80104183:	e8 91 11 00 00       	call   80105319 <release>
        return -1;
...
8010419d:	e8 7e 0e 00 00       	call   80105020 <wakeup>
...
801041b5:	e8 8a 0d 00 00       	call   80104f44 <sleep>
...
8010421e:	e8 fd 0d 00 00       	call   80105020 <wakeup>
  release(&p->lock);
80104223:	8b 45 08             	mov    0x8(%ebp),%eax
80104226:	89 04 24             	mov    %eax,(%esp)
80104229:	e8 eb 10 00 00       	call   80105319 <release>
  return n;
...
80104244:	e8 6e 10 00 00       	call   801052b7 <acquire>
...
8010425e:	e8 b6 10 00 00       	call   80105319 <release>
      return -1;
...
80104280:	e8 bf 0c 00 00       	call   80104f44 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80104311:	e8 0a 0d 00 00       	call   80105020 <wakeup>
  release(&p->lock);
80104316:	8b 45 08             	mov    0x8(%ebp),%eax
80104319:	89 04 24             	mov    %eax,(%esp)
8010431c:	e8 f8 0f 00 00       	call   80105319 <release>
  return i;
...
8010434d:	c7 44 24 04 49 8c 10 	movl   $0x80108c49,0x4(%esp)
80104354:	80 
80104355:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
8010435c:	e8 35 0f 00 00       	call   80105296 <initlock>
}
80104361:	c9                   	leave  
80104362:	c3                   	ret    
...
80104366:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104369:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104370:	e8 42 0f 00 00       	call   801052b7 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104375:	c7 45 f4 74 0f 11 80 	movl   $0x80110f74,-0xc(%ebp)
...
8010438f:	81 7d f4 74 35 11 80 	cmpl   $0x80113574,-0xc(%ebp)
80104396:	72 e6                	jb     8010437e <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104398:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
8010439f:	e8 75 0f 00 00       	call   80105319 <release>
  return 0;
...
801043c7:	a3 04 c0 10 80       	mov    %eax,0x8010c004
  release(&ptable.lock);
801043cc:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
801043d3:	e8 41 0f 00 00       	call   80105319 <release>
...
8010441d:	ba d4 69 10 80       	mov    $0x801069d4,%edx
...
8010444d:	e8 c0 10 00 00       	call   80105512 <memset>
  p->context->eip = (uint)forkret;
80104452:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104455:	8b 40 1c             	mov    0x1c(%eax),%eax
80104458:	ba 18 4f 10 80       	mov    $0x80104f18,%edx
...
80104476:	a3 48 c6 10 80       	mov    %eax,0x8010c648
  if((p->pgdir = setupkvm(kalloc)) == 0)
8010447b:	c7 04 24 27 2e 10 80 	movl   $0x80102e27,(%esp)
80104482:	e8 9c 3c 00 00       	call   80108123 <setupkvm>
...
80104497:	c7 04 24 50 8c 10 80 	movl   $0x80108c50,(%esp)
...
801044b2:	c7 44 24 04 e0 c4 10 	movl   $0x8010c4e0,0x4(%esp)
801044b9:	80 
801044ba:	89 04 24             	mov    %eax,(%esp)
801044bd:	e8 b9 3e 00 00       	call   8010837b <inituvm>
  p->sz = PGSIZE;
...
801044e4:	e8 29 10 00 00       	call   80105512 <memset>
...
8010455d:	00 
8010455e:	c7 44 24 04 69 8c 10 	movl   $0x80108c69,0x4(%esp)
80104565:	80 
80104566:	89 04 24             	mov    %eax,(%esp)
80104569:	e8 d4 11 00 00       	call   80105742 <safestrcpy>
  p->cwd = namei("/");
8010456e:	c7 04 24 72 8c 10 80 	movl   $0x80108c72,(%esp)
...
801045c2:	e8 2e 3f 00 00       	call   801084f5 <allocuvm>
...
801045fc:	e8 ce 3f 00 00       	call   801085cf <deallocuvm>
...
80104625:	e8 ea 3b 00 00       	call   80108214 <switchuvm>
  return 0;
...
8010464d:	e9 78 01 00 00       	jmp    801047ca <fork+0x199>
...
8010466a:	e8 fc 40 00 00       	call   8010876b <copyuvm>
...
801046a6:	e9 1f 01 00 00       	jmp    801047ca <fork+0x199>
  }
  np->sz = proc->sz;
...
80104784:	e8 b9 0f 00 00       	call   80105742 <safestrcpy>
  acquire(&tickslock);
80104789:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80104790:	e8 22 0b 00 00       	call   801052b7 <acquire>
  np->ctime = ticks;
80104795:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
8010479a:	89 c2                	mov    %eax,%edx
8010479c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010479f:	89 50 7c             	mov    %edx,0x7c(%eax)
  release(&tickslock);
801047a2:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
801047a9:	e8 6b 0b 00 00       	call   80105319 <release>
  np->rtime = 0;
...
801047be:	d9 ee                	fldz   
801047c0:	dd 98 90 00 00 00    	fstpl  0x90(%eax)
      break;
801047c6:	90                   	nop
    case _3Q:
      np->priority = HIGH;
  ...
  return pid;
801047c7:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
801047ca:	83 c4 2c             	add    $0x2c,%esp
801047cd:	5b                   	pop    %ebx
801047ce:	5e                   	pop    %esi
801047cf:	5f                   	pop    %edi
801047d0:	5d                   	pop    %ebp
...
801047df:	a1 48 c6 10 80       	mov    0x8010c648,%eax
801047e4:	39 c2                	cmp    %eax,%edx
801047e6:	75 0c                	jne    801047f4 <exit+0x22>
    panic("init exiting");
801047e8:	c7 04 24 74 8c 10 80 	movl   $0x80108c74,(%esp)
801047ef:	e8 52 bd ff ff       	call   80100546 <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801047f4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801047fb:	eb 44                	jmp    80104841 <exit+0x6f>
    if(proc->ofile[fd]){
...
8010480f:	74 2c                	je     8010483d <exit+0x6b>
      fileclose(proc->ofile[fd]);
80104811:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104817:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010481a:	83 c2 08             	add    $0x8,%edx
8010481d:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104821:	89 04 24             	mov    %eax,(%esp)
80104824:	e8 9f ca ff ff       	call   801012c8 <fileclose>
      proc->ofile[fd] = 0;
80104829:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010482f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104832:	83 c2 08             	add    $0x8,%edx
80104835:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010483c:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
8010483d:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104841:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
80104845:	7e b6                	jle    801047fd <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
80104853:	e8 cb d4 ff ff       	call   80101d23 <iput>
  proc->cwd = 0;
80104858:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010485e:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80104865:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
8010486c:	e8 46 0a 00 00       	call   801052b7 <acquire>
  
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104871:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104877:	8b 40 14             	mov    0x14(%eax),%eax
8010487a:	89 04 24             	mov    %eax,(%esp)
8010487d:	e8 5d 07 00 00       	call   80104fdf <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104882:	c7 45 f4 74 0f 11 80 	movl   $0x80110f74,-0xc(%ebp)
80104889:	eb 3b                	jmp    801048c6 <exit+0xf4>
    if(p->parent == proc){
8010488b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010488e:	8b 50 14             	mov    0x14(%eax),%edx
80104891:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104897:	39 c2                	cmp    %eax,%edx
80104899:	75 24                	jne    801048bf <exit+0xed>
      p->parent = initproc;
8010489b:	8b 15 48 c6 10 80    	mov    0x8010c648,%edx
801048a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048a4:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801048a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048aa:	8b 40 0c             	mov    0xc(%eax),%eax
801048ad:	83 f8 05             	cmp    $0x5,%eax
801048b0:	75 0d                	jne    801048bf <exit+0xed>
        wakeup1(initproc);
801048b2:	a1 48 c6 10 80       	mov    0x8010c648,%eax
801048b7:	89 04 24             	mov    %eax,(%esp)
801048ba:	e8 20 07 00 00       	call   80104fdf <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048bf:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801048c6:	81 7d f4 74 35 11 80 	cmpl   $0x80113574,-0xc(%ebp)
801048cd:	72 bc                	jb     8010488b <exit+0xb9>
      if(p->state == ZOMBIE)
        wakeup1(initproc);
    }
  }
...
801048d5:	c7 80 8c 00 00 00 ff 	movl   $0xffffffff,0x8c(%eax)
801048dc:	ff ff ff 
  acquire(&tickslock);
801048df:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
801048e6:	e8 cc 09 00 00       	call   801052b7 <acquire>
  proc->etime = ticks;
801048eb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048f1:	8b 15 c0 3d 11 80    	mov    0x80113dc0,%edx
801048f7:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  release(&tickslock);
801048fd:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80104904:	e8 10 0a 00 00       	call   80105319 <release>
  proc->state = ZOMBIE;
80104909:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010490f:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104916:	e8 18 05 00 00       	call   80104e33 <sched>
  panic("zombie exit");
8010491b:	c7 04 24 81 8c 10 80 	movl   $0x80108c81,(%esp)
80104922:	e8 1f bc ff ff       	call   80100546 <panic>
...
8010492a:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
8010492d:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104934:	e8 7e 09 00 00       	call   801052b7 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104939:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104940:	c7 45 f4 74 0f 11 80 	movl   $0x80110f74,-0xc(%ebp)
80104947:	e9 9d 00 00 00       	jmp    801049e9 <wait+0xc2>
      if(p->parent != proc)
...
8010495a:	0f 85 81 00 00 00    	jne    801049e1 <wait+0xba>
        continue;
      havekids = 1;
80104960:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104967:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496a:	8b 40 0c             	mov    0xc(%eax),%eax
8010496d:	83 f8 05             	cmp    $0x5,%eax
80104970:	75 70                	jne    801049e2 <wait+0xbb>
        // Found one.
        pid = p->pid;
80104972:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104975:	8b 40 10             	mov    0x10(%eax),%eax
80104978:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
8010497b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010497e:	8b 40 08             	mov    0x8(%eax),%eax
80104981:	89 04 24             	mov    %eax,(%esp)
80104984:	e8 05 e4 ff ff       	call   80102d8e <kfree>
        p->kstack = 0;
80104989:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010498c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
80104993:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104996:	8b 40 04             	mov    0x4(%eax),%eax
80104999:	89 04 24             	mov    %eax,(%esp)
8010499c:	e8 ea 3c 00 00       	call   8010868b <freevm>
        p->state = UNUSED;
801049a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049a4:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801049ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049ae:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801049b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049b8:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
801049bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049c2:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
801049c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049c9:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
801049d0:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
801049d7:	e8 3d 09 00 00       	call   80105319 <release>
        return pid;
801049dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801049df:	eb 56                	jmp    80104a37 <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801049e1:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049e2:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801049e9:	81 7d f4 74 35 11 80 	cmpl   $0x80113574,-0xc(%ebp)
801049f0:	0f 82 56 ff ff ff    	jb     8010494c <wait+0x25>
        return pid;
      }
    }
...
801049fa:	74 0d                	je     80104a09 <wait+0xe2>
801049fc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a02:	8b 40 24             	mov    0x24(%eax),%eax
80104a05:	85 c0                	test   %eax,%eax
80104a07:	74 13                	je     80104a1c <wait+0xf5>
      release(&ptable.lock);
80104a09:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104a10:	e8 04 09 00 00       	call   80105319 <release>
      return -1;
80104a15:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a1a:	eb 1b                	jmp    80104a37 <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104a1c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a22:	c7 44 24 04 40 0f 11 	movl   $0x80110f40,0x4(%esp)
80104a29:	80 
80104a2a:	89 04 24             	mov    %eax,(%esp)
80104a2d:	e8 12 05 00 00       	call   80104f44 <sleep>
  }
80104a32:	e9 02 ff ff ff       	jmp    80104939 <wait+0x12>
}
80104a37:	c9                   	leave  
80104a38:	c3                   	ret    
...
80104a3c:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104a3f:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104a46:	e8 6c 08 00 00       	call   801052b7 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104a4b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a52:	c7 45 f4 74 0f 11 80 	movl   $0x80110f74,-0xc(%ebp)
80104a59:	e9 d0 00 00 00       	jmp    80104b2e <wait2+0xf5>
      if(p->parent != proc)
80104a5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a61:	8b 50 14             	mov    0x14(%eax),%edx
80104a64:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a6a:	39 c2                	cmp    %eax,%edx
80104a6c:	0f 85 b4 00 00 00    	jne    80104b26 <wait2+0xed>
        continue;
      havekids = 1;
80104a72:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
80104a79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a7c:	8b 40 0c             	mov    0xc(%eax),%eax
80104a7f:	83 f8 05             	cmp    $0x5,%eax
80104a82:	0f 85 9f 00 00 00    	jne    80104b27 <wait2+0xee>
	*rtime = p->rtime;
80104a88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a8b:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80104a91:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a94:	89 10                	mov    %edx,(%eax)
	*wtime = p->etime - p->ctime - p->rtime;
80104a96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a99:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80104a9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aa2:	8b 40 7c             	mov    0x7c(%eax),%eax
80104aa5:	29 c2                	sub    %eax,%edx
80104aa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aaa:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104ab0:	29 c2                	sub    %eax,%edx
...
80104ac9:	e8 c0 e2 ff ff       	call   80102d8e <kfree>
        p->kstack = 0;
...
80104ae1:	e8 a5 3b 00 00       	call   8010868b <freevm>
        p->state = UNUSED;
80104ae6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ae9:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
80104af0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af3:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
80104afa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104afd:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104b04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b07:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
80104b0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b0e:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104b15:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104b1c:	e8 f8 07 00 00       	call   80105319 <release>
        return pid;
80104b21:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b24:	eb 56                	jmp    80104b7c <wait2+0x143>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b26:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b27:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104b2e:	81 7d f4 74 35 11 80 	cmpl   $0x80113574,-0xc(%ebp)
80104b35:	0f 82 23 ff ff ff    	jb     80104a5e <wait2+0x25>
        return pid;
      }
    }
    ...
    // No point waiting if we don't have any children.
    if(!havekids || proc->killed){
80104b3b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104b3f:	74 0d                	je     80104b4e <wait2+0x115>
80104b41:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b47:	8b 40 24             	mov    0x24(%eax),%eax
80104b4a:	85 c0                	test   %eax,%eax
80104b4c:	74 13                	je     80104b61 <wait2+0x128>
      release(&ptable.lock);
80104b4e:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104b55:	e8 bf 07 00 00       	call   80105319 <release>
      return -1;
80104b5a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b5f:	eb 1b                	jmp    80104b7c <wait2+0x143>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104b61:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b67:	c7 44 24 04 40 0f 11 	movl   $0x80110f40,0x4(%esp)
80104b6e:	80 
80104b6f:	89 04 24             	mov    %eax,(%esp)
80104b72:	e8 cd 03 00 00       	call   80104f44 <sleep>
  }
80104b77:	e9 cf fe ff ff       	jmp    80104a4b <wait2+0x12>
...
80104b81:	83 ec 28             	sub    $0x28,%esp
  char* addr = uva2ka(proc->pgdir, (char*)proc->tf->esp);
80104b84:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b8a:	8b 40 18             	mov    0x18(%eax),%eax
80104b8d:	8b 40 44             	mov    0x44(%eax),%eax
80104b90:	89 c2                	mov    %eax,%edx
80104b92:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b98:	8b 40 04             	mov    0x4(%eax),%eax
80104b9b:	89 54 24 04          	mov    %edx,0x4(%esp)
80104b9f:	89 04 24             	mov    %eax,(%esp)
80104ba2:	e8 d5 3c 00 00       	call   8010887c <uva2ka>
80104ba7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
80104baa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bb0:	8b 40 18             	mov    0x18(%eax),%eax
80104bb3:	8b 40 44             	mov    0x44(%eax),%eax
80104bb6:	25 ff 0f 00 00       	and    $0xfff,%eax
80104bbb:	85 c0                	test   %eax,%eax
80104bbd:	75 0c                	jne    80104bcb <register_handler+0x4d>
    panic("esp_offset == 0");
80104bbf:	c7 04 24 8d 8c 10 80 	movl   $0x80108c8d,(%esp)
80104bc6:	e8 7b b9 ff ff       	call   80100546 <panic>
...
80104bd7:	83 e8 04             	sub    $0x4,%eax
80104bda:	89 c2                	mov    %eax,%edx
80104bdc:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
...
80104bf0:	8b 40 38             	mov    0x38(%eax),%eax
80104bf3:	89 02                	mov    %eax,(%edx)
  proc->tf->esp -= 4;
80104bf5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bfb:	8b 40 18             	mov    0x18(%eax),%eax
80104bfe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104c05:	8b 52 18             	mov    0x18(%edx),%edx
80104c08:	8b 52 44             	mov    0x44(%edx),%edx
80104c0b:	83 ea 04             	sub    $0x4,%edx
80104c0e:	89 50 44             	mov    %edx,0x44(%eax)
...
80104c1d:	89 50 38             	mov    %edx,0x38(%eax)
}
80104c20:	c9                   	leave  
80104c21:	c3                   	ret    
...
80104c26:	83 ec 64             	sub    $0x64,%esp
  struct proc *p;
  struct proc *medium;
  struct proc *high;
  struct proc *head = 0;
80104c29:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  struct proc *t = ptable.proc;
80104c30:	c7 45 e8 74 0f 11 80 	movl   $0x80110f74,-0x18(%ebp)
  uint grt_min;
  ...
  for(;;){
    ...
    sti();
80104c37:	e8 05 f7 ff ff       	call   80104341 <sti>
    highflag = 0;
80104c3c:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
    mediumflag = 0;
80104c43:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
    lowflag = 0;
80104c4a:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    frr_min = 0;
80104c51:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
    grt_min = 0;
80104c58:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    
    if(head && p==head)
80104c5f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104c63:	74 17                	je     80104c7c <scheduler+0x5a>
80104c65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c68:	3b 45 ec             	cmp    -0x14(%ebp),%eax
80104c6b:	75 0f                	jne    80104c7c <scheduler+0x5a>
      t = ++head;
80104c6d:	81 45 ec 98 00 00 00 	addl   $0x98,-0x14(%ebp)
80104c74:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c77:	89 45 e8             	mov    %eax,-0x18(%ebp)
80104c7a:	eb 0c                	jmp    80104c88 <scheduler+0x66>
    else if(head)
80104c7c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80104c80:	74 06                	je     80104c88 <scheduler+0x66>
      t = head;
80104c82:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c85:	89 45 e8             	mov    %eax,-0x18(%ebp)
    
    acquire(&tickslock);
80104c88:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80104c8f:	e8 23 06 00 00       	call   801052b7 <acquire>
    currentime = ticks;
80104c94:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
80104c99:	89 45 cc             	mov    %eax,-0x34(%ebp)
    release(&tickslock);  
80104c9c:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80104ca3:	e8 71 06 00 00       	call   80105319 <release>
    int i=0;
80104ca8:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
    acquire(&ptable.lock); 
80104caf:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104cb6:	e8 fc 05 00 00       	call   801052b7 <acquire>
    for(; i<NPROC; i++)			// Loop over process table looking for process to run.
80104cbb:	e9 f4 00 00 00       	jmp    80104db4 <scheduler+0x192>
    {
      if(t >= &ptable.proc[NPROC])
80104cc0:	81 7d e8 74 35 11 80 	cmpl   $0x80113574,-0x18(%ebp)
80104cc7:	72 07                	jb     80104cd0 <scheduler+0xae>
	t = ptable.proc;
80104cc9:	c7 45 e8 74 0f 11 80 	movl   $0x80110f74,-0x18(%ebp)
      if(t->state != RUNNABLE)
80104cd0:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104cd3:	8b 40 0c             	mov    0xc(%eax),%eax
80104cd6:	83 f8 03             	cmp    $0x3,%eax
80104cd9:	74 0c                	je     80104ce7 <scheduler+0xc5>
      {
	t++;
80104cdb:	81 45 e8 98 00 00 00 	addl   $0x98,-0x18(%ebp)
	continue;
80104ce2:	e9 c9 00 00 00       	jmp    80104db0 <scheduler+0x18e>
	    frr_min = t->qvalue;
	    medium = t;
	  }
	  break;
...
80104cea:	8b 40 7c             	mov    0x7c(%eax),%eax
80104ced:	3b 45 cc             	cmp    -0x34(%ebp),%eax
80104cf0:	74 30                	je     80104d22 <scheduler+0x100>
	    t->qvalue = t->rtime/(currentime-t->ctime);
80104cf2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104cf5:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104cfb:	8b 55 e8             	mov    -0x18(%ebp),%edx
80104cfe:	8b 52 7c             	mov    0x7c(%edx),%edx
80104d01:	8b 4d cc             	mov    -0x34(%ebp),%ecx
80104d04:	89 cb                	mov    %ecx,%ebx
80104d06:	29 d3                	sub    %edx,%ebx
80104d08:	89 5d b4             	mov    %ebx,-0x4c(%ebp)
80104d0b:	89 c2                	mov    %eax,%edx
80104d0d:	c1 fa 1f             	sar    $0x1f,%edx
80104d10:	f7 7d b4             	idivl  -0x4c(%ebp)
80104d13:	89 45 c0             	mov    %eax,-0x40(%ebp)
80104d16:	db 45 c0             	fildl  -0x40(%ebp)
80104d19:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104d1c:	dd 98 90 00 00 00    	fstpl  0x90(%eax)
	  //if(t->pid>2)
	    //cprintf("proc id = %d, qvalue = %d\n",t->pid,t->qvalue);  
	  if(!grt_min)
80104d22:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80104d26:	75 30                	jne    80104d58 <scheduler+0x136>
	  {
	    grt_min = t->qvalue;
80104d28:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104d2b:	dd 80 90 00 00 00    	fldl   0x90(%eax)
80104d31:	d9 7d c6             	fnstcw -0x3a(%ebp)
80104d34:	0f b7 45 c6          	movzwl -0x3a(%ebp),%eax
80104d38:	b4 0c                	mov    $0xc,%ah
80104d3a:	66 89 45 c4          	mov    %ax,-0x3c(%ebp)
80104d3e:	d9 6d c4             	fldcw  -0x3c(%ebp)
80104d41:	df 7d b8             	fistpll -0x48(%ebp)
80104d44:	d9 6d c6             	fldcw  -0x3a(%ebp)
80104d47:	8b 45 b8             	mov    -0x48(%ebp),%eax
80104d4a:	8b 55 bc             	mov    -0x44(%ebp),%edx
80104d4d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	    high = t;
80104d50:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104d53:	89 45 f0             	mov    %eax,-0x10(%ebp)
	  ...
	  break;
80104d56:	eb 50                	jmp    80104da8 <scheduler+0x186>
	  if(!grt_min)
	  {
	    grt_min = t->qvalue;
	    high = t;
...
80104d58:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104d5b:	dd 80 90 00 00 00    	fldl   0x90(%eax)
80104d61:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104d64:	ba 00 00 00 00       	mov    $0x0,%edx
80104d69:	89 45 b8             	mov    %eax,-0x48(%ebp)
80104d6c:	89 55 bc             	mov    %edx,-0x44(%ebp)
80104d6f:	df 6d b8             	fildll -0x48(%ebp)
80104d72:	df e9                	fucomip %st(1),%st
80104d74:	dd d8                	fstp   %st(0)
80104d76:	76 30                	jbe    80104da8 <scheduler+0x186>
	  {
	    grt_min = t->qvalue;
80104d78:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104d7b:	dd 80 90 00 00 00    	fldl   0x90(%eax)
80104d81:	d9 7d c6             	fnstcw -0x3a(%ebp)
80104d84:	0f b7 45 c6          	movzwl -0x3a(%ebp),%eax
80104d88:	b4 0c                	mov    $0xc,%ah
80104d8a:	66 89 45 c4          	mov    %ax,-0x3c(%ebp)
80104d8e:	d9 6d c4             	fldcw  -0x3c(%ebp)
80104d91:	df 7d b8             	fistpll -0x48(%ebp)
80104d94:	d9 6d c6             	fldcw  -0x3a(%ebp)
80104d97:	8b 45 b8             	mov    -0x48(%ebp),%eax
80104d9a:	8b 55 bc             	mov    -0x44(%ebp),%edx
80104d9d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	    high = t;
80104da0:	8b 45 e8             	mov    -0x18(%ebp),%eax
80104da3:	89 45 f0             	mov    %eax,-0x10(%ebp)
	  }
	  break;
80104da6:	eb 00                	jmp    80104da8 <scheduler+0x186>
80104da8:	90                   	nop
	    lowflag = 1;
	    t->quanta = QUANTA;
	  }
      ...
      t++;
80104da9:	81 45 e8 98 00 00 00 	addl   $0x98,-0x18(%ebp)
    acquire(&tickslock);
    currentime = ticks;
    release(&tickslock);  
    int i=0;
    acquire(&ptable.lock); 
    for(; i<NPROC; i++)			// Loop over process table looking for process to run.
80104db0:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
80104db4:	83 7d e0 3f          	cmpl   $0x3f,-0x20(%ebp)
80104db8:	0f 8e 02 ff ff ff    	jle    80104cc0 <scheduler+0x9e>
    if(SCHEDFLAG != _RR)
    {
      if(SCHEDFLAG == _FRR)
	p = medium;
...
80104dc4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104dc8:	74 58                	je     80104e22 <scheduler+0x200>
80104dca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dcd:	8b 40 0c             	mov    0xc(%eax),%eax
80104dd0:	83 f8 03             	cmp    $0x3,%eax
80104dd3:	75 4d                	jne    80104e22 <scheduler+0x200>
      {
	proc = p;
...
80104de4:	e8 2b 34 00 00       	call   80108214 <switchuvm>
	p->state = RUNNING;
80104de9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104dec:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
	swtch(&cpu->scheduler, proc->context);
80104df3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104df9:	8b 40 1c             	mov    0x1c(%eax),%eax
80104dfc:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104e03:	83 c2 04             	add    $0x4,%edx
80104e06:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e0a:	89 14 24             	mov    %edx,(%esp)
80104e0d:	e8 a6 09 00 00       	call   801057b8 <swtch>
	switchkvm();
80104e12:	e8 e0 33 00 00       	call   801081f7 <switchkvm>
	// Process is done running for now.
	// It should have changed its p->state before coming back.
	proc = 0;
80104e17:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104e1e:	00 00 00 00 
      }
    }
    release(&ptable.lock);
80104e22:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104e29:	e8 eb 04 00 00       	call   80105319 <release>
    }
80104e2e:	e9 04 fe ff ff       	jmp    80104c37 <scheduler+0x15>
...
80104e39:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104e40:	e8 9c 05 00 00       	call   801053e1 <holding>
80104e45:	85 c0                	test   %eax,%eax
80104e47:	75 0c                	jne    80104e55 <sched+0x22>
    panic("sched ptable.lock");
80104e49:	c7 04 24 9d 8c 10 80 	movl   $0x80108c9d,(%esp)
80104e50:	e8 f1 b6 ff ff       	call   80100546 <panic>
  if(cpu->ncli != 1)
80104e55:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104e5b:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104e61:	83 f8 01             	cmp    $0x1,%eax
80104e64:	74 0c                	je     80104e72 <sched+0x3f>
    panic("sched locks");
80104e66:	c7 04 24 af 8c 10 80 	movl   $0x80108caf,(%esp)
80104e6d:	e8 d4 b6 ff ff       	call   80100546 <panic>
  if(proc->state == RUNNING)
80104e72:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e78:	8b 40 0c             	mov    0xc(%eax),%eax
80104e7b:	83 f8 04             	cmp    $0x4,%eax
80104e7e:	75 0c                	jne    80104e8c <sched+0x59>
    panic("sched running");
80104e80:	c7 04 24 bb 8c 10 80 	movl   $0x80108cbb,(%esp)
80104e87:	e8 ba b6 ff ff       	call   80100546 <panic>
  if(readeflags()&FL_IF)
80104e8c:	e8 9b f4 ff ff       	call   8010432c <readeflags>
80104e91:	25 00 02 00 00       	and    $0x200,%eax
80104e96:	85 c0                	test   %eax,%eax
80104e98:	74 0c                	je     80104ea6 <sched+0x73>
    panic("sched interruptible");
80104e9a:	c7 04 24 c9 8c 10 80 	movl   $0x80108cc9,(%esp)
80104ea1:	e8 a0 b6 ff ff       	call   80100546 <panic>
  intena = cpu->intena;
80104ea6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104eac:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104eb2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
80104eb5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ebb:	8b 40 04             	mov    0x4(%eax),%eax
80104ebe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104ec5:	83 c2 1c             	add    $0x1c,%edx
80104ec8:	89 44 24 04          	mov    %eax,0x4(%esp)
80104ecc:	89 14 24             	mov    %edx,(%esp)
80104ecf:	e8 e4 08 00 00       	call   801057b8 <swtch>
  cpu->intena = intena;
80104ed4:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104eda:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104edd:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104ee3:	c9                   	leave  
80104ee4:	c3                   	ret    
...
80104eec:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104ef3:	e8 bf 03 00 00       	call   801052b7 <acquire>
  proc->state = RUNNABLE;
80104ef8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104efe:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104f05:	e8 29 ff ff ff       	call   80104e33 <sched>
  release(&ptable.lock);
80104f0a:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104f11:	e8 03 04 00 00       	call   80105319 <release>
...
80104f1b:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104f1e:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104f25:	e8 ef 03 00 00       	call   80105319 <release>

  if (first) {
80104f2a:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104f2f:	85 c0                	test   %eax,%eax
80104f31:	74 0f                	je     80104f42 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104f33:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104f3a:	00 00 00 
    initlog();
80104f3d:	e8 fa e3 ff ff       	call   8010333c <initlog>
  }
...
80104f52:	75 0c                	jne    80104f60 <sleep+0x1c>
    panic("sleep");
80104f54:	c7 04 24 dd 8c 10 80 	movl   $0x80108cdd,(%esp)
80104f5b:	e8 e6 b5 ff ff       	call   80100546 <panic>

  if(lk == 0)
80104f60:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104f64:	75 0c                	jne    80104f72 <sleep+0x2e>
    panic("sleep without lk");
80104f66:	c7 04 24 e3 8c 10 80 	movl   $0x80108ce3,(%esp)
80104f6d:	e8 d4 b5 ff ff       	call   80100546 <panic>
...
80104f72:	81 7d 0c 40 0f 11 80 	cmpl   $0x80110f40,0xc(%ebp)
80104f79:	74 17                	je     80104f92 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104f7b:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104f82:	e8 30 03 00 00       	call   801052b7 <acquire>
    release(lk);
80104f87:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f8a:	89 04 24             	mov    %eax,(%esp)
80104f8d:	e8 87 03 00 00       	call   80105319 <release>
  }
...
80104f9b:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104f9e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fa4:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104fab:	e8 83 fe ff ff       	call   80104e33 <sched>

  // Tidy up.
  proc->chan = 0;
80104fb0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fb6:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104fbd:	81 7d 0c 40 0f 11 80 	cmpl   $0x80110f40,0xc(%ebp)
80104fc4:	74 17                	je     80104fdd <sleep+0x99>
    release(&ptable.lock);
80104fc6:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80104fcd:	e8 47 03 00 00       	call   80105319 <release>
    acquire(lk);
80104fd2:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fd5:	89 04 24             	mov    %eax,(%esp)
80104fd8:	e8 da 02 00 00       	call   801052b7 <acquire>
  }
}
80104fdd:	c9                   	leave  
80104fde:	c3                   	ret    
...
80104fe2:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104fe5:	c7 45 fc 74 0f 11 80 	movl   $0x80110f74,-0x4(%ebp)
80104fec:	eb 27                	jmp    80105015 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104fee:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ff1:	8b 40 0c             	mov    0xc(%eax),%eax
80104ff4:	83 f8 02             	cmp    $0x2,%eax
80104ff7:	75 15                	jne    8010500e <wakeup1+0x2f>
80104ff9:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ffc:	8b 40 20             	mov    0x20(%eax),%eax
80104fff:	3b 45 08             	cmp    0x8(%ebp),%eax
80105002:	75 0a                	jne    8010500e <wakeup1+0x2f>
    {
      p->state = RUNNABLE;
80105004:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105007:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010500e:	81 45 fc 98 00 00 00 	addl   $0x98,-0x4(%ebp)
80105015:	81 7d fc 74 35 11 80 	cmpl   $0x80113574,-0x4(%ebp)
8010501c:	72 d0                	jb     80104fee <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
    {
      p->state = RUNNABLE;
    }
...
80105023:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80105026:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
8010502d:	e8 85 02 00 00       	call   801052b7 <acquire>
  wakeup1(chan);
80105032:	8b 45 08             	mov    0x8(%ebp),%eax
80105035:	89 04 24             	mov    %eax,(%esp)
80105038:	e8 a2 ff ff ff       	call   80104fdf <wakeup1>
  release(&ptable.lock);
8010503d:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80105044:	e8 d0 02 00 00       	call   80105319 <release>
}
80105049:	c9                   	leave  
8010504a:	c3                   	ret    
...
8010504e:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80105051:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80105058:	e8 5a 02 00 00       	call   801052b7 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010505d:	c7 45 f4 74 0f 11 80 	movl   $0x80110f74,-0xc(%ebp)
80105064:	eb 44                	jmp    801050aa <kill+0x5f>
    if(p->pid == pid){
80105066:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105069:	8b 40 10             	mov    0x10(%eax),%eax
8010506c:	3b 45 08             	cmp    0x8(%ebp),%eax
8010506f:	75 32                	jne    801050a3 <kill+0x58>
      p->killed = 1;
80105071:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105074:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010507b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010507e:	8b 40 0c             	mov    0xc(%eax),%eax
80105081:	83 f8 02             	cmp    $0x2,%eax
80105084:	75 0a                	jne    80105090 <kill+0x45>
        p->state = RUNNABLE;
80105086:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105089:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80105090:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
80105097:	e8 7d 02 00 00       	call   80105319 <release>
      return 0;
8010509c:	b8 00 00 00 00       	mov    $0x0,%eax
801050a1:	eb 21                	jmp    801050c4 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050a3:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801050aa:	81 7d f4 74 35 11 80 	cmpl   $0x80113574,-0xc(%ebp)
801050b1:	72 b3                	jb     80105066 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
801050b3:	c7 04 24 40 0f 11 80 	movl   $0x80110f40,(%esp)
801050ba:	e8 5a 02 00 00       	call   80105319 <release>
  return -1;
...
801050c9:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801050cc:	c7 45 f0 74 0f 11 80 	movl   $0x80110f74,-0x10(%ebp)
801050d3:	e9 db 00 00 00       	jmp    801051b3 <procdump+0xed>
    if(p->state == UNUSED)
801050d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050db:	8b 40 0c             	mov    0xc(%eax),%eax
801050de:	85 c0                	test   %eax,%eax
801050e0:	0f 84 c5 00 00 00    	je     801051ab <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801050e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050e9:	8b 40 0c             	mov    0xc(%eax),%eax
801050ec:	83 f8 05             	cmp    $0x5,%eax
801050ef:	77 23                	ja     80105114 <procdump+0x4e>
801050f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801050f4:	8b 40 0c             	mov    0xc(%eax),%eax
801050f7:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
801050fe:	85 c0                	test   %eax,%eax
80105100:	74 12                	je     80105114 <procdump+0x4e>
      state = states[p->state];
80105102:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105105:	8b 40 0c             	mov    0xc(%eax),%eax
80105108:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
8010510f:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105112:	eb 07                	jmp    8010511b <procdump+0x55>
    else
      state = "???";
80105114:	c7 45 ec f4 8c 10 80 	movl   $0x80108cf4,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
8010511b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010511e:	8d 50 6c             	lea    0x6c(%eax),%edx
80105121:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105124:	8b 40 10             	mov    0x10(%eax),%eax
80105127:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010512b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010512e:	89 54 24 08          	mov    %edx,0x8(%esp)
80105132:	89 44 24 04          	mov    %eax,0x4(%esp)
80105136:	c7 04 24 f8 8c 10 80 	movl   $0x80108cf8,(%esp)
8010513d:	e8 68 b2 ff ff       	call   801003aa <cprintf>
    if(p->state == SLEEPING){
80105142:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105145:	8b 40 0c             	mov    0xc(%eax),%eax
80105148:	83 f8 02             	cmp    $0x2,%eax
8010514b:	75 50                	jne    8010519d <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010514d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105150:	8b 40 1c             	mov    0x1c(%eax),%eax
80105153:	8b 40 0c             	mov    0xc(%eax),%eax
80105156:	83 c0 08             	add    $0x8,%eax
80105159:	8d 55 c4             	lea    -0x3c(%ebp),%edx
8010515c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105160:	89 04 24             	mov    %eax,(%esp)
80105163:	e8 00 02 00 00       	call   80105368 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80105168:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010516f:	eb 1b                	jmp    8010518c <procdump+0xc6>
        cprintf(" %p", pc[i]);
80105171:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105174:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105178:	89 44 24 04          	mov    %eax,0x4(%esp)
8010517c:	c7 04 24 01 8d 10 80 	movl   $0x80108d01,(%esp)
80105183:	e8 22 b2 ff ff       	call   801003aa <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
8010518c:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105190:	7f 0b                	jg     8010519d <procdump+0xd7>
80105192:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105195:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80105199:	85 c0                	test   %eax,%eax
8010519b:	75 d4                	jne    80105171 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
8010519d:	c7 04 24 05 8d 10 80 	movl   $0x80108d05,(%esp)
801051a4:	e8 01 b2 ff ff       	call   801003aa <cprintf>
801051a9:	eb 01                	jmp    801051ac <procdump+0xe6>
  char *state;
  uint pc[10];
...
801051ab:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801051ac:	81 45 f0 98 00 00 00 	addl   $0x98,-0x10(%ebp)
801051b3:	81 7d f0 74 35 11 80 	cmpl   $0x80113574,-0x10(%ebp)
801051ba:	0f 82 18 ff ff ff    	jb     801050d8 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
801051d0:	74 76                	je     80105248 <nice+0x86>
  {
    if(proc->priority == HIGH)
801051d2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051d8:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
801051de:	83 f8 03             	cmp    $0x3,%eax
801051e1:	75 38                	jne    8010521b <nice+0x59>
    {
      proc->priority--;
801051e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051e9:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
801051ef:	83 ea 01             	sub    $0x1,%edx
801051f2:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
      proc->qvalue = proc->ctime;
801051f8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051fe:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80105205:	8b 52 7c             	mov    0x7c(%edx),%edx
80105208:	89 55 fc             	mov    %edx,-0x4(%ebp)
8010520b:	db 45 fc             	fildl  -0x4(%ebp)
8010520e:	dd 98 90 00 00 00    	fstpl  0x90(%eax)
      return 0;
80105214:	b8 00 00 00 00       	mov    $0x0,%eax
80105219:	eb 32                	jmp    8010524d <nice+0x8b>
    }
    else if(proc->priority == MEDIUM)
8010521b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105221:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80105227:	83 f8 02             	cmp    $0x2,%eax
8010522a:	75 1c                	jne    80105248 <nice+0x86>
    {
      proc->priority--;
8010522c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105232:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
80105238:	83 ea 01             	sub    $0x1,%edx
8010523b:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
      return 0;
80105241:	b8 00 00 00 00       	mov    $0x0,%eax
80105246:	eb 05                	jmp    8010524d <nice+0x8b>
    }
...
80105257:	9c                   	pushf  
80105258:	5b                   	pop    %ebx
80105259:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
...
80105285:	f0 87 02             	lock xchg %eax,(%edx)
80105288:	89 c3                	mov    %eax,%ebx
8010528a:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
801052cf:	74 0c                	je     801052dd <acquire+0x26>
    panic("acquire");
801052d1:	c7 04 24 31 8d 10 80 	movl   $0x80108d31,(%esp)
801052d8:	e8 69 b2 ff ff       	call   80100546 <panic>
...
801052ec:	e8 80 ff ff ff       	call   80105271 <xchg>
...
8010532c:	75 0c                	jne    8010533a <release+0x21>
    panic("release");
8010532e:	c7 04 24 39 8d 10 80 	movl   $0x80108d39,(%esp)
80105335:	e8 0c b2 ff ff       	call   80100546 <panic>
...
8010535c:	e8 10 ff ff ff       	call   80105271 <xchg>

  popcli();
80105361:	e8 ed 00 00 00       	call   80105453 <popcli>
}
80105366:	c9                   	leave  
80105367:	c3                   	ret    
...
80105384:	74 53                	je     801053d9 <getcallerpcs+0x71>
80105386:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010538d:	76 4a                	jbe    801053d9 <getcallerpcs+0x71>
8010538f:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105393:	74 44                	je     801053d9 <getcallerpcs+0x71>
      break;
...
8010540e:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105411:	e8 3a fe ff ff       	call   80105250 <readeflags>
80105416:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105419:	e8 47 fe ff ff       	call   80105265 <cli>
  if(cpu->ncli++ == 0)
8010541e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105424:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010542a:	85 d2                	test   %edx,%edx
8010542c:	0f 94 c1             	sete   %cl
8010542f:	83 c2 01             	add    $0x1,%edx
80105432:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105438:	84 c9                	test   %cl,%cl
8010543a:	74 15                	je     80105451 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
8010543c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105442:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105445:	81 e2 00 02 00 00    	and    $0x200,%edx
8010544b:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105451:	c9                   	leave  
80105452:	c3                   	ret    
...
80105456:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105459:	e8 f2 fd ff ff       	call   80105250 <readeflags>
8010545e:	25 00 02 00 00       	and    $0x200,%eax
80105463:	85 c0                	test   %eax,%eax
80105465:	74 0c                	je     80105473 <popcli+0x20>
    panic("popcli - interruptible");
80105467:	c7 04 24 41 8d 10 80 	movl   $0x80108d41,(%esp)
8010546e:	e8 d3 b0 ff ff       	call   80100546 <panic>
  if(--cpu->ncli < 0)
80105473:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105479:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010547f:	83 ea 01             	sub    $0x1,%edx
80105482:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105488:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010548e:	85 c0                	test   %eax,%eax
80105490:	79 0c                	jns    8010549e <popcli+0x4b>
    panic("popcli");
80105492:	c7 04 24 58 8d 10 80 	movl   $0x80108d58,(%esp)
80105499:	e8 a8 b0 ff ff       	call   80100546 <panic>
  if(cpu->ncli == 0 && cpu->intena)
8010549e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054a4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054aa:	85 c0                	test   %eax,%eax
801054ac:	75 15                	jne    801054c3 <popcli+0x70>
801054ae:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054b4:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801054ba:	85 c0                	test   %eax,%eax
801054bc:	74 05                	je     801054c3 <popcli+0x70>
    sti();
801054be:	e8 a8 fd ff ff       	call   8010526b <sti>
}
801054c3:	c9                   	leave  
801054c4:	c3                   	ret    
801054c5:	66 90                	xchg   %ax,%ax
801054c7:	90                   	nop
...
801054cd:	8b 4d 08             	mov    0x8(%ebp),%ecx
801054d0:	8b 55 10             	mov    0x10(%ebp),%edx
801054d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801054d6:	89 cb                	mov    %ecx,%ebx
801054d8:	89 df                	mov    %ebx,%edi
801054da:	89 d1                	mov    %edx,%ecx
801054dc:	fc                   	cld    
801054dd:	f3 aa                	rep stos %al,%es:(%edi)
801054df:	89 ca                	mov    %ecx,%edx
801054e1:	89 fb                	mov    %edi,%ebx
801054e3:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
8010551b:	83 e0 03             	and    $0x3,%eax
8010551e:	85 c0                	test   %eax,%eax
80105520:	75 49                	jne    8010556b <memset+0x59>
80105522:	8b 45 10             	mov    0x10(%ebp),%eax
80105525:	83 e0 03             	and    $0x3,%eax
80105528:	85 c0                	test   %eax,%eax
8010552a:	75 3f                	jne    8010556b <memset+0x59>
    c &= 0xFF;
8010552c:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105533:	8b 45 10             	mov    0x10(%ebp),%eax
80105536:	c1 e8 02             	shr    $0x2,%eax
80105539:	89 c2                	mov    %eax,%edx
8010553b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010553e:	89 c1                	mov    %eax,%ecx
80105540:	c1 e1 18             	shl    $0x18,%ecx
80105543:	8b 45 0c             	mov    0xc(%ebp),%eax
80105546:	c1 e0 10             	shl    $0x10,%eax
80105549:	09 c1                	or     %eax,%ecx
8010554b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010554e:	c1 e0 08             	shl    $0x8,%eax
80105551:	09 c8                	or     %ecx,%eax
80105553:	0b 45 0c             	or     0xc(%ebp),%eax
80105556:	89 54 24 08          	mov    %edx,0x8(%esp)
8010555a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010555e:	8b 45 08             	mov    0x8(%ebp),%eax
80105561:	89 04 24             	mov    %eax,(%esp)
80105564:	e8 84 ff ff ff       	call   801054ed <stosl>
80105569:	eb 19                	jmp    80105584 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010557f:	e8 44 ff ff ff       	call   801054c8 <stosb>
  return dst;
...
80105598:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010559b:	eb 32                	jmp    801055cf <memcmp+0x46>
    if(*s1 != *s2)
8010559d:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055a0:	0f b6 10             	movzbl (%eax),%edx
801055a3:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055a6:	0f b6 00             	movzbl (%eax),%eax
801055a9:	38 c2                	cmp    %al,%dl
801055ab:	74 1a                	je     801055c7 <memcmp+0x3e>
      return *s1 - *s2;
...
801055c1:	29 c1                	sub    %eax,%ecx
801055c3:	89 c8                	mov    %ecx,%eax
801055c5:	eb 1c                	jmp    801055e3 <memcmp+0x5a>
    s1++, s2++;
801055c7:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055cb:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
801055d6:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801055da:	84 c0                	test   %al,%al
801055dc:	75 bf                	jne    8010559d <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801055fa:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801055fd:	73 54                	jae    80105653 <memmove+0x6e>
801055ff:	8b 45 10             	mov    0x10(%ebp),%eax
80105602:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105605:	01 d0                	add    %edx,%eax
80105607:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010560a:	76 47                	jbe    80105653 <memmove+0x6e>
    s += n;
8010560c:	8b 45 10             	mov    0x10(%ebp),%eax
8010560f:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105612:	8b 45 10             	mov    0x10(%ebp),%eax
80105615:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105618:	eb 13                	jmp    8010562d <memmove+0x48>
      *--d = *--s;
8010561a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010561e:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105622:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105625:	0f b6 10             	movzbl (%eax),%edx
80105628:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010562b:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
80105631:	0f 95 c0             	setne  %al
80105634:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105638:	84 c0                	test   %al,%al
8010563a:	75 de                	jne    8010561a <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010563c:	eb 25                	jmp    80105663 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105647:	88 10                	mov    %dl,(%eax)
80105649:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
8010564d:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105651:	eb 01                	jmp    80105654 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80105653:	90                   	nop
80105654:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105658:	0f 95 c0             	setne  %al
8010565b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010565f:	84 c0                	test   %al,%al
80105661:	75 db                	jne    8010563e <memmove+0x59>
      *d++ = *s++;
...
80105682:	e8 5e ff ff ff       	call   801055e5 <memmove>
}
80105687:	c9                   	leave  
80105688:	c3                   	ret    
...
8010568a:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
8010568c:	eb 0c                	jmp    8010569a <strncmp+0x11>
    n--, p++, q++;
8010568e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105692:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105696:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
8010569a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010569e:	74 1a                	je     801056ba <strncmp+0x31>
801056a0:	8b 45 08             	mov    0x8(%ebp),%eax
801056a3:	0f b6 00             	movzbl (%eax),%eax
801056a6:	84 c0                	test   %al,%al
801056a8:	74 10                	je     801056ba <strncmp+0x31>
801056aa:	8b 45 08             	mov    0x8(%ebp),%eax
801056ad:	0f b6 10             	movzbl (%eax),%edx
801056b0:	8b 45 0c             	mov    0xc(%ebp),%eax
801056b3:	0f b6 00             	movzbl (%eax),%eax
801056b6:	38 c2                	cmp    %al,%dl
801056b8:	74 d4                	je     8010568e <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801056ba:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801056be:	75 07                	jne    801056c7 <strncmp+0x3e>
    return 0;
801056c0:	b8 00 00 00 00       	mov    $0x0,%eax
801056c5:	eb 18                	jmp    801056df <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
801056c7:	8b 45 08             	mov    0x8(%ebp),%eax
801056ca:	0f b6 00             	movzbl (%eax),%eax
801056cd:	0f b6 d0             	movzbl %al,%edx
801056d0:	8b 45 0c             	mov    0xc(%ebp),%eax
801056d3:	0f b6 00             	movzbl (%eax),%eax
801056d6:	0f b6 c0             	movzbl %al,%eax
801056d9:	89 d1                	mov    %edx,%ecx
801056db:	29 c1                	sub    %eax,%ecx
801056dd:	89 c8                	mov    %ecx,%eax
}
801056df:	5d                   	pop    %ebp
801056e0:	c3                   	ret    
...
801056ea:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
801056ed:	90                   	nop
801056ee:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801056f2:	0f 9f c0             	setg   %al
801056f5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801056f9:	84 c0                	test   %al,%al
801056fb:	74 30                	je     8010572d <strncpy+0x4c>
...
80105710:	0f 95 c0             	setne  %al
80105713:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105717:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010571b:	84 c0                	test   %al,%al
8010571d:	75 cf                	jne    801056ee <strncpy+0xd>
    ;
  while(n-- > 0)
8010571f:	eb 0c                	jmp    8010572d <strncpy+0x4c>
    *s++ = 0;
80105721:	8b 45 08             	mov    0x8(%ebp),%eax
80105724:	c6 00 00             	movb   $0x0,(%eax)
80105727:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010572b:	eb 01                	jmp    8010572e <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
8010572d:	90                   	nop
8010572e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105732:	0f 9f c0             	setg   %al
80105735:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105739:	84 c0                	test   %al,%al
8010573b:	75 e4                	jne    80105721 <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105752:	7f 05                	jg     80105759 <safestrcpy+0x17>
    return os;
80105754:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105757:	eb 35                	jmp    8010578e <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105759:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010575d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105761:	7e 22                	jle    80105785 <safestrcpy+0x43>
80105763:	8b 45 0c             	mov    0xc(%ebp),%eax
80105766:	0f b6 10             	movzbl (%eax),%edx
...
80105776:	0f 95 c0             	setne  %al
80105779:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010577d:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105781:	84 c0                	test   %al,%al
80105783:	75 d4                	jne    80105759 <safestrcpy+0x17>
    ;
  *s = 0;
...
80105793:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80105796:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010579d:	eb 04                	jmp    801057a3 <strlen+0x13>
8010579f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801057a3:	8b 55 fc             	mov    -0x4(%ebp),%edx
801057a6:	8b 45 08             	mov    0x8(%ebp),%eax
801057a9:	01 d0                	add    %edx,%eax
801057ab:	0f b6 00             	movzbl (%eax),%eax
801057ae:	84 c0                	test   %al,%al
801057b0:	75 ed                	jne    8010579f <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801057b8:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801057bc:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801057c3:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
801057c4:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801057c6:	89 d4                	mov    %edx,%esp
...
801057d8:	3b 45 0c             	cmp    0xc(%ebp),%eax
801057db:	76 0f                	jbe    801057ec <fetchint+0x1c>
801057dd:	8b 45 0c             	mov    0xc(%ebp),%eax
801057e0:	8d 50 04             	lea    0x4(%eax),%edx
801057e3:	8b 45 08             	mov    0x8(%ebp),%eax
801057e6:	8b 00                	mov    (%eax),%eax
801057e8:	39 c2                	cmp    %eax,%edx
801057ea:	76 07                	jbe    801057f3 <fetchint+0x23>
    return -1;
801057ec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057f1:	eb 0f                	jmp    80105802 <fetchint+0x32>
  *ip = *(int*)(addr);
801057f3:	8b 45 0c             	mov    0xc(%ebp),%eax
801057f6:	8b 10                	mov    (%eax),%edx
...
8010580f:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105812:	77 07                	ja     8010581b <fetchstr+0x17>
    return -1;
80105814:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105819:	eb 45                	jmp    80105860 <fetchstr+0x5c>
  *pp = (char*)addr;
...
8010584d:	eb 11                	jmp    80105860 <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
8010584f:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105853:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105856:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105859:	72 da                	jb     80105835 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105871:	8b 50 44             	mov    0x44(%eax),%edx
80105874:	8b 45 08             	mov    0x8(%ebp),%eax
80105877:	c1 e0 02             	shl    $0x2,%eax
8010587a:	01 d0                	add    %edx,%eax
8010587c:	8d 48 04             	lea    0x4(%eax),%ecx
8010587f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105885:	8b 55 0c             	mov    0xc(%ebp),%edx
80105888:	89 54 24 08          	mov    %edx,0x8(%esp)
8010588c:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105890:	89 04 24             	mov    %eax,(%esp)
80105893:	e8 38 ff ff ff       	call   801057d0 <fetchint>
}
80105898:	c9                   	leave  
80105899:	c3                   	ret    
...
801058ad:	e8 b0 ff ff ff       	call   80105862 <argint>
801058b2:	85 c0                	test   %eax,%eax
801058b4:	79 07                	jns    801058bd <argptr+0x23>
    return -1;
801058b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058bb:	eb 3d                	jmp    801058fa <argptr+0x60>
...
801058ca:	39 c2                	cmp    %eax,%edx
801058cc:	73 16                	jae    801058e4 <argptr+0x4a>
...
801058e2:	76 07                	jbe    801058eb <argptr+0x51>
    return -1;
801058e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e9:	eb 0f                	jmp    801058fa <argptr+0x60>
  *pp = (char*)i;
...
801058ff:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
...
80105987:	eb 73                	jmp    801059fc <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105989:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
8010598d:	7e 30                	jle    801059bf <syscall+0x80>
8010598f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105992:	83 f8 17             	cmp    $0x17,%eax
80105995:	77 28                	ja     801059bf <syscall+0x80>
80105997:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010599a:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801059a1:	85 c0                	test   %eax,%eax
801059a3:	74 1a                	je     801059bf <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801059a5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059ab:	8b 58 18             	mov    0x18(%eax),%ebx
801059ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059b1:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801059b8:	ff d0                	call   *%eax
801059ba:	89 43 1c             	mov    %eax,0x1c(%ebx)
801059bd:	eb 3d                	jmp    801059fc <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801059bf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059c5:	8d 48 6c             	lea    0x6c(%eax),%ecx
801059c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801059ce:	8b 40 10             	mov    0x10(%eax),%eax
801059d1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801059d4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801059d8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801059dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801059e0:	c7 04 24 5f 8d 10 80 	movl   $0x80108d5f,(%esp)
801059e7:	e8 be a9 ff ff       	call   801003aa <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
...
801059fc:	83 c4 24             	add    $0x24,%esp
801059ff:	5b                   	pop    %ebx
80105a00:	5d                   	pop    %ebp
80105a01:	c3                   	ret    
...
80105a17:	e8 46 fe ff ff       	call   80105862 <argint>
80105a1c:	85 c0                	test   %eax,%eax
80105a1e:	79 07                	jns    80105a27 <argfd+0x23>
    return -1;
80105a20:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a25:	eb 50                	jmp    80105a77 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105a27:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a2a:	85 c0                	test   %eax,%eax
80105a2c:	78 21                	js     80105a4f <argfd+0x4b>
80105a2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a31:	83 f8 0f             	cmp    $0xf,%eax
80105a34:	7f 19                	jg     80105a4f <argfd+0x4b>
80105a36:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a3c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a3f:	83 c2 08             	add    $0x8,%edx
80105a42:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105a46:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a49:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a4d:	75 07                	jne    80105a56 <argfd+0x52>
    return -1;
80105a4f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a54:	eb 21                	jmp    80105a77 <argfd+0x73>
  if(pfd)
80105a56:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105a5a:	74 08                	je     80105a64 <argfd+0x60>
    *pfd = fd;
80105a5c:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105a5f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105a62:	89 10                	mov    %edx,(%eax)
  if(pf)
80105a64:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105a68:	74 08                	je     80105a72 <argfd+0x6e>
    *pf = f;
80105a6a:	8b 45 10             	mov    0x10(%ebp),%eax
80105a6d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a70:	89 10                	mov    %edx,(%eax)
  return 0;
80105a72:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105a77:	c9                   	leave  
80105a78:	c3                   	ret    
...
80105a7c:	83 ec 10             	sub    $0x10,%esp
  int fd;

  for(fd = 0; fd < NOFILE; fd++){
80105a7f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a86:	eb 30                	jmp    80105ab8 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105a88:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a8e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a91:	83 c2 08             	add    $0x8,%edx
80105a94:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105a98:	85 c0                	test   %eax,%eax
80105a9a:	75 18                	jne    80105ab4 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105a9c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105aa2:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105aa5:	8d 4a 08             	lea    0x8(%edx),%ecx
80105aa8:	8b 55 08             	mov    0x8(%ebp),%edx
80105aab:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105aaf:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ab2:	eb 0f                	jmp    80105ac3 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105ab4:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ab8:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105abc:	7e ca                	jle    80105a88 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105ac8:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
...
80105ad2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ad9:	00 
80105ada:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ae1:	e8 1e ff ff ff       	call   80105a04 <argfd>
80105ae6:	85 c0                	test   %eax,%eax
80105ae8:	79 07                	jns    80105af1 <sys_dup+0x2c>
    return -1;
80105aea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aef:	eb 29                	jmp    80105b1a <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
80105af1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105af4:	89 04 24             	mov    %eax,(%esp)
80105af7:	e8 7d ff ff ff       	call   80105a79 <fdalloc>
80105afc:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105aff:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b03:	79 07                	jns    80105b0c <sys_dup+0x47>
    return -1;
80105b05:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b0a:	eb 0e                	jmp    80105b1a <sys_dup+0x55>
  filedup(f);
80105b0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b0f:	89 04 24             	mov    %eax,(%esp)
80105b12:	e8 69 b7 ff ff       	call   80101280 <filedup>
  return fd;
...
80105b25:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b29:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b30:	00 
80105b31:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105b38:	e8 c7 fe ff ff       	call   80105a04 <argfd>
80105b3d:	85 c0                	test   %eax,%eax
80105b3f:	78 35                	js     80105b76 <sys_read+0x5a>
80105b41:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b44:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b48:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105b4f:	e8 0e fd ff ff       	call   80105862 <argint>
80105b54:	85 c0                	test   %eax,%eax
80105b56:	78 1e                	js     80105b76 <sys_read+0x5a>
...
80105b66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b6d:	e8 28 fd ff ff       	call   8010589a <argptr>
80105b72:	85 c0                	test   %eax,%eax
80105b74:	79 07                	jns    80105b7d <sys_read+0x61>
    return -1;
80105b76:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b7b:	eb 19                	jmp    80105b96 <sys_read+0x7a>
  return fileread(f, p, n);
80105b7d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105b80:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b86:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b8a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b8e:	89 04 24             	mov    %eax,(%esp)
80105b91:	e8 57 b8 ff ff       	call   801013ed <fileread>
}
80105b96:	c9                   	leave  
80105b97:	c3                   	ret    
...
80105ba5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105bac:	00 
80105bad:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105bb4:	e8 4b fe ff ff       	call   80105a04 <argfd>
80105bb9:	85 c0                	test   %eax,%eax
80105bbb:	78 35                	js     80105bf2 <sys_write+0x5a>
80105bbd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bc0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bc4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105bcb:	e8 92 fc ff ff       	call   80105862 <argint>
80105bd0:	85 c0                	test   %eax,%eax
80105bd2:	78 1e                	js     80105bf2 <sys_write+0x5a>
80105bd4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bd7:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bdb:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105bde:	89 44 24 04          	mov    %eax,0x4(%esp)
80105be2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105be9:	e8 ac fc ff ff       	call   8010589a <argptr>
80105bee:	85 c0                	test   %eax,%eax
80105bf0:	79 07                	jns    80105bf9 <sys_write+0x61>
    return -1;
80105bf2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bf7:	eb 19                	jmp    80105c12 <sys_write+0x7a>
  return filewrite(f, p, n);
80105bf9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105bfc:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105bff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c02:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105c06:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c0a:	89 04 24             	mov    %eax,(%esp)
80105c0d:	e8 97 b8 ff ff       	call   801014a9 <filewrite>
}
80105c12:	c9                   	leave  
80105c13:	c3                   	ret    
...
80105c81:	e8 7e fd ff ff       	call   80105a04 <argfd>
80105c86:	85 c0                	test   %eax,%eax
80105c88:	78 1f                	js     80105ca9 <sys_fstat+0x44>
80105c8a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105c91:	00 
80105c92:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c95:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c99:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ca0:	e8 f5 fb ff ff       	call   8010589a <argptr>
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	79 07                	jns    80105cb0 <sys_fstat+0x4b>
    return -1;
80105ca9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cae:	eb 12                	jmp    80105cc2 <sys_fstat+0x5d>
  return filestat(f, st);
80105cb0:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105cb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cb6:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cba:	89 04 24             	mov    %eax,(%esp)
80105cbd:	e8 dc b6 ff ff       	call   8010139e <filestat>
}
80105cc2:	c9                   	leave  
80105cc3:	c3                   	ret    
...
80105e08:	e8 63 bd ff ff       	call   80101b70 <ilock>
  ip->nlink--;
80105e0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e10:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e14:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105e24:	e8 8b bb ff ff       	call   801019b4 <iupdate>
  iunlockput(ip);
80105e29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e2c:	89 04 24             	mov    %eax,(%esp)
80105e2f:	e8 c0 bf ff ff       	call   80101df4 <iunlockput>
  commit_trans();
80105e34:	e8 5c d7 ff ff       	call   80103595 <commit_trans>
  return -1;
...
80105e43:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105e46:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105e4d:	eb 4b                	jmp    80105e9a <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105e4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e52:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105e59:	00 
...
80105e6b:	e8 0d c2 ff ff       	call   8010207d <readi>
80105e70:	83 f8 10             	cmp    $0x10,%eax
80105e73:	74 0c                	je     80105e81 <isdirempty+0x41>
      panic("isdirempty: readi");
80105e75:	c7 04 24 7b 8d 10 80 	movl   $0x80108d7b,(%esp)
80105e7c:	e8 c5 a6 ff ff       	call   80100546 <panic>
    if(de.inum != 0)
80105e81:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105e85:	66 85 c0             	test   %ax,%ax
80105e88:	74 07                	je     80105e91 <isdirempty+0x51>
      return 0;
80105e8a:	b8 00 00 00 00       	mov    $0x0,%eax
80105e8f:	eb 1b                	jmp    80105eac <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105e94:	83 c0 10             	add    $0x10,%eax
80105e97:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e9a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e9d:	8b 45 08             	mov    0x8(%ebp),%eax
80105ea0:	8b 40 18             	mov    0x18(%eax),%eax
80105ea3:	39 c2                	cmp    %eax,%edx
80105ea5:	72 a8                	jb     80105e4f <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105eb1:	83 ec 48             	sub    $0x48,%esp
  ...
  if(argstr(0, &path) < 0)
80105eb4:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105eb7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ebb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ec2:	e8 35 fa ff ff       	call   801058fc <argstr>
80105ec7:	85 c0                	test   %eax,%eax
80105ec9:	79 0a                	jns    80105ed5 <sys_unlink+0x27>
    return -1;
80105ecb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ed0:	e9 aa 01 00 00       	jmp    8010607f <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105ed5:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105ed8:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105edb:	89 54 24 04          	mov    %edx,0x4(%esp)
80105edf:	89 04 24             	mov    %eax,(%esp)
80105ee2:	e8 6c c8 ff ff       	call   80102753 <nameiparent>
80105ee7:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105eea:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105eee:	75 0a                	jne    80105efa <sys_unlink+0x4c>
    return -1;
80105ef0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ef5:	e9 85 01 00 00       	jmp    8010607f <sys_unlink+0x1d1>

  begin_trans();
80105efa:	e8 4d d6 ff ff       	call   8010354c <begin_trans>

  ilock(dp);
80105eff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f02:	89 04 24             	mov    %eax,(%esp)
80105f05:	e8 66 bc ff ff       	call   80101b70 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105f0a:	c7 44 24 04 8d 8d 10 	movl   $0x80108d8d,0x4(%esp)
80105f11:	80 
80105f12:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f15:	89 04 24             	mov    %eax,(%esp)
80105f18:	e8 67 c4 ff ff       	call   80102384 <namecmp>
80105f1d:	85 c0                	test   %eax,%eax
80105f1f:	0f 84 45 01 00 00    	je     8010606a <sys_unlink+0x1bc>
80105f25:	c7 44 24 04 8f 8d 10 	movl   $0x80108d8f,0x4(%esp)
80105f2c:	80 
80105f2d:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f30:	89 04 24             	mov    %eax,(%esp)
80105f33:	e8 4c c4 ff ff       	call   80102384 <namecmp>
80105f38:	85 c0                	test   %eax,%eax
80105f3a:	0f 84 2a 01 00 00    	je     8010606a <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105f40:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105f43:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f47:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f4a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f51:	89 04 24             	mov    %eax,(%esp)
80105f54:	e8 4d c4 ff ff       	call   801023a6 <dirlookup>
80105f59:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f5c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f60:	0f 84 03 01 00 00    	je     80106069 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105f66:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f69:	89 04 24             	mov    %eax,(%esp)
80105f6c:	e8 ff bb ff ff       	call   80101b70 <ilock>

  if(ip->nlink < 1)
80105f71:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f74:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f78:	66 85 c0             	test   %ax,%ax
80105f7b:	7f 0c                	jg     80105f89 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105f7d:	c7 04 24 92 8d 10 80 	movl   $0x80108d92,(%esp)
80105f84:	e8 bd a5 ff ff       	call   80100546 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105f89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f8c:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f90:	66 83 f8 01          	cmp    $0x1,%ax
80105f94:	75 1f                	jne    80105fb5 <sys_unlink+0x107>
80105f96:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f99:	89 04 24             	mov    %eax,(%esp)
80105f9c:	e8 9f fe ff ff       	call   80105e40 <isdirempty>
80105fa1:	85 c0                	test   %eax,%eax
80105fa3:	75 10                	jne    80105fb5 <sys_unlink+0x107>
    iunlockput(ip);
80105fa5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa8:	89 04 24             	mov    %eax,(%esp)
80105fab:	e8 44 be ff ff       	call   80101df4 <iunlockput>
    goto bad;
80105fb0:	e9 b5 00 00 00       	jmp    8010606a <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105fb5:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105fbc:	00 
80105fbd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105fc4:	00 
80105fc5:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105fc8:	89 04 24             	mov    %eax,(%esp)
80105fcb:	e8 42 f5 ff ff       	call   80105512 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105fd0:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105fd3:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105fda:	00 
80105fdb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105fdf:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105fe2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fe6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fe9:	89 04 24             	mov    %eax,(%esp)
80105fec:	e8 fa c1 ff ff       	call   801021eb <writei>
80105ff1:	83 f8 10             	cmp    $0x10,%eax
80105ff4:	74 0c                	je     80106002 <sys_unlink+0x154>
    panic("unlink: writei");
80105ff6:	c7 04 24 a4 8d 10 80 	movl   $0x80108da4,(%esp)
80105ffd:	e8 44 a5 ff ff       	call   80100546 <panic>
  if(ip->type == T_DIR){
80106002:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106005:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106009:	66 83 f8 01          	cmp    $0x1,%ax
8010600d:	75 1c                	jne    8010602b <sys_unlink+0x17d>
    dp->nlink--;
8010600f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106012:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106016:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80106026:	e8 89 b9 ff ff       	call   801019b4 <iupdate>
  }
  iunlockput(dp);
8010602b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010602e:	89 04 24             	mov    %eax,(%esp)
80106031:	e8 be bd ff ff       	call   80101df4 <iunlockput>

  ip->nlink--;
80106036:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106039:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010603d:	8d 50 ff             	lea    -0x1(%eax),%edx
...
8010604d:	e8 62 b9 ff ff       	call   801019b4 <iupdate>
  iunlockput(ip);
80106052:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106055:	89 04 24             	mov    %eax,(%esp)
80106058:	e8 97 bd ff ff       	call   80101df4 <iunlockput>

  commit_trans();
8010605d:	e8 33 d5 ff ff       	call   80103595 <commit_trans>

  return 0;
80106062:	b8 00 00 00 00       	mov    $0x0,%eax
80106067:	eb 16                	jmp    8010607f <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106070:	e8 7f bd ff ff       	call   80101df4 <iunlockput>
  commit_trans();
80106075:	e8 1b d5 ff ff       	call   80103595 <commit_trans>
  return -1;
...
80106084:	83 ec 48             	sub    $0x48,%esp
80106087:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010608a:	8b 55 10             	mov    0x10(%ebp),%edx
8010608d:	8b 45 14             	mov    0x14(%ebp),%eax
80106090:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106094:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106098:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010609c:	8d 45 de             	lea    -0x22(%ebp),%eax
8010609f:	89 44 24 04          	mov    %eax,0x4(%esp)
801060a3:	8b 45 08             	mov    0x8(%ebp),%eax
801060a6:	89 04 24             	mov    %eax,(%esp)
801060a9:	e8 a5 c6 ff ff       	call   80102753 <nameiparent>
801060ae:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060b1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060b5:	75 0a                	jne    801060c1 <create+0x40>
    return 0;
801060b7:	b8 00 00 00 00       	mov    $0x0,%eax
801060bc:	e9 7e 01 00 00       	jmp    8010623f <create+0x1be>
  ilock(dp);
801060c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060c4:	89 04 24             	mov    %eax,(%esp)
801060c7:	e8 a4 ba ff ff       	call   80101b70 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801060cc:	8d 45 ec             	lea    -0x14(%ebp),%eax
801060cf:	89 44 24 08          	mov    %eax,0x8(%esp)
801060d3:	8d 45 de             	lea    -0x22(%ebp),%eax
801060d6:	89 44 24 04          	mov    %eax,0x4(%esp)
801060da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060dd:	89 04 24             	mov    %eax,(%esp)
801060e0:	e8 c1 c2 ff ff       	call   801023a6 <dirlookup>
801060e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060ec:	74 47                	je     80106135 <create+0xb4>
    iunlockput(dp);
801060ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060f1:	89 04 24             	mov    %eax,(%esp)
801060f4:	e8 fb bc ff ff       	call   80101df4 <iunlockput>
    ilock(ip);
801060f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060fc:	89 04 24             	mov    %eax,(%esp)
801060ff:	e8 6c ba ff ff       	call   80101b70 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80106104:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106109:	75 15                	jne    80106120 <create+0x9f>
8010610b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010610e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106112:	66 83 f8 02          	cmp    $0x2,%ax
80106116:	75 08                	jne    80106120 <create+0x9f>
      return ip;
80106118:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010611b:	e9 1f 01 00 00       	jmp    8010623f <create+0x1be>
    iunlockput(ip);
80106120:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106123:	89 04 24             	mov    %eax,(%esp)
80106126:	e8 c9 bc ff ff       	call   80101df4 <iunlockput>
    return 0;
8010612b:	b8 00 00 00 00       	mov    $0x0,%eax
80106130:	e9 0a 01 00 00       	jmp    8010623f <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106135:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106139:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613c:	8b 00                	mov    (%eax),%eax
8010613e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106142:	89 04 24             	mov    %eax,(%esp)
80106145:	e8 8b b7 ff ff       	call   801018d5 <ialloc>
8010614a:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010614d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106151:	75 0c                	jne    8010615f <create+0xde>
    panic("create: ialloc");
80106153:	c7 04 24 b3 8d 10 80 	movl   $0x80108db3,(%esp)
8010615a:	e8 e7 a3 ff ff       	call   80100546 <panic>

  ilock(ip);
8010615f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106162:	89 04 24             	mov    %eax,(%esp)
80106165:	e8 06 ba ff ff       	call   80101b70 <ilock>
  ip->major = major;
8010616a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010616d:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106171:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106175:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106178:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
8010617c:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106180:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106183:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106189:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618c:	89 04 24             	mov    %eax,(%esp)
8010618f:	e8 20 b8 ff ff       	call   801019b4 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106194:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106199:	75 6a                	jne    80106205 <create+0x184>
    dp->nlink++;  // for ".."
8010619b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010619e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801061a2:	8d 50 01             	lea    0x1(%eax),%edx
...
801061b2:	e8 fd b7 ff ff       	call   801019b4 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801061b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061ba:	8b 40 04             	mov    0x4(%eax),%eax
801061bd:	89 44 24 08          	mov    %eax,0x8(%esp)
801061c1:	c7 44 24 04 8d 8d 10 	movl   $0x80108d8d,0x4(%esp)
801061c8:	80 
801061c9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061cc:	89 04 24             	mov    %eax,(%esp)
801061cf:	e8 9a c2 ff ff       	call   8010246e <dirlink>
801061d4:	85 c0                	test   %eax,%eax
801061d6:	78 21                	js     801061f9 <create+0x178>
801061d8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061db:	8b 40 04             	mov    0x4(%eax),%eax
801061de:	89 44 24 08          	mov    %eax,0x8(%esp)
801061e2:	c7 44 24 04 8f 8d 10 	movl   $0x80108d8f,0x4(%esp)
801061e9:	80 
801061ea:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061ed:	89 04 24             	mov    %eax,(%esp)
801061f0:	e8 79 c2 ff ff       	call   8010246e <dirlink>
801061f5:	85 c0                	test   %eax,%eax
801061f7:	79 0c                	jns    80106205 <create+0x184>
      panic("create dots");
801061f9:	c7 04 24 c2 8d 10 80 	movl   $0x80108dc2,(%esp)
80106200:	e8 41 a3 ff ff       	call   80100546 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80106205:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106208:	8b 40 04             	mov    0x4(%eax),%eax
8010620b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010620f:	8d 45 de             	lea    -0x22(%ebp),%eax
80106212:	89 44 24 04          	mov    %eax,0x4(%esp)
80106216:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106219:	89 04 24             	mov    %eax,(%esp)
8010621c:	e8 4d c2 ff ff       	call   8010246e <dirlink>
80106221:	85 c0                	test   %eax,%eax
80106223:	79 0c                	jns    80106231 <create+0x1b0>
    panic("create: dirlink");
80106225:	c7 04 24 ce 8d 10 80 	movl   $0x80108dce,(%esp)
8010622c:	e8 15 a3 ff ff       	call   80100546 <panic>

  iunlockput(dp);
80106231:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106234:	89 04 24             	mov    %eax,(%esp)
80106237:	e8 b8 bb ff ff       	call   80101df4 <iunlockput>
...
80106244:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80106255:	e8 a2 f6 ff ff       	call   801058fc <argstr>
8010625a:	85 c0                	test   %eax,%eax
8010625c:	78 17                	js     80106275 <sys_open+0x34>
8010625e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106261:	89 44 24 04          	mov    %eax,0x4(%esp)
80106265:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010626c:	e8 f1 f5 ff ff       	call   80105862 <argint>
80106271:	85 c0                	test   %eax,%eax
80106273:	79 0a                	jns    8010627f <sys_open+0x3e>
    return -1;
80106275:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010627a:	e9 48 01 00 00       	jmp    801063c7 <sys_open+0x186>
  if(omode & O_CREATE){
8010627f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106282:	25 00 02 00 00       	and    $0x200,%eax
80106287:	85 c0                	test   %eax,%eax
80106289:	74 40                	je     801062cb <sys_open+0x8a>
    begin_trans();
8010628b:	e8 bc d2 ff ff       	call   8010354c <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106290:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106293:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010629a:	00 
8010629b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801062a2:	00 
801062a3:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801062aa:	00 
801062ab:	89 04 24             	mov    %eax,(%esp)
801062ae:	e8 ce fd ff ff       	call   80106081 <create>
801062b3:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801062b6:	e8 da d2 ff ff       	call   80103595 <commit_trans>
    if(ip == 0)
801062bb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062bf:	75 5c                	jne    8010631d <sys_open+0xdc>
      return -1;
801062c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062c6:	e9 fc 00 00 00       	jmp    801063c7 <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
801062cb:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062ce:	89 04 24             	mov    %eax,(%esp)
801062d1:	e8 5b c4 ff ff       	call   80102731 <namei>
801062d6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062d9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062dd:	75 0a                	jne    801062e9 <sys_open+0xa8>
      return -1;
801062df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e4:	e9 de 00 00 00       	jmp    801063c7 <sys_open+0x186>
    ilock(ip);
801062e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062ec:	89 04 24             	mov    %eax,(%esp)
801062ef:	e8 7c b8 ff ff       	call   80101b70 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801062f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062f7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062fb:	66 83 f8 01          	cmp    $0x1,%ax
801062ff:	75 1c                	jne    8010631d <sys_open+0xdc>
80106301:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106304:	85 c0                	test   %eax,%eax
80106306:	74 15                	je     8010631d <sys_open+0xdc>
      iunlockput(ip);
80106308:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010630b:	89 04 24             	mov    %eax,(%esp)
8010630e:	e8 e1 ba ff ff       	call   80101df4 <iunlockput>
      return -1;
80106313:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106318:	e9 aa 00 00 00       	jmp    801063c7 <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
8010631d:	e8 fe ae ff ff       	call   80101220 <filealloc>
80106322:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106325:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106329:	74 14                	je     8010633f <sys_open+0xfe>
8010632b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010632e:	89 04 24             	mov    %eax,(%esp)
80106331:	e8 43 f7 ff ff       	call   80105a79 <fdalloc>
80106336:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106339:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010633d:	79 23                	jns    80106362 <sys_open+0x121>
    if(f)
8010633f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106343:	74 0b                	je     80106350 <sys_open+0x10f>
      fileclose(f);
80106345:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106348:	89 04 24             	mov    %eax,(%esp)
8010634b:	e8 78 af ff ff       	call   801012c8 <fileclose>
    iunlockput(ip);
80106350:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106353:	89 04 24             	mov    %eax,(%esp)
80106356:	e8 99 ba ff ff       	call   80101df4 <iunlockput>
    return -1;
8010635b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106360:	eb 65                	jmp    801063c7 <sys_open+0x186>
  }
  iunlock(ip);
80106362:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106365:	89 04 24             	mov    %eax,(%esp)
80106368:	e8 51 b9 ff ff       	call   80101cbe <iunlock>

  f->type = FD_INODE;
8010636d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106370:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106376:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106379:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010637c:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010637f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106382:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106389:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010638c:	83 e0 01             	and    $0x1,%eax
8010638f:	85 c0                	test   %eax,%eax
80106391:	0f 94 c0             	sete   %al
80106394:	89 c2                	mov    %eax,%edx
80106396:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106399:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010639c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010639f:	83 e0 01             	and    $0x1,%eax
801063a2:	85 c0                	test   %eax,%eax
801063a4:	75 0a                	jne    801063b0 <sys_open+0x16f>
801063a6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063a9:	83 e0 02             	and    $0x2,%eax
801063ac:	85 c0                	test   %eax,%eax
801063ae:	74 07                	je     801063b7 <sys_open+0x176>
801063b0:	b8 01 00 00 00       	mov    $0x1,%eax
801063b5:	eb 05                	jmp    801063bc <sys_open+0x17b>
801063b7:	b8 00 00 00 00       	mov    $0x0,%eax
801063bc:	89 c2                	mov    %eax,%edx
801063be:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063c1:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801063cc:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
801063cf:	e8 78 d1 ff ff       	call   8010354c <begin_trans>
...
801063e2:	e8 15 f5 ff ff       	call   801058fc <argstr>
801063e7:	85 c0                	test   %eax,%eax
801063e9:	78 2c                	js     80106417 <sys_mkdir+0x4e>
801063eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063ee:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801063f5:	00 
801063f6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801063fd:	00 
801063fe:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106405:	00 
80106406:	89 04 24             	mov    %eax,(%esp)
80106409:	e8 73 fc ff ff       	call   80106081 <create>
8010640e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106411:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106415:	75 0c                	jne    80106423 <sys_mkdir+0x5a>
    commit_trans();
80106417:	e8 79 d1 ff ff       	call   80103595 <commit_trans>
    return -1;
8010641c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106421:	eb 15                	jmp    80106438 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106423:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106426:	89 04 24             	mov    %eax,(%esp)
80106429:	e8 c6 b9 ff ff       	call   80101df4 <iunlockput>
  commit_trans();
8010642e:	e8 62 d1 ff ff       	call   80103595 <commit_trans>
  return 0;
80106433:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106438:	c9                   	leave  
80106439:	c3                   	ret    
...
8010643d:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80106440:	e8 07 d1 ff ff       	call   8010354c <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80106445:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106448:	89 44 24 04          	mov    %eax,0x4(%esp)
8010644c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106453:	e8 a4 f4 ff ff       	call   801058fc <argstr>
80106458:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010645b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010645f:	78 5e                	js     801064bf <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106461:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106464:	89 44 24 04          	mov    %eax,0x4(%esp)
80106468:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010646f:	e8 ee f3 ff ff       	call   80105862 <argint>
  char *path;
  int len;
  int major, minor;
...
80106476:	78 47                	js     801064bf <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106478:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010647b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010647f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106486:	e8 d7 f3 ff ff       	call   80105862 <argint>
  int len;
  int major, minor;
...
8010648d:	78 30                	js     801064bf <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
8010648f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106492:	0f bf c8             	movswl %ax,%ecx
80106495:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106498:	0f bf d0             	movswl %ax,%edx
8010649b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010649e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801064a2:	89 54 24 08          	mov    %edx,0x8(%esp)
801064a6:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801064ad:	00 
801064ae:	89 04 24             	mov    %eax,(%esp)
801064b1:	e8 cb fb ff ff       	call   80106081 <create>
801064b6:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064b9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064bd:	75 0c                	jne    801064cb <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801064bf:	e8 d1 d0 ff ff       	call   80103595 <commit_trans>
    return -1;
801064c4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064c9:	eb 15                	jmp    801064e0 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801064cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064ce:	89 04 24             	mov    %eax,(%esp)
801064d1:	e8 1e b9 ff ff       	call   80101df4 <iunlockput>
  commit_trans();
801064d6:	e8 ba d0 ff ff       	call   80103595 <commit_trans>
  return 0;
...
801064f6:	e8 01 f4 ff ff       	call   801058fc <argstr>
801064fb:	85 c0                	test   %eax,%eax
801064fd:	78 14                	js     80106513 <sys_chdir+0x31>
801064ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106502:	89 04 24             	mov    %eax,(%esp)
80106505:	e8 27 c2 ff ff       	call   80102731 <namei>
8010650a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010650d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106511:	75 07                	jne    8010651a <sys_chdir+0x38>
    return -1;
80106513:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106518:	eb 57                	jmp    80106571 <sys_chdir+0x8f>
  ilock(ip);
8010651a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651d:	89 04 24             	mov    %eax,(%esp)
80106520:	e8 4b b6 ff ff       	call   80101b70 <ilock>
  if(ip->type != T_DIR){
80106525:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106528:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010652c:	66 83 f8 01          	cmp    $0x1,%ax
80106530:	74 12                	je     80106544 <sys_chdir+0x62>
    iunlockput(ip);
80106532:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106535:	89 04 24             	mov    %eax,(%esp)
80106538:	e8 b7 b8 ff ff       	call   80101df4 <iunlockput>
    return -1;
8010653d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106542:	eb 2d                	jmp    80106571 <sys_chdir+0x8f>
  }
  iunlock(ip);
80106544:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106547:	89 04 24             	mov    %eax,(%esp)
8010654a:	e8 6f b7 ff ff       	call   80101cbe <iunlock>
  iput(proc->cwd);
8010654f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106555:	8b 40 68             	mov    0x68(%eax),%eax
80106558:	89 04 24             	mov    %eax,(%esp)
8010655b:	e8 c3 b7 ff ff       	call   80101d23 <iput>
  proc->cwd = ip;
80106560:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106566:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106569:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106576:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010657c:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010657f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106583:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010658a:	e8 6d f3 ff ff       	call   801058fc <argstr>
8010658f:	85 c0                	test   %eax,%eax
80106591:	78 1a                	js     801065ad <sys_exec+0x3a>
80106593:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106599:	89 44 24 04          	mov    %eax,0x4(%esp)
8010659d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065a4:	e8 b9 f2 ff ff       	call   80105862 <argint>
801065a9:	85 c0                	test   %eax,%eax
801065ab:	79 0a                	jns    801065b7 <sys_exec+0x44>
    return -1;
801065ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065b2:	e9 de 00 00 00       	jmp    80106695 <sys_exec+0x122>
  }
  memset(argv, 0, sizeof(argv));
801065b7:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801065be:	00 
801065bf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801065c6:	00 
801065c7:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801065cd:	89 04 24             	mov    %eax,(%esp)
801065d0:	e8 3d ef ff ff       	call   80105512 <memset>
  for(i=0;; i++){
801065d5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801065dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065df:	83 f8 1f             	cmp    $0x1f,%eax
801065e2:	76 0a                	jbe    801065ee <sys_exec+0x7b>
      return -1;
801065e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065e9:	e9 a7 00 00 00       	jmp    80106695 <sys_exec+0x122>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
801065ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f1:	c1 e0 02             	shl    $0x2,%eax
801065f4:	89 c2                	mov    %eax,%edx
801065f6:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801065fc:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801065ff:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106605:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
8010660b:	89 54 24 08          	mov    %edx,0x8(%esp)
8010660f:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106613:	89 04 24             	mov    %eax,(%esp)
80106616:	e8 b5 f1 ff ff       	call   801057d0 <fetchint>
8010661b:	85 c0                	test   %eax,%eax
8010661d:	79 07                	jns    80106626 <sys_exec+0xb3>
      return -1;
8010661f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106624:	eb 6f                	jmp    80106695 <sys_exec+0x122>
    if(uarg == 0){
80106626:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010662c:	85 c0                	test   %eax,%eax
8010662e:	75 26                	jne    80106656 <sys_exec+0xe3>
      argv[i] = 0;
80106630:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106633:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010663a:	00 00 00 00 
      break;
8010663e:	90                   	nop
    }
...
80106642:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106648:	89 54 24 04          	mov    %edx,0x4(%esp)
8010664c:	89 04 24             	mov    %eax,(%esp)
8010664f:	e8 90 a7 ff ff       	call   80100de4 <exec>
80106654:	eb 3f                	jmp    80106695 <sys_exec+0x122>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010665f:	c1 e2 02             	shl    $0x2,%edx
80106662:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80106665:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
8010666b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106671:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106675:	89 54 24 04          	mov    %edx,0x4(%esp)
80106679:	89 04 24             	mov    %eax,(%esp)
8010667c:	e8 83 f1 ff ff       	call   80105804 <fetchstr>
80106681:	85 c0                	test   %eax,%eax
80106683:	79 07                	jns    8010668c <sys_exec+0x119>
      return -1;
80106685:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010668a:	eb 09                	jmp    80106695 <sys_exec+0x122>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010668c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
80106690:	e9 47 ff ff ff       	jmp    801065dc <sys_exec+0x69>
  return exec(path, argv);
}
80106695:	c9                   	leave  
80106696:	c3                   	ret    
...
8010669a:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
8010669d:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801066a4:	00 
801066a5:	8d 45 ec             	lea    -0x14(%ebp),%eax
801066a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801066ac:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066b3:	e8 e2 f1 ff ff       	call   8010589a <argptr>
801066b8:	85 c0                	test   %eax,%eax
801066ba:	79 0a                	jns    801066c6 <sys_pipe+0x2f>
    return -1;
801066bc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066c1:	e9 9b 00 00 00       	jmp    80106761 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801066c6:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801066c9:	89 44 24 04          	mov    %eax,0x4(%esp)
801066cd:	8d 45 e8             	lea    -0x18(%ebp),%eax
801066d0:	89 04 24             	mov    %eax,(%esp)
801066d3:	e8 98 d8 ff ff       	call   80103f70 <pipealloc>
801066d8:	85 c0                	test   %eax,%eax
801066da:	79 07                	jns    801066e3 <sys_pipe+0x4c>
    return -1;
801066dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066e1:	eb 7e                	jmp    80106761 <sys_pipe+0xca>
  fd0 = -1;
801066e3:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801066ea:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066ed:	89 04 24             	mov    %eax,(%esp)
801066f0:	e8 84 f3 ff ff       	call   80105a79 <fdalloc>
801066f5:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066f8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066fc:	78 14                	js     80106712 <sys_pipe+0x7b>
801066fe:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106701:	89 04 24             	mov    %eax,(%esp)
80106704:	e8 70 f3 ff ff       	call   80105a79 <fdalloc>
80106709:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010670c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106710:	79 37                	jns    80106749 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106712:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106716:	78 14                	js     8010672c <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106718:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010671e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106721:	83 c2 08             	add    $0x8,%edx
80106724:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
8010672b:	00 
    fileclose(rf);
8010672c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010672f:	89 04 24             	mov    %eax,(%esp)
80106732:	e8 91 ab ff ff       	call   801012c8 <fileclose>
    fileclose(wf);
80106737:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010673a:	89 04 24             	mov    %eax,(%esp)
8010673d:	e8 86 ab ff ff       	call   801012c8 <fileclose>
    return -1;
80106742:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106747:	eb 18                	jmp    80106761 <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106749:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010674c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010674f:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106751:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106754:	8d 50 04             	lea    0x4(%eax),%edx
80106757:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010675a:	89 02                	mov    %eax,(%edx)
  return 0;
...
80106767:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010676a:	e8 c2 de ff ff       	call   80104631 <fork>
}
8010676f:	c9                   	leave  
80106770:	c3                   	ret    
...
80106774:	83 ec 08             	sub    $0x8,%esp
  exit();
80106777:	e8 56 e0 ff ff       	call   801047d2 <exit>
...
80106786:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106789:	e8 99 e1 ff ff       	call   80104927 <wait>
}
8010678e:	c9                   	leave  
8010678f:	c3                   	ret    
...
80106793:	83 ec 28             	sub    $0x28,%esp
  char *rtime=0;
80106796:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  char *wtime=0;
8010679d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  argptr(1,&rtime,sizeof(rtime));
801067a4:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801067ab:	00 
801067ac:	8d 45 f4             	lea    -0xc(%ebp),%eax
801067af:	89 44 24 04          	mov    %eax,0x4(%esp)
801067b3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801067ba:	e8 db f0 ff ff       	call   8010589a <argptr>
  argptr(0,&wtime,sizeof(wtime));
801067bf:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801067c6:	00 
801067c7:	8d 45 f0             	lea    -0x10(%ebp),%eax
801067ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801067ce:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067d5:	e8 c0 f0 ff ff       	call   8010589a <argptr>
...
801067e7:	e8 4d e2 ff ff       	call   80104a39 <wait2>
}
801067ec:	c9                   	leave  
801067ed:	c3                   	ret    
...
801067f1:	83 ec 08             	sub    $0x8,%esp
  return nice();
801067f4:	e8 c9 e9 ff ff       	call   801051c2 <nice>
}
801067f9:	c9                   	leave  
801067fa:	c3                   	ret    
...
801067fe:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0)
80106801:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106804:	89 44 24 04          	mov    %eax,0x4(%esp)
80106808:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010680f:	e8 4e f0 ff ff       	call   80105862 <argint>
80106814:	85 c0                	test   %eax,%eax
80106816:	79 07                	jns    8010681f <sys_kill+0x24>
    return -1;
80106818:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010681d:	eb 0b                	jmp    8010682a <sys_kill+0x2f>
  return kill(pid);
8010681f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106822:	89 04 24             	mov    %eax,(%esp)
80106825:	e8 21 e8 ff ff       	call   8010504b <kill>
}
8010682a:	c9                   	leave  
8010682b:	c3                   	ret    
...
80106835:	8b 40 10             	mov    0x10(%eax),%eax
}
80106838:	5d                   	pop    %ebp
80106839:	c3                   	ret    
...
8010684e:	e8 0f f0 ff ff       	call   80105862 <argint>
80106853:	85 c0                	test   %eax,%eax
80106855:	79 07                	jns    8010685e <sys_sbrk+0x24>
    return -1;
80106857:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010685c:	eb 24                	jmp    80106882 <sys_sbrk+0x48>
  addr = proc->sz;
...
8010686f:	e8 18 dd ff ff       	call   8010458c <growproc>
80106874:	85 c0                	test   %eax,%eax
80106876:	79 07                	jns    8010687f <sys_sbrk+0x45>
    return -1;
80106878:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010687d:	eb 03                	jmp    80106882 <sys_sbrk+0x48>
  return addr;
...
80106887:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
8010688a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010688d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106891:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106898:	e8 c5 ef ff ff       	call   80105862 <argint>
8010689d:	85 c0                	test   %eax,%eax
8010689f:	79 07                	jns    801068a8 <sys_sleep+0x24>
    return -1;
801068a1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068a6:	eb 6c                	jmp    80106914 <sys_sleep+0x90>
  acquire(&tickslock);
801068a8:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
801068af:	e8 03 ea ff ff       	call   801052b7 <acquire>
  ticks0 = ticks;
801068b4:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
801068b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801068bc:	eb 34                	jmp    801068f2 <sys_sleep+0x6e>
    if(proc->killed){
801068be:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068c4:	8b 40 24             	mov    0x24(%eax),%eax
801068c7:	85 c0                	test   %eax,%eax
801068c9:	74 13                	je     801068de <sys_sleep+0x5a>
      release(&tickslock);
801068cb:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
801068d2:	e8 42 ea ff ff       	call   80105319 <release>
      return -1;
801068d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068dc:	eb 36                	jmp    80106914 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801068de:	c7 44 24 04 80 35 11 	movl   $0x80113580,0x4(%esp)
801068e5:	80 
801068e6:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
801068ed:	e8 52 e6 ff ff       	call   80104f44 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801068f2:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
801068f7:	89 c2                	mov    %eax,%edx
801068f9:	2b 55 f4             	sub    -0xc(%ebp),%edx
801068fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068ff:	39 c2                	cmp    %eax,%edx
80106901:	72 bb                	jb     801068be <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106903:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
8010690a:	e8 0a ea ff ff       	call   80105319 <release>
  return 0;
8010690f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106914:	c9                   	leave  
80106915:	c3                   	ret    
...
80106919:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
8010691c:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80106923:	e8 8f e9 ff ff       	call   801052b7 <acquire>
  xticks = ticks;
80106928:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
8010692d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106930:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80106937:	e8 dd e9 ff ff       	call   80105319 <release>
  return xticks;
8010693c:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
8010693f:	c9                   	leave  
80106940:	c3                   	ret    
80106941:	66 90                	xchg   %ax,%ax
80106943:	90                   	nop
...
8010694d:	8b 45 0c             	mov    0xc(%ebp),%eax
80106950:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106954:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106957:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010695b:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
8010695f:	ee                   	out    %al,(%dx)
}
80106960:	c9                   	leave  
80106961:	c3                   	ret    
...
80106965:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106968:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010696f:	00 
80106970:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106977:	e8 c8 ff ff ff       	call   80106944 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010697c:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106983:	00 
80106984:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010698b:	e8 b4 ff ff ff       	call   80106944 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106990:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106997:	00 
80106998:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010699f:	e8 a0 ff ff ff       	call   80106944 <outb>
  picenable(IRQ_TIMER);
801069a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069ab:	e8 49 d4 ff ff       	call   80103df9 <picenable>
}
801069b0:	c9                   	leave  
801069b1:	c3                   	ret    
...
801069c1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801069c3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801069c7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801069c9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801069cb:	54                   	push   %esp
  call trap
801069cc:	e8 de 01 00 00       	call   80106baf <trap>
  addl $4, %esp
801069d1:	83 c4 04             	add    $0x4,%esp
...
801069d4:	61                   	popa   
  popl %gs
801069d5:	0f a9                	pop    %gs
  popl %fs
801069d7:	0f a1                	pop    %fs
  popl %es
801069d9:	07                   	pop    %es
  popl %ds
801069da:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801069db:	83 c4 08             	add    $0x8,%esp
  iret
801069de:	cf                   	iret   
801069df:	90                   	nop
...
801069e3:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801069e6:	8b 45 0c             	mov    0xc(%ebp),%eax
801069e9:	83 e8 01             	sub    $0x1,%eax
801069ec:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801069f0:	8b 45 08             	mov    0x8(%ebp),%eax
801069f3:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801069f7:	8b 45 08             	mov    0x8(%ebp),%eax
801069fa:	c1 e8 10             	shr    $0x10,%eax
801069fd:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106a01:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106a04:	0f 01 18             	lidtl  (%eax)
}
80106a07:	c9                   	leave  
80106a08:	c3                   	ret    
...
80106a0d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106a10:	0f 20 d3             	mov    %cr2,%ebx
80106a13:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106a16:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106a22:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106a25:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a2c:	e9 c3 00 00 00       	jmp    80106af4 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106a31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a34:	8b 04 85 a0 c0 10 80 	mov    -0x7fef3f60(,%eax,4),%eax
80106a3b:	89 c2                	mov    %eax,%edx
80106a3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a40:	66 89 14 c5 c0 35 11 	mov    %dx,-0x7feeca40(,%eax,8)
80106a47:	80 
80106a48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a4b:	66 c7 04 c5 c2 35 11 	movw   $0x8,-0x7feeca3e(,%eax,8)
80106a52:	80 08 00 
80106a55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a58:	0f b6 14 c5 c4 35 11 	movzbl -0x7feeca3c(,%eax,8),%edx
80106a5f:	80 
80106a60:	83 e2 e0             	and    $0xffffffe0,%edx
80106a63:	88 14 c5 c4 35 11 80 	mov    %dl,-0x7feeca3c(,%eax,8)
80106a6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a6d:	0f b6 14 c5 c4 35 11 	movzbl -0x7feeca3c(,%eax,8),%edx
80106a74:	80 
80106a75:	83 e2 1f             	and    $0x1f,%edx
80106a78:	88 14 c5 c4 35 11 80 	mov    %dl,-0x7feeca3c(,%eax,8)
80106a7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a82:	0f b6 14 c5 c5 35 11 	movzbl -0x7feeca3b(,%eax,8),%edx
80106a89:	80 
80106a8a:	83 e2 f0             	and    $0xfffffff0,%edx
80106a8d:	83 ca 0e             	or     $0xe,%edx
80106a90:	88 14 c5 c5 35 11 80 	mov    %dl,-0x7feeca3b(,%eax,8)
80106a97:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a9a:	0f b6 14 c5 c5 35 11 	movzbl -0x7feeca3b(,%eax,8),%edx
80106aa1:	80 
80106aa2:	83 e2 ef             	and    $0xffffffef,%edx
80106aa5:	88 14 c5 c5 35 11 80 	mov    %dl,-0x7feeca3b(,%eax,8)
80106aac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aaf:	0f b6 14 c5 c5 35 11 	movzbl -0x7feeca3b(,%eax,8),%edx
80106ab6:	80 
80106ab7:	83 e2 9f             	and    $0xffffff9f,%edx
80106aba:	88 14 c5 c5 35 11 80 	mov    %dl,-0x7feeca3b(,%eax,8)
80106ac1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ac4:	0f b6 14 c5 c5 35 11 	movzbl -0x7feeca3b(,%eax,8),%edx
80106acb:	80 
80106acc:	83 ca 80             	or     $0xffffff80,%edx
80106acf:	88 14 c5 c5 35 11 80 	mov    %dl,-0x7feeca3b(,%eax,8)
80106ad6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad9:	8b 04 85 a0 c0 10 80 	mov    -0x7fef3f60(,%eax,4),%eax
80106ae0:	c1 e8 10             	shr    $0x10,%eax
80106ae3:	89 c2                	mov    %eax,%edx
80106ae5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ae8:	66 89 14 c5 c6 35 11 	mov    %dx,-0x7feeca3a(,%eax,8)
80106aef:	80 
void
tvinit(void)
{
...
80106af4:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106afb:	0f 8e 30 ff ff ff    	jle    80106a31 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106b01:	a1 a0 c1 10 80       	mov    0x8010c1a0,%eax
80106b06:	66 a3 c0 37 11 80    	mov    %ax,0x801137c0
80106b0c:	66 c7 05 c2 37 11 80 	movw   $0x8,0x801137c2
80106b13:	08 00 
80106b15:	0f b6 05 c4 37 11 80 	movzbl 0x801137c4,%eax
80106b1c:	83 e0 e0             	and    $0xffffffe0,%eax
80106b1f:	a2 c4 37 11 80       	mov    %al,0x801137c4
80106b24:	0f b6 05 c4 37 11 80 	movzbl 0x801137c4,%eax
80106b2b:	83 e0 1f             	and    $0x1f,%eax
80106b2e:	a2 c4 37 11 80       	mov    %al,0x801137c4
80106b33:	0f b6 05 c5 37 11 80 	movzbl 0x801137c5,%eax
80106b3a:	83 c8 0f             	or     $0xf,%eax
80106b3d:	a2 c5 37 11 80       	mov    %al,0x801137c5
80106b42:	0f b6 05 c5 37 11 80 	movzbl 0x801137c5,%eax
80106b49:	83 e0 ef             	and    $0xffffffef,%eax
80106b4c:	a2 c5 37 11 80       	mov    %al,0x801137c5
80106b51:	0f b6 05 c5 37 11 80 	movzbl 0x801137c5,%eax
80106b58:	83 c8 60             	or     $0x60,%eax
80106b5b:	a2 c5 37 11 80       	mov    %al,0x801137c5
80106b60:	0f b6 05 c5 37 11 80 	movzbl 0x801137c5,%eax
80106b67:	83 c8 80             	or     $0xffffff80,%eax
80106b6a:	a2 c5 37 11 80       	mov    %al,0x801137c5
80106b6f:	a1 a0 c1 10 80       	mov    0x8010c1a0,%eax
80106b74:	c1 e8 10             	shr    $0x10,%eax
80106b77:	66 a3 c6 37 11 80    	mov    %ax,0x801137c6
  
  initlock(&tickslock, "time");
80106b7d:	c7 44 24 04 e0 8d 10 	movl   $0x80108de0,0x4(%esp)
80106b84:	80 
80106b85:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80106b8c:	e8 05 e7 ff ff       	call   80105296 <initlock>
}
80106b91:	c9                   	leave  
80106b92:	c3                   	ret    
...
80106b96:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106b99:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106ba0:	00 
80106ba1:	c7 04 24 c0 35 11 80 	movl   $0x801135c0,(%esp)
80106ba8:	e8 33 fe ff ff       	call   801069e0 <lidt>
}
80106bad:	c9                   	leave  
80106bae:	c3                   	ret    
...
80106bb2:	57                   	push   %edi
80106bb3:	56                   	push   %esi
80106bb4:	53                   	push   %ebx
80106bb5:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106bb8:	8b 45 08             	mov    0x8(%ebp),%eax
80106bbb:	8b 40 30             	mov    0x30(%eax),%eax
80106bbe:	83 f8 40             	cmp    $0x40,%eax
80106bc1:	75 3e                	jne    80106c01 <trap+0x52>
    if(proc->killed)
80106bc3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bc9:	8b 40 24             	mov    0x24(%eax),%eax
80106bcc:	85 c0                	test   %eax,%eax
80106bce:	74 05                	je     80106bd5 <trap+0x26>
      exit();
80106bd0:	e8 fd db ff ff       	call   801047d2 <exit>
    proc->tf = tf;
80106bd5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bdb:	8b 55 08             	mov    0x8(%ebp),%edx
80106bde:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106be1:	e8 59 ed ff ff       	call   8010593f <syscall>
    if(proc->killed)
80106be6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bec:	8b 40 24             	mov    0x24(%eax),%eax
80106bef:	85 c0                	test   %eax,%eax
80106bf1:	0f 84 78 02 00 00    	je     80106e6f <trap+0x2c0>
      exit();
80106bf7:	e8 d6 db ff ff       	call   801047d2 <exit>
    return;
80106bfc:	e9 6e 02 00 00       	jmp    80106e6f <trap+0x2c0>
  }

  switch(tf->trapno){
80106c01:	8b 45 08             	mov    0x8(%ebp),%eax
80106c04:	8b 40 30             	mov    0x30(%eax),%eax
80106c07:	83 e8 20             	sub    $0x20,%eax
80106c0a:	83 f8 1f             	cmp    $0x1f,%eax
80106c0d:	0f 87 f0 00 00 00    	ja     80106d03 <trap+0x154>
80106c13:	8b 04 85 88 8e 10 80 	mov    -0x7fef7178(,%eax,4),%eax
80106c1a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106c1c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106c22:	0f b6 00             	movzbl (%eax),%eax
80106c25:	84 c0                	test   %al,%al
80106c27:	75 65                	jne    80106c8e <trap+0xdf>
      acquire(&tickslock);
80106c29:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80106c30:	e8 82 e6 ff ff       	call   801052b7 <acquire>
      ticks++;
80106c35:	a1 c0 3d 11 80       	mov    0x80113dc0,%eax
80106c3a:	83 c0 01             	add    $0x1,%eax
80106c3d:	a3 c0 3d 11 80       	mov    %eax,0x80113dc0
      if(proc)
80106c42:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c48:	85 c0                	test   %eax,%eax
80106c4a:	74 2a                	je     80106c76 <trap+0xc7>
      {
	proc->rtime++;
80106c4c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c52:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80106c58:	83 c2 01             	add    $0x1,%edx
80106c5b:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
	proc->quanta--;
80106c61:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c67:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80106c6d:	83 ea 01             	sub    $0x1,%edx
80106c70:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
      }
      wakeup(&ticks);
80106c76:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
80106c7d:	e8 9e e3 ff ff       	call   80105020 <wakeup>
      release(&tickslock);
80106c82:	c7 04 24 80 35 11 80 	movl   $0x80113580,(%esp)
80106c89:	e8 8b e6 ff ff       	call   80105319 <release>
    }
    lapiceoi();
80106c8e:	e8 82 c5 ff ff       	call   80103215 <lapiceoi>
    break;
80106c93:	e9 41 01 00 00       	jmp    80106dd9 <trap+0x22a>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106c98:	e8 7c bd ff ff       	call   80102a19 <ideintr>
    lapiceoi();
80106c9d:	e8 73 c5 ff ff       	call   80103215 <lapiceoi>
    break;
80106ca2:	e9 32 01 00 00       	jmp    80106dd9 <trap+0x22a>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106ca7:	e8 45 c3 ff ff       	call   80102ff1 <kbdintr>
    lapiceoi();
80106cac:	e8 64 c5 ff ff       	call   80103215 <lapiceoi>
    break;
80106cb1:	e9 23 01 00 00       	jmp    80106dd9 <trap+0x22a>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106cb6:	e8 b9 03 00 00       	call   80107074 <uartintr>
    lapiceoi();
80106cbb:	e8 55 c5 ff ff       	call   80103215 <lapiceoi>
    break;
80106cc0:	e9 14 01 00 00       	jmp    80106dd9 <trap+0x22a>
  case T_IRQ0 + 7:
...
80106cc5:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106cc8:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80106cce:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106cd2:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106ce1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106ce5:	89 54 24 08          	mov    %edx,0x8(%esp)
80106ce9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ced:	c7 04 24 e8 8d 10 80 	movl   $0x80108de8,(%esp)
80106cf4:	e8 b1 96 ff ff       	call   801003aa <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106cf9:	e8 17 c5 ff ff       	call   80103215 <lapiceoi>
    break;
80106cfe:	e9 d6 00 00 00       	jmp    80106dd9 <trap+0x22a>
...
80106d0b:	74 11                	je     80106d1e <trap+0x16f>
...
80106d1c:	75 46                	jne    80106d64 <trap+0x1b5>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106d1e:	e8 e6 fc ff ff       	call   80106a09 <rcr2>
...
80106d23:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106d26:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106d29:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106d30:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106d33:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106d36:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106d39:	8b 52 30             	mov    0x30(%edx),%edx
80106d3c:	89 44 24 10          	mov    %eax,0x10(%esp)
80106d40:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106d44:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106d48:	89 54 24 04          	mov    %edx,0x4(%esp)
80106d4c:	c7 04 24 0c 8e 10 80 	movl   $0x80108e0c,(%esp)
80106d53:	e8 52 96 ff ff       	call   801003aa <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106d58:	c7 04 24 3e 8e 10 80 	movl   $0x80108e3e,(%esp)
80106d5f:	e8 e2 97 ff ff       	call   80100546 <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d64:	e8 a0 fc ff ff       	call   80106a09 <rcr2>
80106d69:	89 c2                	mov    %eax,%edx
...
80106d6b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d6e:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
80106d77:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d7a:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106d7d:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d80:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106d83:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d86:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106d89:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106d8f:	83 c0 6c             	add    $0x6c,%eax
...
80106d95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106d9b:	8b 40 10             	mov    0x10(%eax),%eax
80106d9e:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106da2:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106da6:	89 74 24 14          	mov    %esi,0x14(%esp)
80106daa:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106dae:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106db2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106db5:	89 54 24 08          	mov    %edx,0x8(%esp)
80106db9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106dbd:	c7 04 24 44 8e 10 80 	movl   $0x80108e44,(%esp)
80106dc4:	e8 e1 95 ff ff       	call   801003aa <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106dc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106dcf:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106dd6:	eb 01                	jmp    80106dd9 <trap+0x22a>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106de1:	74 24                	je     80106e07 <trap+0x258>
80106de3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106de9:	8b 40 24             	mov    0x24(%eax),%eax
80106dec:	85 c0                	test   %eax,%eax
80106dee:	74 17                	je     80106e07 <trap+0x258>
80106df0:	8b 45 08             	mov    0x8(%ebp),%eax
80106df3:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106df7:	0f b7 c0             	movzwl %ax,%eax
80106dfa:	83 e0 03             	and    $0x3,%eax
80106dfd:	83 f8 03             	cmp    $0x3,%eax
80106e00:	75 05                	jne    80106e07 <trap+0x258>
    exit();
80106e02:	e8 cb d9 ff ff       	call   801047d2 <exit>
...
80106e0f:	74 2e                	je     80106e3f <trap+0x290>
80106e11:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e17:	8b 40 0c             	mov    0xc(%eax),%eax
80106e1a:	83 f8 04             	cmp    $0x4,%eax
80106e1d:	75 20                	jne    80106e3f <trap+0x290>
80106e1f:	8b 45 08             	mov    0x8(%ebp),%eax
80106e22:	8b 40 30             	mov    0x30(%eax),%eax
80106e25:	83 f8 20             	cmp    $0x20,%eax
80106e28:	75 15                	jne    80106e3f <trap+0x290>
80106e2a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e30:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80106e36:	85 c0                	test   %eax,%eax
80106e38:	7f 05                	jg     80106e3f <trap+0x290>
    yield();
80106e3a:	e8 a6 e0 ff ff       	call   80104ee5 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106e3f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e45:	85 c0                	test   %eax,%eax
80106e47:	74 27                	je     80106e70 <trap+0x2c1>
80106e49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e4f:	8b 40 24             	mov    0x24(%eax),%eax
80106e52:	85 c0                	test   %eax,%eax
80106e54:	74 1a                	je     80106e70 <trap+0x2c1>
...
80106e66:	75 08                	jne    80106e70 <trap+0x2c1>
    exit();
80106e68:	e8 65 d9 ff ff       	call   801047d2 <exit>
80106e6d:	eb 01                	jmp    80106e70 <trap+0x2c1>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106e70:	83 c4 3c             	add    $0x3c,%esp
80106e73:	5b                   	pop    %ebx
80106e74:	5e                   	pop    %esi
80106e75:	5f                   	pop    %edi
80106e76:	5d                   	pop    %ebp
...
80106e82:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106e86:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106e8a:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106e8e:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106e92:	ec                   	in     (%dx),%al
80106e93:	89 c3                	mov    %eax,%ebx
80106e95:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106e98:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
...
outb(ushort port, uchar data)
{
80106ea2:	55                   	push   %ebp
80106ea3:	89 e5                	mov    %esp,%ebp
80106ea5:	83 ec 08             	sub    $0x8,%esp
80106ea8:	8b 55 08             	mov    0x8(%ebp),%edx
80106eab:	8b 45 0c             	mov    0xc(%ebp),%eax
80106eae:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106eb2:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106eb5:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106eb9:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106ec3:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106ec6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ecd:	00 
80106ece:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106ed5:	e8 c8 ff ff ff       	call   80106ea2 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106eda:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106ee1:	00 
80106ee2:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106ee9:	e8 b4 ff ff ff       	call   80106ea2 <outb>
  outb(COM1+0, 115200/9600);
80106eee:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106ef5:	00 
80106ef6:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106efd:	e8 a0 ff ff ff       	call   80106ea2 <outb>
  outb(COM1+1, 0);
80106f02:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f09:	00 
80106f0a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106f11:	e8 8c ff ff ff       	call   80106ea2 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106f16:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106f1d:	00 
80106f1e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106f25:	e8 78 ff ff ff       	call   80106ea2 <outb>
  outb(COM1+4, 0);
80106f2a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f31:	00 
80106f32:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106f39:	e8 64 ff ff ff       	call   80106ea2 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106f3e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106f45:	00 
80106f46:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106f4d:	e8 50 ff ff ff       	call   80106ea2 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106f52:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106f59:	e8 1a ff ff ff       	call   80106e78 <inb>
80106f5e:	3c ff                	cmp    $0xff,%al
80106f60:	74 6c                	je     80106fce <uartinit+0x10e>
    return;
  uart = 1;
80106f62:	c7 05 4c c6 10 80 01 	movl   $0x1,0x8010c64c
80106f69:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106f6c:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106f73:	e8 00 ff ff ff       	call   80106e78 <inb>
  inb(COM1+0);
80106f78:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106f7f:	e8 f4 fe ff ff       	call   80106e78 <inb>
  picenable(IRQ_COM1);
80106f84:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106f8b:	e8 69 ce ff ff       	call   80103df9 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106f90:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106f97:	00 
80106f98:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106f9f:	e8 fa bc ff ff       	call   80102c9e <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106fa4:	c7 45 f4 08 8f 10 80 	movl   $0x80108f08,-0xc(%ebp)
80106fab:	eb 15                	jmp    80106fc2 <uartinit+0x102>
    uartputc(*p);
80106fad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106fb0:	0f b6 00             	movzbl (%eax),%eax
80106fb3:	0f be c0             	movsbl %al,%eax
80106fb6:	89 04 24             	mov    %eax,(%esp)
80106fb9:	e8 13 00 00 00       	call   80106fd1 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106fc5:	0f b6 00             	movzbl (%eax),%eax
80106fc8:	84 c0                	test   %al,%al
80106fca:	75 e1                	jne    80106fad <uartinit+0xed>
80106fcc:	eb 01                	jmp    80106fcf <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106fd4:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106fd7:	a1 4c c6 10 80       	mov    0x8010c64c,%eax
80106fdc:	85 c0                	test   %eax,%eax
80106fde:	74 4d                	je     8010702d <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106fe0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106fe7:	eb 10                	jmp    80106ff9 <uartputc+0x28>
    microdelay(10);
80106fe9:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106ff0:	e8 45 c2 ff ff       	call   8010323a <microdelay>
{
  int i;
...
80107026:	e8 77 fe ff ff       	call   80106ea2 <outb>
8010702b:	eb 01                	jmp    8010702e <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80107033:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80107036:	a1 4c c6 10 80       	mov    0x8010c64c,%eax
8010703b:	85 c0                	test   %eax,%eax
8010703d:	75 07                	jne    80107046 <uartgetc+0x16>
    return -1;
8010703f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107044:	eb 2c                	jmp    80107072 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80107046:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010704d:	e8 26 fe ff ff       	call   80106e78 <inb>
80107052:	0f b6 c0             	movzbl %al,%eax
80107055:	83 e0 01             	and    $0x1,%eax
80107058:	85 c0                	test   %eax,%eax
8010705a:	75 07                	jne    80107063 <uartgetc+0x33>
    return -1;
8010705c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107061:	eb 0f                	jmp    80107072 <uartgetc+0x42>
  return inb(COM1+0);
80107063:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010706a:	e8 09 fe ff ff       	call   80106e78 <inb>
...
8010707a:	c7 04 24 30 70 10 80 	movl   $0x80107030,(%esp)
80107081:	e8 f5 97 ff ff       	call   8010087b <consoleintr>
}
80107086:	c9                   	leave  
80107087:	c3                   	ret    
...
8010708a:	6a 00                	push   $0x0
  jmp alltraps
8010708c:	e9 23 f9 ff ff       	jmp    801069b4 <alltraps>
...
80107093:	6a 01                	push   $0x1
  jmp alltraps
80107095:	e9 1a f9 ff ff       	jmp    801069b4 <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $2
8010709c:	6a 02                	push   $0x2
  jmp alltraps
8010709e:	e9 11 f9 ff ff       	jmp    801069b4 <alltraps>
...
801070a3:	6a 00                	push   $0x0
  pushl $3
801070a5:	6a 03                	push   $0x3
  jmp alltraps
801070a7:	e9 08 f9 ff ff       	jmp    801069b4 <alltraps>
...
801070ae:	6a 04                	push   $0x4
  jmp alltraps
801070b0:	e9 ff f8 ff ff       	jmp    801069b4 <alltraps>
...
801070b5:	6a 00                	push   $0x0
  pushl $5
801070b7:	6a 05                	push   $0x5
  jmp alltraps
801070b9:	e9 f6 f8 ff ff       	jmp    801069b4 <alltraps>
...
801070c0:	6a 06                	push   $0x6
  jmp alltraps
801070c2:	e9 ed f8 ff ff       	jmp    801069b4 <alltraps>
...
801070c7:	6a 00                	push   $0x0
  pushl $7
801070c9:	6a 07                	push   $0x7
  jmp alltraps
801070cb:	e9 e4 f8 ff ff       	jmp    801069b4 <alltraps>

801070d0 <vector8>:
.globl vector8
vector8:
  pushl $8
801070d0:	6a 08                	push   $0x8
  jmp alltraps
801070d2:	e9 dd f8 ff ff       	jmp    801069b4 <alltraps>
...
801070d7:	6a 00                	push   $0x0
  pushl $9
801070d9:	6a 09                	push   $0x9
  jmp alltraps
801070db:	e9 d4 f8 ff ff       	jmp    801069b4 <alltraps>

801070e0 <vector10>:
.globl vector10
vector10:
  pushl $10
801070e0:	6a 0a                	push   $0xa
  jmp alltraps
801070e2:	e9 cd f8 ff ff       	jmp    801069b4 <alltraps>

801070e7 <vector11>:
.globl vector11
vector11:
  pushl $11
801070e7:	6a 0b                	push   $0xb
  jmp alltraps
801070e9:	e9 c6 f8 ff ff       	jmp    801069b4 <alltraps>

801070ee <vector12>:
.globl vector12
vector12:
  pushl $12
801070ee:	6a 0c                	push   $0xc
  jmp alltraps
801070f0:	e9 bf f8 ff ff       	jmp    801069b4 <alltraps>

801070f5 <vector13>:
.globl vector13
vector13:
  pushl $13
801070f5:	6a 0d                	push   $0xd
  jmp alltraps
801070f7:	e9 b8 f8 ff ff       	jmp    801069b4 <alltraps>

801070fc <vector14>:
.globl vector14
vector14:
  pushl $14
801070fc:	6a 0e                	push   $0xe
  jmp alltraps
801070fe:	e9 b1 f8 ff ff       	jmp    801069b4 <alltraps>
...
80107103:	6a 00                	push   $0x0
  pushl $15
80107105:	6a 0f                	push   $0xf
  jmp alltraps
80107107:	e9 a8 f8 ff ff       	jmp    801069b4 <alltraps>
...
8010710c:	6a 00                	push   $0x0
  pushl $16
8010710e:	6a 10                	push   $0x10
  jmp alltraps
80107110:	e9 9f f8 ff ff       	jmp    801069b4 <alltraps>

80107115 <vector17>:
.globl vector17
vector17:
  pushl $17
80107115:	6a 11                	push   $0x11
  jmp alltraps
...
80107377:	6a 00                	push   $0x0
  pushl $85
80107379:	6a 55                	push   $0x55
  jmp alltraps
8010737b:	e9 34 f6 ff ff       	jmp    801069b4 <alltraps>
...
80107380:	6a 00                	push   $0x0
  pushl $86
80107382:	6a 56                	push   $0x56
  jmp alltraps
80107384:	e9 2b f6 ff ff       	jmp    801069b4 <alltraps>
...
80107389:	6a 00                	push   $0x0
  pushl $87
8010738b:	6a 57                	push   $0x57
  jmp alltraps
8010738d:	e9 22 f6 ff ff       	jmp    801069b4 <alltraps>
...
8010739b:	6a 00                	push   $0x0
  pushl $89
8010739d:	6a 59                	push   $0x59
  jmp alltraps
8010739f:	e9 10 f6 ff ff       	jmp    801069b4 <alltraps>
...
801073a4:	6a 00                	push   $0x0
  pushl $90
801073a6:	6a 5a                	push   $0x5a
  jmp alltraps
801073a8:	e9 07 f6 ff ff       	jmp    801069b4 <alltraps>
...
801073ad:	6a 00                	push   $0x0
  pushl $91
801073af:	6a 5b                	push   $0x5b
  jmp alltraps
801073b1:	e9 fe f5 ff ff       	jmp    801069b4 <alltraps>
...
801073bf:	6a 00                	push   $0x0
  pushl $93
801073c1:	6a 5d                	push   $0x5d
  jmp alltraps
801073c3:	e9 ec f5 ff ff       	jmp    801069b4 <alltraps>
...
801073c8:	6a 00                	push   $0x0
  pushl $94
801073ca:	6a 5e                	push   $0x5e
  jmp alltraps
801073cc:	e9 e3 f5 ff ff       	jmp    801069b4 <alltraps>
...
801073d1:	6a 00                	push   $0x0
  pushl $95
801073d3:	6a 5f                	push   $0x5f
  jmp alltraps
801073d5:	e9 da f5 ff ff       	jmp    801069b4 <alltraps>
...
801073e3:	6a 00                	push   $0x0
  pushl $97
801073e5:	6a 61                	push   $0x61
  jmp alltraps
801073e7:	e9 c8 f5 ff ff       	jmp    801069b4 <alltraps>
...
801073ec:	6a 00                	push   $0x0
  pushl $98
801073ee:	6a 62                	push   $0x62
  jmp alltraps
801073f0:	e9 bf f5 ff ff       	jmp    801069b4 <alltraps>
...
801073f5:	6a 00                	push   $0x0
  pushl $99
801073f7:	6a 63                	push   $0x63
  jmp alltraps
801073f9:	e9 b6 f5 ff ff       	jmp    801069b4 <alltraps>
...
80107407:	6a 00                	push   $0x0
  pushl $101
80107409:	6a 65                	push   $0x65
  jmp alltraps
8010740b:	e9 a4 f5 ff ff       	jmp    801069b4 <alltraps>
...
80107410:	6a 00                	push   $0x0
  pushl $102
80107412:	6a 66                	push   $0x66
  jmp alltraps
80107414:	e9 9b f5 ff ff       	jmp    801069b4 <alltraps>
...
80107419:	6a 00                	push   $0x0
  pushl $103
8010741b:	6a 67                	push   $0x67
  jmp alltraps
8010741d:	e9 92 f5 ff ff       	jmp    801069b4 <alltraps>
...
8010742b:	6a 00                	push   $0x0
  pushl $105
8010742d:	6a 69                	push   $0x69
  jmp alltraps
8010742f:	e9 80 f5 ff ff       	jmp    801069b4 <alltraps>
...
80107434:	6a 00                	push   $0x0
  pushl $106
80107436:	6a 6a                	push   $0x6a
  jmp alltraps
80107438:	e9 77 f5 ff ff       	jmp    801069b4 <alltraps>
...
8010743d:	6a 00                	push   $0x0
  pushl $107
8010743f:	6a 6b                	push   $0x6b
  jmp alltraps
80107441:	e9 6e f5 ff ff       	jmp    801069b4 <alltraps>
...
8010744f:	6a 00                	push   $0x0
  pushl $109
80107451:	6a 6d                	push   $0x6d
  jmp alltraps
80107453:	e9 5c f5 ff ff       	jmp    801069b4 <alltraps>
...
80107458:	6a 00                	push   $0x0
  pushl $110
8010745a:	6a 6e                	push   $0x6e
  jmp alltraps
8010745c:	e9 53 f5 ff ff       	jmp    801069b4 <alltraps>
...
80107461:	6a 00                	push   $0x0
  pushl $111
80107463:	6a 6f                	push   $0x6f
  jmp alltraps
80107465:	e9 4a f5 ff ff       	jmp    801069b4 <alltraps>
...
80107473:	6a 00                	push   $0x0
  pushl $113
80107475:	6a 71                	push   $0x71
  jmp alltraps
80107477:	e9 38 f5 ff ff       	jmp    801069b4 <alltraps>
...
8010747c:	6a 00                	push   $0x0
  pushl $114
8010747e:	6a 72                	push   $0x72
  jmp alltraps
80107480:	e9 2f f5 ff ff       	jmp    801069b4 <alltraps>
...
80107485:	6a 00                	push   $0x0
  pushl $115
80107487:	6a 73                	push   $0x73
  jmp alltraps
80107489:	e9 26 f5 ff ff       	jmp    801069b4 <alltraps>
...
80107497:	6a 00                	push   $0x0
  pushl $117
80107499:	6a 75                	push   $0x75
  jmp alltraps
8010749b:	e9 14 f5 ff ff       	jmp    801069b4 <alltraps>
...
801074a0:	6a 00                	push   $0x0
  pushl $118
801074a2:	6a 76                	push   $0x76
  jmp alltraps
801074a4:	e9 0b f5 ff ff       	jmp    801069b4 <alltraps>
...
801074a9:	6a 00                	push   $0x0
  pushl $119
801074ab:	6a 77                	push   $0x77
  jmp alltraps
801074ad:	e9 02 f5 ff ff       	jmp    801069b4 <alltraps>
...
801074bb:	6a 00                	push   $0x0
  pushl $121
801074bd:	6a 79                	push   $0x79
  jmp alltraps
801074bf:	e9 f0 f4 ff ff       	jmp    801069b4 <alltraps>
...
801074c4:	6a 00                	push   $0x0
  pushl $122
801074c6:	6a 7a                	push   $0x7a
  jmp alltraps
801074c8:	e9 e7 f4 ff ff       	jmp    801069b4 <alltraps>
...
801074cd:	6a 00                	push   $0x0
  pushl $123
801074cf:	6a 7b                	push   $0x7b
  jmp alltraps
801074d1:	e9 de f4 ff ff       	jmp    801069b4 <alltraps>
...
801074df:	6a 00                	push   $0x0
  pushl $125
801074e1:	6a 7d                	push   $0x7d
  jmp alltraps
801074e3:	e9 cc f4 ff ff       	jmp    801069b4 <alltraps>
...
801074e8:	6a 00                	push   $0x0
  pushl $126
801074ea:	6a 7e                	push   $0x7e
  jmp alltraps
801074ec:	e9 c3 f4 ff ff       	jmp    801069b4 <alltraps>
...
801074f1:	6a 00                	push   $0x0
  pushl $127
801074f3:	6a 7f                	push   $0x7f
  jmp alltraps
801074f5:	e9 ba f4 ff ff       	jmp    801069b4 <alltraps>
...
801074fa:	6a 00                	push   $0x0
  pushl $128
801074fc:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107501:	e9 ae f4 ff ff       	jmp    801069b4 <alltraps>
...
80107506:	6a 00                	push   $0x0
  pushl $129
80107508:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010750d:	e9 a2 f4 ff ff       	jmp    801069b4 <alltraps>
...
80107512:	6a 00                	push   $0x0
  pushl $130
80107514:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107519:	e9 96 f4 ff ff       	jmp    801069b4 <alltraps>
...
8010751e:	6a 00                	push   $0x0
  pushl $131
80107520:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107525:	e9 8a f4 ff ff       	jmp    801069b4 <alltraps>
...
8010752a:	6a 00                	push   $0x0
  pushl $132
8010752c:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107531:	e9 7e f4 ff ff       	jmp    801069b4 <alltraps>
...
80107536:	6a 00                	push   $0x0
  pushl $133
80107538:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010753d:	e9 72 f4 ff ff       	jmp    801069b4 <alltraps>
...
80107542:	6a 00                	push   $0x0
  pushl $134
80107544:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107549:	e9 66 f4 ff ff       	jmp    801069b4 <alltraps>
...
8010754e:	6a 00                	push   $0x0
  pushl $135
80107550:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107555:	e9 5a f4 ff ff       	jmp    801069b4 <alltraps>
...
8010755a:	6a 00                	push   $0x0
  pushl $136
8010755c:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107561:	e9 4e f4 ff ff       	jmp    801069b4 <alltraps>
...
80107566:	6a 00                	push   $0x0
  pushl $137
80107568:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010756d:	e9 42 f4 ff ff       	jmp    801069b4 <alltraps>
...
80107572:	6a 00                	push   $0x0
  pushl $138
80107574:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107579:	e9 36 f4 ff ff       	jmp    801069b4 <alltraps>
...
8010757e:	6a 00                	push   $0x0
  pushl $139
80107580:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107585:	e9 2a f4 ff ff       	jmp    801069b4 <alltraps>
...
8010758a:	6a 00                	push   $0x0
  pushl $140
8010758c:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107591:	e9 1e f4 ff ff       	jmp    801069b4 <alltraps>
...
80107596:	6a 00                	push   $0x0
  pushl $141
80107598:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010759d:	e9 12 f4 ff ff       	jmp    801069b4 <alltraps>
...
801075a2:	6a 00                	push   $0x0
  pushl $142
801075a4:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801075a9:	e9 06 f4 ff ff       	jmp    801069b4 <alltraps>
...
801075ae:	6a 00                	push   $0x0
  pushl $143
801075b0:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801075b5:	e9 fa f3 ff ff       	jmp    801069b4 <alltraps>
...
801075ba:	6a 00                	push   $0x0
  pushl $144
801075bc:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801075c1:	e9 ee f3 ff ff       	jmp    801069b4 <alltraps>
...
801075c6:	6a 00                	push   $0x0
  pushl $145
801075c8:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801075cd:	e9 e2 f3 ff ff       	jmp    801069b4 <alltraps>
...
801075d2:	6a 00                	push   $0x0
  pushl $146
801075d4:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801075d9:	e9 d6 f3 ff ff       	jmp    801069b4 <alltraps>
...
801075de:	6a 00                	push   $0x0
  pushl $147
801075e0:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801075e5:	e9 ca f3 ff ff       	jmp    801069b4 <alltraps>
...
801075ea:	6a 00                	push   $0x0
  pushl $148
801075ec:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801075f1:	e9 be f3 ff ff       	jmp    801069b4 <alltraps>
...
801075f6:	6a 00                	push   $0x0
  pushl $149
801075f8:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801075fd:	e9 b2 f3 ff ff       	jmp    801069b4 <alltraps>
...
80107602:	6a 00                	push   $0x0
  pushl $150
80107604:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107609:	e9 a6 f3 ff ff       	jmp    801069b4 <alltraps>
...
8010760e:	6a 00                	push   $0x0
  pushl $151
80107610:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107615:	e9 9a f3 ff ff       	jmp    801069b4 <alltraps>
...
8010761a:	6a 00                	push   $0x0
  pushl $152
8010761c:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107621:	e9 8e f3 ff ff       	jmp    801069b4 <alltraps>
...
80107626:	6a 00                	push   $0x0
  pushl $153
80107628:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010762d:	e9 82 f3 ff ff       	jmp    801069b4 <alltraps>
...
80107632:	6a 00                	push   $0x0
  pushl $154
80107634:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107639:	e9 76 f3 ff ff       	jmp    801069b4 <alltraps>
...
8010763e:	6a 00                	push   $0x0
  pushl $155
80107640:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107645:	e9 6a f3 ff ff       	jmp    801069b4 <alltraps>
...
8010764a:	6a 00                	push   $0x0
  pushl $156
8010764c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107651:	e9 5e f3 ff ff       	jmp    801069b4 <alltraps>
...
80107656:	6a 00                	push   $0x0
  pushl $157
80107658:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010765d:	e9 52 f3 ff ff       	jmp    801069b4 <alltraps>
...
80107662:	6a 00                	push   $0x0
  pushl $158
80107664:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107669:	e9 46 f3 ff ff       	jmp    801069b4 <alltraps>
...
8010766e:	6a 00                	push   $0x0
  pushl $159
80107670:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107675:	e9 3a f3 ff ff       	jmp    801069b4 <alltraps>
...
8010767a:	6a 00                	push   $0x0
  pushl $160
8010767c:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107681:	e9 2e f3 ff ff       	jmp    801069b4 <alltraps>
...
80107686:	6a 00                	push   $0x0
  pushl $161
80107688:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010768d:	e9 22 f3 ff ff       	jmp    801069b4 <alltraps>
...
80107692:	6a 00                	push   $0x0
  pushl $162
80107694:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107699:	e9 16 f3 ff ff       	jmp    801069b4 <alltraps>
...
8010769e:	6a 00                	push   $0x0
  pushl $163
801076a0:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801076a5:	e9 0a f3 ff ff       	jmp    801069b4 <alltraps>
...
801076aa:	6a 00                	push   $0x0
  pushl $164
801076ac:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801076b1:	e9 fe f2 ff ff       	jmp    801069b4 <alltraps>
...
801076b6:	6a 00                	push   $0x0
  pushl $165
801076b8:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801076bd:	e9 f2 f2 ff ff       	jmp    801069b4 <alltraps>
...
801076c2:	6a 00                	push   $0x0
  pushl $166
801076c4:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801076c9:	e9 e6 f2 ff ff       	jmp    801069b4 <alltraps>
...
801076ce:	6a 00                	push   $0x0
  pushl $167
801076d0:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801076d5:	e9 da f2 ff ff       	jmp    801069b4 <alltraps>
...
801076da:	6a 00                	push   $0x0
  pushl $168
801076dc:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801076e1:	e9 ce f2 ff ff       	jmp    801069b4 <alltraps>
...
801076e6:	6a 00                	push   $0x0
  pushl $169
801076e8:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801076ed:	e9 c2 f2 ff ff       	jmp    801069b4 <alltraps>
...
801076f2:	6a 00                	push   $0x0
  pushl $170
801076f4:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801076f9:	e9 b6 f2 ff ff       	jmp    801069b4 <alltraps>
...
801076fe:	6a 00                	push   $0x0
  pushl $171
80107700:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107705:	e9 aa f2 ff ff       	jmp    801069b4 <alltraps>
...
8010770a:	6a 00                	push   $0x0
  pushl $172
8010770c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107711:	e9 9e f2 ff ff       	jmp    801069b4 <alltraps>
...
80107716:	6a 00                	push   $0x0
  pushl $173
80107718:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010771d:	e9 92 f2 ff ff       	jmp    801069b4 <alltraps>
...
80107722:	6a 00                	push   $0x0
  pushl $174
80107724:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107729:	e9 86 f2 ff ff       	jmp    801069b4 <alltraps>
...
8010772e:	6a 00                	push   $0x0
  pushl $175
80107730:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107735:	e9 7a f2 ff ff       	jmp    801069b4 <alltraps>
...
8010773a:	6a 00                	push   $0x0
  pushl $176
8010773c:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107741:	e9 6e f2 ff ff       	jmp    801069b4 <alltraps>
...
80107746:	6a 00                	push   $0x0
  pushl $177
80107748:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010774d:	e9 62 f2 ff ff       	jmp    801069b4 <alltraps>
...
80107752:	6a 00                	push   $0x0
  pushl $178
80107754:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107759:	e9 56 f2 ff ff       	jmp    801069b4 <alltraps>
...
8010775e:	6a 00                	push   $0x0
  pushl $179
80107760:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107765:	e9 4a f2 ff ff       	jmp    801069b4 <alltraps>
...
8010776a:	6a 00                	push   $0x0
  pushl $180
8010776c:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107771:	e9 3e f2 ff ff       	jmp    801069b4 <alltraps>
...
80107776:	6a 00                	push   $0x0
  pushl $181
80107778:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010777d:	e9 32 f2 ff ff       	jmp    801069b4 <alltraps>
...
80107782:	6a 00                	push   $0x0
  pushl $182
80107784:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107789:	e9 26 f2 ff ff       	jmp    801069b4 <alltraps>
...
8010778e:	6a 00                	push   $0x0
  pushl $183
80107790:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107795:	e9 1a f2 ff ff       	jmp    801069b4 <alltraps>
...
8010779a:	6a 00                	push   $0x0
  pushl $184
8010779c:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801077a1:	e9 0e f2 ff ff       	jmp    801069b4 <alltraps>
...
801077a6:	6a 00                	push   $0x0
  pushl $185
801077a8:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801077ad:	e9 02 f2 ff ff       	jmp    801069b4 <alltraps>
...
801077b2:	6a 00                	push   $0x0
  pushl $186
801077b4:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801077b9:	e9 f6 f1 ff ff       	jmp    801069b4 <alltraps>
...
801077be:	6a 00                	push   $0x0
  pushl $187
801077c0:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801077c5:	e9 ea f1 ff ff       	jmp    801069b4 <alltraps>
...
801077ca:	6a 00                	push   $0x0
  pushl $188
801077cc:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801077d1:	e9 de f1 ff ff       	jmp    801069b4 <alltraps>
...
801077d6:	6a 00                	push   $0x0
  pushl $189
801077d8:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801077dd:	e9 d2 f1 ff ff       	jmp    801069b4 <alltraps>
...
801077e2:	6a 00                	push   $0x0
  pushl $190
801077e4:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801077e9:	e9 c6 f1 ff ff       	jmp    801069b4 <alltraps>
...
801077ee:	6a 00                	push   $0x0
  pushl $191
801077f0:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801077f5:	e9 ba f1 ff ff       	jmp    801069b4 <alltraps>
...
801077fa:	6a 00                	push   $0x0
  pushl $192
801077fc:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107801:	e9 ae f1 ff ff       	jmp    801069b4 <alltraps>
...
80107806:	6a 00                	push   $0x0
  pushl $193
80107808:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010780d:	e9 a2 f1 ff ff       	jmp    801069b4 <alltraps>
...
80107812:	6a 00                	push   $0x0
  pushl $194
80107814:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107819:	e9 96 f1 ff ff       	jmp    801069b4 <alltraps>
...
8010781e:	6a 00                	push   $0x0
  pushl $195
80107820:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107825:	e9 8a f1 ff ff       	jmp    801069b4 <alltraps>
...
8010782a:	6a 00                	push   $0x0
  pushl $196
8010782c:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107831:	e9 7e f1 ff ff       	jmp    801069b4 <alltraps>
...
80107836:	6a 00                	push   $0x0
  pushl $197
80107838:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010783d:	e9 72 f1 ff ff       	jmp    801069b4 <alltraps>
...
80107842:	6a 00                	push   $0x0
  pushl $198
80107844:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107849:	e9 66 f1 ff ff       	jmp    801069b4 <alltraps>
...
8010784e:	6a 00                	push   $0x0
  pushl $199
80107850:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107855:	e9 5a f1 ff ff       	jmp    801069b4 <alltraps>
...
8010785a:	6a 00                	push   $0x0
  pushl $200
8010785c:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107861:	e9 4e f1 ff ff       	jmp    801069b4 <alltraps>
...
80107866:	6a 00                	push   $0x0
  pushl $201
80107868:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010786d:	e9 42 f1 ff ff       	jmp    801069b4 <alltraps>
...
80107872:	6a 00                	push   $0x0
  pushl $202
80107874:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107879:	e9 36 f1 ff ff       	jmp    801069b4 <alltraps>
...
8010787e:	6a 00                	push   $0x0
  pushl $203
80107880:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107885:	e9 2a f1 ff ff       	jmp    801069b4 <alltraps>
...
8010788a:	6a 00                	push   $0x0
  pushl $204
8010788c:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107891:	e9 1e f1 ff ff       	jmp    801069b4 <alltraps>
...
80107896:	6a 00                	push   $0x0
  pushl $205
80107898:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010789d:	e9 12 f1 ff ff       	jmp    801069b4 <alltraps>
...
801078a2:	6a 00                	push   $0x0
  pushl $206
801078a4:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801078a9:	e9 06 f1 ff ff       	jmp    801069b4 <alltraps>
...
801078ae:	6a 00                	push   $0x0
  pushl $207
801078b0:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801078b5:	e9 fa f0 ff ff       	jmp    801069b4 <alltraps>
...
801078ba:	6a 00                	push   $0x0
  pushl $208
801078bc:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801078c1:	e9 ee f0 ff ff       	jmp    801069b4 <alltraps>
...
801078c6:	6a 00                	push   $0x0
  pushl $209
801078c8:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801078cd:	e9 e2 f0 ff ff       	jmp    801069b4 <alltraps>
...
801078d2:	6a 00                	push   $0x0
  pushl $210
801078d4:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801078d9:	e9 d6 f0 ff ff       	jmp    801069b4 <alltraps>
...
801078de:	6a 00                	push   $0x0
  pushl $211
801078e0:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801078e5:	e9 ca f0 ff ff       	jmp    801069b4 <alltraps>
...
801078ea:	6a 00                	push   $0x0
  pushl $212
801078ec:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801078f1:	e9 be f0 ff ff       	jmp    801069b4 <alltraps>
...
801078f6:	6a 00                	push   $0x0
  pushl $213
801078f8:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801078fd:	e9 b2 f0 ff ff       	jmp    801069b4 <alltraps>
...
80107902:	6a 00                	push   $0x0
  pushl $214
80107904:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107909:	e9 a6 f0 ff ff       	jmp    801069b4 <alltraps>
...
8010790e:	6a 00                	push   $0x0
  pushl $215
80107910:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107915:	e9 9a f0 ff ff       	jmp    801069b4 <alltraps>
...
8010791a:	6a 00                	push   $0x0
  pushl $216
8010791c:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107921:	e9 8e f0 ff ff       	jmp    801069b4 <alltraps>
...
80107926:	6a 00                	push   $0x0
  pushl $217
80107928:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010792d:	e9 82 f0 ff ff       	jmp    801069b4 <alltraps>
...
80107932:	6a 00                	push   $0x0
  pushl $218
80107934:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107939:	e9 76 f0 ff ff       	jmp    801069b4 <alltraps>
...
8010793e:	6a 00                	push   $0x0
  pushl $219
80107940:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107945:	e9 6a f0 ff ff       	jmp    801069b4 <alltraps>
...
8010794a:	6a 00                	push   $0x0
  pushl $220
8010794c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107951:	e9 5e f0 ff ff       	jmp    801069b4 <alltraps>
...
80107956:	6a 00                	push   $0x0
  pushl $221
80107958:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010795d:	e9 52 f0 ff ff       	jmp    801069b4 <alltraps>
...
80107962:	6a 00                	push   $0x0
  pushl $222
80107964:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107969:	e9 46 f0 ff ff       	jmp    801069b4 <alltraps>
...
8010796e:	6a 00                	push   $0x0
  pushl $223
80107970:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107975:	e9 3a f0 ff ff       	jmp    801069b4 <alltraps>
...
8010797a:	6a 00                	push   $0x0
  pushl $224
8010797c:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107981:	e9 2e f0 ff ff       	jmp    801069b4 <alltraps>
...
80107986:	6a 00                	push   $0x0
  pushl $225
80107988:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010798d:	e9 22 f0 ff ff       	jmp    801069b4 <alltraps>
...
80107992:	6a 00                	push   $0x0
  pushl $226
80107994:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107999:	e9 16 f0 ff ff       	jmp    801069b4 <alltraps>
...
8010799e:	6a 00                	push   $0x0
  pushl $227
801079a0:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801079a5:	e9 0a f0 ff ff       	jmp    801069b4 <alltraps>
...
801079aa:	6a 00                	push   $0x0
  pushl $228
801079ac:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801079b1:	e9 fe ef ff ff       	jmp    801069b4 <alltraps>
...
801079b6:	6a 00                	push   $0x0
  pushl $229
801079b8:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801079bd:	e9 f2 ef ff ff       	jmp    801069b4 <alltraps>
...
801079c2:	6a 00                	push   $0x0
  pushl $230
801079c4:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801079c9:	e9 e6 ef ff ff       	jmp    801069b4 <alltraps>
...
801079ce:	6a 00                	push   $0x0
  pushl $231
801079d0:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801079d5:	e9 da ef ff ff       	jmp    801069b4 <alltraps>
...
801079da:	6a 00                	push   $0x0
  pushl $232
801079dc:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801079e1:	e9 ce ef ff ff       	jmp    801069b4 <alltraps>
...
801079e6:	6a 00                	push   $0x0
  pushl $233
801079e8:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801079ed:	e9 c2 ef ff ff       	jmp    801069b4 <alltraps>
...
801079f2:	6a 00                	push   $0x0
  pushl $234
801079f4:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801079f9:	e9 b6 ef ff ff       	jmp    801069b4 <alltraps>
...
801079fe:	6a 00                	push   $0x0
  pushl $235
80107a00:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107a05:	e9 aa ef ff ff       	jmp    801069b4 <alltraps>
...
80107a0a:	6a 00                	push   $0x0
  pushl $236
80107a0c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107a11:	e9 9e ef ff ff       	jmp    801069b4 <alltraps>
...
80107a16:	6a 00                	push   $0x0
  pushl $237
80107a18:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107a1d:	e9 92 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a22:	6a 00                	push   $0x0
  pushl $238
80107a24:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107a29:	e9 86 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a2e:	6a 00                	push   $0x0
  pushl $239
80107a30:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107a35:	e9 7a ef ff ff       	jmp    801069b4 <alltraps>
...
80107a3a:	6a 00                	push   $0x0
  pushl $240
80107a3c:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107a41:	e9 6e ef ff ff       	jmp    801069b4 <alltraps>
...
80107a46:	6a 00                	push   $0x0
  pushl $241
80107a48:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107a4d:	e9 62 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a52:	6a 00                	push   $0x0
  pushl $242
80107a54:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107a59:	e9 56 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a5e:	6a 00                	push   $0x0
  pushl $243
80107a60:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107a65:	e9 4a ef ff ff       	jmp    801069b4 <alltraps>
...
80107a6a:	6a 00                	push   $0x0
  pushl $244
80107a6c:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107a71:	e9 3e ef ff ff       	jmp    801069b4 <alltraps>
...
80107a76:	6a 00                	push   $0x0
  pushl $245
80107a78:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107a7d:	e9 32 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a82:	6a 00                	push   $0x0
  pushl $246
80107a84:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107a89:	e9 26 ef ff ff       	jmp    801069b4 <alltraps>
...
80107a8e:	6a 00                	push   $0x0
  pushl $247
80107a90:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107a95:	e9 1a ef ff ff       	jmp    801069b4 <alltraps>
...
80107a9a:	6a 00                	push   $0x0
  pushl $248
80107a9c:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107aa1:	e9 0e ef ff ff       	jmp    801069b4 <alltraps>
...
80107aa6:	6a 00                	push   $0x0
  pushl $249
80107aa8:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107aad:	e9 02 ef ff ff       	jmp    801069b4 <alltraps>
...
80107ab2:	6a 00                	push   $0x0
  pushl $250
80107ab4:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107ab9:	e9 f6 ee ff ff       	jmp    801069b4 <alltraps>
...
80107abe:	6a 00                	push   $0x0
  pushl $251
80107ac0:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107ac5:	e9 ea ee ff ff       	jmp    801069b4 <alltraps>
...
80107aca:	6a 00                	push   $0x0
  pushl $252
80107acc:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107ad1:	e9 de ee ff ff       	jmp    801069b4 <alltraps>
...
80107ad6:	6a 00                	push   $0x0
  pushl $253
80107ad8:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107add:	e9 d2 ee ff ff       	jmp    801069b4 <alltraps>
...
80107ae2:	6a 00                	push   $0x0
  pushl $254
80107ae4:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ae9:	e9 c6 ee ff ff       	jmp    801069b4 <alltraps>
...
80107aee:	6a 00                	push   $0x0
  pushl $255
80107af0:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107af5:	e9 ba ee ff ff       	jmp    801069b4 <alltraps>
...
80107aff:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107b02:	8b 45 0c             	mov    0xc(%ebp),%eax
80107b05:	83 e8 01             	sub    $0x1,%eax
80107b08:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107b0c:	8b 45 08             	mov    0x8(%ebp),%eax
80107b0f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107b13:	8b 45 08             	mov    0x8(%ebp),%eax
80107b16:	c1 e8 10             	shr    $0x10,%eax
80107b19:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107b1d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107b20:	0f 01 10             	lgdtl  (%eax)
}
80107b23:	c9                   	leave  
80107b24:	c3                   	ret    
...
80107b2e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107b32:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107b36:	0f 00 d8             	ltr    %ax
}
80107b39:	c9                   	leave  
80107b3a:	c3                   	ret    
...
80107b41:	8b 45 08             	mov    0x8(%ebp),%eax
80107b44:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107b48:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107b4c:	8e e8                	mov    %eax,%gs
}
80107b4e:	c9                   	leave  
80107b4f:	c3                   	ret    
...
80107b6e:	05 00 00 00 80       	add    $0x80000000,%eax
80107b73:	5d                   	pop    %ebp
80107b74:	c3                   	ret    
...
80107b79:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107b7c:	e8 38 b6 ff ff       	call   801031b9 <cpunum>
80107b81:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107b87:	05 40 09 11 80       	add    $0x80110940,%eax
...
80107fc0:	e8 37 fb ff ff       	call   80107afc <lgdt>
  loadgs(SEG_KCPU << 3);
80107fc5:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107fcc:	e8 6a fb ff ff       	call   80107b3b <loadgs>
...
8010801f:	e8 44 fb ff ff       	call   80107b68 <p2v>
...
8010802f:	e8 f3 ad ff ff       	call   80102e27 <kalloc>
...
8010805a:	e8 b3 d4 ff ff       	call   80105512 <memset>
...
80108065:	e8 f1 fa ff ff       	call   80107b5b <v2p>
8010806a:	89 c2                	mov    %eax,%edx
8010806c:	83 ca 07             	or     $0x7,%edx
...
801080d9:	eb 46                	jmp    80108121 <mappages+0x94>
    if(*pte & PTE_P)
...
801080e5:	74 0c                	je     801080f3 <mappages+0x66>
      panic("remap");
801080e7:	c7 04 24 10 8f 10 80 	movl   $0x80108f10,(%esp)
801080ee:	e8 53 84 ff ff       	call   80100546 <panic>
    *pte = pa | perm | PTE_P;
801080f3:	8b 45 18             	mov    0x18(%ebp),%eax
801080f6:	0b 45 14             	or     0x14(%ebp),%eax
801080f9:	89 c2                	mov    %eax,%edx
801080fb:	83 ca 01             	or     $0x1,%edx
...
80108109:	74 10                	je     8010811b <mappages+0x8e>
      break;
    a += PGSIZE;
8010810b:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80108112:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80108119:	eb 96                	jmp    801080b1 <mappages+0x24>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108127:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
8010812a:	e8 f8 ac ff ff       	call   80102e27 <kalloc>
8010812f:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108132:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108136:	75 0a                	jne    80108142 <setupkvm+0x1f>
    return 0;
80108138:	b8 00 00 00 00       	mov    $0x0,%eax
8010813d:	e9 98 00 00 00       	jmp    801081da <setupkvm+0xb7>
...
80108158:	e8 b5 d3 ff ff       	call   80105512 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
8010815d:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80108164:	e8 ff f9 ff ff       	call   80107b68 <p2v>
80108169:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
8010816e:	76 0c                	jbe    8010817c <setupkvm+0x59>
    panic("PHYSTOP too high");
80108170:	c7 04 24 16 8f 10 80 	movl   $0x80108f16,(%esp)
80108177:	e8 ca 83 ff ff       	call   80100546 <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010817c:	c7 45 f4 a0 c4 10 80 	movl   $0x8010c4a0,-0xc(%ebp)
80108183:	eb 49                	jmp    801081ce <setupkvm+0xab>
...
80108185:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108188:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
8010818b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010818e:	8b 50 04             	mov    0x4(%eax),%edx
80108191:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108194:	8b 58 08             	mov    0x8(%eax),%ebx
80108197:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819a:	8b 40 04             	mov    0x4(%eax),%eax
8010819d:	29 c3                	sub    %eax,%ebx
8010819f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081a2:	8b 00                	mov    (%eax),%eax
801081a4:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801081a8:	89 54 24 0c          	mov    %edx,0xc(%esp)
801081ac:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801081b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801081b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081b7:	89 04 24             	mov    %eax,(%esp)
801081ba:	e8 ce fe ff ff       	call   8010808d <mappages>
801081bf:	85 c0                	test   %eax,%eax
801081c1:	79 07                	jns    801081ca <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
801081c3:	b8 00 00 00 00       	mov    $0x0,%eax
801081c8:	eb 10                	jmp    801081da <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801081ca:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801081ce:	81 7d f4 e0 c4 10 80 	cmpl   $0x8010c4e0,-0xc(%ebp)
801081d5:	72 ae                	jb     80108185 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801081da:	83 c4 34             	add    $0x34,%esp
801081dd:	5b                   	pop    %ebx
801081de:	5d                   	pop    %ebp
801081df:	c3                   	ret    
...
801081e3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801081e6:	e8 38 ff ff ff       	call   80108123 <setupkvm>
801081eb:	a3 18 3e 11 80       	mov    %eax,0x80113e18
  switchkvm();
801081f0:	e8 02 00 00 00       	call   801081f7 <switchkvm>
}
801081f5:	c9                   	leave  
801081f6:	c3                   	ret    
...
801081fa:	83 ec 04             	sub    $0x4,%esp
  lcr3(v2p(kpgdir));   // switch to the kernel page table
801081fd:	a1 18 3e 11 80       	mov    0x80113e18,%eax
80108202:	89 04 24             	mov    %eax,(%esp)
80108205:	e8 51 f9 ff ff       	call   80107b5b <v2p>
8010820a:	89 04 24             	mov    %eax,(%esp)
8010820d:	e8 3e f9 ff ff       	call   80107b50 <lcr3>
}
80108212:	c9                   	leave  
80108213:	c3                   	ret    
...
80108218:	83 ec 14             	sub    $0x14,%esp
  pushcli();
8010821b:	e8 eb d1 ff ff       	call   8010540b <pushcli>
...
8010824e:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108255:	67 00 
80108257:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010825e:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108264:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010826b:	83 e1 f0             	and    $0xfffffff0,%ecx
8010826e:	83 c9 09             	or     $0x9,%ecx
80108271:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108277:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010827e:	83 c9 10             	or     $0x10,%ecx
80108281:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108287:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010828e:	83 e1 9f             	and    $0xffffff9f,%ecx
80108291:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108297:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010829e:	83 c9 80             	or     $0xffffff80,%ecx
801082a1:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801082a7:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801082ae:	83 e1 f0             	and    $0xfffffff0,%ecx
801082b1:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801082b7:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801082be:	83 e1 ef             	and    $0xffffffef,%ecx
801082c1:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801082c7:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801082ce:	83 e1 df             	and    $0xffffffdf,%ecx
801082d1:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801082d7:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801082de:	83 c9 40             	or     $0x40,%ecx
801082e1:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801082e7:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801082ee:	83 e1 7f             	and    $0x7f,%ecx
801082f1:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801082f7:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801082fd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108303:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
8010830a:	83 e2 ef             	and    $0xffffffef,%edx
8010830d:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108313:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108319:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010831f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108325:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010832c:	8b 52 08             	mov    0x8(%edx),%edx
8010832f:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108335:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108338:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010833f:	e8 e1 f7 ff ff       	call   80107b25 <ltr>
  if(p->pgdir == 0)
80108344:	8b 45 08             	mov    0x8(%ebp),%eax
80108347:	8b 40 04             	mov    0x4(%eax),%eax
8010834a:	85 c0                	test   %eax,%eax
8010834c:	75 0c                	jne    8010835a <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010834e:	c7 04 24 27 8f 10 80 	movl   $0x80108f27,(%esp)
80108355:	e8 ec 81 ff ff       	call   80100546 <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
8010835a:	8b 45 08             	mov    0x8(%ebp),%eax
8010835d:	8b 40 04             	mov    0x4(%eax),%eax
80108360:	89 04 24             	mov    %eax,(%esp)
80108363:	e8 f3 f7 ff ff       	call   80107b5b <v2p>
80108368:	89 04 24             	mov    %eax,(%esp)
8010836b:	e8 e0 f7 ff ff       	call   80107b50 <lcr3>
  popcli();
80108370:	e8 de d0 ff ff       	call   80105453 <popcli>
}
80108375:	83 c4 14             	add    $0x14,%esp
80108378:	5b                   	pop    %ebx
80108379:	5d                   	pop    %ebp
8010837a:	c3                   	ret    
...
8010837e:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108381:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108388:	76 0c                	jbe    80108396 <inituvm+0x1b>
    panic("inituvm: more than a page");
8010838a:	c7 04 24 3b 8f 10 80 	movl   $0x80108f3b,(%esp)
80108391:	e8 b0 81 ff ff       	call   80100546 <panic>
  mem = kalloc();
80108396:	e8 8c aa ff ff       	call   80102e27 <kalloc>
8010839b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
8010839e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083a5:	00 
801083a6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801083ad:	00 
801083ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b1:	89 04 24             	mov    %eax,(%esp)
801083b4:	e8 59 d1 ff ff       	call   80105512 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801083b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083bc:	89 04 24             	mov    %eax,(%esp)
801083bf:	e8 97 f7 ff ff       	call   80107b5b <v2p>
801083c4:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801083cb:	00 
801083cc:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
801083e6:	e8 a2 fc ff ff       	call   8010808d <mappages>
  memmove(mem, init, sz);
801083eb:	8b 45 10             	mov    0x10(%ebp),%eax
...
801083ff:	e8 e1 d1 ff ff       	call   801055e5 <memmove>
}
80108404:	c9                   	leave  
80108405:	c3                   	ret    
...
8010840a:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010840d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108410:	25 ff 0f 00 00       	and    $0xfff,%eax
80108415:	85 c0                	test   %eax,%eax
80108417:	74 0c                	je     80108425 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108419:	c7 04 24 58 8f 10 80 	movl   $0x80108f58,(%esp)
80108420:	e8 21 81 ff ff       	call   80100546 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108425:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010842c:	e9 ad 00 00 00       	jmp    801084de <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108431:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108434:	8b 55 0c             	mov    0xc(%ebp),%edx
...
8010844b:	e8 9b fb ff ff       	call   80107feb <walkpgdir>
80108450:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108453:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108457:	75 0c                	jne    80108465 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108459:	c7 04 24 7b 8f 10 80 	movl   $0x80108f7b,(%esp)
80108460:	e8 e1 80 ff ff       	call   80100546 <panic>
    pa = PTE_ADDR(*pte);
...
801084ac:	e8 b7 f6 ff ff       	call   80107b68 <p2v>
...
801084c6:	e8 b2 9b ff ff       	call   8010207d <readi>
801084cb:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801084ce:	74 07                	je     801084d7 <loaduvm+0xd1>
      return -1;
801084d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084d5:	eb 18                	jmp    801084ef <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
801084e4:	0f 82 47 ff ff ff    	jb     80108431 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
8010852c:	e9 8d 00 00 00       	jmp    801085be <allocuvm+0xc9>
    mem = kalloc();
80108531:	e8 f1 a8 ff ff       	call   80102e27 <kalloc>
80108536:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108539:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010853d:	75 2c                	jne    8010856b <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010853f:	c7 04 24 99 8f 10 80 	movl   $0x80108f99,(%esp)
80108546:	e8 5f 7e ff ff       	call   801003aa <cprintf>
...
80108581:	e8 8c cf ff ff       	call   80105512 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108586:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108589:	89 04 24             	mov    %eax,(%esp)
8010858c:	e8 ca f5 ff ff       	call   80107b5b <v2p>
...
801085b2:	e8 d6 fa ff ff       	call   8010808d <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
8010860f:	e8 d7 f9 ff ff       	call   80107feb <walkpgdir>
...
80108643:	75 0c                	jne    80108651 <deallocuvm+0x82>
        panic("kfree");
80108645:	c7 04 24 b1 8f 10 80 	movl   $0x80108fb1,(%esp)
8010864c:	e8 f5 7e ff ff       	call   80100546 <panic>
      char *v = p2v(pa);
80108651:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108654:	89 04 24             	mov    %eax,(%esp)
80108657:	e8 0c f5 ff ff       	call   80107b68 <p2v>
8010865c:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010865f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108662:	89 04 24             	mov    %eax,(%esp)
80108665:	e8 24 a7 ff ff       	call   80102d8e <kfree>
      *pte = 0;
...
80108697:	c7 04 24 b7 8f 10 80 	movl   $0x80108fb7,(%esp)
8010869e:	e8 a3 7e ff ff       	call   80100546 <panic>
...
8010871e:	e8 6b a6 ff ff       	call   80102d8e <kfree>
}
80108723:	c9                   	leave  
80108724:	c3                   	ret    
...
80108740:	e8 a6 f8 ff ff       	call   80107feb <walkpgdir>
80108745:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108748:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010874c:	75 0c                	jne    8010875a <clearpteu+0x35>
    panic("clearpteu");
8010874e:	c7 04 24 c8 8f 10 80 	movl   $0x80108fc8,(%esp)
80108755:	e8 ec 7d ff ff       	call   80100546 <panic>
  *pte &= ~PTE_U;
8010875a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010875d:	8b 00                	mov    (%eax),%eax
8010875f:	89 c2                	mov    %eax,%edx
80108761:	83 e2 fb             	and    $0xfffffffb,%edx
...
8010876e:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108771:	e8 ad f9 ff ff       	call   80108123 <setupkvm>
80108776:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108779:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010877d:	75 0a                	jne    80108789 <copyuvm+0x1e>
    return 0;
8010877f:	b8 00 00 00 00       	mov    $0x0,%eax
80108784:	e9 f1 00 00 00       	jmp    8010887a <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
80108789:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108790:	e9 c0 00 00 00       	jmp    80108855 <copyuvm+0xea>
...
801087aa:	e8 3c f8 ff ff       	call   80107feb <walkpgdir>
801087af:	89 45 ec             	mov    %eax,-0x14(%ebp)
801087b2:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801087b6:	75 0c                	jne    801087c4 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
801087b8:	c7 04 24 d2 8f 10 80 	movl   $0x80108fd2,(%esp)
801087bf:	e8 82 7d ff ff       	call   80100546 <panic>
    if(!(*pte & PTE_P))
801087c4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801087c7:	8b 00                	mov    (%eax),%eax
801087c9:	83 e0 01             	and    $0x1,%eax
801087cc:	85 c0                	test   %eax,%eax
801087ce:	75 0c                	jne    801087dc <copyuvm+0x71>
      panic("copyuvm: page not present");
801087d0:	c7 04 24 ec 8f 10 80 	movl   $0x80108fec,(%esp)
801087d7:	e8 6a 7d ff ff       	call   80100546 <panic>
    pa = PTE_ADDR(*pte);
801087dc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801087df:	8b 00                	mov    (%eax),%eax
801087e1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801087e6:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
801087e9:	e8 39 a6 ff ff       	call   80102e27 <kalloc>
801087ee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801087f1:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801087f5:	74 6f                	je     80108866 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801087f7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801087fa:	89 04 24             	mov    %eax,(%esp)
801087fd:	e8 66 f3 ff ff       	call   80107b68 <p2v>
...
80108814:	e8 cc cd ff ff       	call   801055e5 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
80108819:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010881c:	89 04 24             	mov    %eax,(%esp)
8010881f:	e8 37 f3 ff ff       	call   80107b5b <v2p>
...
8010884c:	78 1b                	js     80108869 <copyuvm+0xfe>
  uint pa, i;
  char *mem;
...
8010885b:	0f 82 34 ff ff ff    	jb     80108795 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108864:	eb 14                	jmp    8010887a <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108866:	90                   	nop
80108867:	eb 01                	jmp    8010886a <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108869:	90                   	nop
...
80108870:	e8 16 fe ff ff       	call   8010868b <freevm>
  return 0;
...
80108897:	e8 4f f7 ff ff       	call   80107feb <walkpgdir>
...
801088d2:	e8 91 f2 ff ff       	call   80107b68 <p2v>
}
801088d7:	c9                   	leave  
801088d8:	c3                   	ret    
...
801088e2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801088e5:	e9 89 00 00 00       	jmp    80108973 <copyout+0x9a>
...
80108915:	eb 6b                	jmp    80108982 <copyout+0xa9>
    n = PGSIZE - (va - va0);
80108917:	8b 45 0c             	mov    0xc(%ebp),%eax
8010891a:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010891d:	89 d1                	mov    %edx,%ecx
8010891f:	29 c1                	sub    %eax,%ecx
80108921:	89 c8                	mov    %ecx,%eax
80108923:	05 00 10 00 00       	add    $0x1000,%eax
80108928:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
8010892b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010892e:	3b 45 14             	cmp    0x14(%ebp),%eax
80108931:	76 06                	jbe    80108939 <copyout+0x60>
      n = len;
80108933:	8b 45 14             	mov    0x14(%ebp),%eax
80108936:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108939:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010893c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010893f:	29 c2                	sub    %eax,%edx
80108941:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108944:	01 c2                	add    %eax,%edx
...
80108954:	89 14 24             	mov    %edx,(%esp)
80108957:	e8 89 cc ff ff       	call   801055e5 <memmove>
    len -= n;
8010895c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010895f:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108962:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108965:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108968:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010896b:	05 00 10 00 00       	add    $0x1000,%eax
80108970:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108973:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108977:	0f 85 6d ff ff ff    	jne    801088ea <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
