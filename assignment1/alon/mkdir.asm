...
main(int argc, char *argv[])
{
  ...
  41:	e8 b6 04 00 00       	call   4fc <mkdir>
  ...
  5a:	c7 44 24 04 e6 09 00 	movl   $0x9e6,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5a2:	0f b6 90 c8 0c 00 00 	movzbl 0xcc8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 701:	75 27                	jne    72a <printf+0x11f>
          s = "(null)";
 703:	c7 45 f4 02 0a 00 00 	movl   $0xa02,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7cf:	a1 e4 0c 00 00       	mov    0xce4,%eax
...
free(void *ap)
{
 ...
 890:	a3 e4 0c 00 00       	mov    %eax,0xce4
}
 895:	c9                   	leave  
 896:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8e3:	e8 d8 fe ff ff       	call   7c0 <free>
  return freep;
 8e8:	a1 e4 0c 00 00       	mov    0xce4,%eax
}
 8ed:	c9                   	leave  
 8ee:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 901:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 904:	a1 e4 0c 00 00       	mov    0xce4,%eax
 909:	89 45 f0             	mov    %eax,-0x10(%ebp)
 90c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 910:	75 23                	jne    935 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 912:	c7 45 f0 dc 0c 00 00 	movl   $0xcdc,-0x10(%ebp)
 919:	8b 45 f0             	mov    -0x10(%ebp),%eax
 91c:	a3 e4 0c 00 00       	mov    %eax,0xce4
 921:	a1 e4 0c 00 00       	mov    0xce4,%eax
 926:	a3 dc 0c 00 00       	mov    %eax,0xcdc
    base.s.size = 0;
 92b:	c7 05 e0 0c 00 00 00 	movl   $0x0,0xce0
 932:	00 00 00 
  }
 ...
 988:	a3 e4 0c 00 00       	mov    %eax,0xce4
      return (void*)(p + 1);
 ...
 993:	eb 38                	jmp    9cd <malloc+0xde>
    ...
    if(p == freep)
 995:	a1 e4 0c 00 00       	mov    0xce4,%eax
