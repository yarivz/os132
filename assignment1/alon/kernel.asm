...
8010003a:	c7 44 24 04 98 87 10 	movl   $0x80108798,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
80100049:	e8 70 50 00 00       	call   801050be <initlock>
...
801000bd:	e8 1d 50 00 00       	call   801050df <acquire>
...
80100104:	e8 38 50 00 00       	call   80105141 <release>
        return b;
...
8010017c:	e8 c0 4f 00 00       	call   80105141 <release>
      return b;
...
80100198:	c7 04 24 9f 87 10 80 	movl   $0x8010879f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 b0 87 10 80 	movl   $0x801087b0,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 b7 87 10 80 	movl   $0x801087b7,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 9e 4e 00 00       	call   801050df <acquire>
...
8010029d:	e8 31 4c 00 00       	call   80104ed3 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 93 4e 00 00       	call   80105141 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 1e 4d 00 00       	call   801050df <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 be 87 10 80 	movl   $0x801087be,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec c7 87 10 80 	movl   $0x801087c7,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 06 4c 00 00       	call   80105141 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 ce 87 10 80 	movl   $0x801087ce,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 dd 87 10 80 	movl   $0x801087dd,(%esp)
...
80100592:	e8 f9 4b 00 00       	call   80105190 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 df 87 10 80 	movl   $0x801087df,(%esp)
...
8010072b:	e8 d1 4c 00 00       	call   80105401 <memmove>
    pos -= 80;
...
8010075a:	e8 cf 4b 00 00       	call   8010532e <memset>
  }
...
80100801:	e8 f7 65 00 00       	call   80106dfd <uartputc>
80100806:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010080d:	e8 eb 65 00 00       	call   80106dfd <uartputc>
80100812:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100819:	e8 df 65 00 00       	call   80106dfd <uartputc>
...
80100826:	e8 d2 65 00 00       	call   80106dfd <uartputc>
  cgaputc(c);
...
801008db:	e8 ff 47 00 00       	call   801050df <acquire>
  while((c = getc()) >= 0){
...
8010091c:	e9 aa 01 00 00       	jmp    80100acb <consoleintr+0x1fd>
    case C('P'):  // Process listing.
      procdump();
80100921:	e8 53 46 00 00       	call   80104f79 <procdump>
      break;
...
80100c5a:	e8 74 42 00 00       	call   80104ed3 <wakeup>
        }
      }
      break;
...
80100c87:	e8 b5 44 00 00       	call   80105141 <release>
}
80100c8c:	c9                   	leave  
80100c8d:	c3                   	ret    
...
80100cac:	e8 2e 44 00 00       	call   801050df <acquire>
  while(n > 0){
...
80100cca:	e8 72 44 00 00       	call   80105141 <release>
        ilock(ip);
...
80100cf3:	e8 ff 40 00 00       	call   80104df7 <sleep>
...
80100d71:	e8 cb 43 00 00       	call   80105141 <release>
  ilock(ip);
...
80100da7:	e8 33 43 00 00       	call   801050df <acquire>
  for(i = 0; i < n; i++)
...
80100de1:	e8 5b 43 00 00       	call   80105141 <release>
  ilock(ip);
...
80100dfc:	c7 44 24 04 e3 87 10 	movl   $0x801087e3,0x4(%esp)
80100e03:	80 
80100e04:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100e0b:	e8 ae 42 00 00       	call   801050be <initlock>
  initlock(&input.lock, "input");
80100e10:	c7 44 24 04 eb 87 10 	movl   $0x801087eb,0x4(%esp)
80100e17:	80 
80100e18:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100e1f:	e8 9a 42 00 00       	call   801050be <initlock>
...
80100ee3:	e8 59 70 00 00       	call   80107f41 <setupkvm>
...
80100f7c:	e8 92 73 00 00       	call   80108313 <allocuvm>
...
80100fb9:	e8 66 72 00 00       	call   80108224 <loaduvm>
...
80101024:	e8 ea 72 00 00       	call   80108313 <allocuvm>
...
80101048:	e8 ea 74 00 00       	call   80108537 <clearpteu>
  sp = sz;
...
80101077:	e8 30 45 00 00       	call   801055ac <strlen>
...
80101095:	e8 12 45 00 00       	call   801055ac <strlen>
...
801010bf:	e8 27 76 00 00       	call   801086eb <copyout>
...
8010115f:	e8 87 75 00 00       	call   801086eb <copyout>
...
801011b6:	e8 a3 43 00 00       	call   8010555e <safestrcpy>
...
80101208:	e8 25 6e 00 00       	call   80108032 <switchuvm>
  freevm(oldpgdir);
8010120d:	8b 45 d0             	mov    -0x30(%ebp),%eax
80101210:	89 04 24             	mov    %eax,(%esp)
80101213:	e8 91 72 00 00       	call   801084a9 <freevm>
  return 0;
...
8010124a:	e8 5a 72 00 00       	call   801084a9 <freevm>
  if(ip)
...
8010126e:	c7 44 24 04 f1 87 10 	movl   $0x801087f1,0x4(%esp)
80101275:	80 
80101276:	c7 04 24 80 de 10 80 	movl   $0x8010de80,(%esp)
8010127d:	e8 3c 3e 00 00       	call   801050be <initlock>
}
80101282:	c9                   	leave  
80101283:	c3                   	ret    
...
80101291:	e8 49 3e 00 00       	call   801050df <acquire>
...
801012ba:	e8 82 3e 00 00       	call   80105141 <release>
      return f;
...
801012d8:	e8 64 3e 00 00       	call   80105141 <release>
  return 0;
...
801012f1:	e8 e9 3d 00 00       	call   801050df <acquire>
  if(f->ref < 1)
...
801012fe:	7f 0c                	jg     8010130c <filedup+0x28>
    panic("filedup");
80101300:	c7 04 24 f8 87 10 80 	movl   $0x801087f8,(%esp)
...
80101322:	e8 1a 3e 00 00       	call   80105141 <release>
  return f;
...
80101339:	e8 a1 3d 00 00       	call   801050df <acquire>
  if(f->ref < 1)
...
80101346:	7f 0c                	jg     80101354 <fileclose+0x28>
    panic("fileclose");
80101348:	c7 04 24 00 88 10 80 	movl   $0x80108800,(%esp)
...
80101374:	e8 c8 3d 00 00       	call   80105141 <release>
    return;
...
801013be:	e8 7e 3d 00 00       	call   80105141 <release>
...
801014fd:	eb 0c                	jmp    8010150b <fileread+0xba>
  ...
  panic("fileread");
801014ff:	c7 04 24 0a 88 10 80 	movl   $0x8010880a,(%esp)
...
8010160b:	c7 04 24 13 88 10 80 	movl   $0x80108813,(%esp)
...
8010163e:	eb 0c                	jmp    8010164c <filewrite+0x13f>
  ...
  panic("filewrite");
80101640:	c7 04 24 23 88 10 80 	movl   $0x80108823,(%esp)
...
80101688:	e8 74 3d 00 00       	call   80105401 <memmove>
  brelse(bp);
...
801016ce:	e8 5b 3c 00 00       	call   8010532e <memset>
  log_write(bp);
...
80101830:	0f 82 e1 fe ff ff    	jb     80101717 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
80101836:	c7 04 24 2d 88 10 80 	movl   $0x8010882d,(%esp)
...
801018cd:	c7 04 24 43 88 10 80 	movl   $0x80108843,(%esp)
...
80101921:	c7 44 24 04 56 88 10 	movl   $0x80108856,0x4(%esp)
80101928:	80 
80101929:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101930:	e8 89 37 00 00       	call   801050be <initlock>
}
80101935:	c9                   	leave  
80101936:	c3                   	ret    
...
801019b2:	e8 77 39 00 00       	call   8010532e <memset>
      dip->type = type;
...
80101a02:	0f 82 5a ff ff ff    	jb     80101962 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101a08:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
...
80101aaf:	e8 4d 39 00 00       	call   80105401 <memmove>
  log_write(bp);
...
80101ad9:	e8 01 36 00 00       	call   801050df <acquire>
...
80101b23:	e8 19 36 00 00       	call   80105141 <release>
      return ip;
...
80101b56:	c7 04 24 6f 88 10 80 	movl   $0x8010886f,(%esp)
...
80101b94:	e8 a8 35 00 00       	call   80105141 <release>
...
80101bab:	e8 2f 35 00 00       	call   801050df <acquire>
  ip->ref++;
...
80101bc6:	e8 76 35 00 00       	call   80105141 <release>
  return ip;
...
80101be4:	7f 0c                	jg     80101bf2 <ilock+0x22>
    panic("ilock");
80101be6:	c7 04 24 7f 88 10 80 	movl   $0x8010887f,(%esp)
80101bed:	e8 4b e9 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101bf2:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101bf9:	e8 e1 34 00 00       	call   801050df <acquire>
...
80101c0e:	e8 e4 31 00 00       	call   80104df7 <sleep>
...
80101c38:	e8 04 35 00 00       	call   80105141 <release>
...
80101ce3:	e8 19 37 00 00       	call   80105401 <memmove>
    brelse(bp);
...
80101d0e:	75 0c                	jne    80101d1c <ilock+0x14c>
      panic("ilock: no type");
80101d10:	c7 04 24 85 88 10 80 	movl   $0x80108885,(%esp)
...
80101d3f:	7f 0c                	jg     80101d4d <iunlock+0x2f>
    panic("iunlock");
80101d41:	c7 04 24 94 88 10 80 	movl   $0x80108894,(%esp)
80101d48:	e8 f0 e7 ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101d4d:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101d54:	e8 86 33 00 00       	call   801050df <acquire>
  ip->flags &= ~I_BUSY;
...
80101d70:	e8 5e 31 00 00       	call   80104ed3 <wakeup>
  release(&icache.lock);
80101d75:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101d7c:	e8 c0 33 00 00       	call   80105141 <release>
}
80101d81:	c9                   	leave  
80101d82:	c3                   	ret    
...
80101d90:	e8 4a 33 00 00       	call   801050df <acquire>
...
80101dcc:	74 0c                	je     80101dda <iput+0x57>
      panic("iput busy");
80101dce:	c7 04 24 9c 88 10 80 	movl   $0x8010889c,(%esp)
...
80101df2:	e8 4a 33 00 00       	call   80105141 <release>
    itrunc(ip);
...
80101e1d:	e8 bd 32 00 00       	call   801050df <acquire>
    ip->flags = 0;
...
80101e32:	e8 9c 30 00 00       	call   80104ed3 <wakeup>
  }
  ip->ref--;
...
80101e4d:	e8 ef 32 00 00       	call   80105141 <release>
}
80101e52:	c9                   	leave  
80101e53:	c3                   	ret    
...
80101f62:	c7 04 24 a6 88 10 80 	movl   $0x801088a6,(%esp)
...
801021fa:	e8 02 32 00 00       	call   80105401 <memmove>
    brelse(bp);
...
80102360:	e8 9c 30 00 00       	call   80105401 <memmove>
    log_write(bp);
...
801023e2:	e8 be 30 00 00       	call   801054a5 <strncmp>
}
801023e7:	c9                   	leave  
801023e8:	c3                   	ret    
...
801023fc:	c7 04 24 b9 88 10 80 	movl   $0x801088b9,(%esp)
...
80102438:	74 0c                	je     80102446 <dirlookup+0x5d>
      panic("dirlink read");
8010243a:	c7 04 24 cb 88 10 80 	movl   $0x801088cb,(%esp)
...
8010251c:	74 0c                	je     8010252a <dirlink+0x79>
      panic("dirlink read");
8010251e:	c7 04 24 cb 88 10 80 	movl   $0x801088cb,(%esp)
...
80102564:	e8 94 2f 00 00       	call   801054fd <strncpy>
  de.inum = inum;
...
80102594:	74 0c                	je     801025a2 <dirlink+0xf1>
    panic("dirlink");
80102596:	c7 04 24 d8 88 10 80 	movl   $0x801088d8,(%esp)
...
8010261d:	e8 df 2d 00 00       	call   80105401 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
80102638:	e8 c4 2d 00 00       	call   80105401 <memmove>
    name[len] = 0;
...
80102894:	c7 44 24 04 e0 88 10 	movl   $0x801088e0,0x4(%esp)
8010289b:	80 
8010289c:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
801028a3:	e8 16 28 00 00       	call   801050be <initlock>
  picenable(IRQ_IDE);
...
8010293e:	75 0c                	jne    8010294c <idestart+0x18>
    panic("idestart");
80102940:	c7 04 24 e4 88 10 80 	movl   $0x801088e4,(%esp)
...
80102a66:	e8 74 26 00 00       	call   801050df <acquire>
  if((b = idequeue) == 0){
...
80102a80:	e8 bc 26 00 00       	call   80105141 <release>
...
80102af3:	e8 db 23 00 00       	call   80104ed3 <wakeup>
...
80102b15:	e8 27 26 00 00       	call   80105141 <release>
}
80102b1a:	c9                   	leave  
80102b1b:	c3                   	ret    
...
80102b2e:	c7 04 24 ed 88 10 80 	movl   $0x801088ed,(%esp)
...
80102b47:	c7 04 24 01 89 10 80 	movl   $0x80108901,(%esp)
...
80102bd2:	e8 20 22 00 00       	call   80104df7 <sleep>
...
80102bee:	e8 4e 25 00 00       	call   80105141 <release>
}
80102bf3:	c9                   	leave  
80102bf4:	c3                   	ret    
...
80102c7e:	c7 04 24 34 89 10 80 	movl   $0x80108934,(%esp)
...
80102d3f:	c7 44 24 04 66 89 10 	movl   $0x80108966,0x4(%esp)
80102d46:	80 
80102d47:	c7 04 24 60 f8 10 80 	movl   $0x8010f860,(%esp)
80102d4e:	e8 6b 23 00 00       	call   801050be <initlock>
  kmem.use_lock = 0;
...
80102de0:	81 7d 08 1c 2b 11 80 	cmpl   $0x80112b1c,0x8(%ebp)
...
80102df9:	76 0c                	jbe    80102e07 <kfree+0x39>
    panic("kfree");
80102dfb:	c7 04 24 6b 89 10 80 	movl   $0x8010896b,(%esp)
...
80102e1d:	e8 0c 25 00 00       	call   8010532e <memset>
...
80102e32:	e8 a8 22 00 00       	call   801050df <acquire>
  r = (struct run*)v;
...
80102e60:	e8 dc 22 00 00       	call   80105141 <release>
}
80102e65:	c9                   	leave  
80102e66:	c3                   	ret    
...
80102e7d:	e8 5d 22 00 00       	call   801050df <acquire>
  r = kmem.freelist;
...
80102eaa:	e8 92 22 00 00       	call   80105141 <release>
  return (char*)r;
...
80103226:	c7 04 24 74 89 10 80 	movl   $0x80108974,(%esp)
...
8010337e:	c7 44 24 04 a0 89 10 	movl   $0x801089a0,0x4(%esp)
80103385:	80 
80103386:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
8010338d:	e8 2c 1d 00 00       	call   801050be <initlock>
  readsb(ROOTDEV, &sb);
...
80103440:	e8 bc 1f 00 00       	call   80105401 <memmove>
...
80103592:	e8 48 1b 00 00       	call   801050df <acquire>
  while (log.busy) {
...
801035a8:	e8 4a 18 00 00       	call   80104df7 <sleep>
...
801035c7:	e8 75 1b 00 00       	call   80105141 <release>
}
801035cc:	c9                   	leave  
801035cd:	c3                   	ret    
...
80103648:	c7 04 24 a4 89 10 80 	movl   $0x801089a4,(%esp)
...
8010365d:	c7 04 24 ba 89 10 80 	movl   $0x801089ba,(%esp)
...
801036ec:	e8 10 1d 00 00       	call   80105401 <memmove>
  bwrite(lbuf);
...
8010377f:	80 
80103780:	c7 04 24 1c 2b 11 80 	movl   $0x80112b1c,(%esp)
80103787:	e8 ad f5 ff ff       	call   80102d39 <kinit1>
  kvmalloc();      // kernel page table
8010378c:	e8 6d 48 00 00       	call   80107ffe <kvmalloc>
...
801037a3:	e8 f9 41 00 00       	call   801079a1 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
801037b8:	c7 04 24 d1 89 10 80 	movl   $0x801089d1,(%esp)
...
801037d3:	e8 14 35 00 00       	call   80106cec <uartinit>
  pinit();         // process table
801037d8:	e8 96 0b 00 00       	call   80104373 <pinit>
  tvinit();        // trap vectors
801037dd:	e8 4d 30 00 00       	call   8010682f <tvinit>
  binit();         // buffer cache
...
801037ff:	e8 6e 2f 00 00       	call   80106772 <timerinit>
...
8010382a:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
8010382d:	e8 e3 47 00 00       	call   80108015 <switchkvm>
  seginit();
80103832:	e8 6a 41 00 00       	call   801079a1 <seginit>
  lapicinit(cpunum());
...
8010385f:	c7 04 24 e8 89 10 80 	movl   $0x801089e8,(%esp)
80103866:	e8 36 cb ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
8010386b:	e8 33 31 00 00       	call   801069a3 <idtinit>
...
801038bd:	e8 3f 1b 00 00       	call   80105401 <memmove>
...
80103a4b:	00 
80103a4c:	c7 44 24 04 fc 89 10 	movl   $0x801089fc,0x4(%esp)
80103a53:	80 
80103a54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a57:	89 04 24             	mov    %eax,(%esp)
80103a5a:	e8 46 19 00 00       	call   801053a5 <memcmp>
...
80103b8c:	00 
80103b8d:	c7 44 24 04 01 8a 10 	movl   $0x80108a01,0x4(%esp)
80103b94:	80 
80103b95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103b98:	89 04 24             	mov    %eax,(%esp)
80103b9b:	e8 05 18 00 00       	call   801053a5 <memcmp>
...
80103c66:	8b 04 85 44 8a 10 80 	mov    -0x7fef75bc(,%eax,4),%eax
...
80103c9f:	c7 04 24 06 8a 10 80 	movl   $0x80108a06,(%esp)
...
80103d32:	c7 04 24 24 8a 10 80 	movl   $0x80108a24,(%esp)
...
80104037:	c7 44 24 04 58 8a 10 	movl   $0x80108a58,0x4(%esp)
8010403e:	80 
8010403f:	89 04 24             	mov    %eax,(%esp)
80104042:	e8 77 10 00 00       	call   801050be <initlock>
  (*f0)->type = FD_PIPE;
...
801040ef:	e8 eb 0f 00 00       	call   801050df <acquire>
  if(writable){
...
80104112:	e8 bc 0d 00 00       	call   80104ed3 <wakeup>
...
80104131:	e8 9d 0d 00 00       	call   80104ed3 <wakeup>
  }
...
80104156:	e8 e6 0f 00 00       	call   80105141 <release>
    kfree((char*)p);
...
8010416e:	e8 ce 0f 00 00       	call   80105141 <release>
}
80104173:	c9                   	leave  
80104174:	c3                   	ret    
...
80104182:	e8 58 0f 00 00       	call   801050df <acquire>
  for(i = 0; i < n; i++){
...
801041b3:	e8 89 0f 00 00       	call   80105141 <release>
        return -1;
...
801041cd:	e8 01 0d 00 00       	call   80104ed3 <wakeup>
...
801041e5:	e8 0d 0c 00 00       	call   80104df7 <sleep>
...
8010424c:	e8 82 0c 00 00       	call   80104ed3 <wakeup>
  release(&p->lock);
80104251:	8b 45 08             	mov    0x8(%ebp),%eax
80104254:	89 04 24             	mov    %eax,(%esp)
80104257:	e8 e5 0e 00 00       	call   80105141 <release>
  return n;
...
80104272:	e8 68 0e 00 00       	call   801050df <acquire>
...
8010428c:	e8 b0 0e 00 00       	call   80105141 <release>
      return -1;
...
801042ae:	e8 44 0b 00 00       	call   80104df7 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
8010433e:	e8 90 0b 00 00       	call   80104ed3 <wakeup>
  release(&p->lock);
80104343:	8b 45 08             	mov    0x8(%ebp),%eax
80104346:	89 04 24             	mov    %eax,(%esp)
80104349:	e8 f3 0d 00 00       	call   80105141 <release>
  return i;
...
80104379:	c7 44 24 04 5d 8a 10 	movl   $0x80108a5d,0x4(%esp)
80104380:	80 
80104381:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104388:	e8 31 0d 00 00       	call   801050be <initlock>
}
8010438d:	c9                   	leave  
8010438e:	c3                   	ret    
...
8010439c:	e8 3e 0d 00 00       	call   801050df <acquire>
...
801043b2:	74 26                	je     801043da <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043b4:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801043bb:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
801043c2:	72 e6                	jb     801043aa <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
801043c4:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801043cb:	e8 71 0d 00 00       	call   80105141 <release>
  return 0;
...
801043ff:	e8 3d 0d 00 00       	call   80105141 <release>
...
80104449:	ba e4 67 10 80       	mov    $0x801067e4,%edx
...
80104479:	e8 b0 0e 00 00       	call   8010532e <memset>
  p->context->eip = (uint)forkret;
8010447e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104481:	8b 40 1c             	mov    0x1c(%eax),%eax
80104484:	ba cb 4d 10 80       	mov    $0x80104dcb,%edx
...
801044ae:	e8 8e 3a 00 00       	call   80107f41 <setupkvm>
...
801044c3:	c7 04 24 64 8a 10 80 	movl   $0x80108a64,(%esp)
...
801044e9:	e8 ab 3c 00 00       	call   80108199 <inituvm>
  p->sz = PGSIZE;
...
80104510:	e8 19 0e 00 00       	call   8010532e <memset>
...
80104589:	00 
8010458a:	c7 44 24 04 7d 8a 10 	movl   $0x80108a7d,0x4(%esp)
80104591:	80 
80104592:	89 04 24             	mov    %eax,(%esp)
80104595:	e8 c4 0f 00 00       	call   8010555e <safestrcpy>
  p->cwd = namei("/");
8010459a:	c7 04 24 86 8a 10 80 	movl   $0x80108a86,(%esp)
...
801045ee:	e8 20 3d 00 00       	call   80108313 <allocuvm>
...
80104628:	e8 c0 3d 00 00       	call   801083ed <deallocuvm>
...
80104651:	e8 dc 39 00 00       	call   80108032 <switchuvm>
  return 0;
...
80104696:	e8 e2 3e 00 00       	call   8010857d <copyuvm>
...
801047b0:	e8 a9 0d 00 00       	call   8010555e <safestrcpy>
  acquire(&tickslock);
801047b5:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801047bc:	e8 1e 09 00 00       	call   801050df <acquire>
  np->ctime = ticks;
801047c1:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
801047c6:	89 c2                	mov    %eax,%edx
801047c8:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047cb:	89 50 7c             	mov    %edx,0x7c(%eax)
  release(&tickslock);
801047ce:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801047d5:	e8 67 09 00 00       	call   80105141 <release>
  np->rtime = 0;
...
80104806:	75 0c                	jne    80104814 <exit+0x22>
    panic("init exiting");
80104808:	c7 04 24 88 8a 10 80 	movl   $0x80108a88,(%esp)
...
8010488c:	e8 4e 08 00 00       	call   801050df <acquire>
...
8010489d:	e8 f0 05 00 00       	call   80104e92 <wakeup1>
...
801048da:	e8 b3 05 00 00       	call   80104e92 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048df:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801048e6:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
801048ed:	72 bc                	jb     801048ab <exit+0xb9>
  ...
  acquire(&tickslock);
801048ef:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801048f6:	e8 e4 07 00 00       	call   801050df <acquire>
  proc->etime = ticks;
801048fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104901:	8b 15 c0 2a 11 80    	mov    0x80112ac0,%edx
80104907:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  release(&tickslock);
8010490d:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80104914:	e8 28 08 00 00       	call   80105141 <release>
  proc->state = ZOMBIE;
80104919:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010491f:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104926:	e8 bc 03 00 00       	call   80104ce7 <sched>
  panic("zombie exit");
8010492b:	c7 04 24 95 8a 10 80 	movl   $0x80108a95,(%esp)
...
80104944:	e8 96 07 00 00       	call   801050df <acquire>
  for(;;){
...
801049ac:	e8 f8 3a 00 00       	call   801084a9 <freevm>
        p->state = UNUSED;
...
801049e7:	e8 55 07 00 00       	call   80105141 <release>
        return pid;
...
801049f1:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049f2:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
801049f9:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
...
80104a20:	e8 1c 07 00 00       	call   80105141 <release>
      return -1;
...
80104a3d:	e8 b5 03 00 00       	call   80104df7 <sleep>
  }
...
80104a56:	e8 84 06 00 00       	call   801050df <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
...
80104af1:	e8 b3 39 00 00       	call   801084a9 <freevm>
        p->state = UNUSED;
...
80104b2c:	e8 10 06 00 00       	call   80105141 <release>
        return pid;
...
80104b36:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b37:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
80104b3e:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
...
80104b65:	e8 d7 05 00 00       	call   80105141 <release>
      return -1;
...
80104b82:	e8 70 02 00 00       	call   80104df7 <sleep>
  }
...
80104bb2:	e8 d7 3a 00 00       	call   8010868e <uva2ka>
...
80104bcd:	75 0c                	jne    80104bdb <register_handler+0x4d>
    panic("esp_offset == 0");
80104bcf:	c7 04 24 a1 8a 10 80 	movl   $0x80108aa1,(%esp)
...
80104c40:	e8 9a 04 00 00       	call   801050df <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c45:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104c4c:	eb 7b                	jmp    80104cc9 <scheduler+0x9b>
      if(p->state != RUNNABLE)
80104c4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c51:	8b 40 0c             	mov    0xc(%eax),%eax
80104c54:	83 f8 03             	cmp    $0x3,%eax
80104c57:	75 68                	jne    80104cc1 <scheduler+0x93>
	if(t)
	  cprintf("scheduler proc id: %d\n",t->pid);*/
      switch(SCHEDFLAG)
      {
	case _RR:
	cprintf("bla\n");
80104c59:	c7 04 24 b1 8a 10 80 	movl   $0x80108ab1,(%esp)
80104c60:	e8 3c b7 ff ff       	call   801003a1 <cprintf>
...
80104c74:	e8 b9 33 00 00       	call   80108032 <switchuvm>
      p->state = RUNNING;
80104c79:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c7c:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      p->quanta = QUANTA;
80104c83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c86:	c7 80 88 00 00 00 05 	movl   $0x5,0x88(%eax)
80104c8d:	00 00 00 
...
80104caa:	e8 25 09 00 00       	call   801055d4 <swtch>
      switchkvm();
80104caf:	e8 61 33 00 00       	call   80108015 <switchkvm>
      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
80104cb4:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104cbb:	00 00 00 00 
80104cbf:	eb 01                	jmp    80104cc2 <scheduler+0x94>
...
80104cc1:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cc2:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
80104cc9:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
80104cd0:	0f 82 78 ff ff ff    	jb     80104c4e <scheduler+0x20>
      switchkvm();
      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
...
80104cdd:	e8 5f 04 00 00       	call   80105141 <release>

  }
80104ce2:	e9 4d ff ff ff       	jmp    80104c34 <scheduler+0x6>
...
80104ced:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104cf4:	e8 04 05 00 00       	call   801051fd <holding>
80104cf9:	85 c0                	test   %eax,%eax
80104cfb:	75 0c                	jne    80104d09 <sched+0x22>
    panic("sched ptable.lock");
80104cfd:	c7 04 24 b6 8a 10 80 	movl   $0x80108ab6,(%esp)
80104d04:	e8 34 b8 ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
80104d09:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d0f:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104d15:	83 f8 01             	cmp    $0x1,%eax
80104d18:	74 0c                	je     80104d26 <sched+0x3f>
    panic("sched locks");
80104d1a:	c7 04 24 c8 8a 10 80 	movl   $0x80108ac8,(%esp)
...
80104d2f:	83 f8 04             	cmp    $0x4,%eax
80104d32:	75 0c                	jne    80104d40 <sched+0x59>
    panic("sched running");
80104d34:	c7 04 24 d4 8a 10 80 	movl   $0x80108ad4,(%esp)
80104d3b:	e8 fd b7 ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104d40:	e8 13 f6 ff ff       	call   80104358 <readeflags>
80104d45:	25 00 02 00 00       	and    $0x200,%eax
80104d4a:	85 c0                	test   %eax,%eax
80104d4c:	74 0c                	je     80104d5a <sched+0x73>
    panic("sched interruptible");
80104d4e:	c7 04 24 e2 8a 10 80 	movl   $0x80108ae2,(%esp)
80104d55:	e8 e3 b7 ff ff       	call   8010053d <panic>
  intena = cpu->intena;
...
80104d80:	89 14 24             	mov    %edx,(%esp)
80104d83:	e8 4c 08 00 00       	call   801055d4 <swtch>
  cpu->intena = intena;
...
80104d9f:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104da6:	e8 34 03 00 00       	call   801050df <acquire>
  proc->state = RUNNABLE;
80104dab:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104db1:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104db8:	e8 2a ff ff ff       	call   80104ce7 <sched>
  release(&ptable.lock);
80104dbd:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104dc4:	e8 78 03 00 00       	call   80105141 <release>
}
80104dc9:	c9                   	leave  
80104dca:	c3                   	ret    
...
80104dd8:	e8 64 03 00 00       	call   80105141 <release>

  if (first) {
80104ddd:	a1 20 b0 10 80       	mov    0x8010b020,%eax
...
80104de4:	74 0f                	je     80104df5 <forkret+0x2a>
    ...
    // be run from main().
    first = 0;
80104de6:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
80104ded:	00 00 00 
    initlog();
80104df0:	e8 83 e5 ff ff       	call   80103378 <initlog>
  }
...
80104e05:	75 0c                	jne    80104e13 <sleep+0x1c>
    panic("sleep");
80104e07:	c7 04 24 f6 8a 10 80 	movl   $0x80108af6,(%esp)
...
80104e19:	c7 04 24 fc 8a 10 80 	movl   $0x80108afc,(%esp)
80104e20:	e8 18 b7 ff ff       	call   8010053d <panic>
...
80104e25:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
80104e2c:	74 17                	je     80104e45 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104e2e:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104e35:	e8 a5 02 00 00       	call   801050df <acquire>
    release(lk);
80104e3a:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e3d:	89 04 24             	mov    %eax,(%esp)
80104e40:	e8 fc 02 00 00       	call   80105141 <release>
  }

  // Go to sleep.
  proc->chan = chan;
80104e45:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e4b:	8b 55 08             	mov    0x8(%ebp),%edx
80104e4e:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104e51:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e57:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104e5e:	e8 84 fe ff ff       	call   80104ce7 <sched>

  // Tidy up.
  proc->chan = 0;
80104e63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e69:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104e70:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
80104e77:	74 17                	je     80104e90 <sleep+0x99>
    release(&ptable.lock);
80104e79:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104e80:	e8 bc 02 00 00       	call   80105141 <release>
    acquire(lk);
80104e85:	8b 45 0c             	mov    0xc(%ebp),%eax
80104e88:	89 04 24             	mov    %eax,(%esp)
80104e8b:	e8 4f 02 00 00       	call   801050df <acquire>
  }
}
80104e90:	c9                   	leave  
80104e91:	c3                   	ret    
...
80104e95:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104e98:	c7 45 fc 74 ff 10 80 	movl   $0x8010ff74,-0x4(%ebp)
80104e9f:	eb 27                	jmp    80104ec8 <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104ea1:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ea4:	8b 40 0c             	mov    0xc(%eax),%eax
80104ea7:	83 f8 02             	cmp    $0x2,%eax
80104eaa:	75 15                	jne    80104ec1 <wakeup1+0x2f>
80104eac:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104eaf:	8b 40 20             	mov    0x20(%eax),%eax
80104eb2:	3b 45 08             	cmp    0x8(%ebp),%eax
80104eb5:	75 0a                	jne    80104ec1 <wakeup1+0x2f>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104ec1:	81 45 fc 8c 00 00 00 	addl   $0x8c,-0x4(%ebp)
80104ec8:	81 7d fc 74 22 11 80 	cmpl   $0x80112274,-0x4(%ebp)
80104ecf:	72 d0                	jb     80104ea1 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104ed1:	c9                   	leave  
...
80104ed6:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104ed9:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104ee0:	e8 fa 01 00 00       	call   801050df <acquire>
  wakeup1(chan);
80104ee5:	8b 45 08             	mov    0x8(%ebp),%eax
80104ee8:	89 04 24             	mov    %eax,(%esp)
80104eeb:	e8 a2 ff ff ff       	call   80104e92 <wakeup1>
  release(&ptable.lock);
80104ef0:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104ef7:	e8 45 02 00 00       	call   80105141 <release>
}
80104efc:	c9                   	leave  
80104efd:	c3                   	ret    
...
80104f01:	83 ec 28             	sub    $0x28,%esp
  struct proc *p;

  acquire(&ptable.lock);
80104f04:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104f0b:	e8 cf 01 00 00       	call   801050df <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f10:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104f17:	eb 44                	jmp    80104f5d <kill+0x5f>
    if(p->pid == pid){
80104f19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f1c:	8b 40 10             	mov    0x10(%eax),%eax
80104f1f:	3b 45 08             	cmp    0x8(%ebp),%eax
80104f22:	75 32                	jne    80104f56 <kill+0x58>
      p->killed = 1;
80104f24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f27:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104f2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f31:	8b 40 0c             	mov    0xc(%eax),%eax
80104f34:	83 f8 02             	cmp    $0x2,%eax
80104f37:	75 0a                	jne    80104f43 <kill+0x45>
        p->state = RUNNABLE;
80104f39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f3c:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104f43:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104f4a:	e8 f2 01 00 00       	call   80105141 <release>
      return 0;
80104f4f:	b8 00 00 00 00       	mov    $0x0,%eax
80104f54:	eb 21                	jmp    80104f77 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f56:	81 45 f4 8c 00 00 00 	addl   $0x8c,-0xc(%ebp)
80104f5d:	81 7d f4 74 22 11 80 	cmpl   $0x80112274,-0xc(%ebp)
80104f64:	72 b3                	jb     80104f19 <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104f66:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104f6d:	e8 cf 01 00 00       	call   80105141 <release>
  return -1;
...
80104f7c:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104f7f:	c7 45 f0 74 ff 10 80 	movl   $0x8010ff74,-0x10(%ebp)
80104f86:	e9 db 00 00 00       	jmp    80105066 <procdump+0xed>
    if(p->state == UNUSED)
80104f8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f8e:	8b 40 0c             	mov    0xc(%eax),%eax
80104f91:	85 c0                	test   %eax,%eax
80104f93:	0f 84 c5 00 00 00    	je     8010505e <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104f99:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104f9c:	8b 40 0c             	mov    0xc(%eax),%eax
80104f9f:	83 f8 05             	cmp    $0x5,%eax
80104fa2:	77 23                	ja     80104fc7 <procdump+0x4e>
80104fa4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104fa7:	8b 40 0c             	mov    0xc(%eax),%eax
80104faa:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104fb1:	85 c0                	test   %eax,%eax
80104fb3:	74 12                	je     80104fc7 <procdump+0x4e>
      state = states[p->state];
80104fb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104fb8:	8b 40 0c             	mov    0xc(%eax),%eax
80104fbb:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
80104fc2:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104fc5:	eb 07                	jmp    80104fce <procdump+0x55>
    else
      state = "???";
80104fc7:	c7 45 ec 0d 8b 10 80 	movl   $0x80108b0d,-0x14(%ebp)
...
80104fda:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104fde:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104fe1:	89 54 24 08          	mov    %edx,0x8(%esp)
80104fe5:	89 44 24 04          	mov    %eax,0x4(%esp)
80104fe9:	c7 04 24 11 8b 10 80 	movl   $0x80108b11,(%esp)
80104ff0:	e8 ac b3 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104ff5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104ff8:	8b 40 0c             	mov    0xc(%eax),%eax
80104ffb:	83 f8 02             	cmp    $0x2,%eax
80104ffe:	75 50                	jne    80105050 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80105000:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105003:	8b 40 1c             	mov    0x1c(%eax),%eax
80105006:	8b 40 0c             	mov    0xc(%eax),%eax
80105009:	83 c0 08             	add    $0x8,%eax
8010500c:	8d 55 c4             	lea    -0x3c(%ebp),%edx
8010500f:	89 54 24 04          	mov    %edx,0x4(%esp)
80105013:	89 04 24             	mov    %eax,(%esp)
80105016:	e8 75 01 00 00       	call   80105190 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
8010501b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80105022:	eb 1b                	jmp    8010503f <procdump+0xc6>
        cprintf(" %p", pc[i]);
80105024:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105027:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010502b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010502f:	c7 04 24 1a 8b 10 80 	movl   $0x80108b1a,(%esp)
80105036:	e8 66 b3 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
8010503b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010503f:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80105043:	7f 0b                	jg     80105050 <procdump+0xd7>
80105045:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105048:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
8010504c:	85 c0                	test   %eax,%eax
8010504e:	75 d4                	jne    80105024 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80105050:	c7 04 24 1e 8b 10 80 	movl   $0x80108b1e,(%esp)
80105057:	e8 45 b3 ff ff       	call   801003a1 <cprintf>
8010505c:	eb 01                	jmp    8010505f <procdump+0xe6>
  char *state;
  uint pc[10];
...
8010505e:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010505f:	81 45 f0 8c 00 00 00 	addl   $0x8c,-0x10(%ebp)
80105066:	81 7d f0 74 22 11 80 	cmpl   $0x80112274,-0x10(%ebp)
8010506d:	0f 82 18 ff ff ff    	jb     80104f8b <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
8010507f:	9c                   	pushf  
80105080:	5b                   	pop    %ebx
80105081:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80105084:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
xchg(volatile uint *addr, uint newval)
{
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
801050a9:	89 c3                	mov    %eax,%ebx
801050ab:	89 d8                	mov    %ebx,%eax
801050ad:	f0 87 02             	lock xchg %eax,(%edx)
801050b0:	89 c3                	mov    %eax,%ebx
801050b2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
801050b5:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
801050c4:	8b 55 0c             	mov    0xc(%ebp),%edx
801050c7:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801050ca:	8b 45 08             	mov    0x8(%ebp),%eax
801050cd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801050d3:	8b 45 08             	mov    0x8(%ebp),%eax
801050d6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801050dd:	5d                   	pop    %ebp
801050de:	c3                   	ret    
...
801050e5:	e8 3d 01 00 00       	call   80105227 <pushcli>
  if(holding(lk))
801050ea:	8b 45 08             	mov    0x8(%ebp),%eax
801050ed:	89 04 24             	mov    %eax,(%esp)
801050f0:	e8 08 01 00 00       	call   801051fd <holding>
801050f5:	85 c0                	test   %eax,%eax
801050f7:	74 0c                	je     80105105 <acquire+0x26>
    panic("acquire");
801050f9:	c7 04 24 4a 8b 10 80 	movl   $0x80108b4a,(%esp)
80105100:	e8 38 b4 ff ff       	call   8010053d <panic>
...
80105114:	e8 80 ff ff ff       	call   80105099 <xchg>
80105119:	85 c0                	test   %eax,%eax
8010511b:	75 e9                	jne    80105106 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
8010511d:	8b 45 08             	mov    0x8(%ebp),%eax
80105120:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105127:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
8010512a:	8b 45 08             	mov    0x8(%ebp),%eax
8010512d:	83 c0 0c             	add    $0xc,%eax
80105130:	89 44 24 04          	mov    %eax,0x4(%esp)
80105134:	8d 45 08             	lea    0x8(%ebp),%eax
80105137:	89 04 24             	mov    %eax,(%esp)
8010513a:	e8 51 00 00 00       	call   80105190 <getcallerpcs>
}
8010513f:	c9                   	leave  
80105140:	c3                   	ret    
...
8010514d:	e8 ab 00 00 00       	call   801051fd <holding>
80105152:	85 c0                	test   %eax,%eax
80105154:	75 0c                	jne    80105162 <release+0x21>
    panic("release");
80105156:	c7 04 24 52 8b 10 80 	movl   $0x80108b52,(%esp)
...
80105184:	e8 10 ff ff ff       	call   80105099 <xchg>

  popcli();
80105189:	e8 e1 00 00 00       	call   8010526f <popcli>
}
8010518e:	c9                   	leave  
8010518f:	c3                   	ret    
...
801051a6:	eb 32                	jmp    801051da <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801051a8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
801051ac:	74 47                	je     801051f5 <getcallerpcs+0x65>
801051ae:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
801051b5:	76 3e                	jbe    801051f5 <getcallerpcs+0x65>
801051b7:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
801051bb:	74 38                	je     801051f5 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
801051bd:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051c0:	c1 e0 02             	shl    $0x2,%eax
801051c3:	03 45 0c             	add    0xc(%ebp),%eax
801051c6:	8b 55 fc             	mov    -0x4(%ebp),%edx
801051c9:	8b 52 04             	mov    0x4(%edx),%edx
801051cc:	89 10                	mov    %edx,(%eax)
...
801051de:	7e c8                	jle    801051a8 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801051e0:	eb 13                	jmp    801051f5 <getcallerpcs+0x65>
    pcs[i] = 0;
801051e2:	8b 45 f8             	mov    -0x8(%ebp),%eax
801051e5:	c1 e0 02             	shl    $0x2,%eax
801051e8:	03 45 0c             	add    0xc(%ebp),%eax
801051eb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
801051f5:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801051f9:	7e e7                	jle    801051e2 <getcallerpcs+0x52>
    pcs[i] = 0;
}
801051fb:	c9                   	leave  
801051fc:	c3                   	ret    
...
80105207:	74 17                	je     80105220 <holding+0x23>
80105209:	8b 45 08             	mov    0x8(%ebp),%eax
8010520c:	8b 50 08             	mov    0x8(%eax),%edx
8010520f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105215:	39 c2                	cmp    %eax,%edx
80105217:	75 07                	jne    80105220 <holding+0x23>
80105219:	b8 01 00 00 00       	mov    $0x1,%eax
8010521e:	eb 05                	jmp    80105225 <holding+0x28>
...
8010522a:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
8010522d:	e8 46 fe ff ff       	call   80105078 <readeflags>
80105232:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105235:	e8 53 fe ff ff       	call   8010508d <cli>
  if(cpu->ncli++ == 0)
8010523a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105240:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105246:	85 d2                	test   %edx,%edx
80105248:	0f 94 c1             	sete   %cl
8010524b:	83 c2 01             	add    $0x1,%edx
8010524e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105254:	84 c9                	test   %cl,%cl
80105256:	74 15                	je     8010526d <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105258:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010525e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105261:	81 e2 00 02 00 00    	and    $0x200,%edx
80105267:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
8010526d:	c9                   	leave  
8010526e:	c3                   	ret    
...
80105272:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105275:	e8 fe fd ff ff       	call   80105078 <readeflags>
8010527a:	25 00 02 00 00       	and    $0x200,%eax
8010527f:	85 c0                	test   %eax,%eax
80105281:	74 0c                	je     8010528f <popcli+0x20>
    panic("popcli - interruptible");
80105283:	c7 04 24 5a 8b 10 80 	movl   $0x80108b5a,(%esp)
8010528a:	e8 ae b2 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
8010528f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105295:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010529b:	83 ea 01             	sub    $0x1,%edx
8010529e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801052a4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801052aa:	85 c0                	test   %eax,%eax
801052ac:	79 0c                	jns    801052ba <popcli+0x4b>
    panic("popcli");
801052ae:	c7 04 24 71 8b 10 80 	movl   $0x80108b71,(%esp)
801052b5:	e8 83 b2 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
801052ba:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801052c0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801052c6:	85 c0                	test   %eax,%eax
801052c8:	75 15                	jne    801052df <popcli+0x70>
801052ca:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801052d0:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801052d6:	85 c0                	test   %eax,%eax
801052d8:	74 05                	je     801052df <popcli+0x70>
    sti();
801052da:	e8 b4 fd ff ff       	call   80105093 <sti>
}
801052df:	c9                   	leave  
801052e0:	c3                   	ret    
801052e1:	00 00                	add    %al,(%eax)
	...
...
8010531d:	fc                   	cld    
8010531e:	f3 ab                	rep stos %eax,%es:(%edi)
...
80105337:	83 e0 03             	and    $0x3,%eax
8010533a:	85 c0                	test   %eax,%eax
8010533c:	75 49                	jne    80105387 <memset+0x59>
8010533e:	8b 45 10             	mov    0x10(%ebp),%eax
80105341:	83 e0 03             	and    $0x3,%eax
80105344:	85 c0                	test   %eax,%eax
80105346:	75 3f                	jne    80105387 <memset+0x59>
    c &= 0xFF;
80105348:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010534f:	8b 45 10             	mov    0x10(%ebp),%eax
80105352:	c1 e8 02             	shr    $0x2,%eax
80105355:	89 c2                	mov    %eax,%edx
80105357:	8b 45 0c             	mov    0xc(%ebp),%eax
8010535a:	89 c1                	mov    %eax,%ecx
8010535c:	c1 e1 18             	shl    $0x18,%ecx
8010535f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105362:	c1 e0 10             	shl    $0x10,%eax
80105365:	09 c1                	or     %eax,%ecx
80105367:	8b 45 0c             	mov    0xc(%ebp),%eax
8010536a:	c1 e0 08             	shl    $0x8,%eax
8010536d:	09 c8                	or     %ecx,%eax
8010536f:	0b 45 0c             	or     0xc(%ebp),%eax
80105372:	89 54 24 08          	mov    %edx,0x8(%esp)
80105376:	89 44 24 04          	mov    %eax,0x4(%esp)
8010537a:	8b 45 08             	mov    0x8(%ebp),%eax
8010537d:	89 04 24             	mov    %eax,(%esp)
80105380:	e8 84 ff ff ff       	call   80105309 <stosl>
80105385:	eb 19                	jmp    801053a0 <memset+0x72>
  } else
    stosb(dst, c, n);
...
8010539b:	e8 44 ff ff ff       	call   801052e4 <stosb>
  return dst;
...
801053b4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801053b7:	eb 32                	jmp    801053eb <memcmp+0x46>
    if(*s1 != *s2)
...
801053c7:	74 1a                	je     801053e3 <memcmp+0x3e>
      return *s1 - *s2;
...
801053dd:	29 c1                	sub    %eax,%ecx
801053df:	89 c8                	mov    %ecx,%eax
801053e1:	eb 1c                	jmp    801053ff <memcmp+0x5a>
    s1++, s2++;
...
801053ef:	0f 95 c0             	setne  %al
801053f2:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801053f6:	84 c0                	test   %al,%al
801053f8:	75 bf                	jne    801053b9 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
801053fa:	b8 00 00 00 00       	mov    $0x0,%eax
}
801053ff:	c9                   	leave  
80105400:	c3                   	ret    
...
80105419:	73 54                	jae    8010546f <memmove+0x6e>
8010541b:	8b 45 10             	mov    0x10(%ebp),%eax
8010541e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105421:	01 d0                	add    %edx,%eax
80105423:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105426:	76 47                	jbe    8010546f <memmove+0x6e>
    s += n;
80105428:	8b 45 10             	mov    0x10(%ebp),%eax
8010542b:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010542e:	8b 45 10             	mov    0x10(%ebp),%eax
80105431:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105434:	eb 13                	jmp    80105449 <memmove+0x48>
      *--d = *--s;
80105436:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010543a:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
8010544d:	0f 95 c0             	setne  %al
80105450:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105454:	84 c0                	test   %al,%al
80105456:	75 de                	jne    80105436 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105458:	eb 25                	jmp    8010547f <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
8010545d:	0f b6 10             	movzbl (%eax),%edx
80105460:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105463:	88 10                	mov    %dl,(%eax)
80105465:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105469:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010546d:	eb 01                	jmp    80105470 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105474:	0f 95 c0             	setne  %al
80105477:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010547b:	84 c0                	test   %al,%al
8010547d:	75 db                	jne    8010545a <memmove+0x59>
      *d++ = *s++;
...
8010548d:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010549e:	e8 5e ff ff ff       	call   80105401 <memmove>
}
801054a3:	c9                   	leave  
801054a4:	c3                   	ret    
...
801054a6:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801054a8:	eb 0c                	jmp    801054b6 <strncmp+0x11>
    n--, p++, q++;
801054aa:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801054ae:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801054b2:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
8010554e:	0f 9f c0             	setg   %al
80105551:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105555:	84 c0                	test   %al,%al
80105557:	75 e4                	jne    8010553d <strncpy+0x40>
    *s++ = 0;
  return os;
...
80105573:	eb 35                	jmp    801055aa <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105575:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105579:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010557d:	7e 22                	jle    801055a1 <safestrcpy+0x43>
...
80105592:	0f 95 c0             	setne  %al
80105595:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105599:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010559d:	84 c0                	test   %al,%al
8010559f:	75 d4                	jne    80105575 <safestrcpy+0x17>
    ;
  *s = 0;
801055a1:	8b 45 08             	mov    0x8(%ebp),%eax
801055a4:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
801055af:	83 ec 10             	sub    $0x10,%esp
  int n;

  for(n = 0; s[n]; n++)
801055b2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801055b9:	eb 04                	jmp    801055bf <strlen+0x13>
801055bb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055bf:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055c2:	03 45 08             	add    0x8(%ebp),%eax
801055c5:	0f b6 00             	movzbl (%eax),%eax
801055c8:	84 c0                	test   %al,%al
801055ca:	75 ef                	jne    801055bb <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801055d4:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801055d8:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801055de:	56                   	push   %esi
  pushl %edi
801055df:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
801055e0:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801055e2:	89 d4                	mov    %edx,%esp
...
801055f4:	3b 45 0c             	cmp    0xc(%ebp),%eax
801055f7:	76 0f                	jbe    80105608 <fetchint+0x1c>
801055f9:	8b 45 0c             	mov    0xc(%ebp),%eax
801055fc:	8d 50 04             	lea    0x4(%eax),%edx
801055ff:	8b 45 08             	mov    0x8(%ebp),%eax
80105602:	8b 00                	mov    (%eax),%eax
80105604:	39 c2                	cmp    %eax,%edx
80105606:	76 07                	jbe    8010560f <fetchint+0x23>
    return -1;
80105608:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010560d:	eb 0f                	jmp    8010561e <fetchint+0x32>
  *ip = *(int*)(addr);
8010560f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105612:	8b 10                	mov    (%eax),%edx
...
8010562b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010562e:	77 07                	ja     80105637 <fetchstr+0x17>
    return -1;
80105630:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105635:	eb 45                	jmp    8010567c <fetchstr+0x5c>
  *pp = (char*)addr;
...
80105669:	eb 11                	jmp    8010567c <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
8010566b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010566f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105672:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105675:	72 da                	jb     80105651 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010568a:	8b 40 18             	mov    0x18(%eax),%eax
8010568d:	8b 50 44             	mov    0x44(%eax),%edx
80105690:	8b 45 08             	mov    0x8(%ebp),%eax
80105693:	c1 e0 02             	shl    $0x2,%eax
80105696:	01 d0                	add    %edx,%eax
80105698:	8d 48 04             	lea    0x4(%eax),%ecx
8010569b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801056a1:	8b 55 0c             	mov    0xc(%ebp),%edx
801056a4:	89 54 24 08          	mov    %edx,0x8(%esp)
801056a8:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801056ac:	89 04 24             	mov    %eax,(%esp)
801056af:	e8 38 ff ff ff       	call   801055ec <fetchint>
}
801056b4:	c9                   	leave  
801056b5:	c3                   	ret    
...
801056c9:	e8 b0 ff ff ff       	call   8010567e <argint>
801056ce:	85 c0                	test   %eax,%eax
801056d0:	79 07                	jns    801056d9 <argptr+0x23>
    return -1;
801056d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056d7:	eb 3d                	jmp    80105716 <argptr+0x60>
...
8010571b:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  if(argint(n, &addr) < 0)
...
8010575f:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105762:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105768:	8b 40 18             	mov    0x18(%eax),%eax
8010576b:	8b 40 1c             	mov    0x1c(%eax),%eax
8010576e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80105771:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105775:	78 2e                	js     801057a5 <syscall+0x4a>
80105777:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
8010577b:	7f 28                	jg     801057a5 <syscall+0x4a>
8010577d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105780:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105787:	85 c0                	test   %eax,%eax
80105789:	74 1a                	je     801057a5 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
8010578b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105791:	8b 58 18             	mov    0x18(%eax),%ebx
80105794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105797:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
8010579e:	ff d0                	call   *%eax
801057a0:	89 43 1c             	mov    %eax,0x1c(%ebx)
801057a3:	eb 73                	jmp    80105818 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
801057a5:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
801057a9:	7e 30                	jle    801057db <syscall+0x80>
801057ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ae:	83 f8 16             	cmp    $0x16,%eax
801057b1:	77 28                	ja     801057db <syscall+0x80>
801057b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057b6:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801057bd:	85 c0                	test   %eax,%eax
801057bf:	74 1a                	je     801057db <syscall+0x80>
    proc->tf->eax = syscalls[num]();
801057c1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057c7:	8b 58 18             	mov    0x18(%eax),%ebx
801057ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057cd:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801057d4:	ff d0                	call   *%eax
801057d6:	89 43 1c             	mov    %eax,0x1c(%ebx)
801057d9:	eb 3d                	jmp    80105818 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801057db:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801057e1:	8d 48 6c             	lea    0x6c(%eax),%ecx
801057e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801057ea:	8b 40 10             	mov    0x10(%eax),%eax
801057ed:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057f0:	89 54 24 0c          	mov    %edx,0xc(%esp)
801057f4:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801057f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801057fc:	c7 04 24 78 8b 10 80 	movl   $0x80108b78,(%esp)
80105803:	e8 99 ab ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105808:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010580e:	8b 40 18             	mov    0x18(%eax),%eax
80105811:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105818:	83 c4 24             	add    $0x24,%esp
8010581b:	5b                   	pop    %ebx
8010581c:	5d                   	pop    %ebp
8010581d:	c3                   	ret    
	...
...
80105898:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010589b:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801058a2:	eb 30                	jmp    801058d4 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
801058a4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058aa:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058ad:	83 c2 08             	add    $0x8,%edx
801058b0:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801058b4:	85 c0                	test   %eax,%eax
801058b6:	75 18                	jne    801058d0 <fdalloc+0x3b>
      proc->ofile[fd] = f;
801058b8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801058be:	8b 55 fc             	mov    -0x4(%ebp),%edx
801058c1:	8d 4a 08             	lea    0x8(%edx),%ecx
801058c4:	8b 55 08             	mov    0x8(%ebp),%edx
801058c7:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801058cb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801058ce:	eb 0f                	jmp    801058df <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
801058d4:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801058d8:	7e ca                	jle    801058a4 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010593b:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;
...
80105941:	89 44 24 08          	mov    %eax,0x8(%esp)
80105945:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010594c:	00 
8010594d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105954:	e8 c7 fe ff ff       	call   80105820 <argfd>
80105959:	85 c0                	test   %eax,%eax
8010595b:	78 35                	js     80105992 <sys_read+0x5a>
8010595d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105960:	89 44 24 04          	mov    %eax,0x4(%esp)
80105964:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010596b:	e8 0e fd ff ff       	call   8010567e <argint>
80105970:	85 c0                	test   %eax,%eax
80105972:	78 1e                	js     80105992 <sys_read+0x5a>
...
80105989:	e8 28 fd ff ff       	call   801056b6 <argptr>
8010598e:	85 c0                	test   %eax,%eax
80105990:	79 07                	jns    80105999 <sys_read+0x61>
    return -1;
80105992:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105997:	eb 19                	jmp    801059b2 <sys_read+0x7a>
  return fileread(f, p, n);
80105999:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010599c:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010599f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801059a6:	89 54 24 04          	mov    %edx,0x4(%esp)
801059aa:	89 04 24             	mov    %eax,(%esp)
801059ad:	e8 9f ba ff ff       	call   80101451 <fileread>
}
801059b2:	c9                   	leave  
801059b3:	c3                   	ret    
...
801059d0:	e8 4b fe ff ff       	call   80105820 <argfd>
801059d5:	85 c0                	test   %eax,%eax
801059d7:	78 35                	js     80105a0e <sys_write+0x5a>
801059d9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801059dc:	89 44 24 04          	mov    %eax,0x4(%esp)
801059e0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801059e7:	e8 92 fc ff ff       	call   8010567e <argint>
801059ec:	85 c0                	test   %eax,%eax
801059ee:	78 1e                	js     80105a0e <sys_write+0x5a>
801059f0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059f3:	89 44 24 08          	mov    %eax,0x8(%esp)
801059f7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801059fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801059fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a05:	e8 ac fc ff ff       	call   801056b6 <argptr>
80105a0a:	85 c0                	test   %eax,%eax
80105a0c:	79 07                	jns    80105a15 <sys_write+0x61>
    return -1;
80105a0e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a13:	eb 19                	jmp    80105a2e <sys_write+0x7a>
  return filewrite(f, p, n);
80105a15:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105a18:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105a1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a1e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105a22:	89 54 24 04          	mov    %edx,0x4(%esp)
80105a26:	89 04 24             	mov    %eax,(%esp)
80105a29:	e8 df ba ff ff       	call   8010150d <filewrite>
}
80105a2e:	c9                   	leave  
80105a2f:	c3                   	ret    
...
80105a8e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105a95:	00 
80105a96:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a9d:	e8 7e fd ff ff       	call   80105820 <argfd>
80105aa2:	85 c0                	test   %eax,%eax
80105aa4:	78 1f                	js     80105ac5 <sys_fstat+0x44>
80105aa6:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105aad:	00 
80105aae:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105ab1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ab5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105abc:	e8 f5 fb ff ff       	call   801056b6 <argptr>
80105ac1:	85 c0                	test   %eax,%eax
80105ac3:	79 07                	jns    80105acc <sys_fstat+0x4b>
    return -1;
80105ac5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aca:	eb 12                	jmp    80105ade <sys_fstat+0x5d>
  return filestat(f, st);
80105acc:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105acf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad2:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ad6:	89 04 24             	mov    %eax,(%esp)
80105ad9:	e8 24 b9 ff ff       	call   80101402 <filestat>
}
80105ade:	c9                   	leave  
80105adf:	c3                   	ret    
...
80105ae3:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80105ae6:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105ae9:	89 44 24 04          	mov    %eax,0x4(%esp)
80105aed:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105af4:	e8 1f fc ff ff       	call   80105718 <argstr>
80105af9:	85 c0                	test   %eax,%eax
80105afb:	78 17                	js     80105b14 <sys_link+0x34>
80105afd:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105b00:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b0b:	e8 08 fc ff ff       	call   80105718 <argstr>
80105b10:	85 c0                	test   %eax,%eax
80105b12:	79 0a                	jns    80105b1e <sys_link+0x3e>
    return -1;
80105b14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b19:	e9 3c 01 00 00       	jmp    80105c5a <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80105b1e:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105b21:	89 04 24             	mov    %eax,(%esp)
80105b24:	e8 49 cc ff ff       	call   80102772 <namei>
80105b29:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105b2c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b30:	75 0a                	jne    80105b3c <sys_link+0x5c>
    return -1;
80105b32:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b37:	e9 1e 01 00 00       	jmp    80105c5a <sys_link+0x17a>

  begin_trans();
80105b3c:	e8 44 da ff ff       	call   80103585 <begin_trans>

  ilock(ip);
80105b41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b44:	89 04 24             	mov    %eax,(%esp)
80105b47:	e8 84 c0 ff ff       	call   80101bd0 <ilock>
  if(ip->type == T_DIR){
80105b4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b4f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b53:	66 83 f8 01          	cmp    $0x1,%ax
80105b57:	75 1a                	jne    80105b73 <sys_link+0x93>
    iunlockput(ip);
80105b59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5c:	89 04 24             	mov    %eax,(%esp)
80105b5f:	e8 f0 c2 ff ff       	call   80101e54 <iunlockput>
    commit_trans();
80105b64:	e8 65 da ff ff       	call   801035ce <commit_trans>
    return -1;
80105b69:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b6e:	e9 e7 00 00 00       	jmp    80105c5a <sys_link+0x17a>
  }

  ip->nlink++;
80105b73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b76:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b7a:	8d 50 01             	lea    0x1(%eax),%edx
...
80105b8a:	e8 85 be ff ff       	call   80101a14 <iupdate>
  iunlock(ip);
80105b8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b92:	89 04 24             	mov    %eax,(%esp)
80105b95:	e8 84 c1 ff ff       	call   80101d1e <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105b9a:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b9d:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105ba0:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ba4:	89 04 24             	mov    %eax,(%esp)
80105ba7:	e8 e8 cb ff ff       	call   80102794 <nameiparent>
80105bac:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105baf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105bb3:	74 68                	je     80105c1d <sys_link+0x13d>
    goto bad;
  ilock(dp);
80105bb5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bb8:	89 04 24             	mov    %eax,(%esp)
80105bbb:	e8 10 c0 ff ff       	call   80101bd0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105bc0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bc3:	8b 10                	mov    (%eax),%edx
80105bc5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bc8:	8b 00                	mov    (%eax),%eax
80105bca:	39 c2                	cmp    %eax,%edx
80105bcc:	75 20                	jne    80105bee <sys_link+0x10e>
80105bce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bd1:	8b 40 04             	mov    0x4(%eax),%eax
80105bd4:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bd8:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105bdb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be2:	89 04 24             	mov    %eax,(%esp)
80105be5:	e8 c7 c8 ff ff       	call   801024b1 <dirlink>
80105bea:	85 c0                	test   %eax,%eax
80105bec:	79 0d                	jns    80105bfb <sys_link+0x11b>
    iunlockput(dp);
80105bee:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bf1:	89 04 24             	mov    %eax,(%esp)
80105bf4:	e8 5b c2 ff ff       	call   80101e54 <iunlockput>
    goto bad;
80105bf9:	eb 23                	jmp    80105c1e <sys_link+0x13e>
  }
  iunlockput(dp);
80105bfb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bfe:	89 04 24             	mov    %eax,(%esp)
80105c01:	e8 4e c2 ff ff       	call   80101e54 <iunlockput>
  iput(ip);
80105c06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c09:	89 04 24             	mov    %eax,(%esp)
80105c0c:	e8 72 c1 ff ff       	call   80101d83 <iput>

  commit_trans();
80105c11:	e8 b8 d9 ff ff       	call   801035ce <commit_trans>

  return 0;
80105c16:	b8 00 00 00 00       	mov    $0x0,%eax
80105c1b:	eb 3d                	jmp    80105c5a <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105c24:	e8 a7 bf ff ff       	call   80101bd0 <ilock>
  ip->nlink--;
80105c29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c2c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c30:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105c40:	e8 cf bd ff ff       	call   80101a14 <iupdate>
  iunlockput(ip);
80105c45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c48:	89 04 24             	mov    %eax,(%esp)
80105c4b:	e8 04 c2 ff ff       	call   80101e54 <iunlockput>
  commit_trans();
80105c50:	e8 79 d9 ff ff       	call   801035ce <commit_trans>
  return -1;
...
80105c69:	eb 4b                	jmp    80105cb6 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105c6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c6e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105c75:	00 
80105c76:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c7a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105c7d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c81:	8b 45 08             	mov    0x8(%ebp),%eax
80105c84:	89 04 24             	mov    %eax,(%esp)
80105c87:	e8 3a c4 ff ff       	call   801020c6 <readi>
80105c8c:	83 f8 10             	cmp    $0x10,%eax
80105c8f:	74 0c                	je     80105c9d <isdirempty+0x41>
      panic("isdirempty: readi");
80105c91:	c7 04 24 94 8b 10 80 	movl   $0x80108b94,(%esp)
80105c98:	e8 a0 a8 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105c9d:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105ca1:	66 85 c0             	test   %ax,%ax
80105ca4:	74 07                	je     80105cad <isdirempty+0x51>
      return 0;
80105ca6:	b8 00 00 00 00       	mov    $0x0,%eax
80105cab:	eb 1b                	jmp    80105cc8 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105cb0:	83 c0 10             	add    $0x10,%eax
80105cb3:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105cb6:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105cb9:	8b 45 08             	mov    0x8(%ebp),%eax
80105cbc:	8b 40 18             	mov    0x18(%eax),%eax
80105cbf:	39 c2                	cmp    %eax,%edx
80105cc1:	72 a8                	jb     80105c6b <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105ccd:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
...
80105cd7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105cde:	e8 35 fa ff ff       	call   80105718 <argstr>
80105ce3:	85 c0                	test   %eax,%eax
80105ce5:	79 0a                	jns    80105cf1 <sys_unlink+0x27>
    return -1;
80105ce7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cec:	e9 aa 01 00 00       	jmp    80105e9b <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105cf1:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105cf4:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105cf7:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cfb:	89 04 24             	mov    %eax,(%esp)
80105cfe:	e8 91 ca ff ff       	call   80102794 <nameiparent>
80105d03:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d06:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d0a:	75 0a                	jne    80105d16 <sys_unlink+0x4c>
    return -1;
80105d0c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d11:	e9 85 01 00 00       	jmp    80105e9b <sys_unlink+0x1d1>

  begin_trans();
80105d16:	e8 6a d8 ff ff       	call   80103585 <begin_trans>

  ilock(dp);
80105d1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d1e:	89 04 24             	mov    %eax,(%esp)
80105d21:	e8 aa be ff ff       	call   80101bd0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105d26:	c7 44 24 04 a6 8b 10 	movl   $0x80108ba6,0x4(%esp)
80105d2d:	80 
80105d2e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d31:	89 04 24             	mov    %eax,(%esp)
80105d34:	e8 8e c6 ff ff       	call   801023c7 <namecmp>
80105d39:	85 c0                	test   %eax,%eax
80105d3b:	0f 84 45 01 00 00    	je     80105e86 <sys_unlink+0x1bc>
80105d41:	c7 44 24 04 a8 8b 10 	movl   $0x80108ba8,0x4(%esp)
80105d48:	80 
80105d49:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d4c:	89 04 24             	mov    %eax,(%esp)
80105d4f:	e8 73 c6 ff ff       	call   801023c7 <namecmp>
80105d54:	85 c0                	test   %eax,%eax
80105d56:	0f 84 2a 01 00 00    	je     80105e86 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105d5c:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105d5f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d63:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105d66:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d6d:	89 04 24             	mov    %eax,(%esp)
80105d70:	e8 74 c6 ff ff       	call   801023e9 <dirlookup>
80105d75:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d78:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d7c:	0f 84 03 01 00 00    	je     80105e85 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105d82:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d85:	89 04 24             	mov    %eax,(%esp)
80105d88:	e8 43 be ff ff       	call   80101bd0 <ilock>

  if(ip->nlink < 1)
80105d8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d90:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d94:	66 85 c0             	test   %ax,%ax
80105d97:	7f 0c                	jg     80105da5 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105d99:	c7 04 24 ab 8b 10 80 	movl   $0x80108bab,(%esp)
80105da0:	e8 98 a7 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105da5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105da8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105dac:	66 83 f8 01          	cmp    $0x1,%ax
80105db0:	75 1f                	jne    80105dd1 <sys_unlink+0x107>
80105db2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105db5:	89 04 24             	mov    %eax,(%esp)
80105db8:	e8 9f fe ff ff       	call   80105c5c <isdirempty>
80105dbd:	85 c0                	test   %eax,%eax
80105dbf:	75 10                	jne    80105dd1 <sys_unlink+0x107>
    iunlockput(ip);
80105dc1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dc4:	89 04 24             	mov    %eax,(%esp)
80105dc7:	e8 88 c0 ff ff       	call   80101e54 <iunlockput>
    goto bad;
80105dcc:	e9 b5 00 00 00       	jmp    80105e86 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105dd1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105dd8:	00 
80105dd9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105de0:	00 
80105de1:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105de4:	89 04 24             	mov    %eax,(%esp)
80105de7:	e8 42 f5 ff ff       	call   8010532e <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105dec:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105def:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105df6:	00 
80105df7:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105e08:	e8 24 c4 ff ff       	call   80102231 <writei>
80105e0d:	83 f8 10             	cmp    $0x10,%eax
80105e10:	74 0c                	je     80105e1e <sys_unlink+0x154>
    panic("unlink: writei");
80105e12:	c7 04 24 bd 8b 10 80 	movl   $0x80108bbd,(%esp)
80105e19:	e8 1f a7 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105e1e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e21:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e25:	66 83 f8 01          	cmp    $0x1,%ax
80105e29:	75 1c                	jne    80105e47 <sys_unlink+0x17d>
    dp->nlink--;
80105e2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e2e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e32:	8d 50 ff             	lea    -0x1(%eax),%edx
80105e35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e38:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105e3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e3f:	89 04 24             	mov    %eax,(%esp)
80105e42:	e8 cd bb ff ff       	call   80101a14 <iupdate>
  }
  iunlockput(dp);
80105e47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e4a:	89 04 24             	mov    %eax,(%esp)
80105e4d:	e8 02 c0 ff ff       	call   80101e54 <iunlockput>
...
80105e69:	e8 a6 bb ff ff       	call   80101a14 <iupdate>
  iunlockput(ip);
80105e6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e71:	89 04 24             	mov    %eax,(%esp)
80105e74:	e8 db bf ff ff       	call   80101e54 <iunlockput>

  commit_trans();
80105e79:	e8 50 d7 ff ff       	call   801035ce <commit_trans>

  return 0;
80105e7e:	b8 00 00 00 00       	mov    $0x0,%eax
80105e83:	eb 16                	jmp    80105e9b <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105e8c:	e8 c3 bf ff ff       	call   80101e54 <iunlockput>
  commit_trans();
80105e91:	e8 38 d7 ff ff       	call   801035ce <commit_trans>
  return -1;
...
80105ea0:	83 ec 48             	sub    $0x48,%esp
80105ea3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105ea6:	8b 55 10             	mov    0x10(%ebp),%edx
80105ea9:	8b 45 14             	mov    0x14(%ebp),%eax
80105eac:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105eb0:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105eb4:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80105eb8:	8d 45 de             	lea    -0x22(%ebp),%eax
80105ebb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ebf:	8b 45 08             	mov    0x8(%ebp),%eax
80105ec2:	89 04 24             	mov    %eax,(%esp)
80105ec5:	e8 ca c8 ff ff       	call   80102794 <nameiparent>
80105eca:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ecd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ed1:	75 0a                	jne    80105edd <create+0x40>
    return 0;
80105ed3:	b8 00 00 00 00       	mov    $0x0,%eax
80105ed8:	e9 7e 01 00 00       	jmp    8010605b <create+0x1be>
  ilock(dp);
80105edd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee0:	89 04 24             	mov    %eax,(%esp)
80105ee3:	e8 e8 bc ff ff       	call   80101bd0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105ee8:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105eeb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eef:	8d 45 de             	lea    -0x22(%ebp),%eax
80105ef2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ef6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ef9:	89 04 24             	mov    %eax,(%esp)
80105efc:	e8 e8 c4 ff ff       	call   801023e9 <dirlookup>
80105f01:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f04:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f08:	74 47                	je     80105f51 <create+0xb4>
    iunlockput(dp);
80105f0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f0d:	89 04 24             	mov    %eax,(%esp)
80105f10:	e8 3f bf ff ff       	call   80101e54 <iunlockput>
    ilock(ip);
80105f15:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f18:	89 04 24             	mov    %eax,(%esp)
80105f1b:	e8 b0 bc ff ff       	call   80101bd0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105f20:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105f25:	75 15                	jne    80105f3c <create+0x9f>
80105f27:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f2a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f2e:	66 83 f8 02          	cmp    $0x2,%ax
80105f32:	75 08                	jne    80105f3c <create+0x9f>
      return ip;
80105f34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f37:	e9 1f 01 00 00       	jmp    8010605b <create+0x1be>
    iunlockput(ip);
80105f3c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f3f:	89 04 24             	mov    %eax,(%esp)
80105f42:	e8 0d bf ff ff       	call   80101e54 <iunlockput>
    return 0;
80105f47:	b8 00 00 00 00       	mov    $0x0,%eax
80105f4c:	e9 0a 01 00 00       	jmp    8010605b <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105f51:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105f55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f58:	8b 00                	mov    (%eax),%eax
80105f5a:	89 54 24 04          	mov    %edx,0x4(%esp)
80105f5e:	89 04 24             	mov    %eax,(%esp)
80105f61:	e8 d1 b9 ff ff       	call   80101937 <ialloc>
80105f66:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f69:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f6d:	75 0c                	jne    80105f7b <create+0xde>
    panic("create: ialloc");
80105f6f:	c7 04 24 cc 8b 10 80 	movl   $0x80108bcc,(%esp)
80105f76:	e8 c2 a5 ff ff       	call   8010053d <panic>

  ilock(ip);
80105f7b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f7e:	89 04 24             	mov    %eax,(%esp)
80105f81:	e8 4a bc ff ff       	call   80101bd0 <ilock>
  ip->major = major;
80105f86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f89:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105f8d:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105f91:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f94:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105f98:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105f9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f9f:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105fa5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa8:	89 04 24             	mov    %eax,(%esp)
80105fab:	e8 64 ba ff ff       	call   80101a14 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105fb0:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105fb5:	75 6a                	jne    80106021 <create+0x184>
    dp->nlink++;  // for ".."
80105fb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105fba:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105fbe:	8d 50 01             	lea    0x1(%eax),%edx
...
80106038:	e8 74 c4 ff ff       	call   801024b1 <dirlink>
8010603d:	85 c0                	test   %eax,%eax
8010603f:	79 0c                	jns    8010604d <create+0x1b0>
    panic("create: dirlink");
80106041:	c7 04 24 e7 8b 10 80 	movl   $0x80108be7,(%esp)
80106048:	e8 f0 a4 ff ff       	call   8010053d <panic>
...
80106063:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106066:	89 44 24 04          	mov    %eax,0x4(%esp)
8010606a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106071:	e8 a2 f6 ff ff       	call   80105718 <argstr>
80106076:	85 c0                	test   %eax,%eax
80106078:	78 17                	js     80106091 <sys_open+0x34>
8010607a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010607d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106081:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106088:	e8 f1 f5 ff ff       	call   8010567e <argint>
8010608d:	85 c0                	test   %eax,%eax
8010608f:	79 0a                	jns    8010609b <sys_open+0x3e>
    return -1;
80106091:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106096:	e9 46 01 00 00       	jmp    801061e1 <sys_open+0x184>
  if(omode & O_CREATE){
8010609b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010609e:	25 00 02 00 00       	and    $0x200,%eax
801060a3:	85 c0                	test   %eax,%eax
801060a5:	74 40                	je     801060e7 <sys_open+0x8a>
    begin_trans();
801060a7:	e8 d9 d4 ff ff       	call   80103585 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
801060ac:	8b 45 e8             	mov    -0x18(%ebp),%eax
801060af:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801060b6:	00 
801060b7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801060be:	00 
801060bf:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801060c6:	00 
801060c7:	89 04 24             	mov    %eax,(%esp)
801060ca:	e8 ce fd ff ff       	call   80105e9d <create>
801060cf:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801060d2:	e8 f7 d4 ff ff       	call   801035ce <commit_trans>
    if(ip == 0)
801060d7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060db:	75 5c                	jne    80106139 <sys_open+0xdc>
      return -1;
801060dd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060e2:	e9 fa 00 00 00       	jmp    801061e1 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
801060e7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801060ea:	89 04 24             	mov    %eax,(%esp)
801060ed:	e8 80 c6 ff ff       	call   80102772 <namei>
801060f2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060f5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060f9:	75 0a                	jne    80106105 <sys_open+0xa8>
      return -1;
801060fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106100:	e9 dc 00 00 00       	jmp    801061e1 <sys_open+0x184>
    ilock(ip);
80106105:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106108:	89 04 24             	mov    %eax,(%esp)
8010610b:	e8 c0 ba ff ff       	call   80101bd0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80106110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106113:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106117:	66 83 f8 01          	cmp    $0x1,%ax
8010611b:	75 1c                	jne    80106139 <sys_open+0xdc>
8010611d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106120:	85 c0                	test   %eax,%eax
80106122:	74 15                	je     80106139 <sys_open+0xdc>
      iunlockput(ip);
80106124:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106127:	89 04 24             	mov    %eax,(%esp)
8010612a:	e8 25 bd ff ff       	call   80101e54 <iunlockput>
      return -1;
8010612f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106134:	e9 a8 00 00 00       	jmp    801061e1 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106139:	e8 46 b1 ff ff       	call   80101284 <filealloc>
8010613e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106141:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106145:	74 14                	je     8010615b <sys_open+0xfe>
80106147:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010614a:	89 04 24             	mov    %eax,(%esp)
8010614d:	e8 43 f7 ff ff       	call   80105895 <fdalloc>
80106152:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106155:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106159:	79 23                	jns    8010617e <sys_open+0x121>
    if(f)
8010615b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010615f:	74 0b                	je     8010616c <sys_open+0x10f>
      fileclose(f);
80106161:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106164:	89 04 24             	mov    %eax,(%esp)
80106167:	e8 c0 b1 ff ff       	call   8010132c <fileclose>
    iunlockput(ip);
8010616c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010616f:	89 04 24             	mov    %eax,(%esp)
80106172:	e8 dd bc ff ff       	call   80101e54 <iunlockput>
    return -1;
80106177:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010617c:	eb 63                	jmp    801061e1 <sys_open+0x184>
  }
  iunlock(ip);
8010617e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106181:	89 04 24             	mov    %eax,(%esp)
80106184:	e8 95 bb ff ff       	call   80101d1e <iunlock>

  f->type = FD_INODE;
80106189:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010618c:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80106192:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106195:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106198:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
8010619b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010619e:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
801061a5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061a8:	83 e0 01             	and    $0x1,%eax
801061ab:	85 c0                	test   %eax,%eax
801061ad:	0f 94 c2             	sete   %dl
801061b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b3:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801061b6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061b9:	83 e0 01             	and    $0x1,%eax
801061bc:	84 c0                	test   %al,%al
801061be:	75 0a                	jne    801061ca <sys_open+0x16d>
801061c0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801061c3:	83 e0 02             	and    $0x2,%eax
801061c6:	85 c0                	test   %eax,%eax
801061c8:	74 07                	je     801061d1 <sys_open+0x174>
801061ca:	b8 01 00 00 00       	mov    $0x1,%eax
801061cf:	eb 05                	jmp    801061d6 <sys_open+0x179>
801061d1:	b8 00 00 00 00       	mov    $0x0,%eax
801061d6:	89 c2                	mov    %eax,%edx
801061d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061db:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801061e6:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
801061e9:	e8 97 d3 ff ff       	call   80103585 <begin_trans>
...
801061fc:	e8 17 f5 ff ff       	call   80105718 <argstr>
80106201:	85 c0                	test   %eax,%eax
80106203:	78 2c                	js     80106231 <sys_mkdir+0x4e>
...
80106217:	00 
80106218:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010621f:	00 
80106220:	89 04 24             	mov    %eax,(%esp)
80106223:	e8 75 fc ff ff       	call   80105e9d <create>
80106228:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010622b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010622f:	75 0c                	jne    8010623d <sys_mkdir+0x5a>
    commit_trans();
80106231:	e8 98 d3 ff ff       	call   801035ce <commit_trans>
    return -1;
80106236:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010623b:	eb 15                	jmp    80106252 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010623d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106240:	89 04 24             	mov    %eax,(%esp)
80106243:	e8 0c bc ff ff       	call   80101e54 <iunlockput>
  commit_trans();
80106248:	e8 81 d3 ff ff       	call   801035ce <commit_trans>
  return 0;
8010624d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106252:	c9                   	leave  
80106253:	c3                   	ret    
...
80106257:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_trans();
8010625a:	e8 26 d3 ff ff       	call   80103585 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
8010625f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106262:	89 44 24 04          	mov    %eax,0x4(%esp)
80106266:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010626d:	e8 a6 f4 ff ff       	call   80105718 <argstr>
80106272:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106275:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106279:	78 5e                	js     801062d9 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
8010627b:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010627e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106282:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106289:	e8 f0 f3 ff ff       	call   8010567e <argint>
  char *path;
  int len;
  int major, minor;
...
80106290:	78 47                	js     801062d9 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106292:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106295:	89 44 24 04          	mov    %eax,0x4(%esp)
80106299:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801062a0:	e8 d9 f3 ff ff       	call   8010567e <argint>
  int len;
  int major, minor;
...
801062a7:	78 30                	js     801062d9 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
801062a9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062ac:	0f bf c8             	movswl %ax,%ecx
801062af:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062b2:	0f bf d0             	movswl %ax,%edx
801062b5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
801062b8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801062bc:	89 54 24 08          	mov    %edx,0x8(%esp)
801062c0:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801062c7:	00 
801062c8:	89 04 24             	mov    %eax,(%esp)
801062cb:	e8 cd fb ff ff       	call   80105e9d <create>
801062d0:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062d3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062d7:	75 0c                	jne    801062e5 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801062d9:	e8 f0 d2 ff ff       	call   801035ce <commit_trans>
    return -1;
801062de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062e3:	eb 15                	jmp    801062fa <sys_mknod+0xa6>
  }
  iunlockput(ip);
801062e5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062e8:	89 04 24             	mov    %eax,(%esp)
801062eb:	e8 64 bb ff ff       	call   80101e54 <iunlockput>
  commit_trans();
801062f0:	e8 d9 d2 ff ff       	call   801035ce <commit_trans>
  return 0;
...
80106305:	89 44 24 04          	mov    %eax,0x4(%esp)
80106309:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106310:	e8 03 f4 ff ff       	call   80105718 <argstr>
80106315:	85 c0                	test   %eax,%eax
80106317:	78 14                	js     8010632d <sys_chdir+0x31>
80106319:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010631c:	89 04 24             	mov    %eax,(%esp)
8010631f:	e8 4e c4 ff ff       	call   80102772 <namei>
80106324:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106327:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010632b:	75 07                	jne    80106334 <sys_chdir+0x38>
    return -1;
8010632d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106332:	eb 57                	jmp    8010638b <sys_chdir+0x8f>
  ilock(ip);
80106334:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106337:	89 04 24             	mov    %eax,(%esp)
8010633a:	e8 91 b8 ff ff       	call   80101bd0 <ilock>
  if(ip->type != T_DIR){
8010633f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106342:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106346:	66 83 f8 01          	cmp    $0x1,%ax
8010634a:	74 12                	je     8010635e <sys_chdir+0x62>
    iunlockput(ip);
8010634c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010634f:	89 04 24             	mov    %eax,(%esp)
80106352:	e8 fd ba ff ff       	call   80101e54 <iunlockput>
    return -1;
80106357:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010635c:	eb 2d                	jmp    8010638b <sys_chdir+0x8f>
  }
  iunlock(ip);
8010635e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106361:	89 04 24             	mov    %eax,(%esp)
80106364:	e8 b5 b9 ff ff       	call   80101d1e <iunlock>
  iput(proc->cwd);
80106369:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010636f:	8b 40 68             	mov    0x68(%eax),%eax
80106372:	89 04 24             	mov    %eax,(%esp)
80106375:	e8 09 ba ff ff       	call   80101d83 <iput>
  proc->cwd = ip;
...
801063a4:	e8 6f f3 ff ff       	call   80105718 <argstr>
...
801063ea:	e8 3f ef ff ff       	call   8010532e <memset>
  for(i=0;; i++){
...
80106403:	e9 ab 00 00 00       	jmp    801064b3 <sys_exec+0x126>
...
80106416:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80106419:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010641f:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
80106425:	89 54 24 08          	mov    %edx,0x8(%esp)
80106429:	89 4c 24 04          	mov    %ecx,0x4(%esp)
8010642d:	89 04 24             	mov    %eax,(%esp)
80106430:	e8 b7 f1 ff ff       	call   801055ec <fetchint>
80106435:	85 c0                	test   %eax,%eax
80106437:	79 07                	jns    80106440 <sys_exec+0xb3>
      return -1;
80106439:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010643e:	eb 73                	jmp    801064b3 <sys_exec+0x126>
    if(uarg == 0){
80106440:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106446:	85 c0                	test   %eax,%eax
80106448:	75 26                	jne    80106470 <sys_exec+0xe3>
      argv[i] = 0;
8010644a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010644d:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106454:	00 00 00 00 
      break;
80106458:	90                   	nop
    }
...
8010645c:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106462:	89 54 24 04          	mov    %edx,0x4(%esp)
80106466:	89 04 24             	mov    %eax,(%esp)
80106469:	e8 f6 a9 ff ff       	call   80100e64 <exec>
8010646e:	eb 43                	jmp    801064b3 <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106473:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
8010647a:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106480:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
80106483:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
...
8010649a:	e8 81 f1 ff ff       	call   80105620 <fetchstr>
8010649f:	85 c0                	test   %eax,%eax
801064a1:	79 07                	jns    801064aa <sys_exec+0x11d>
      return -1;
801064a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064a8:	eb 09                	jmp    801064b3 <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
801064aa:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
801064ae:	e9 43 ff ff ff       	jmp    801063f6 <sys_exec+0x69>
  return exec(path, argv);
}
801064b3:	c9                   	leave  
801064b4:	c3                   	ret    
...
801064b8:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
801064bb:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801064c2:	00 
801064c3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801064c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801064ca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064d1:	e8 e0 f1 ff ff       	call   801056b6 <argptr>
801064d6:	85 c0                	test   %eax,%eax
801064d8:	79 0a                	jns    801064e4 <sys_pipe+0x2f>
    return -1;
801064da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064df:	e9 9b 00 00 00       	jmp    8010657f <sys_pipe+0xca>
...
801064f1:	e8 aa da ff ff       	call   80103fa0 <pipealloc>
801064f6:	85 c0                	test   %eax,%eax
801064f8:	79 07                	jns    80106501 <sys_pipe+0x4c>
    return -1;
801064fa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064ff:	eb 7e                	jmp    8010657f <sys_pipe+0xca>
  fd0 = -1;
...
8010650e:	e8 82 f3 ff ff       	call   80105895 <fdalloc>
80106513:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106516:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010651a:	78 14                	js     80106530 <sys_pipe+0x7b>
8010651c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010651f:	89 04 24             	mov    %eax,(%esp)
80106522:	e8 6e f3 ff ff       	call   80105895 <fdalloc>
80106527:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010652a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010652e:	79 37                	jns    80106567 <sys_pipe+0xb2>
    if(fd0 >= 0)
80106530:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106534:	78 14                	js     8010654a <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106536:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010653c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010653f:	83 c2 08             	add    $0x8,%edx
80106542:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106549:	00 
    fileclose(rf);
8010654a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010654d:	89 04 24             	mov    %eax,(%esp)
80106550:	e8 d7 ad ff ff       	call   8010132c <fileclose>
    fileclose(wf);
80106555:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106558:	89 04 24             	mov    %eax,(%esp)
8010655b:	e8 cc ad ff ff       	call   8010132c <fileclose>
    return -1;
80106560:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106565:	eb 18                	jmp    8010657f <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106567:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010656a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010656d:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010656f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106572:	8d 50 04             	lea    0x4(%eax),%edx
80106575:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106578:	89 02                	mov    %eax,(%edx)
  return 0;
8010657a:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010657f:	c9                   	leave  
80106580:	c3                   	ret    
80106581:	00 00                	add    %al,(%eax)
	...
...
80106587:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010658a:	e8 ce e0 ff ff       	call   8010465d <fork>
}
8010658f:	c9                   	leave  
80106590:	c3                   	ret    
...
80106594:	83 ec 08             	sub    $0x8,%esp
  exit();
80106597:	e8 56 e2 ff ff       	call   801047f2 <exit>
...
801065a6:	83 ec 08             	sub    $0x8,%esp
  return wait();
801065a9:	e8 89 e3 ff ff       	call   80104937 <wait>
}
801065ae:	c9                   	leave  
801065af:	c3                   	ret    
...
801065b3:	83 ec 28             	sub    $0x28,%esp
  char *rtime=0;
801065b6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  char *wtime=0;
801065bd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  argptr(1,&rtime,sizeof(rtime));
801065c4:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801065cb:	00 
801065cc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801065cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801065d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065da:	e8 d7 f0 ff ff       	call   801056b6 <argptr>
  argptr(0,&wtime,sizeof(wtime));
801065df:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801065e6:	00 
801065e7:	8d 45 f0             	lea    -0x10(%ebp),%eax
801065ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801065ee:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065f5:	e8 bc f0 ff ff       	call   801056b6 <argptr>
...
80106607:	e8 3d e4 ff ff       	call   80104a49 <wait2>
}
8010660c:	c9                   	leave  
8010660d:	c3                   	ret    
...
801066a4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066ab:	e8 ce ef ff ff       	call   8010567e <argint>
801066b0:	85 c0                	test   %eax,%eax
801066b2:	79 07                	jns    801066bb <sys_sleep+0x24>
    return -1;
801066b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066b9:	eb 6c                	jmp    80106727 <sys_sleep+0x90>
  acquire(&tickslock);
801066bb:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801066c2:	e8 18 ea ff ff       	call   801050df <acquire>
  ticks0 = ticks;
801066c7:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
801066cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801066cf:	eb 34                	jmp    80106705 <sys_sleep+0x6e>
    if(proc->killed){
801066d1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066d7:	8b 40 24             	mov    0x24(%eax),%eax
801066da:	85 c0                	test   %eax,%eax
801066dc:	74 13                	je     801066f1 <sys_sleep+0x5a>
      release(&tickslock);
801066de:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
801066e5:	e8 57 ea ff ff       	call   80105141 <release>
      return -1;
801066ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066ef:	eb 36                	jmp    80106727 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801066f1:	c7 44 24 04 80 22 11 	movl   $0x80112280,0x4(%esp)
801066f8:	80 
801066f9:	c7 04 24 c0 2a 11 80 	movl   $0x80112ac0,(%esp)
80106700:	e8 f2 e6 ff ff       	call   80104df7 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106705:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
8010670a:	89 c2                	mov    %eax,%edx
8010670c:	2b 55 f4             	sub    -0xc(%ebp),%edx
8010670f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106712:	39 c2                	cmp    %eax,%edx
80106714:	72 bb                	jb     801066d1 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106716:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010671d:	e8 1f ea ff ff       	call   80105141 <release>
  return 0;
...
8010672c:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
8010672f:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80106736:	e8 a4 e9 ff ff       	call   801050df <acquire>
  xticks = ticks;
8010673b:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
80106740:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
80106743:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010674a:	e8 f2 e9 ff ff       	call   80105141 <release>
  return xticks;
...
80106778:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
8010677f:	00 
80106780:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106787:	e8 c8 ff ff ff       	call   80106754 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
8010678c:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106793:	00 
80106794:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010679b:	e8 b4 ff ff ff       	call   80106754 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
801067a0:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
801067a7:	00 
801067a8:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801067af:	e8 a0 ff ff ff       	call   80106754 <outb>
  picenable(IRQ_TIMER);
801067b4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067bb:	e8 69 d6 ff ff       	call   80103e29 <picenable>
}
801067c0:	c9                   	leave  
801067c1:	c3                   	ret    
	...
...
801067c5:	06                   	push   %es
  pushl %fs
801067c6:	0f a0                	push   %fs
  pushl %gs
801067c8:	0f a8                	push   %gs
  pushal
801067ca:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801067cb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801067cf:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801067d1:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801067d3:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801067d7:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801067d9:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801067db:	54                   	push   %esp
  call trap
801067dc:	e8 de 01 00 00       	call   801069bf <trap>
  addl $4, %esp
801067e1:	83 c4 04             	add    $0x4,%esp
...
801067e4:	61                   	popa   
  popl %gs
801067e5:	0f a9                	pop    %gs
  popl %fs
801067e7:	0f a1                	pop    %fs
  popl %es
801067e9:	07                   	pop    %es
  popl %ds
801067ea:	1f                   	pop    %ds
...
801067f9:	83 e8 01             	sub    $0x1,%eax
801067fc:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106800:	8b 45 08             	mov    0x8(%ebp),%eax
80106803:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106807:	8b 45 08             	mov    0x8(%ebp),%eax
8010680a:	c1 e8 10             	shr    $0x10,%eax
8010680d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106811:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106814:	0f 01 18             	lidtl  (%eax)
}
80106817:	c9                   	leave  
80106818:	c3                   	ret    
...
8010681c:	53                   	push   %ebx
8010681d:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106820:	0f 20 d3             	mov    %cr2,%ebx
80106823:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106826:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106832:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
80106835:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010683c:	e9 c3 00 00 00       	jmp    80106904 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106841:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106844:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
8010684b:	89 c2                	mov    %eax,%edx
8010684d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106850:	66 89 14 c5 c0 22 11 	mov    %dx,-0x7feedd40(,%eax,8)
80106857:	80 
80106858:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010685b:	66 c7 04 c5 c2 22 11 	movw   $0x8,-0x7feedd3e(,%eax,8)
80106862:	80 08 00 
80106865:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106868:	0f b6 14 c5 c4 22 11 	movzbl -0x7feedd3c(,%eax,8),%edx
8010686f:	80 
80106870:	83 e2 e0             	and    $0xffffffe0,%edx
80106873:	88 14 c5 c4 22 11 80 	mov    %dl,-0x7feedd3c(,%eax,8)
8010687a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010687d:	0f b6 14 c5 c4 22 11 	movzbl -0x7feedd3c(,%eax,8),%edx
80106884:	80 
80106885:	83 e2 1f             	and    $0x1f,%edx
80106888:	88 14 c5 c4 22 11 80 	mov    %dl,-0x7feedd3c(,%eax,8)
8010688f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106892:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
80106899:	80 
8010689a:	83 e2 f0             	and    $0xfffffff0,%edx
8010689d:	83 ca 0e             	or     $0xe,%edx
801068a0:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801068a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068aa:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801068b1:	80 
801068b2:	83 e2 ef             	and    $0xffffffef,%edx
801068b5:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801068bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068bf:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801068c6:	80 
801068c7:	83 e2 9f             	and    $0xffffff9f,%edx
801068ca:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801068d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068d4:	0f b6 14 c5 c5 22 11 	movzbl -0x7feedd3b(,%eax,8),%edx
801068db:	80 
801068dc:	83 ca 80             	or     $0xffffff80,%edx
801068df:	88 14 c5 c5 22 11 80 	mov    %dl,-0x7feedd3b(,%eax,8)
801068e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068e9:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
801068f0:	c1 e8 10             	shr    $0x10,%eax
801068f3:	89 c2                	mov    %eax,%edx
801068f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068f8:	66 89 14 c5 c6 22 11 	mov    %dx,-0x7feedd3a(,%eax,8)
801068ff:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106900:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106904:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
8010690b:	0f 8e 30 ff ff ff    	jle    80106841 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106911:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
80106916:	66 a3 c0 24 11 80    	mov    %ax,0x801124c0
8010691c:	66 c7 05 c2 24 11 80 	movw   $0x8,0x801124c2
80106923:	08 00 
80106925:	0f b6 05 c4 24 11 80 	movzbl 0x801124c4,%eax
8010692c:	83 e0 e0             	and    $0xffffffe0,%eax
8010692f:	a2 c4 24 11 80       	mov    %al,0x801124c4
80106934:	0f b6 05 c4 24 11 80 	movzbl 0x801124c4,%eax
8010693b:	83 e0 1f             	and    $0x1f,%eax
8010693e:	a2 c4 24 11 80       	mov    %al,0x801124c4
80106943:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
8010694a:	83 c8 0f             	or     $0xf,%eax
8010694d:	a2 c5 24 11 80       	mov    %al,0x801124c5
80106952:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106959:	83 e0 ef             	and    $0xffffffef,%eax
8010695c:	a2 c5 24 11 80       	mov    %al,0x801124c5
80106961:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106968:	83 c8 60             	or     $0x60,%eax
8010696b:	a2 c5 24 11 80       	mov    %al,0x801124c5
80106970:	0f b6 05 c5 24 11 80 	movzbl 0x801124c5,%eax
80106977:	83 c8 80             	or     $0xffffff80,%eax
8010697a:	a2 c5 24 11 80       	mov    %al,0x801124c5
8010697f:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
80106984:	c1 e8 10             	shr    $0x10,%eax
80106987:	66 a3 c6 24 11 80    	mov    %ax,0x801124c6
  
  initlock(&tickslock, "time");
8010698d:	c7 44 24 04 f8 8b 10 	movl   $0x80108bf8,0x4(%esp)
80106994:	80 
80106995:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
8010699c:	e8 1d e7 ff ff       	call   801050be <initlock>
}
801069a1:	c9                   	leave  
801069a2:	c3                   	ret    
...
801069a6:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801069a9:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801069b0:	00 
801069b1:	c7 04 24 c0 22 11 80 	movl   $0x801122c0,(%esp)
801069b8:	e8 33 fe ff ff       	call   801067f0 <lidt>
}
801069bd:	c9                   	leave  
801069be:	c3                   	ret    
...
801069c5:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801069c8:	8b 45 08             	mov    0x8(%ebp),%eax
801069cb:	8b 40 30             	mov    0x30(%eax),%eax
801069ce:	83 f8 40             	cmp    $0x40,%eax
801069d1:	75 3e                	jne    80106a11 <trap+0x52>
    if(proc->killed)
801069d3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069d9:	8b 40 24             	mov    0x24(%eax),%eax
801069dc:	85 c0                	test   %eax,%eax
801069de:	74 05                	je     801069e5 <trap+0x26>
      exit();
801069e0:	e8 0d de ff ff       	call   801047f2 <exit>
    proc->tf = tf;
801069e5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069eb:	8b 55 08             	mov    0x8(%ebp),%edx
801069ee:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801069f1:	e8 65 ed ff ff       	call   8010575b <syscall>
    if(proc->killed)
801069f6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069fc:	8b 40 24             	mov    0x24(%eax),%eax
801069ff:	85 c0                	test   %eax,%eax
80106a01:	0f 84 91 02 00 00    	je     80106c98 <trap+0x2d9>
      exit();
80106a07:	e8 e6 dd ff ff       	call   801047f2 <exit>
    return;
80106a0c:	e9 87 02 00 00       	jmp    80106c98 <trap+0x2d9>
  }

  switch(tf->trapno){
80106a11:	8b 45 08             	mov    0x8(%ebp),%eax
80106a14:	8b 40 30             	mov    0x30(%eax),%eax
80106a17:	83 e8 20             	sub    $0x20,%eax
80106a1a:	83 f8 1f             	cmp    $0x1f,%eax
80106a1d:	0f 87 f0 00 00 00    	ja     80106b13 <trap+0x154>
80106a23:	8b 04 85 b0 8c 10 80 	mov    -0x7fef7350(,%eax,4),%eax
80106a2a:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106a2c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106a32:	0f b6 00             	movzbl (%eax),%eax
80106a35:	84 c0                	test   %al,%al
80106a37:	75 65                	jne    80106a9e <trap+0xdf>
      acquire(&tickslock);
80106a39:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80106a40:	e8 9a e6 ff ff       	call   801050df <acquire>
      ticks++;
80106a45:	a1 c0 2a 11 80       	mov    0x80112ac0,%eax
80106a4a:	83 c0 01             	add    $0x1,%eax
80106a4d:	a3 c0 2a 11 80       	mov    %eax,0x80112ac0
      if(proc)
80106a52:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a58:	85 c0                	test   %eax,%eax
80106a5a:	74 2a                	je     80106a86 <trap+0xc7>
      {
	proc->rtime++;
80106a5c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a62:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80106a68:	83 c2 01             	add    $0x1,%edx
80106a6b:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
	proc->quanta--;
80106a71:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a77:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80106a7d:	83 ea 01             	sub    $0x1,%edx
80106a80:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
      }
      wakeup(&ticks);
80106a86:	c7 04 24 c0 2a 11 80 	movl   $0x80112ac0,(%esp)
80106a8d:	e8 41 e4 ff ff       	call   80104ed3 <wakeup>
      release(&tickslock);
80106a92:	c7 04 24 80 22 11 80 	movl   $0x80112280,(%esp)
80106a99:	e8 a3 e6 ff ff       	call   80105141 <release>
    }
    lapiceoi();
80106a9e:	e8 ae c7 ff ff       	call   80103251 <lapiceoi>
    break;
80106aa3:	e9 41 01 00 00       	jmp    80106be9 <trap+0x22a>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106aa8:	e8 ac bf ff ff       	call   80102a59 <ideintr>
    lapiceoi();
80106aad:	e8 9f c7 ff ff       	call   80103251 <lapiceoi>
    break;
80106ab2:	e9 32 01 00 00       	jmp    80106be9 <trap+0x22a>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106ab7:	e8 73 c5 ff ff       	call   8010302f <kbdintr>
    lapiceoi();
80106abc:	e8 90 c7 ff ff       	call   80103251 <lapiceoi>
    break;
80106ac1:	e9 23 01 00 00       	jmp    80106be9 <trap+0x22a>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106ac6:	e8 d5 03 00 00       	call   80106ea0 <uartintr>
    lapiceoi();
80106acb:	e8 81 c7 ff ff       	call   80103251 <lapiceoi>
    break;
80106ad0:	e9 14 01 00 00       	jmp    80106be9 <trap+0x22a>
  case T_IRQ0 + 7:
...
80106ad5:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106ad8:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106adb:	8b 45 08             	mov    0x8(%ebp),%eax
80106ade:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106ae2:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106ae5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106aeb:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80106af1:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106af5:	89 54 24 08          	mov    %edx,0x8(%esp)
80106af9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106afd:	c7 04 24 00 8c 10 80 	movl   $0x80108c00,(%esp)
80106b04:	e8 98 98 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106b09:	e8 43 c7 ff ff       	call   80103251 <lapiceoi>
    break;
80106b0e:	e9 d6 00 00 00       	jmp    80106be9 <trap+0x22a>
...
80106b1b:	74 11                	je     80106b2e <trap+0x16f>
...
80106b2c:	75 46                	jne    80106b74 <trap+0x1b5>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b2e:	e8 e6 fc ff ff       	call   80106819 <rcr2>
...
80106b33:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b36:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106b39:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106b40:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b43:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106b46:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106b49:	8b 52 30             	mov    0x30(%edx),%edx
80106b4c:	89 44 24 10          	mov    %eax,0x10(%esp)
80106b50:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106b54:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106b58:	89 54 24 04          	mov    %edx,0x4(%esp)
80106b5c:	c7 04 24 24 8c 10 80 	movl   $0x80108c24,(%esp)
80106b63:	e8 39 98 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106b68:	c7 04 24 56 8c 10 80 	movl   $0x80108c56,(%esp)
80106b6f:	e8 c9 99 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b74:	e8 a0 fc ff ff       	call   80106819 <rcr2>
...
80106b7b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b7e:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106b81:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106b87:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b8a:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106b8d:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b90:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106b93:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106b96:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106b99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106b9f:	83 c0 6c             	add    $0x6c,%eax
...
80106bae:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106bb2:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106bb6:	89 74 24 14          	mov    %esi,0x14(%esp)
80106bba:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106bbe:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106bc2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106bc5:	89 54 24 08          	mov    %edx,0x8(%esp)
80106bc9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bcd:	c7 04 24 5c 8c 10 80 	movl   $0x80108c5c,(%esp)
...
80106bdf:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106be6:	eb 01                	jmp    80106be9 <trap+0x22a>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106bf1:	74 24                	je     80106c17 <trap+0x258>
80106bf3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106bf9:	8b 40 24             	mov    0x24(%eax),%eax
80106bfc:	85 c0                	test   %eax,%eax
80106bfe:	74 17                	je     80106c17 <trap+0x258>
80106c00:	8b 45 08             	mov    0x8(%ebp),%eax
80106c03:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106c07:	0f b7 c0             	movzwl %ax,%eax
80106c0a:	83 e0 03             	and    $0x3,%eax
80106c0d:	83 f8 03             	cmp    $0x3,%eax
80106c10:	75 05                	jne    80106c17 <trap+0x258>
    exit();
80106c12:	e8 db db ff ff       	call   801047f2 <exit>
...
80106c1f:	74 47                	je     80106c68 <trap+0x2a9>
80106c21:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c27:	8b 40 0c             	mov    0xc(%eax),%eax
80106c2a:	83 f8 04             	cmp    $0x4,%eax
80106c2d:	75 39                	jne    80106c68 <trap+0x2a9>
80106c2f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c32:	8b 40 30             	mov    0x30(%eax),%eax
80106c35:	83 f8 20             	cmp    $0x20,%eax
80106c38:	75 2e                	jne    80106c68 <trap+0x2a9>
80106c3a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c40:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80106c46:	85 c0                	test   %eax,%eax
80106c48:	75 1e                	jne    80106c68 <trap+0x2a9>
  {
    cprintf("process id: %d\n",proc->pid);
80106c4a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c50:	8b 40 10             	mov    0x10(%eax),%eax
80106c53:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c57:	c7 04 24 9f 8c 10 80 	movl   $0x80108c9f,(%esp)
80106c5e:	e8 3e 97 ff ff       	call   801003a1 <cprintf>
    yield();
80106c63:	e8 31 e1 ff ff       	call   80104d99 <yield>
  }
...
80106c70:	74 27                	je     80106c99 <trap+0x2da>
80106c72:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106c78:	8b 40 24             	mov    0x24(%eax),%eax
80106c7b:	85 c0                	test   %eax,%eax
80106c7d:	74 1a                	je     80106c99 <trap+0x2da>
80106c7f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c82:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106c86:	0f b7 c0             	movzwl %ax,%eax
80106c89:	83 e0 03             	and    $0x3,%eax
80106c8c:	83 f8 03             	cmp    $0x3,%eax
80106c8f:	75 08                	jne    80106c99 <trap+0x2da>
    exit();
80106c91:	e8 5c db ff ff       	call   801047f2 <exit>
80106c96:	eb 01                	jmp    80106c99 <trap+0x2da>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106c99:	83 c4 3c             	add    $0x3c,%esp
80106c9c:	5b                   	pop    %ebx
80106c9d:	5e                   	pop    %esi
80106c9e:	5f                   	pop    %edi
80106c9f:	5d                   	pop    %ebp
80106ca0:	c3                   	ret    
80106ca1:	00 00                	add    %al,(%eax)
	...
...
80106ca8:	83 ec 14             	sub    $0x14,%esp
80106cab:	8b 45 08             	mov    0x8(%ebp),%eax
80106cae:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106cb2:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106cb6:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106cba:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106cbe:	ec                   	in     (%dx),%al
80106cbf:	89 c3                	mov    %eax,%ebx
80106cc1:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106cc4:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106cc8:	83 c4 14             	add    $0x14,%esp
80106ccb:	5b                   	pop    %ebx
80106ccc:	5d                   	pop    %ebp
80106ccd:	c3                   	ret    
...
80106cda:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106cde:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ce1:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106ce5:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106ce9:	ee                   	out    %al,(%dx)
}
80106cea:	c9                   	leave  
80106ceb:	c3                   	ret    
...
80106cef:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
80106cf2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106cf9:	00 
80106cfa:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106d01:	e8 c8 ff ff ff       	call   80106cce <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106d06:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106d0d:	00 
80106d0e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106d15:	e8 b4 ff ff ff       	call   80106cce <outb>
  outb(COM1+0, 115200/9600);
80106d1a:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106d21:	00 
80106d22:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106d29:	e8 a0 ff ff ff       	call   80106cce <outb>
  outb(COM1+1, 0);
80106d2e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d35:	00 
80106d36:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d3d:	e8 8c ff ff ff       	call   80106cce <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106d42:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106d49:	00 
80106d4a:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106d51:	e8 78 ff ff ff       	call   80106cce <outb>
  outb(COM1+4, 0);
80106d56:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d5d:	00 
80106d5e:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106d65:	e8 64 ff ff ff       	call   80106cce <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106d6a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106d71:	00 
80106d72:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106d79:	e8 50 ff ff ff       	call   80106cce <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106d7e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106d85:	e8 1a ff ff ff       	call   80106ca4 <inb>
80106d8a:	3c ff                	cmp    $0xff,%al
80106d8c:	74 6c                	je     80106dfa <uartinit+0x10e>
    return;
  uart = 1;
80106d8e:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106d95:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106d98:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106d9f:	e8 00 ff ff ff       	call   80106ca4 <inb>
  inb(COM1+0);
80106da4:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106dab:	e8 f4 fe ff ff       	call   80106ca4 <inb>
  picenable(IRQ_COM1);
80106db0:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106db7:	e8 6d d0 ff ff       	call   80103e29 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106dbc:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dc3:	00 
80106dc4:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106dcb:	e8 0e bf ff ff       	call   80102cde <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106dd0:	c7 45 f4 30 8d 10 80 	movl   $0x80108d30,-0xc(%ebp)
80106dd7:	eb 15                	jmp    80106dee <uartinit+0x102>
    uartputc(*p);
...
80106de5:	e8 13 00 00 00       	call   80106dfd <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106df6:	75 e1                	jne    80106dd9 <uartinit+0xed>
80106df8:	eb 01                	jmp    80106dfb <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106e00:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106e03:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106e08:	85 c0                	test   %eax,%eax
80106e0a:	74 4d                	je     80106e59 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106e0c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106e13:	eb 10                	jmp    80106e25 <uartputc+0x28>
    microdelay(10);
80106e15:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106e1c:	e8 55 c4 ff ff       	call   80103276 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106e21:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106e25:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106e29:	7f 16                	jg     80106e41 <uartputc+0x44>
80106e2b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e32:	e8 6d fe ff ff       	call   80106ca4 <inb>
80106e37:	0f b6 c0             	movzbl %al,%eax
80106e3a:	83 e0 20             	and    $0x20,%eax
80106e3d:	85 c0                	test   %eax,%eax
80106e3f:	74 d4                	je     80106e15 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
80106e41:	8b 45 08             	mov    0x8(%ebp),%eax
80106e44:	0f b6 c0             	movzbl %al,%eax
80106e47:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e4b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e52:	e8 77 fe ff ff       	call   80106cce <outb>
80106e57:	eb 01                	jmp    80106e5a <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106e5f:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106e62:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106e67:	85 c0                	test   %eax,%eax
80106e69:	75 07                	jne    80106e72 <uartgetc+0x16>
    return -1;
80106e6b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e70:	eb 2c                	jmp    80106e9e <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106e72:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106e79:	e8 26 fe ff ff       	call   80106ca4 <inb>
80106e7e:	0f b6 c0             	movzbl %al,%eax
80106e81:	83 e0 01             	and    $0x1,%eax
80106e84:	85 c0                	test   %eax,%eax
80106e86:	75 07                	jne    80106e8f <uartgetc+0x33>
    return -1;
80106e88:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106e8d:	eb 0f                	jmp    80106e9e <uartgetc+0x42>
  return inb(COM1+0);
80106e8f:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106e96:	e8 09 fe ff ff       	call   80106ca4 <inb>
...
80106ea6:	c7 04 24 5c 6e 10 80 	movl   $0x80106e5c,(%esp)
80106ead:	e8 1c 9a ff ff       	call   801008ce <consoleintr>
}
80106eb2:	c9                   	leave  
80106eb3:	c3                   	ret    
...
80106eb6:	6a 00                	push   $0x0
  jmp alltraps
80106eb8:	e9 07 f9 ff ff       	jmp    801067c4 <alltraps>
...
80106ebf:	6a 01                	push   $0x1
  jmp alltraps
80106ec1:	e9 fe f8 ff ff       	jmp    801067c4 <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $2
80106ec8:	6a 02                	push   $0x2
  jmp alltraps
80106eca:	e9 f5 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106ecf:	6a 00                	push   $0x0
  pushl $3
80106ed1:	6a 03                	push   $0x3
  jmp alltraps
80106ed3:	e9 ec f8 ff ff       	jmp    801067c4 <alltraps>
...
80106ed8:	6a 00                	push   $0x0
  pushl $4
80106eda:	6a 04                	push   $0x4
  jmp alltraps
80106edc:	e9 e3 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106ee1:	6a 00                	push   $0x0
  pushl $5
80106ee3:	6a 05                	push   $0x5
  jmp alltraps
80106ee5:	e9 da f8 ff ff       	jmp    801067c4 <alltraps>
...
80106eec:	6a 06                	push   $0x6
  jmp alltraps
80106eee:	e9 d1 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106ef3:	6a 00                	push   $0x0
  pushl $7
80106ef5:	6a 07                	push   $0x7
  jmp alltraps
80106ef7:	e9 c8 f8 ff ff       	jmp    801067c4 <alltraps>

80106efc <vector8>:
.globl vector8
vector8:
  pushl $8
80106efc:	6a 08                	push   $0x8
  jmp alltraps
80106efe:	e9 c1 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f03:	6a 00                	push   $0x0
  pushl $9
80106f05:	6a 09                	push   $0x9
  jmp alltraps
80106f07:	e9 b8 f8 ff ff       	jmp    801067c4 <alltraps>

80106f0c <vector10>:
.globl vector10
vector10:
  pushl $10
80106f0c:	6a 0a                	push   $0xa
  jmp alltraps
80106f0e:	e9 b1 f8 ff ff       	jmp    801067c4 <alltraps>

80106f13 <vector11>:
.globl vector11
vector11:
  pushl $11
80106f13:	6a 0b                	push   $0xb
  jmp alltraps
80106f15:	e9 aa f8 ff ff       	jmp    801067c4 <alltraps>

80106f1a <vector12>:
.globl vector12
vector12:
  pushl $12
80106f1a:	6a 0c                	push   $0xc
  jmp alltraps
80106f1c:	e9 a3 f8 ff ff       	jmp    801067c4 <alltraps>

80106f21 <vector13>:
.globl vector13
vector13:
  pushl $13
80106f21:	6a 0d                	push   $0xd
  jmp alltraps
80106f23:	e9 9c f8 ff ff       	jmp    801067c4 <alltraps>

80106f28 <vector14>:
.globl vector14
vector14:
  pushl $14
80106f28:	6a 0e                	push   $0xe
  jmp alltraps
80106f2a:	e9 95 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f2f:	6a 00                	push   $0x0
  pushl $15
80106f31:	6a 0f                	push   $0xf
  jmp alltraps
80106f33:	e9 8c f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f38:	6a 00                	push   $0x0
  pushl $16
80106f3a:	6a 10                	push   $0x10
  jmp alltraps
80106f3c:	e9 83 f8 ff ff       	jmp    801067c4 <alltraps>

80106f41 <vector17>:
.globl vector17
vector17:
  pushl $17
80106f41:	6a 11                	push   $0x11
  jmp alltraps
80106f43:	e9 7c f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f48:	6a 00                	push   $0x0
  pushl $18
80106f4a:	6a 12                	push   $0x12
  jmp alltraps
80106f4c:	e9 73 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f51:	6a 00                	push   $0x0
  pushl $19
80106f53:	6a 13                	push   $0x13
  jmp alltraps
80106f55:	e9 6a f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f5a:	6a 00                	push   $0x0
  pushl $20
80106f5c:	6a 14                	push   $0x14
  jmp alltraps
80106f5e:	e9 61 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f63:	6a 00                	push   $0x0
  pushl $21
80106f65:	6a 15                	push   $0x15
  jmp alltraps
80106f67:	e9 58 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f6c:	6a 00                	push   $0x0
  pushl $22
80106f6e:	6a 16                	push   $0x16
  jmp alltraps
80106f70:	e9 4f f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f75:	6a 00                	push   $0x0
  pushl $23
80106f77:	6a 17                	push   $0x17
  jmp alltraps
80106f79:	e9 46 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f7e:	6a 00                	push   $0x0
  pushl $24
80106f80:	6a 18                	push   $0x18
  jmp alltraps
80106f82:	e9 3d f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f87:	6a 00                	push   $0x0
  pushl $25
80106f89:	6a 19                	push   $0x19
  jmp alltraps
80106f8b:	e9 34 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f90:	6a 00                	push   $0x0
  pushl $26
80106f92:	6a 1a                	push   $0x1a
  jmp alltraps
80106f94:	e9 2b f8 ff ff       	jmp    801067c4 <alltraps>
...
80106f99:	6a 00                	push   $0x0
  pushl $27
80106f9b:	6a 1b                	push   $0x1b
  jmp alltraps
80106f9d:	e9 22 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106fa2:	6a 00                	push   $0x0
  pushl $28
80106fa4:	6a 1c                	push   $0x1c
  jmp alltraps
80106fa6:	e9 19 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106fab:	6a 00                	push   $0x0
  pushl $29
80106fad:	6a 1d                	push   $0x1d
  jmp alltraps
80106faf:	e9 10 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106fb4:	6a 00                	push   $0x0
  pushl $30
80106fb6:	6a 1e                	push   $0x1e
  jmp alltraps
80106fb8:	e9 07 f8 ff ff       	jmp    801067c4 <alltraps>
...
80106fbd:	6a 00                	push   $0x0
  pushl $31
80106fbf:	6a 1f                	push   $0x1f
  jmp alltraps
80106fc1:	e9 fe f7 ff ff       	jmp    801067c4 <alltraps>
...
80106fc6:	6a 00                	push   $0x0
  pushl $32
80106fc8:	6a 20                	push   $0x20
  jmp alltraps
80106fca:	e9 f5 f7 ff ff       	jmp    801067c4 <alltraps>
...
80106fcf:	6a 00                	push   $0x0
  pushl $33
80106fd1:	6a 21                	push   $0x21
  jmp alltraps
80106fd3:	e9 ec f7 ff ff       	jmp    801067c4 <alltraps>
...
80106fd8:	6a 00                	push   $0x0
  pushl $34
80106fda:	6a 22                	push   $0x22
  jmp alltraps
80106fdc:	e9 e3 f7 ff ff       	jmp    801067c4 <alltraps>
...
80106fe1:	6a 00                	push   $0x0
  pushl $35
80106fe3:	6a 23                	push   $0x23
  jmp alltraps
80106fe5:	e9 da f7 ff ff       	jmp    801067c4 <alltraps>
...
80106fea:	6a 00                	push   $0x0
  pushl $36
80106fec:	6a 24                	push   $0x24
  jmp alltraps
80106fee:	e9 d1 f7 ff ff       	jmp    801067c4 <alltraps>
...
80106ff3:	6a 00                	push   $0x0
  pushl $37
80106ff5:	6a 25                	push   $0x25
  jmp alltraps
80106ff7:	e9 c8 f7 ff ff       	jmp    801067c4 <alltraps>
...
80106ffc:	6a 00                	push   $0x0
  pushl $38
80106ffe:	6a 26                	push   $0x26
  jmp alltraps
80107000:	e9 bf f7 ff ff       	jmp    801067c4 <alltraps>
...
80107005:	6a 00                	push   $0x0
  pushl $39
80107007:	6a 27                	push   $0x27
  jmp alltraps
80107009:	e9 b6 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010700e:	6a 00                	push   $0x0
  pushl $40
80107010:	6a 28                	push   $0x28
  jmp alltraps
80107012:	e9 ad f7 ff ff       	jmp    801067c4 <alltraps>
...
80107017:	6a 00                	push   $0x0
  pushl $41
80107019:	6a 29                	push   $0x29
  jmp alltraps
8010701b:	e9 a4 f7 ff ff       	jmp    801067c4 <alltraps>
...
80107020:	6a 00                	push   $0x0
  pushl $42
80107022:	6a 2a                	push   $0x2a
  jmp alltraps
80107024:	e9 9b f7 ff ff       	jmp    801067c4 <alltraps>
...
80107029:	6a 00                	push   $0x0
  pushl $43
8010702b:	6a 2b                	push   $0x2b
  jmp alltraps
8010702d:	e9 92 f7 ff ff       	jmp    801067c4 <alltraps>
...
80107032:	6a 00                	push   $0x0
  pushl $44
80107034:	6a 2c                	push   $0x2c
  jmp alltraps
80107036:	e9 89 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010703b:	6a 00                	push   $0x0
  pushl $45
8010703d:	6a 2d                	push   $0x2d
  jmp alltraps
8010703f:	e9 80 f7 ff ff       	jmp    801067c4 <alltraps>
...
80107044:	6a 00                	push   $0x0
  pushl $46
80107046:	6a 2e                	push   $0x2e
  jmp alltraps
80107048:	e9 77 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010704d:	6a 00                	push   $0x0
  pushl $47
8010704f:	6a 2f                	push   $0x2f
  jmp alltraps
80107051:	e9 6e f7 ff ff       	jmp    801067c4 <alltraps>
...
80107056:	6a 00                	push   $0x0
  pushl $48
80107058:	6a 30                	push   $0x30
  jmp alltraps
8010705a:	e9 65 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010705f:	6a 00                	push   $0x0
  pushl $49
80107061:	6a 31                	push   $0x31
  jmp alltraps
80107063:	e9 5c f7 ff ff       	jmp    801067c4 <alltraps>
...
80107068:	6a 00                	push   $0x0
  pushl $50
8010706a:	6a 32                	push   $0x32
  jmp alltraps
8010706c:	e9 53 f7 ff ff       	jmp    801067c4 <alltraps>
...
80107071:	6a 00                	push   $0x0
  pushl $51
80107073:	6a 33                	push   $0x33
  jmp alltraps
80107075:	e9 4a f7 ff ff       	jmp    801067c4 <alltraps>
...
8010707a:	6a 00                	push   $0x0
  pushl $52
8010707c:	6a 34                	push   $0x34
  jmp alltraps
8010707e:	e9 41 f7 ff ff       	jmp    801067c4 <alltraps>
...
80107083:	6a 00                	push   $0x0
  pushl $53
80107085:	6a 35                	push   $0x35
  jmp alltraps
80107087:	e9 38 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010708c:	6a 00                	push   $0x0
  pushl $54
8010708e:	6a 36                	push   $0x36
  jmp alltraps
80107090:	e9 2f f7 ff ff       	jmp    801067c4 <alltraps>
...
80107095:	6a 00                	push   $0x0
  pushl $55
80107097:	6a 37                	push   $0x37
  jmp alltraps
80107099:	e9 26 f7 ff ff       	jmp    801067c4 <alltraps>
...
8010709e:	6a 00                	push   $0x0
  pushl $56
801070a0:	6a 38                	push   $0x38
  jmp alltraps
801070a2:	e9 1d f7 ff ff       	jmp    801067c4 <alltraps>
...
801070a7:	6a 00                	push   $0x0
  pushl $57
801070a9:	6a 39                	push   $0x39
  jmp alltraps
801070ab:	e9 14 f7 ff ff       	jmp    801067c4 <alltraps>
...
801070b0:	6a 00                	push   $0x0
  pushl $58
801070b2:	6a 3a                	push   $0x3a
  jmp alltraps
801070b4:	e9 0b f7 ff ff       	jmp    801067c4 <alltraps>
...
801070b9:	6a 00                	push   $0x0
  pushl $59
801070bb:	6a 3b                	push   $0x3b
  jmp alltraps
801070bd:	e9 02 f7 ff ff       	jmp    801067c4 <alltraps>
...
801070c2:	6a 00                	push   $0x0
  pushl $60
801070c4:	6a 3c                	push   $0x3c
  jmp alltraps
801070c6:	e9 f9 f6 ff ff       	jmp    801067c4 <alltraps>
...
801070cb:	6a 00                	push   $0x0
  pushl $61
801070cd:	6a 3d                	push   $0x3d
  jmp alltraps
801070cf:	e9 f0 f6 ff ff       	jmp    801067c4 <alltraps>
...
801070d4:	6a 00                	push   $0x0
  pushl $62
801070d6:	6a 3e                	push   $0x3e
  jmp alltraps
801070d8:	e9 e7 f6 ff ff       	jmp    801067c4 <alltraps>
...
801070dd:	6a 00                	push   $0x0
  pushl $63
801070df:	6a 3f                	push   $0x3f
  jmp alltraps
801070e1:	e9 de f6 ff ff       	jmp    801067c4 <alltraps>
...
801070e6:	6a 00                	push   $0x0
  pushl $64
801070e8:	6a 40                	push   $0x40
  jmp alltraps
801070ea:	e9 d5 f6 ff ff       	jmp    801067c4 <alltraps>
...
801070ef:	6a 00                	push   $0x0
  pushl $65
801070f1:	6a 41                	push   $0x41
  jmp alltraps
801070f3:	e9 cc f6 ff ff       	jmp    801067c4 <alltraps>
...
801070f8:	6a 00                	push   $0x0
  pushl $66
801070fa:	6a 42                	push   $0x42
  jmp alltraps
801070fc:	e9 c3 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107101:	6a 00                	push   $0x0
  pushl $67
80107103:	6a 43                	push   $0x43
  jmp alltraps
80107105:	e9 ba f6 ff ff       	jmp    801067c4 <alltraps>
...
8010710a:	6a 00                	push   $0x0
  pushl $68
8010710c:	6a 44                	push   $0x44
  jmp alltraps
8010710e:	e9 b1 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107113:	6a 00                	push   $0x0
  pushl $69
80107115:	6a 45                	push   $0x45
  jmp alltraps
80107117:	e9 a8 f6 ff ff       	jmp    801067c4 <alltraps>
...
8010711c:	6a 00                	push   $0x0
  pushl $70
8010711e:	6a 46                	push   $0x46
  jmp alltraps
80107120:	e9 9f f6 ff ff       	jmp    801067c4 <alltraps>
...
80107125:	6a 00                	push   $0x0
  pushl $71
80107127:	6a 47                	push   $0x47
  jmp alltraps
80107129:	e9 96 f6 ff ff       	jmp    801067c4 <alltraps>
...
8010712e:	6a 00                	push   $0x0
  pushl $72
80107130:	6a 48                	push   $0x48
  jmp alltraps
80107132:	e9 8d f6 ff ff       	jmp    801067c4 <alltraps>
...
80107137:	6a 00                	push   $0x0
  pushl $73
80107139:	6a 49                	push   $0x49
  jmp alltraps
8010713b:	e9 84 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107140:	6a 00                	push   $0x0
  pushl $74
80107142:	6a 4a                	push   $0x4a
  jmp alltraps
80107144:	e9 7b f6 ff ff       	jmp    801067c4 <alltraps>
...
80107149:	6a 00                	push   $0x0
  pushl $75
8010714b:	6a 4b                	push   $0x4b
  jmp alltraps
8010714d:	e9 72 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107152:	6a 00                	push   $0x0
  pushl $76
80107154:	6a 4c                	push   $0x4c
  jmp alltraps
80107156:	e9 69 f6 ff ff       	jmp    801067c4 <alltraps>
...
8010715b:	6a 00                	push   $0x0
  pushl $77
8010715d:	6a 4d                	push   $0x4d
  jmp alltraps
8010715f:	e9 60 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107164:	6a 00                	push   $0x0
  pushl $78
80107166:	6a 4e                	push   $0x4e
  jmp alltraps
80107168:	e9 57 f6 ff ff       	jmp    801067c4 <alltraps>
...
8010716d:	6a 00                	push   $0x0
  pushl $79
8010716f:	6a 4f                	push   $0x4f
  jmp alltraps
80107171:	e9 4e f6 ff ff       	jmp    801067c4 <alltraps>
...
80107176:	6a 00                	push   $0x0
  pushl $80
80107178:	6a 50                	push   $0x50
  jmp alltraps
8010717a:	e9 45 f6 ff ff       	jmp    801067c4 <alltraps>
...
8010717f:	6a 00                	push   $0x0
  pushl $81
80107181:	6a 51                	push   $0x51
  jmp alltraps
80107183:	e9 3c f6 ff ff       	jmp    801067c4 <alltraps>
...
80107188:	6a 00                	push   $0x0
  pushl $82
8010718a:	6a 52                	push   $0x52
  jmp alltraps
8010718c:	e9 33 f6 ff ff       	jmp    801067c4 <alltraps>
...
80107191:	6a 00                	push   $0x0
  pushl $83
80107193:	6a 53                	push   $0x53
  jmp alltraps
80107195:	e9 2a f6 ff ff       	jmp    801067c4 <alltraps>
...
8010719a:	6a 00                	push   $0x0
  pushl $84
8010719c:	6a 54                	push   $0x54
  jmp alltraps
8010719e:	e9 21 f6 ff ff       	jmp    801067c4 <alltraps>
...
801071a3:	6a 00                	push   $0x0
  pushl $85
801071a5:	6a 55                	push   $0x55
  jmp alltraps
801071a7:	e9 18 f6 ff ff       	jmp    801067c4 <alltraps>
...
801071ac:	6a 00                	push   $0x0
  pushl $86
801071ae:	6a 56                	push   $0x56
  jmp alltraps
801071b0:	e9 0f f6 ff ff       	jmp    801067c4 <alltraps>
...
801071b5:	6a 00                	push   $0x0
  pushl $87
801071b7:	6a 57                	push   $0x57
  jmp alltraps
801071b9:	e9 06 f6 ff ff       	jmp    801067c4 <alltraps>
...
801071be:	6a 00                	push   $0x0
  pushl $88
801071c0:	6a 58                	push   $0x58
  jmp alltraps
801071c2:	e9 fd f5 ff ff       	jmp    801067c4 <alltraps>
...
801071c7:	6a 00                	push   $0x0
  pushl $89
801071c9:	6a 59                	push   $0x59
  jmp alltraps
801071cb:	e9 f4 f5 ff ff       	jmp    801067c4 <alltraps>
...
801071d0:	6a 00                	push   $0x0
  pushl $90
801071d2:	6a 5a                	push   $0x5a
  jmp alltraps
801071d4:	e9 eb f5 ff ff       	jmp    801067c4 <alltraps>
...
801071d9:	6a 00                	push   $0x0
  pushl $91
801071db:	6a 5b                	push   $0x5b
  jmp alltraps
801071dd:	e9 e2 f5 ff ff       	jmp    801067c4 <alltraps>
...
801071e2:	6a 00                	push   $0x0
  pushl $92
801071e4:	6a 5c                	push   $0x5c
  jmp alltraps
801071e6:	e9 d9 f5 ff ff       	jmp    801067c4 <alltraps>
...
801071eb:	6a 00                	push   $0x0
  pushl $93
801071ed:	6a 5d                	push   $0x5d
  jmp alltraps
801071ef:	e9 d0 f5 ff ff       	jmp    801067c4 <alltraps>
...
801071f4:	6a 00                	push   $0x0
  pushl $94
801071f6:	6a 5e                	push   $0x5e
  jmp alltraps
801071f8:	e9 c7 f5 ff ff       	jmp    801067c4 <alltraps>
...
801071fd:	6a 00                	push   $0x0
  pushl $95
801071ff:	6a 5f                	push   $0x5f
  jmp alltraps
80107201:	e9 be f5 ff ff       	jmp    801067c4 <alltraps>
...
80107206:	6a 00                	push   $0x0
  pushl $96
80107208:	6a 60                	push   $0x60
  jmp alltraps
8010720a:	e9 b5 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010720f:	6a 00                	push   $0x0
  pushl $97
80107211:	6a 61                	push   $0x61
  jmp alltraps
80107213:	e9 ac f5 ff ff       	jmp    801067c4 <alltraps>
...
80107218:	6a 00                	push   $0x0
  pushl $98
8010721a:	6a 62                	push   $0x62
  jmp alltraps
8010721c:	e9 a3 f5 ff ff       	jmp    801067c4 <alltraps>
...
80107221:	6a 00                	push   $0x0
  pushl $99
80107223:	6a 63                	push   $0x63
  jmp alltraps
80107225:	e9 9a f5 ff ff       	jmp    801067c4 <alltraps>
...
8010722a:	6a 00                	push   $0x0
  pushl $100
8010722c:	6a 64                	push   $0x64
  jmp alltraps
8010722e:	e9 91 f5 ff ff       	jmp    801067c4 <alltraps>
...
80107233:	6a 00                	push   $0x0
  pushl $101
80107235:	6a 65                	push   $0x65
  jmp alltraps
80107237:	e9 88 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010723c:	6a 00                	push   $0x0
  pushl $102
8010723e:	6a 66                	push   $0x66
  jmp alltraps
80107240:	e9 7f f5 ff ff       	jmp    801067c4 <alltraps>
...
80107245:	6a 00                	push   $0x0
  pushl $103
80107247:	6a 67                	push   $0x67
  jmp alltraps
80107249:	e9 76 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010724e:	6a 00                	push   $0x0
  pushl $104
80107250:	6a 68                	push   $0x68
  jmp alltraps
80107252:	e9 6d f5 ff ff       	jmp    801067c4 <alltraps>
...
80107257:	6a 00                	push   $0x0
  pushl $105
80107259:	6a 69                	push   $0x69
  jmp alltraps
8010725b:	e9 64 f5 ff ff       	jmp    801067c4 <alltraps>
...
80107260:	6a 00                	push   $0x0
  pushl $106
80107262:	6a 6a                	push   $0x6a
  jmp alltraps
80107264:	e9 5b f5 ff ff       	jmp    801067c4 <alltraps>
...
80107269:	6a 00                	push   $0x0
  pushl $107
8010726b:	6a 6b                	push   $0x6b
  jmp alltraps
8010726d:	e9 52 f5 ff ff       	jmp    801067c4 <alltraps>
...
80107272:	6a 00                	push   $0x0
  pushl $108
80107274:	6a 6c                	push   $0x6c
  jmp alltraps
80107276:	e9 49 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010727b:	6a 00                	push   $0x0
  pushl $109
8010727d:	6a 6d                	push   $0x6d
  jmp alltraps
8010727f:	e9 40 f5 ff ff       	jmp    801067c4 <alltraps>
...
80107284:	6a 00                	push   $0x0
  pushl $110
80107286:	6a 6e                	push   $0x6e
  jmp alltraps
80107288:	e9 37 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010728d:	6a 00                	push   $0x0
  pushl $111
8010728f:	6a 6f                	push   $0x6f
  jmp alltraps
80107291:	e9 2e f5 ff ff       	jmp    801067c4 <alltraps>
...
80107296:	6a 00                	push   $0x0
  pushl $112
80107298:	6a 70                	push   $0x70
  jmp alltraps
8010729a:	e9 25 f5 ff ff       	jmp    801067c4 <alltraps>
...
8010729f:	6a 00                	push   $0x0
  pushl $113
801072a1:	6a 71                	push   $0x71
  jmp alltraps
801072a3:	e9 1c f5 ff ff       	jmp    801067c4 <alltraps>
...
801072a8:	6a 00                	push   $0x0
  pushl $114
801072aa:	6a 72                	push   $0x72
  jmp alltraps
801072ac:	e9 13 f5 ff ff       	jmp    801067c4 <alltraps>
...
801072b1:	6a 00                	push   $0x0
  pushl $115
801072b3:	6a 73                	push   $0x73
  jmp alltraps
801072b5:	e9 0a f5 ff ff       	jmp    801067c4 <alltraps>
...
801072ba:	6a 00                	push   $0x0
  pushl $116
801072bc:	6a 74                	push   $0x74
  jmp alltraps
801072be:	e9 01 f5 ff ff       	jmp    801067c4 <alltraps>
...
801072c3:	6a 00                	push   $0x0
  pushl $117
801072c5:	6a 75                	push   $0x75
  jmp alltraps
801072c7:	e9 f8 f4 ff ff       	jmp    801067c4 <alltraps>
...
801072cc:	6a 00                	push   $0x0
  pushl $118
801072ce:	6a 76                	push   $0x76
  jmp alltraps
801072d0:	e9 ef f4 ff ff       	jmp    801067c4 <alltraps>
...
801072d5:	6a 00                	push   $0x0
  pushl $119
801072d7:	6a 77                	push   $0x77
  jmp alltraps
801072d9:	e9 e6 f4 ff ff       	jmp    801067c4 <alltraps>
...
801072de:	6a 00                	push   $0x0
  pushl $120
801072e0:	6a 78                	push   $0x78
  jmp alltraps
801072e2:	e9 dd f4 ff ff       	jmp    801067c4 <alltraps>
...
801072e7:	6a 00                	push   $0x0
  pushl $121
801072e9:	6a 79                	push   $0x79
  jmp alltraps
801072eb:	e9 d4 f4 ff ff       	jmp    801067c4 <alltraps>
...
801072f0:	6a 00                	push   $0x0
  pushl $122
801072f2:	6a 7a                	push   $0x7a
  jmp alltraps
801072f4:	e9 cb f4 ff ff       	jmp    801067c4 <alltraps>
...
801072f9:	6a 00                	push   $0x0
  pushl $123
801072fb:	6a 7b                	push   $0x7b
  jmp alltraps
801072fd:	e9 c2 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107302:	6a 00                	push   $0x0
  pushl $124
80107304:	6a 7c                	push   $0x7c
  jmp alltraps
80107306:	e9 b9 f4 ff ff       	jmp    801067c4 <alltraps>
...
8010730b:	6a 00                	push   $0x0
  pushl $125
8010730d:	6a 7d                	push   $0x7d
  jmp alltraps
8010730f:	e9 b0 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107314:	6a 00                	push   $0x0
  pushl $126
80107316:	6a 7e                	push   $0x7e
  jmp alltraps
80107318:	e9 a7 f4 ff ff       	jmp    801067c4 <alltraps>
...
8010731d:	6a 00                	push   $0x0
  pushl $127
8010731f:	6a 7f                	push   $0x7f
  jmp alltraps
80107321:	e9 9e f4 ff ff       	jmp    801067c4 <alltraps>
...
80107326:	6a 00                	push   $0x0
  pushl $128
80107328:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010732d:	e9 92 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107332:	6a 00                	push   $0x0
  pushl $129
80107334:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107339:	e9 86 f4 ff ff       	jmp    801067c4 <alltraps>
...
8010733e:	6a 00                	push   $0x0
  pushl $130
80107340:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107345:	e9 7a f4 ff ff       	jmp    801067c4 <alltraps>
...
8010734a:	6a 00                	push   $0x0
  pushl $131
8010734c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107351:	e9 6e f4 ff ff       	jmp    801067c4 <alltraps>
...
80107356:	6a 00                	push   $0x0
  pushl $132
80107358:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010735d:	e9 62 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107362:	6a 00                	push   $0x0
  pushl $133
80107364:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107369:	e9 56 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107370:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107375:	e9 4a f4 ff ff       	jmp    801067c4 <alltraps>
...
8010737a:	6a 00                	push   $0x0
  pushl $135
8010737c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107381:	e9 3e f4 ff ff       	jmp    801067c4 <alltraps>
...
80107386:	6a 00                	push   $0x0
  pushl $136
80107388:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010738d:	e9 32 f4 ff ff       	jmp    801067c4 <alltraps>
...
80107392:	6a 00                	push   $0x0
  pushl $137
80107394:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107399:	e9 26 f4 ff ff       	jmp    801067c4 <alltraps>
...
8010739e:	6a 00                	push   $0x0
  pushl $138
801073a0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801073a5:	e9 1a f4 ff ff       	jmp    801067c4 <alltraps>
...
801073aa:	6a 00                	push   $0x0
  pushl $139
801073ac:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801073b1:	e9 0e f4 ff ff       	jmp    801067c4 <alltraps>
...
801073b6:	6a 00                	push   $0x0
  pushl $140
801073b8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801073bd:	e9 02 f4 ff ff       	jmp    801067c4 <alltraps>
...
801073c2:	6a 00                	push   $0x0
  pushl $141
801073c4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801073c9:	e9 f6 f3 ff ff       	jmp    801067c4 <alltraps>
...
801073ce:	6a 00                	push   $0x0
  pushl $142
801073d0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801073d5:	e9 ea f3 ff ff       	jmp    801067c4 <alltraps>
...
801073da:	6a 00                	push   $0x0
  pushl $143
801073dc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801073e1:	e9 de f3 ff ff       	jmp    801067c4 <alltraps>
...
801073e6:	6a 00                	push   $0x0
  pushl $144
801073e8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801073ed:	e9 d2 f3 ff ff       	jmp    801067c4 <alltraps>
...
801073f2:	6a 00                	push   $0x0
  pushl $145
801073f4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801073f9:	e9 c6 f3 ff ff       	jmp    801067c4 <alltraps>
...
801073fe:	6a 00                	push   $0x0
  pushl $146
80107400:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107405:	e9 ba f3 ff ff       	jmp    801067c4 <alltraps>
...
8010740a:	6a 00                	push   $0x0
  pushl $147
8010740c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107411:	e9 ae f3 ff ff       	jmp    801067c4 <alltraps>
...
80107416:	6a 00                	push   $0x0
  pushl $148
80107418:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010741d:	e9 a2 f3 ff ff       	jmp    801067c4 <alltraps>
...
80107422:	6a 00                	push   $0x0
  pushl $149
80107424:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107429:	e9 96 f3 ff ff       	jmp    801067c4 <alltraps>
...
8010742e:	6a 00                	push   $0x0
  pushl $150
80107430:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107435:	e9 8a f3 ff ff       	jmp    801067c4 <alltraps>
...
8010743a:	6a 00                	push   $0x0
  pushl $151
8010743c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107441:	e9 7e f3 ff ff       	jmp    801067c4 <alltraps>
...
80107446:	6a 00                	push   $0x0
  pushl $152
80107448:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010744d:	e9 72 f3 ff ff       	jmp    801067c4 <alltraps>
...
80107452:	6a 00                	push   $0x0
  pushl $153
80107454:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107459:	e9 66 f3 ff ff       	jmp    801067c4 <alltraps>
...
8010745e:	6a 00                	push   $0x0
  pushl $154
80107460:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107465:	e9 5a f3 ff ff       	jmp    801067c4 <alltraps>
...
8010746a:	6a 00                	push   $0x0
  pushl $155
8010746c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107471:	e9 4e f3 ff ff       	jmp    801067c4 <alltraps>
...
80107476:	6a 00                	push   $0x0
  pushl $156
80107478:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010747d:	e9 42 f3 ff ff       	jmp    801067c4 <alltraps>
...
80107482:	6a 00                	push   $0x0
  pushl $157
80107484:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107489:	e9 36 f3 ff ff       	jmp    801067c4 <alltraps>
...
8010748e:	6a 00                	push   $0x0
  pushl $158
80107490:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107495:	e9 2a f3 ff ff       	jmp    801067c4 <alltraps>
...
8010749a:	6a 00                	push   $0x0
  pushl $159
8010749c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801074a1:	e9 1e f3 ff ff       	jmp    801067c4 <alltraps>
...
801074a6:	6a 00                	push   $0x0
  pushl $160
801074a8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801074ad:	e9 12 f3 ff ff       	jmp    801067c4 <alltraps>
...
801074b2:	6a 00                	push   $0x0
  pushl $161
801074b4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801074b9:	e9 06 f3 ff ff       	jmp    801067c4 <alltraps>
...
801074be:	6a 00                	push   $0x0
  pushl $162
801074c0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801074c5:	e9 fa f2 ff ff       	jmp    801067c4 <alltraps>
...
801074ca:	6a 00                	push   $0x0
  pushl $163
801074cc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801074d1:	e9 ee f2 ff ff       	jmp    801067c4 <alltraps>
...
801074d6:	6a 00                	push   $0x0
  pushl $164
801074d8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801074dd:	e9 e2 f2 ff ff       	jmp    801067c4 <alltraps>
...
801074e2:	6a 00                	push   $0x0
  pushl $165
801074e4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801074e9:	e9 d6 f2 ff ff       	jmp    801067c4 <alltraps>
...
801074ee:	6a 00                	push   $0x0
  pushl $166
801074f0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801074f5:	e9 ca f2 ff ff       	jmp    801067c4 <alltraps>
...
801074fa:	6a 00                	push   $0x0
  pushl $167
801074fc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107501:	e9 be f2 ff ff       	jmp    801067c4 <alltraps>
...
80107506:	6a 00                	push   $0x0
  pushl $168
80107508:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010750d:	e9 b2 f2 ff ff       	jmp    801067c4 <alltraps>
...
80107512:	6a 00                	push   $0x0
  pushl $169
80107514:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107519:	e9 a6 f2 ff ff       	jmp    801067c4 <alltraps>
...
8010751e:	6a 00                	push   $0x0
  pushl $170
80107520:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107525:	e9 9a f2 ff ff       	jmp    801067c4 <alltraps>
...
8010752a:	6a 00                	push   $0x0
  pushl $171
8010752c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107531:	e9 8e f2 ff ff       	jmp    801067c4 <alltraps>
...
80107536:	6a 00                	push   $0x0
  pushl $172
80107538:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010753d:	e9 82 f2 ff ff       	jmp    801067c4 <alltraps>
...
80107542:	6a 00                	push   $0x0
  pushl $173
80107544:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107549:	e9 76 f2 ff ff       	jmp    801067c4 <alltraps>
...
8010754e:	6a 00                	push   $0x0
  pushl $174
80107550:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107555:	e9 6a f2 ff ff       	jmp    801067c4 <alltraps>
...
8010755a:	6a 00                	push   $0x0
  pushl $175
8010755c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107561:	e9 5e f2 ff ff       	jmp    801067c4 <alltraps>
...
80107566:	6a 00                	push   $0x0
  pushl $176
80107568:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010756d:	e9 52 f2 ff ff       	jmp    801067c4 <alltraps>
...
80107572:	6a 00                	push   $0x0
  pushl $177
80107574:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107579:	e9 46 f2 ff ff       	jmp    801067c4 <alltraps>
...
8010757e:	6a 00                	push   $0x0
  pushl $178
80107580:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107585:	e9 3a f2 ff ff       	jmp    801067c4 <alltraps>
...
8010758a:	6a 00                	push   $0x0
  pushl $179
8010758c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107591:	e9 2e f2 ff ff       	jmp    801067c4 <alltraps>
...
80107596:	6a 00                	push   $0x0
  pushl $180
80107598:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010759d:	e9 22 f2 ff ff       	jmp    801067c4 <alltraps>
...
801075a2:	6a 00                	push   $0x0
  pushl $181
801075a4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801075a9:	e9 16 f2 ff ff       	jmp    801067c4 <alltraps>
...
801075ae:	6a 00                	push   $0x0
  pushl $182
801075b0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801075b5:	e9 0a f2 ff ff       	jmp    801067c4 <alltraps>
...
801075ba:	6a 00                	push   $0x0
  pushl $183
801075bc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801075c1:	e9 fe f1 ff ff       	jmp    801067c4 <alltraps>
...
801075c6:	6a 00                	push   $0x0
  pushl $184
801075c8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801075cd:	e9 f2 f1 ff ff       	jmp    801067c4 <alltraps>
...
801075d2:	6a 00                	push   $0x0
  pushl $185
801075d4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801075d9:	e9 e6 f1 ff ff       	jmp    801067c4 <alltraps>
...
801075de:	6a 00                	push   $0x0
  pushl $186
801075e0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801075e5:	e9 da f1 ff ff       	jmp    801067c4 <alltraps>
...
801075ea:	6a 00                	push   $0x0
  pushl $187
801075ec:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801075f1:	e9 ce f1 ff ff       	jmp    801067c4 <alltraps>
...
801075f6:	6a 00                	push   $0x0
  pushl $188
801075f8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801075fd:	e9 c2 f1 ff ff       	jmp    801067c4 <alltraps>
...
80107602:	6a 00                	push   $0x0
  pushl $189
80107604:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107609:	e9 b6 f1 ff ff       	jmp    801067c4 <alltraps>
...
8010760e:	6a 00                	push   $0x0
  pushl $190
80107610:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107615:	e9 aa f1 ff ff       	jmp    801067c4 <alltraps>
...
8010761a:	6a 00                	push   $0x0
  pushl $191
8010761c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107621:	e9 9e f1 ff ff       	jmp    801067c4 <alltraps>
...
80107626:	6a 00                	push   $0x0
  pushl $192
80107628:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010762d:	e9 92 f1 ff ff       	jmp    801067c4 <alltraps>
...
80107632:	6a 00                	push   $0x0
  pushl $193
80107634:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107639:	e9 86 f1 ff ff       	jmp    801067c4 <alltraps>
...
8010763e:	6a 00                	push   $0x0
  pushl $194
80107640:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107645:	e9 7a f1 ff ff       	jmp    801067c4 <alltraps>
...
8010764a:	6a 00                	push   $0x0
  pushl $195
8010764c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107651:	e9 6e f1 ff ff       	jmp    801067c4 <alltraps>
...
80107656:	6a 00                	push   $0x0
  pushl $196
80107658:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010765d:	e9 62 f1 ff ff       	jmp    801067c4 <alltraps>
...
80107662:	6a 00                	push   $0x0
  pushl $197
80107664:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107669:	e9 56 f1 ff ff       	jmp    801067c4 <alltraps>
...
8010766e:	6a 00                	push   $0x0
  pushl $198
80107670:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107675:	e9 4a f1 ff ff       	jmp    801067c4 <alltraps>
...
8010767a:	6a 00                	push   $0x0
  pushl $199
8010767c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107681:	e9 3e f1 ff ff       	jmp    801067c4 <alltraps>
...
80107686:	6a 00                	push   $0x0
  pushl $200
80107688:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010768d:	e9 32 f1 ff ff       	jmp    801067c4 <alltraps>
...
80107692:	6a 00                	push   $0x0
  pushl $201
80107694:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107699:	e9 26 f1 ff ff       	jmp    801067c4 <alltraps>
...
8010769e:	6a 00                	push   $0x0
  pushl $202
801076a0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801076a5:	e9 1a f1 ff ff       	jmp    801067c4 <alltraps>
...
801076aa:	6a 00                	push   $0x0
  pushl $203
801076ac:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801076b1:	e9 0e f1 ff ff       	jmp    801067c4 <alltraps>
...
801076b6:	6a 00                	push   $0x0
  pushl $204
801076b8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801076bd:	e9 02 f1 ff ff       	jmp    801067c4 <alltraps>
...
801076c2:	6a 00                	push   $0x0
  pushl $205
801076c4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801076c9:	e9 f6 f0 ff ff       	jmp    801067c4 <alltraps>
...
801076ce:	6a 00                	push   $0x0
  pushl $206
801076d0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801076d5:	e9 ea f0 ff ff       	jmp    801067c4 <alltraps>
...
801076da:	6a 00                	push   $0x0
  pushl $207
801076dc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801076e1:	e9 de f0 ff ff       	jmp    801067c4 <alltraps>
...
801076e6:	6a 00                	push   $0x0
  pushl $208
801076e8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801076ed:	e9 d2 f0 ff ff       	jmp    801067c4 <alltraps>
...
801076f2:	6a 00                	push   $0x0
  pushl $209
801076f4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801076f9:	e9 c6 f0 ff ff       	jmp    801067c4 <alltraps>
...
801076fe:	6a 00                	push   $0x0
  pushl $210
80107700:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107705:	e9 ba f0 ff ff       	jmp    801067c4 <alltraps>
...
8010770a:	6a 00                	push   $0x0
  pushl $211
8010770c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107711:	e9 ae f0 ff ff       	jmp    801067c4 <alltraps>
...
80107716:	6a 00                	push   $0x0
  pushl $212
80107718:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010771d:	e9 a2 f0 ff ff       	jmp    801067c4 <alltraps>
...
80107722:	6a 00                	push   $0x0
  pushl $213
80107724:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107729:	e9 96 f0 ff ff       	jmp    801067c4 <alltraps>
...
8010772e:	6a 00                	push   $0x0
  pushl $214
80107730:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107735:	e9 8a f0 ff ff       	jmp    801067c4 <alltraps>
...
8010773a:	6a 00                	push   $0x0
  pushl $215
8010773c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107741:	e9 7e f0 ff ff       	jmp    801067c4 <alltraps>
...
80107746:	6a 00                	push   $0x0
  pushl $216
80107748:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010774d:	e9 72 f0 ff ff       	jmp    801067c4 <alltraps>
...
80107752:	6a 00                	push   $0x0
  pushl $217
80107754:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107759:	e9 66 f0 ff ff       	jmp    801067c4 <alltraps>
...
8010775e:	6a 00                	push   $0x0
  pushl $218
80107760:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107765:	e9 5a f0 ff ff       	jmp    801067c4 <alltraps>
...
8010776a:	6a 00                	push   $0x0
  pushl $219
8010776c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107771:	e9 4e f0 ff ff       	jmp    801067c4 <alltraps>
...
80107776:	6a 00                	push   $0x0
  pushl $220
80107778:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010777d:	e9 42 f0 ff ff       	jmp    801067c4 <alltraps>
...
80107782:	6a 00                	push   $0x0
  pushl $221
80107784:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107789:	e9 36 f0 ff ff       	jmp    801067c4 <alltraps>
...
8010778e:	6a 00                	push   $0x0
  pushl $222
80107790:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107795:	e9 2a f0 ff ff       	jmp    801067c4 <alltraps>
...
8010779a:	6a 00                	push   $0x0
  pushl $223
8010779c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801077a1:	e9 1e f0 ff ff       	jmp    801067c4 <alltraps>
...
801077a6:	6a 00                	push   $0x0
  pushl $224
801077a8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801077ad:	e9 12 f0 ff ff       	jmp    801067c4 <alltraps>
...
801077b2:	6a 00                	push   $0x0
  pushl $225
801077b4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801077b9:	e9 06 f0 ff ff       	jmp    801067c4 <alltraps>
...
801077be:	6a 00                	push   $0x0
  pushl $226
801077c0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801077c5:	e9 fa ef ff ff       	jmp    801067c4 <alltraps>
...
801077ca:	6a 00                	push   $0x0
  pushl $227
801077cc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801077d1:	e9 ee ef ff ff       	jmp    801067c4 <alltraps>
...
801077d6:	6a 00                	push   $0x0
  pushl $228
801077d8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801077dd:	e9 e2 ef ff ff       	jmp    801067c4 <alltraps>
...
801077e2:	6a 00                	push   $0x0
  pushl $229
801077e4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801077e9:	e9 d6 ef ff ff       	jmp    801067c4 <alltraps>
...
801077ee:	6a 00                	push   $0x0
  pushl $230
801077f0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801077f5:	e9 ca ef ff ff       	jmp    801067c4 <alltraps>
...
801077fa:	6a 00                	push   $0x0
  pushl $231
801077fc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107801:	e9 be ef ff ff       	jmp    801067c4 <alltraps>
...
80107806:	6a 00                	push   $0x0
  pushl $232
80107808:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010780d:	e9 b2 ef ff ff       	jmp    801067c4 <alltraps>
...
80107812:	6a 00                	push   $0x0
  pushl $233
80107814:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107819:	e9 a6 ef ff ff       	jmp    801067c4 <alltraps>
...
8010781e:	6a 00                	push   $0x0
  pushl $234
80107820:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107825:	e9 9a ef ff ff       	jmp    801067c4 <alltraps>
...
8010782a:	6a 00                	push   $0x0
  pushl $235
8010782c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107831:	e9 8e ef ff ff       	jmp    801067c4 <alltraps>
...
80107836:	6a 00                	push   $0x0
  pushl $236
80107838:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010783d:	e9 82 ef ff ff       	jmp    801067c4 <alltraps>
...
80107842:	6a 00                	push   $0x0
  pushl $237
80107844:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107849:	e9 76 ef ff ff       	jmp    801067c4 <alltraps>
...
8010784e:	6a 00                	push   $0x0
  pushl $238
80107850:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107855:	e9 6a ef ff ff       	jmp    801067c4 <alltraps>
...
8010785a:	6a 00                	push   $0x0
  pushl $239
8010785c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107861:	e9 5e ef ff ff       	jmp    801067c4 <alltraps>
...
80107866:	6a 00                	push   $0x0
  pushl $240
80107868:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010786d:	e9 52 ef ff ff       	jmp    801067c4 <alltraps>
...
80107872:	6a 00                	push   $0x0
  pushl $241
80107874:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107879:	e9 46 ef ff ff       	jmp    801067c4 <alltraps>
...
8010787e:	6a 00                	push   $0x0
  pushl $242
80107880:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107885:	e9 3a ef ff ff       	jmp    801067c4 <alltraps>
...
8010788a:	6a 00                	push   $0x0
  pushl $243
8010788c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107891:	e9 2e ef ff ff       	jmp    801067c4 <alltraps>
...
80107896:	6a 00                	push   $0x0
  pushl $244
80107898:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010789d:	e9 22 ef ff ff       	jmp    801067c4 <alltraps>
...
801078a2:	6a 00                	push   $0x0
  pushl $245
801078a4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801078a9:	e9 16 ef ff ff       	jmp    801067c4 <alltraps>
...
801078ae:	6a 00                	push   $0x0
  pushl $246
801078b0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801078b5:	e9 0a ef ff ff       	jmp    801067c4 <alltraps>
...
801078ba:	6a 00                	push   $0x0
  pushl $247
801078bc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801078c1:	e9 fe ee ff ff       	jmp    801067c4 <alltraps>
...
801078c6:	6a 00                	push   $0x0
  pushl $248
801078c8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801078cd:	e9 f2 ee ff ff       	jmp    801067c4 <alltraps>
...
801078d2:	6a 00                	push   $0x0
  pushl $249
801078d4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801078d9:	e9 e6 ee ff ff       	jmp    801067c4 <alltraps>
...
801078de:	6a 00                	push   $0x0
  pushl $250
801078e0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801078e5:	e9 da ee ff ff       	jmp    801067c4 <alltraps>
...
801078ea:	6a 00                	push   $0x0
  pushl $251
801078ec:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801078f1:	e9 ce ee ff ff       	jmp    801067c4 <alltraps>
...
801078f6:	6a 00                	push   $0x0
  pushl $252
801078f8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801078fd:	e9 c2 ee ff ff       	jmp    801067c4 <alltraps>
...
80107902:	6a 00                	push   $0x0
  pushl $253
80107904:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107909:	e9 b6 ee ff ff       	jmp    801067c4 <alltraps>
...
8010790e:	6a 00                	push   $0x0
  pushl $254
80107910:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107915:	e9 aa ee ff ff       	jmp    801067c4 <alltraps>
...
8010791a:	6a 00                	push   $0x0
  pushl $255
8010791c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107921:	e9 9e ee ff ff       	jmp    801067c4 <alltraps>
	...
...
8010792b:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
8010792e:	8b 45 0c             	mov    0xc(%ebp),%eax
80107931:	83 e8 01             	sub    $0x1,%eax
80107934:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107938:	8b 45 08             	mov    0x8(%ebp),%eax
8010793b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010793f:	8b 45 08             	mov    0x8(%ebp),%eax
80107942:	c1 e8 10             	shr    $0x10,%eax
80107945:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107949:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010794c:	0f 01 10             	lgdtl  (%eax)
}
8010794f:	c9                   	leave  
80107950:	c3                   	ret    
...
8010796a:	83 ec 04             	sub    $0x4,%esp
8010796d:	8b 45 08             	mov    0x8(%ebp),%eax
80107970:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107974:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107978:	8e e8                	mov    %eax,%gs
}
8010797a:	c9                   	leave  
8010797b:	c3                   	ret    
...
8010799a:	05 00 00 00 80       	add    $0x80000000,%eax
8010799f:	5d                   	pop    %ebp
801079a0:	c3                   	ret    
...
801079a5:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801079a8:	e8 48 b8 ff ff       	call   801031f5 <cpunum>
801079ad:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801079b3:	05 40 f9 10 80       	add    $0x8010f940,%eax
801079b8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801079bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079be:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801079c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c7:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801079cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d0:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801079d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801079db:	83 e2 f0             	and    $0xfffffff0,%edx
801079de:	83 ca 0a             	or     $0xa,%edx
...
80107a42:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107a46:	83 ca 80             	or     $0xffffff80,%edx
80107a49:	88 50 7e             	mov    %dl,0x7e(%eax)
80107a4c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107a53:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a56:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107a5d:	ff ff 
80107a5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a62:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107a69:	00 00 
80107a6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a6e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107a75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a78:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107a7f:	83 e2 f0             	and    $0xfffffff0,%edx
80107a82:	83 ca 02             	or     $0x2,%edx
80107a85:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a8e:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107a95:	83 ca 10             	or     $0x10,%edx
80107a98:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107a9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aa1:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107aa8:	83 e2 9f             	and    $0xffffff9f,%edx
80107aab:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107ab1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab4:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107abb:	83 ca 80             	or     $0xffffff80,%edx
80107abe:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107ac4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac7:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ace:	83 ca 0f             	or     $0xf,%edx
80107ad1:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107ad7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ada:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107ae1:	83 e2 ef             	and    $0xffffffef,%edx
80107ae4:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107aea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aed:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107af4:	83 e2 df             	and    $0xffffffdf,%edx
80107af7:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107afd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b00:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107b07:	83 ca 40             	or     $0x40,%edx
80107b0a:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107b10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b13:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107b1a:	83 ca 80             	or     $0xffffff80,%edx
80107b1d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b26:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107b2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b30:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107b37:	ff ff 
80107b39:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3c:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107b43:	00 00 
80107b45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b48:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b52:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b59:	83 e2 f0             	and    $0xfffffff0,%edx
80107b5c:	83 ca 0a             	or     $0xa,%edx
80107b5f:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107b65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b68:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b6f:	83 ca 10             	or     $0x10,%edx
80107b72:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107b78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b7b:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b82:	83 ca 60             	or     $0x60,%edx
80107b85:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b8e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107b95:	83 ca 80             	or     $0xffffff80,%edx
80107b98:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107b9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba1:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107ba8:	83 ca 0f             	or     $0xf,%edx
80107bab:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107bb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bb4:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107bbb:	83 e2 ef             	and    $0xffffffef,%edx
80107bbe:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107bc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bc7:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107bce:	83 e2 df             	and    $0xffffffdf,%edx
80107bd1:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107bd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bda:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107be1:	83 ca 40             	or     $0x40,%edx
80107be4:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107bea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bed:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107bf4:	83 ca 80             	or     $0xffffff80,%edx
80107bf7:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107bfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c00:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107c07:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c0a:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107c11:	ff ff 
80107c13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c16:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107c1d:	00 00 
80107c1f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c22:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107c29:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c2c:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c33:	83 e2 f0             	and    $0xfffffff0,%edx
80107c36:	83 ca 02             	or     $0x2,%edx
80107c39:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c42:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c49:	83 ca 10             	or     $0x10,%edx
80107c4c:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c55:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c5c:	83 ca 60             	or     $0x60,%edx
80107c5f:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c68:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107c6f:	83 ca 80             	or     $0xffffff80,%edx
80107c72:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107c78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c7b:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107c82:	83 ca 0f             	or     $0xf,%edx
80107c85:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107c8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c8e:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107c95:	83 e2 ef             	and    $0xffffffef,%edx
80107c98:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107c9e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ca1:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107ca8:	83 e2 df             	and    $0xffffffdf,%edx
80107cab:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107cb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb4:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107cbb:	83 ca 40             	or     $0x40,%edx
80107cbe:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107cc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cc7:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107cce:	83 ca 80             	or     $0xffffff80,%edx
80107cd1:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107cd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cda:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107ce1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce4:	05 b4 00 00 00       	add    $0xb4,%eax
...
80107cf6:	89 c1                	mov    %eax,%ecx
80107cf8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cfb:	05 b4 00 00 00       	add    $0xb4,%eax
80107d00:	c1 e8 18             	shr    $0x18,%eax
80107d03:	89 c2                	mov    %eax,%edx
80107d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d08:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107d0f:	00 00 
80107d11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d14:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107d1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d1e:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107d24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d27:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d2e:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d31:	83 c9 02             	or     $0x2,%ecx
80107d34:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d3a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d3d:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d44:	83 c9 10             	or     $0x10,%ecx
80107d47:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d50:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d57:	83 e1 9f             	and    $0xffffff9f,%ecx
80107d5a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d63:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107d6a:	83 c9 80             	or     $0xffffff80,%ecx
80107d6d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107d73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d76:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d7d:	83 e1 f0             	and    $0xfffffff0,%ecx
80107d80:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d89:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107d90:	83 e1 ef             	and    $0xffffffef,%ecx
80107d93:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107d99:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d9c:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107da3:	83 e1 df             	and    $0xffffffdf,%ecx
80107da6:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107dac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107daf:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107db6:	83 c9 40             	or     $0x40,%ecx
80107db9:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107dbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dc2:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107dc9:	83 c9 80             	or     $0xffffff80,%ecx
80107dcc:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107dd2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dd5:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107ddb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dde:	83 c0 70             	add    $0x70,%eax
80107de1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107de8:	00 
80107de9:	89 04 24             	mov    %eax,(%esp)
80107dec:	e8 37 fb ff ff       	call   80107928 <lgdt>
  loadgs(SEG_KCPU << 3);
80107df1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107df8:	e8 6a fb ff ff       	call   80107967 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e00:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107e06:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107e0d:	00 00 00 00 
}
80107e11:	83 c4 24             	add    $0x24,%esp
80107e14:	5b                   	pop    %ebx
80107e15:	5d                   	pop    %ebp
80107e16:	c3                   	ret    
...
80107e20:	c1 e8 16             	shr    $0x16,%eax
80107e23:	c1 e0 02             	shl    $0x2,%eax
80107e26:	03 45 08             	add    0x8(%ebp),%eax
...
80107e36:	74 17                	je     80107e4f <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107e38:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e3b:	8b 00                	mov    (%eax),%eax
80107e3d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e42:	89 04 24             	mov    %eax,(%esp)
80107e45:	e8 4a fb ff ff       	call   80107994 <p2v>
80107e4a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e4d:	eb 4b                	jmp    80107e9a <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107e4f:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107e53:	74 0e                	je     80107e63 <walkpgdir+0x4c>
80107e55:	e8 0d b0 ff ff       	call   80102e67 <kalloc>
80107e5a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107e5d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107e61:	75 07                	jne    80107e6a <walkpgdir+0x53>
      return 0;
80107e63:	b8 00 00 00 00       	mov    $0x0,%eax
80107e68:	eb 41                	jmp    80107eab <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107e6a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e71:	00 
80107e72:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e79:	00 
80107e7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e7d:	89 04 24             	mov    %eax,(%esp)
80107e80:	e8 a9 d4 ff ff       	call   8010532e <memset>
...
80107e8b:	e8 f7 fa ff ff       	call   80107987 <v2p>
80107e90:	89 c2                	mov    %eax,%edx
80107e92:	83 ca 07             	or     $0x7,%edx
80107e95:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e98:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107e9a:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e9d:	c1 e8 0c             	shr    $0xc,%eax
80107ea0:	25 ff 03 00 00       	and    $0x3ff,%eax
80107ea5:	c1 e0 02             	shl    $0x2,%eax
80107ea8:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107eab:	c9                   	leave  
80107eac:	c3                   	ret    
...
80107ebe:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ec1:	03 45 10             	add    0x10(%ebp),%eax
80107ec4:	83 e8 01             	sub    $0x1,%eax
80107ec7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107ecc:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107ecf:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107ed6:	00 
...
80107ee4:	e8 2e ff ff ff       	call   80107e17 <walkpgdir>
80107ee9:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107eec:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107ef0:	75 07                	jne    80107ef9 <mappages+0x4c>
      return -1;
80107ef2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107ef7:	eb 46                	jmp    80107f3f <mappages+0x92>
    if(*pte & PTE_P)
80107ef9:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107efc:	8b 00                	mov    (%eax),%eax
80107efe:	83 e0 01             	and    $0x1,%eax
80107f01:	84 c0                	test   %al,%al
80107f03:	74 0c                	je     80107f11 <mappages+0x64>
      panic("remap");
80107f05:	c7 04 24 38 8d 10 80 	movl   $0x80108d38,(%esp)
80107f0c:	e8 2c 86 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107f11:	8b 45 18             	mov    0x18(%ebp),%eax
80107f14:	0b 45 14             	or     0x14(%ebp),%eax
80107f17:	89 c2                	mov    %eax,%edx
80107f19:	83 ca 01             	or     $0x1,%edx
80107f1c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f1f:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107f21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f24:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f27:	74 10                	je     80107f39 <mappages+0x8c>
      break;
    a += PGSIZE;
80107f29:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107f30:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107f37:	eb 96                	jmp    80107ecf <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107f45:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107f48:	e8 1a af ff ff       	call   80102e67 <kalloc>
80107f4d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107f50:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f54:	75 0a                	jne    80107f60 <setupkvm+0x1f>
    return 0;
80107f56:	b8 00 00 00 00       	mov    $0x0,%eax
80107f5b:	e9 98 00 00 00       	jmp    80107ff8 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107f60:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f67:	00 
80107f68:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f6f:	00 
80107f70:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f73:	89 04 24             	mov    %eax,(%esp)
80107f76:	e8 b3 d3 ff ff       	call   8010532e <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107f7b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107f82:	e8 0d fa ff ff       	call   80107994 <p2v>
80107f87:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107f8c:	76 0c                	jbe    80107f9a <setupkvm+0x59>
    panic("PHYSTOP too high");
80107f8e:	c7 04 24 3e 8d 10 80 	movl   $0x80108d3e,(%esp)
80107f95:	e8 a3 85 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107f9a:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107fa1:	eb 49                	jmp    80107fec <setupkvm+0xab>
...
80107fa3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107fa6:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107fa9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107fac:	8b 50 04             	mov    0x4(%eax),%edx
80107faf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb2:	8b 58 08             	mov    0x8(%eax),%ebx
80107fb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb8:	8b 40 04             	mov    0x4(%eax),%eax
80107fbb:	29 c3                	sub    %eax,%ebx
80107fbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc0:	8b 00                	mov    (%eax),%eax
80107fc2:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107fc6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107fca:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107fce:	89 44 24 04          	mov    %eax,0x4(%esp)
80107fd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fd5:	89 04 24             	mov    %eax,(%esp)
80107fd8:	e8 d0 fe ff ff       	call   80107ead <mappages>
80107fdd:	85 c0                	test   %eax,%eax
80107fdf:	79 07                	jns    80107fe8 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107fe1:	b8 00 00 00 00       	mov    $0x0,%eax
80107fe6:	eb 10                	jmp    80107ff8 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107fe8:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107fec:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107ff3:	72 ae                	jb     80107fa3 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107ff8:	83 c4 34             	add    $0x34,%esp
80107ffb:	5b                   	pop    %ebx
80107ffc:	5d                   	pop    %ebp
80107ffd:	c3                   	ret    
...
80108001:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108004:	e8 38 ff ff ff       	call   80107f41 <setupkvm>
80108009:	a3 18 2b 11 80       	mov    %eax,0x80112b18
  switchkvm();
8010800e:	e8 02 00 00 00       	call   80108015 <switchkvm>
}
80108013:	c9                   	leave  
80108014:	c3                   	ret    
...
8010801b:	a1 18 2b 11 80       	mov    0x80112b18,%eax
80108020:	89 04 24             	mov    %eax,(%esp)
80108023:	e8 5f f9 ff ff       	call   80107987 <v2p>
80108028:	89 04 24             	mov    %eax,(%esp)
8010802b:	e8 4c f9 ff ff       	call   8010797c <lcr3>
}
80108030:	c9                   	leave  
80108031:	c3                   	ret    
...
80108036:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80108039:	e8 e9 d1 ff ff       	call   80105227 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010803e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108044:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010804b:	83 c2 08             	add    $0x8,%edx
8010804e:	89 d3                	mov    %edx,%ebx
80108050:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108057:	83 c2 08             	add    $0x8,%edx
8010805a:	c1 ea 10             	shr    $0x10,%edx
8010805d:	89 d1                	mov    %edx,%ecx
8010805f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108066:	83 c2 08             	add    $0x8,%edx
80108069:	c1 ea 18             	shr    $0x18,%edx
8010806c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80108073:	67 00 
80108075:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
8010807c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80108082:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108089:	83 e1 f0             	and    $0xfffffff0,%ecx
8010808c:	83 c9 09             	or     $0x9,%ecx
8010808f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108095:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
8010809c:	83 c9 10             	or     $0x10,%ecx
8010809f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080a5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080ac:	83 e1 9f             	and    $0xffffff9f,%ecx
801080af:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080b5:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
801080bc:	83 c9 80             	or     $0xffffff80,%ecx
801080bf:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
801080c5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080cc:	83 e1 f0             	and    $0xfffffff0,%ecx
801080cf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080d5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080dc:	83 e1 ef             	and    $0xffffffef,%ecx
801080df:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080e5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080ec:	83 e1 df             	and    $0xffffffdf,%ecx
801080ef:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801080f5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801080fc:	83 c9 40             	or     $0x40,%ecx
801080ff:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108105:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
8010810c:	83 e1 7f             	and    $0x7f,%ecx
8010810f:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108115:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
8010811b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108121:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80108128:	83 e2 ef             	and    $0xffffffef,%edx
8010812b:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80108131:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108137:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
8010813d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80108143:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010814a:	8b 52 08             	mov    0x8(%edx),%edx
8010814d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80108153:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108156:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
8010815d:	e8 ef f7 ff ff       	call   80107951 <ltr>
  if(p->pgdir == 0)
80108162:	8b 45 08             	mov    0x8(%ebp),%eax
80108165:	8b 40 04             	mov    0x4(%eax),%eax
80108168:	85 c0                	test   %eax,%eax
8010816a:	75 0c                	jne    80108178 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
8010816c:	c7 04 24 4f 8d 10 80 	movl   $0x80108d4f,(%esp)
...
80108181:	e8 01 f8 ff ff       	call   80107987 <v2p>
80108186:	89 04 24             	mov    %eax,(%esp)
80108189:	e8 ee f7 ff ff       	call   8010797c <lcr3>
  popcli();
8010818e:	e8 dc d0 ff ff       	call   8010526f <popcli>
}
80108193:	83 c4 14             	add    $0x14,%esp
80108196:	5b                   	pop    %ebx
80108197:	5d                   	pop    %ebp
80108198:	c3                   	ret    
...
8010819c:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010819f:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
801081a6:	76 0c                	jbe    801081b4 <inituvm+0x1b>
    panic("inituvm: more than a page");
801081a8:	c7 04 24 63 8d 10 80 	movl   $0x80108d63,(%esp)
801081af:	e8 89 83 ff ff       	call   8010053d <panic>
  mem = kalloc();
801081b4:	e8 ae ac ff ff       	call   80102e67 <kalloc>
...
801081d2:	e8 57 d1 ff ff       	call   8010532e <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
801081d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081da:	89 04 24             	mov    %eax,(%esp)
801081dd:	e8 a5 f7 ff ff       	call   80107987 <v2p>
...
801081f5:	00 
801081f6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801081fd:	00 
801081fe:	8b 45 08             	mov    0x8(%ebp),%eax
80108201:	89 04 24             	mov    %eax,(%esp)
80108204:	e8 a4 fc ff ff       	call   80107ead <mappages>
  memmove(mem, init, sz);
...
8010821d:	e8 df d1 ff ff       	call   80105401 <memmove>
}
80108222:	c9                   	leave  
80108223:	c3                   	ret    
...
80108228:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010822b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010822e:	25 ff 0f 00 00       	and    $0xfff,%eax
80108233:	85 c0                	test   %eax,%eax
80108235:	74 0c                	je     80108243 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80108237:	c7 04 24 80 8d 10 80 	movl   $0x80108d80,(%esp)
8010823e:	e8 fa 82 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80108243:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010824a:	e9 ad 00 00 00       	jmp    801082fc <loaduvm+0xd8>
...
80108269:	e8 a9 fb ff ff       	call   80107e17 <walkpgdir>
8010826e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108271:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108275:	75 0c                	jne    80108283 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108277:	c7 04 24 a3 8d 10 80 	movl   $0x80108da3,(%esp)
8010827e:	e8 ba 82 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80108293:	8b 55 18             	mov    0x18(%ebp),%edx
80108296:	89 d1                	mov    %edx,%ecx
80108298:	29 c1                	sub    %eax,%ecx
8010829a:	89 c8                	mov    %ecx,%eax
8010829c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801082a1:	77 11                	ja     801082b4 <loaduvm+0x90>
      n = sz - i;
801082a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a6:	8b 55 18             	mov    0x18(%ebp),%edx
801082a9:	89 d1                	mov    %edx,%ecx
801082ab:	29 c1                	sub    %eax,%ecx
801082ad:	89 c8                	mov    %ecx,%eax
801082af:	89 45 f0             	mov    %eax,-0x10(%ebp)
801082b2:	eb 07                	jmp    801082bb <loaduvm+0x97>
    else
      n = PGSIZE;
801082b4:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
801082bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082be:	8b 55 14             	mov    0x14(%ebp),%edx
801082c1:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801082c4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082c7:	89 04 24             	mov    %eax,(%esp)
801082ca:	e8 c5 f6 ff ff       	call   80107994 <p2v>
801082cf:	8b 55 f0             	mov    -0x10(%ebp),%edx
801082d2:	89 54 24 0c          	mov    %edx,0xc(%esp)
801082d6:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801082da:	89 44 24 04          	mov    %eax,0x4(%esp)
801082de:	8b 45 10             	mov    0x10(%ebp),%eax
801082e1:	89 04 24             	mov    %eax,(%esp)
801082e4:	e8 dd 9d ff ff       	call   801020c6 <readi>
801082e9:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801082ec:	74 07                	je     801082f5 <loaduvm+0xd1>
      return -1;
801082ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082f3:	eb 18                	jmp    8010830d <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801082f5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801082fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082ff:	3b 45 18             	cmp    0x18(%ebp),%eax
80108302:	0f 82 47 ff ff ff    	jb     8010824f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108316:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80108325:	e9 c1 00 00 00       	jmp    801083eb <allocuvm+0xd8>
  if(newsz < oldsz)
...
80108335:	e9 b1 00 00 00       	jmp    801083eb <allocuvm+0xd8>
...
8010834a:	e9 8d 00 00 00       	jmp    801083dc <allocuvm+0xc9>
    mem = kalloc();
8010834f:	e8 13 ab ff ff       	call   80102e67 <kalloc>
80108354:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108357:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010835b:	75 2c                	jne    80108389 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
8010835d:	c7 04 24 c1 8d 10 80 	movl   $0x80108dc1,(%esp)
80108364:	e8 38 80 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108369:	8b 45 0c             	mov    0xc(%ebp),%eax
8010836c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010837d:	e8 6b 00 00 00       	call   801083ed <deallocuvm>
      return 0;
80108382:	b8 00 00 00 00       	mov    $0x0,%eax
80108387:	eb 62                	jmp    801083eb <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108389:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108390:	00 
80108391:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108398:	00 
80108399:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010839c:	89 04 24             	mov    %eax,(%esp)
8010839f:	e8 8a cf ff ff       	call   8010532e <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801083a4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083a7:	89 04 24             	mov    %eax,(%esp)
801083aa:	e8 d8 f5 ff ff       	call   80107987 <v2p>
801083af:	8b 55 f4             	mov    -0xc(%ebp),%edx
801083b2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801083b9:	00 
801083ba:	89 44 24 0c          	mov    %eax,0xc(%esp)
801083be:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083c5:	00 
801083c6:	89 54 24 04          	mov    %edx,0x4(%esp)
801083ca:	8b 45 08             	mov    0x8(%ebp),%eax
801083cd:	89 04 24             	mov    %eax,(%esp)
801083d0:	e8 d8 fa ff ff       	call   80107ead <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801083e2:	0f 82 67 ff ff ff    	jb     8010834f <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801083f0:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
801083fe:	e9 a4 00 00 00       	jmp    801084a7 <deallocuvm+0xba>
...
80108413:	e9 80 00 00 00       	jmp    80108498 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80108418:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010841b:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108422:	00 
80108423:	89 44 24 04          	mov    %eax,0x4(%esp)
80108427:	8b 45 08             	mov    0x8(%ebp),%eax
8010842a:	89 04 24             	mov    %eax,(%esp)
8010842d:	e8 e5 f9 ff ff       	call   80107e17 <walkpgdir>
80108432:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108435:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108439:	75 09                	jne    80108444 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010843b:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108442:	eb 4d                	jmp    80108491 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108444:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108447:	8b 00                	mov    (%eax),%eax
80108449:	83 e0 01             	and    $0x1,%eax
8010844c:	84 c0                	test   %al,%al
8010844e:	74 41                	je     80108491 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108450:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108453:	8b 00                	mov    (%eax),%eax
80108455:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010845a:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
8010845d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108461:	75 0c                	jne    8010846f <deallocuvm+0x82>
        panic("kfree");
80108463:	c7 04 24 d9 8d 10 80 	movl   $0x80108dd9,(%esp)
8010846a:	e8 ce 80 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010846f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108472:	89 04 24             	mov    %eax,(%esp)
80108475:	e8 1a f5 ff ff       	call   80107994 <p2v>
8010847a:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
8010847d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108480:	89 04 24             	mov    %eax,(%esp)
80108483:	e8 46 a9 ff ff       	call   80102dce <kfree>
      *pte = 0;
80108488:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010848b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010849e:	0f 82 74 ff ff ff    	jb     80108418 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801084ac:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801084af:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801084b3:	75 0c                	jne    801084c1 <freevm+0x18>
    panic("freevm: no pgdir");
801084b5:	c7 04 24 df 8d 10 80 	movl   $0x80108ddf,(%esp)
801084bc:	e8 7c 80 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801084c1:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084c8:	00 
801084c9:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801084d0:	80 
...
80108518:	e8 b1 a8 ff ff       	call   80102dce <kfree>
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
8010851d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80108521:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
80108528:	76 bb                	jbe    801084e5 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108530:	e8 99 a8 ff ff       	call   80102dce <kfree>
}
80108535:	c9                   	leave  
80108536:	c3                   	ret    
...
80108548:	89 44 24 04          	mov    %eax,0x4(%esp)
8010854c:	8b 45 08             	mov    0x8(%ebp),%eax
8010854f:	89 04 24             	mov    %eax,(%esp)
80108552:	e8 c0 f8 ff ff       	call   80107e17 <walkpgdir>
80108557:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010855a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010855e:	75 0c                	jne    8010856c <clearpteu+0x35>
    panic("clearpteu");
80108560:	c7 04 24 f0 8d 10 80 	movl   $0x80108df0,(%esp)
...
80108573:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108580:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108583:	e8 b9 f9 ff ff       	call   80107f41 <setupkvm>
80108588:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010858b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010858f:	75 0a                	jne    8010859b <copyuvm+0x1e>
    return 0;
80108591:	b8 00 00 00 00       	mov    $0x0,%eax
80108596:	e9 f1 00 00 00       	jmp    8010868c <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
8010859b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801085a2:	e9 c0 00 00 00       	jmp    80108667 <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801085a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085aa:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801085b1:	00 
801085b2:	89 44 24 04          	mov    %eax,0x4(%esp)
801085b6:	8b 45 08             	mov    0x8(%ebp),%eax
801085b9:	89 04 24             	mov    %eax,(%esp)
801085bc:	e8 56 f8 ff ff       	call   80107e17 <walkpgdir>
801085c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
801085c4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801085c8:	75 0c                	jne    801085d6 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
801085ca:	c7 04 24 fa 8d 10 80 	movl   $0x80108dfa,(%esp)
...
801085e0:	75 0c                	jne    801085ee <copyuvm+0x71>
      panic("copyuvm: page not present");
801085e2:	c7 04 24 14 8e 10 80 	movl   $0x80108e14,(%esp)
801085e9:	e8 4f 7f ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
...
80108626:	e8 d6 cd ff ff       	call   80105401 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
8010862b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010862e:	89 04 24             	mov    %eax,(%esp)
80108631:	e8 51 f3 ff ff       	call   80107987 <v2p>
80108636:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108639:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108640:	00 
80108641:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108645:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010864c:	00 
8010864d:	89 54 24 04          	mov    %edx,0x4(%esp)
80108651:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108654:	89 04 24             	mov    %eax,(%esp)
80108657:	e8 51 f8 ff ff       	call   80107ead <mappages>
8010865c:	85 c0                	test   %eax,%eax
8010865e:	78 1b                	js     8010867b <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108660:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108667:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010866a:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010866d:	0f 82 34 ff ff ff    	jb     801085a7 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108676:	eb 14                	jmp    8010868c <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108678:	90                   	nop
80108679:	eb 01                	jmp    8010867c <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
8010867b:	90                   	nop
...
80108682:	e8 22 fe ff ff       	call   801084a9 <freevm>
  return 0;
...
801086ee:	83 ec 28             	sub    $0x28,%esp
  ...
  buf = (char*)p;
801086f1:	8b 45 10             	mov    0x10(%ebp),%eax
801086f4:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801086f7:	e9 8b 00 00 00       	jmp    80108787 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801086fc:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80108714:	e8 75 ff ff ff       	call   8010868e <uva2ka>
80108719:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
8010871c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108720:	75 07                	jne    80108729 <copyout+0x3e>
      return -1;
80108722:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108727:	eb 6d                	jmp    80108796 <copyout+0xab>
    n = PGSIZE - (va - va0);
80108729:	8b 45 0c             	mov    0xc(%ebp),%eax
8010872c:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010872f:	89 d1                	mov    %edx,%ecx
80108731:	29 c1                	sub    %eax,%ecx
80108733:	89 c8                	mov    %ecx,%eax
80108735:	05 00 10 00 00       	add    $0x1000,%eax
8010873a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
8010873d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108740:	3b 45 14             	cmp    0x14(%ebp),%eax
80108743:	76 06                	jbe    8010874b <copyout+0x60>
      n = len;
80108745:	8b 45 14             	mov    0x14(%ebp),%eax
80108748:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010874b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010874e:	8b 55 0c             	mov    0xc(%ebp),%edx
80108751:	89 d1                	mov    %edx,%ecx
80108753:	29 c1                	sub    %eax,%ecx
80108755:	89 c8                	mov    %ecx,%eax
80108757:	03 45 e8             	add    -0x18(%ebp),%eax
8010875a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010875d:	89 54 24 08          	mov    %edx,0x8(%esp)
80108761:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108764:	89 54 24 04          	mov    %edx,0x4(%esp)
80108768:	89 04 24             	mov    %eax,(%esp)
8010876b:	e8 91 cc ff ff       	call   80105401 <memmove>
    len -= n;
80108770:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108773:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108776:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108779:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
8010877c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010877f:	05 00 10 00 00       	add    $0x1000,%eax
80108784:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108787:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
8010878b:	0f 85 6b ff ff ff    	jne    801086fc <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
